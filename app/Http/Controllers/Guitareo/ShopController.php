...
class ShopController extends BaseController
{
    ...
    {
        $products = Product::whereHas('brand', fn($query) => $query->where('name', 'guitareo'))->where([['shop_card_visible', 1], ['product_type_id', '!=', 6], ['is_seasonal', 0]])
        ...
        return view('guitareo.shop.shop', [
            'lessons' => $lessons,
