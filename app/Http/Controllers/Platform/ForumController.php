...
class ForumController extends Controller
{
     ...
     */
    public function forumIndex(Request $request, $domain, $brand)
    {
        ...
        foreach ($discussions as $discussion) {
            ...
            $mappedDiscussions[] = [
                ...
                "url" => url()->route('forums.thread.list', [$discussion['slug'], $discussion['id']]),
     ...
     */
    public function searchIndex(Request $request, $domain, $brand)
    {
        ...
        foreach ($results as $index => $post) {
            ...
            $mappedItems[] = [
                ...
                'url' => url()->route('forums.post.jump-to', [$post['id']]),
                'thread' => [
     ...
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\Foundation\Application|\Illuminate\View\View
     */
    public function createThread(Request $request, $domain, $brand)
    {
        $categories = $this->categoryRepository->getDecoratedCategories();

        return view(
            'members.forums.create',
            [
                "user" => user(),
     ...
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\Foundation\Application|\Illuminate\View\View
     */
    public function updateThread(Request $request, $domain, $brand, $id)
    {
     ...
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\Foundation\Application|\Illuminate\View\View
     */
    public function showThreadById(Request $request, $domain, $brand, $id)
    {
        $thread =
        ...
        return $this->showThread($category->slug, $category->id, $thread->slug, $thread->id, $request);
    }
     ...
     */
    public function jumpToPost(Request $request, $domain, $brand, $id)
    {
     ...
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\Foundation\Application|\Illuminate\View\View
     */
    public function threadList(Request $request, $domain, $brand, $categorySlug, $categoryId)
    {
        ...
        return view(
            ...
            [
                ...
                'user' => $currentUser,
                'isAdmin' => $isAdmin,
                "categoryUrl" => url()->route('forums.thread.list', [$category->slug, $category->id]),
            ]
        );
    }
    ...
    public function showThread(Request $request, $domain, $brand, $categorySlug, $categoryId, $threadSlug, $id)
    {
        ...
        $mappedThread = [
            ...
            "url" => url()->route('forums.thread', [$thread->id]),
            "currentPage" => $page,
            "totalPages" => ceil($total / $amount),
            "update" => url()->route('forums.thread.update', [$thread->id]),
        ];
     ...
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\Foundation\Application|\Illuminate\View\View
     */
    public function createForum(Request $request, $domain, $brand)
    {
        return view(
     ...
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\Foundation\Application|\Illuminate\View\View
     */
    public function updateForum(Request $request, $domain, $brand, $id)
    {
     ...
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\Foundation\Application|\Illuminate\View\View
     */
    public function forumIndexNew(Request $request, $domain, $brand)
    {
        $amount = $request->get('amount', 20);
        $page = $request->get('page', 1);
        $sortBy = $request->get('sortby_val', '-last_post_published_on');
        ...
        return view('members.forums.latest', [
            "threads" => $mappedThreads,
            'threadCount' => $threadsCount,
            'user' => $currentUser,
        ]);
