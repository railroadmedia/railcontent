...
class ShopController extends BaseController
{
    public function shop(Request $request)
    {
        ...
        $sale1dollar = Product::whereHas('brand', fn($query) => $query->where('name', 'drumeo'))->where([['sold_out', 0]])->orderBy('price', 'desc')->get()->whereIn('id', [59, 61, 62, 63, 64, 65, 66, 67, 68, 69, 70, 71, 73, 74]);
