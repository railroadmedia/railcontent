...
/**
 * Defines the schema structure for a Boot camp document type in Sanity.
 *
 ...
 */
class BootCamp extends BaseSanityModel
{
    public function __construct()
    {
        ...
        parent::__construct(self::getName(), 'Boot Camps', fields: $fields, preview: $preview, groups: $groups);
    }
