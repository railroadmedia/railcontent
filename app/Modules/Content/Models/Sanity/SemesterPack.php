 ...
 */
class SemesterPack extends BaseSanityModel
{
    public function __construct()
    {
        $childReference = new Reference([['type' => 'semester-pack-lesson']]);
        ...
        parent::__construct(self::getName(), 'Semester Packs', fields: $fields, preview: $preview, groups: $groups);
    }
