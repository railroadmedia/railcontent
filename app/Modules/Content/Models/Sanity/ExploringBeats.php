...
/**
 * Defines the schema structure for a Exploring Beats document type in Sanity.
 *
 ...
 */
class ExploringBeats extends BaseSanityModel
{
    public function __construct()
    {
        ...
        parent::__construct(self::getName(), 'Exploring Beats', fields: $fields, preview: $preview, groups: $groups);
    }

    public static function getName(): string
    {
        return 'exploring-beats';
    }
}
