...
/**
 * Defines the schema structure for a Behind The Scenes document type in Sanity.
 *
 ...
 */
class BehindTheScenes extends BaseSanityModel
{
    public function __construct()
    {
        ...
        parent::__construct(self::getName(), 'Behind The Scenes', fields: $fields, preview: $preview, groups: $groups);
    }
