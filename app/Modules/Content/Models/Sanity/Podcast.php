...
/**
 * Defines the schema structure for a Podcast document type in Sanity.
 *
 ...
 */
class Podcast extends BaseSanityModel
{
    public function __construct()
    {
        ...
        parent::__construct(self::getName(), 'Podcasts', fields: $fields, preview: $preview, groups: $groups);
    }
