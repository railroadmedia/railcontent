...
/**
 * Defines the schema structure for a In Rhythm document type in Sanity.
 *
 ...
 */
class InRhythm extends BaseSanityModel
{
    public function __construct()
    {
        ...
        parent::__construct(self::getName(), 'In Rhythm', fields: $fields, preview: $preview, groups: $groups);
    }
