...
/**
 * Defines the schema structure for a Gear Guide document type in Sanity.
 *
 ...
 */
class GearGuide extends BaseSanityModel
{
    public function __construct()
    {
        ...
        parent::__construct(self::getName(), 'Gear Guides', fields: $fields, preview: $preview, groups: $groups);
    }
