...
/**
 * Defines the schema structure for a Sonor document type in Sanity.
 *
 ...
 */
class Sonor extends BaseSanityModel
{
    public function __construct()
    {
        ...
        parent::__construct(self::getName(), 'Sonor Drums', fields: $fields, preview: $preview, groups: $groups);
    }
