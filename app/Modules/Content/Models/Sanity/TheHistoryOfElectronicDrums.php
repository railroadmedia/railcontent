...
/**
 * Defines the schema structure for a History Of Electronic Drums document type in Sanity.
 *
 ...
 */
class TheHistoryOfElectronicDrums extends BaseSanityModel
{
    public function __construct()
    {
        ...
        parent::__construct(self::getName(), 'The History Of Electronic Drums', fields: $fields, preview: $preview, groups: $groups);
    }

    public static function getName(): string
    {
        return 'the-history-of-electronic-drums';
    }
}
