...
/**
 * Defines the schema structure for a Challenges document type in Sanity.
 *
 ...
 */
class Challenges extends BaseSanityModel
{
    public function __construct()
    {
        ...
        parent::__construct(self::getName(), 'Challenges', fields: $fields, preview: $preview, groups: $groups);
    }
