 ...
 */
class Foundation extends BaseSanityModel
{
...
//            new Field(FieldType::Number, 'popularity', 'Popularity', readOnly: "true", group: $detailsGroup),
        ...
        parent::__construct(self::getName(), 'Foundation 2019 - WIP', fields: $fields, preview: $preview, groups: $groups);
    }

    public static function getName(): string
    {
        return 'foundation-2019';
    }
}
