...
/**
 * Defines the schema structure for a Question And Answer document type in Sanity.
 *
 ...
 */
class QuestionAndAnswer extends BaseSanityModel
{
    public function __construct()
    {
        ...
        parent::__construct(self::getName(), 'Question & Answer', fields: $fields, preview: $preview, groups: $groups);
    }
