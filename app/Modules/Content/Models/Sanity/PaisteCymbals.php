...
/**
 * Defines the schema structure for a Paiste document type in Sanity.
 *
 ...
 */
class PaisteCymbals extends BaseSanityModel
{
    public function __construct()
    {
        ...
        parent::__construct(self::getName(), 'Paiste Cymbals', fields: $fields, preview: $preview, groups: $groups);
    }

    public static function getName(): string
    {
        return 'paiste-cymbals';
    }
}
