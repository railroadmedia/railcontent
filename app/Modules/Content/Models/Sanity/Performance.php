...
/**
 * Defines the schema structure for a Performance document type in Sanity.
 *
 ...
 */
class Performance extends BaseSanityModel
{
    public function __construct()
    {
        ...
        parent::__construct(self::getName(), 'Performances', fields: $fields, preview: $preview, groups: $groups);
    }
