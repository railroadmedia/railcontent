...
/**
 * Defines the schema structure for a Solo document type in Sanity.
 *
 ...
 */
class Solo extends BaseSanityModel
{
    public function __construct()
    {
        ...
        parent::__construct(self::getName(), 'Solos', fields: $fields, preview: $preview, groups: $groups);
    }
