 ...
 */
class Workout extends BaseSanityModel
{
    public function __construct()
    {
        ...
        $video = new ListObject(fields: [new Field(FieldType::String, 'type', options:['list' => array_column(VideoType::cases(), 'value')],  validation: "(rule) => rule.required()"),
