...
/**
 * Defines the schema structure for a Student Collaboration document type in Sanity.
 *
 ...
 */
class StudentCollaboration extends BaseSanityModel
{
    public function __construct()
    {
        ...
        parent::__construct(self::getName(), 'Student Collaborations', fields: $fields, preview: $preview, groups: $groups);
    }

    public static function getName(): string
    {
        return 'student-collaboration';
    }
}
