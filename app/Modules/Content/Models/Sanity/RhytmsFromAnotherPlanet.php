 ...
 */
class RhytmsFromAnotherPlanet extends BaseSanityModel
{
    public function __construct()
    {
        ...
        parent::__construct(self::getName(), 'Rhytms From Another Planet', fields: $fields, preview: $preview, groups: $groups);
    }
