...
/**
 * Defines the schema structure for a Diy Drum Experiments document type in Sanity.
 *
 ...
 */
class Diy extends BaseSanityModel
{
    public function __construct()
    {
        ...
        parent::__construct(self::getName(), 'Diy Drum Experiments', fields: $fields, preview: $preview, groups: $groups);
    }

    public static function getName(): string
    {
        return 'diy-drum-experiment';
    }
}
