...
class MaxDate extends ValidationRule
{
    /**
     * @param  string  $value  the ISO 8601 string format of the maximum date,
     *                      or the string name of the field to reference if $useValueOfField is true
     * @param  bool  $useValueOfField when set, the $value is the name of a field to use the value of as the maximum date
