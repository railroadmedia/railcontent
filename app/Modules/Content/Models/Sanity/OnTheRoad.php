...
/**
 * Defines the schema structure for an On The Road document type in Sanity.
 *
 ...
 */
class OnTheRoad extends BaseSanityModel
{
    public function __construct()
    {
        ...
        parent::__construct(self::getName(), 'On The Road', fields: $fields, preview: $preview, groups: $groups);
    }
