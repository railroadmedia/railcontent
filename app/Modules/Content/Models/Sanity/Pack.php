...
/**
 * Defines the schema structure for a Pack document type in Sanity.
 *
 ...
 */
class Pack extends BaseSanityModel
{
...
//            new Field(FieldType::Number, 'popularity', 'Popularity', readOnly: "true", group: $detailsGroup),
        ...
        parent::__construct(self::getName(), 'Packs - WIP', fields: $fields, preview: $preview, groups: $groups);
    }
