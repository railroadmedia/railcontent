...
/**
 * Defines the schema structure for a Backstage Secret document type in Sanity.
 *
 ...
 */
class BackstageSecret extends BaseSanityModel
{
    public function __construct()
    {
        ...
        parent::__construct(self::getName(), 'Backstage Secrets', fields: $fields, preview: $preview, groups: $groups);
    }

    public static function getName(): string
    {
        return 'backstage-secret';
    }
}
