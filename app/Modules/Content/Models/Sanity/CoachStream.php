...
/**
 * Defines the schema structure for a Coach Stream document type in Sanity.
 *
 ...
 */
class CoachStream extends BaseSanityModel
{
...
//            new Field(FieldType::Number, 'popularity', 'Popularity', readOnly: "true", group: $detailsGroup),
        ...
        parent::__construct(self::getName(), 'Coach Stream - WIP', fields: $fields, preview: $preview, groups: $groups);
    }
