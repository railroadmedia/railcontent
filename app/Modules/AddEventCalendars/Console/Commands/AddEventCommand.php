...
class AddEventCommand extends Command
{
    ...
    private function overviewCurrent()
    {
        ...
        $this->info('');
        $this->info(
            'calendar_title,calendar_uniquekey,id,unique_key,startTime,title,date_modified,content_id,cmsUrl,errorMsg'
        );
    ...
    private function getCalendarIdsForMusora(): void
    {
        ...
        $this->info(
            'copy and paste this into \'uniquekeys-by-brand\' array under relevant brand in config/addevent.php in Musora'
        );
        $this->info('-----------------------------------------------------------------------------------------');
        $this->info('');
        $this->info('');
