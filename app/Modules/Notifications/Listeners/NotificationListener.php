...
class NotificationListener
{
    ...
    public function handle(Event $event)
    {
        ...
        switch ($event->type) {
            ...
            case Notification::TYPE_LESSON_COMMENT_REPLY:
                ...
                $contentMobileAppUrl =
                    $content['url'] . '?goToComment=' . $comment['parent_id'] ?? $comment['id'];
            ...
            case Notification::TYPE_LESSON_COMMENT_LIKED:
                ...
                $contentMobileAppUrl = $content['url'] . '?goToComment=' . $comment['id'];
    ...
    public function handleCommentCreated(CommentCreated $event)
    {
        ...
        $contentMobileAppUrl =  $content['url'] . '?goToComment=' . $comment['parent_id'] ?? $comment['id'];
