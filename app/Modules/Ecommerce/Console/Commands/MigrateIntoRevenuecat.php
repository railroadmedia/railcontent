        ...
        foreach ($resPianote as $userR) {
            ...
            if (!empty($entitlements)) {
                foreach ($entitlements as $entitlement) {
                    ...
                    $isActiveRevenueCat =
                        ((Carbon::parse($subscriptionData->expires_date) >= now()->subDays(5) &&
                    ...
                    $isActive =
                        $musoraSubscriptions->apple_expiration_date ==
                        Carbon::parse($subscriptionData->expires_date)
                            ->toDateTimeString();
                    if ($isActive) {
                        $conditionMeet = true;
