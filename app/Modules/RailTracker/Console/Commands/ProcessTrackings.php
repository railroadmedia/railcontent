...
use App\Modules\RailTracker\Events\RequestTracked;
use App\Modules\RailTracker\Repositories\RequestRepository;
...
class ProcessTrackings extends Command
{
    /**
     * @var string
     */
    ...
    public function handle()
    {
        ...
        while ($redisIterator !== 0) {
            ...
            try {
                ...
                $redisIterator = $scanResult ? (int)$scanResult[0] : 0;
