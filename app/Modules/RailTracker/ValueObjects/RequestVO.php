...
namespace App\Modules\RailTracker\ValueObjects;
...
//        };
        ...
        // cookie id
        //cookie id too long, not sure if this is really useful so it was truncated
        $cookieId = $httpRequest->cookie(self::$visitorCookieKey);
        $this->cookieId = $cookieId ? substr($cookieId, 0, 64) : $cookieId;
