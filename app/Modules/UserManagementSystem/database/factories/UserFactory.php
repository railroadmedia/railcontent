...
class UserFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'membership_expiration_date' => Carbon::now()->addMonths(3)->toDateTimeString(),
            ...
            'membership_start_date' => Carbon::now()->subMonths(3)->toDateTimeString(),
            'revenuecat_origin_app_user_id' => null,
            'drumeo_trial_section_hide' => 0,
            'pianote_trial_section_hide' => 0,
            'guitareo_trial_section_hide' => 0,
            'singeo_trial_section_hide' => 0,
            'send_mobile_app_push_notifications' => 1,
            'send_email_notifications' => 1,
            'has_recharge_subscription' => 0,
            'recharge_interval' => null,
            'has_apple_subscription' => 0,
            'has_google_subscription' => 0,
            'requires_password_update' => 0,
            'cio_synced_workspaces' => null,
            'recharge_renewal_date' => null,
