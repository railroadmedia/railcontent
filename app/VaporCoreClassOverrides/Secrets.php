...
/**
 * This class override is done through the composer file. This class is nessecary to allow us to use
 * Laravel Vapor Secrets as .env files. See https://github.com/laravel/vapor-core/pull/96
 *
