...
Route::domain('{singeoDomain}')
    ...
    ->group(function () {
        ...
        Route::get('/affiliate/musician-wave-sing', [SalesController::class, 'musicianwavesing']);
        Route::get('/affiliate/singeo-musicradar', [SalesController::class, 'singeomusicradar']);
