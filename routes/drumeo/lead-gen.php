...
Route::domain('{drumeoDomain}')->middleware(['web_public'])->group(function () {
    ...
    Route::get('/{page?}', LeadGenController::class . '@pages')
        ->whereIn('page', [
            'lifetime-members-masterclass', 'click', 'free-drum-lessons', 'quick-drummer-survey', 'teach-a-beginner', 'thankyou', 'thank-you', 'ty-annual', 'ty-monthly', '30-day-drummer-unsubscribe', '30-day-drummer-subscribe', 'subscribed', 'confirming', 'lets-stay-together', 'welcome-party', 'recitals', '30-day-drummer-live', 'awards', 'fwtgf-blog', '40s-blog', 'gsd-blog', 'gojb-blog', 'fpa-blog'
        ]);
