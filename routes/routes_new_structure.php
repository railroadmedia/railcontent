...
use Railroad\Railcontent\Middleware\NewDatabaseStructureMiddleware;

Route::group(
    [
        'prefix' => 'railcontent_new',
        'middleware' => array_merge(config('railcontent.all_routes_middleware'),[NewDatabaseStructureMiddleware::class])
    ],
    function () {
