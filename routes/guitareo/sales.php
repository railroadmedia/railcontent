...
Route::domain('{guitareoDomain}')->group(function () {
    ...
    Route::get('/acoustic-guitar-made-easy', [SalesController::class, 'acousticGuitarMadeEasy']);
    ...
    Route::get('/guitar-system', [SalesController::class, 'gs']);
    Route::get('/guitar-technique-made-easy', [SalesController::class, 'guitarTechniqueMadeEasy']);
    ...
    Route::get('/rhythm-and-groove', [SalesController::class, 'rhythmAndGroove']);
});
