<div class="flex flex-row ">
    <div class="relative gq-container corners-10 overflow">
        <a href="{{ $lessonsUrl }}">
            ...
            <div class="bg-guitareoGuitarQuest text-white tw-font-bison-bold tw-font-normal dense uppercase title tw-px-3 tw-py-2 tw-leading-none" style="position:absolute;top:0;left:0;border-radius:10px 0 10px 0">
        ...
        <div class="gq-cta">
            <div class="flex flex-row align-v-center" style="height: 100%;">
                <div class="flex flex-column align-h-center">
                    ...
                    <a
                        href="{{ $lessonsUrl }}"
                        class="mt-1 text-white dense uppercase tiny no-decoration hide-xs-only" style="opacity:0.8"
                    >
