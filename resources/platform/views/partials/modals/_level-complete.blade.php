...
<div x-show.transition.opacity="modalOpen === 'levelComplete'"
     ...
     style="background-image: url( https://www.musora.com/cdn-cgi/image/width=1500,quality=95/https://d122ay5chh2hr5.cloudfront.net/guitarquest/assets/star-pattern.svg); background-color: #000718;"
>
    ...
    <div class="tw-w-full tw-flex tw-flex-col tw-min-h-full">
        <div class="tw-w-full md:tw-w-3/4 lg:tw-w-7/12 tw-m-auto tw-flex-1">
            <div class="tw-flex tw-flex-col tw-relative tw-items-center">
                <img id="packLogo"
                    src="https://www.musora.com/cdn-cgi/image/width=1000,quality=95/https://d122ay5chh2hr5.cloudfront.net/guitarquest/assets/guitar-quest-logo.png"
                ...
                <h1 class="heading tw-text-white tw-m-4 tw-uppercase tw-font-normal tw-text-center tw-items-center tw-flex tw-tracking-widest">
                    <img class="tw-w-10 tw-inline-flex tw-mr-3" src="https://www.musora.com/cdn-cgi/image/width=500,quality=95/https://d122ay5chh2hr5.cloudfront.net/guitarquest/assets/coin-challenges-completed.png">
                        ...
                        <div class="tw-relative tw-rounded-xl tw-border-solid tw-border-4 tw-border-gray-500 tw-overflow-hidden">
                            ...
                            <div class="tw-absolute tw-justify-center tw-items-center tw-inset-0 tw-bg-black tw-bg-opacity-50 tw-z-250 tw-flex">
                                <img class="tw-w-16 lg:tw-w-24 tw-block"
                                    src="https://www.musora.com/cdn-cgi/image/width=185,quality=95/https://d122ay5chh2hr5.cloudfront.net/guitarquest/assets/coin-lessons-crushed.png"
                                >
                            </div>
                        </div>
                    ...
                    <div class="tw-w-full lg:tw-w-2/3 tw-mx-auto">
                        <div class="tw-w-full md:tw-w-3/4 tw-mx-auto tw-flex tw-justify-around">
                            ...
                            <div class="tw-flex tw-flex-col tw-items-center">
                                <img class="tw-w-24 sm:tw-w-32 md:tw-w-36 tw-block" src="https://www.musora.com/cdn-cgi/image/width=185,quality=95/https://d122ay5chh2hr5.cloudfront.net/guitarquest/assets/coin-lessons-crushed.png">
                            ...
                            <div class="tw-flex tw-flex-col tw-items-center">
                                <img class="tw-w-24 sm:tw-w-32 md:tw-w-36 tw-block" src="https://www.musora.com/cdn-cgi/image/width=185,quality=95/https://d122ay5chh2hr5.cloudfront.net/guitarquest/assets/coin-challenges-completed.png">
