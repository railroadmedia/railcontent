        ...
        <div class="tw-w-full md:tw-w-5/6 xl:tw-w-7/12 tw-m-auto tw-flex-1">
            <div class="tw-flex tw-flex-col tw-relative tw-items-center">
                ...
                <h1 class="heading tw-text-white tw-m-4 tw-uppercase tw-font-normal tw-text-center tw-items-center tw-flex tw-tracking-widest">
                    <img class="tw-block tw-w-10 tw-inline-flex tw-mr-3" src="{{ imgix("https://d122ay5chh2hr5.cloudfront.net/guitarquest/assets/coin-lessons-crushed.png", ["auto" => "format", "w" => 185]) }}">
                    Lesson Completed!
                </h1>
                ...
                <div class="tw-flex tw-w-full tw-pb-16 tw-flex-wrap tw-flex-col sm:tw-w-1/2">
                    <div class="tw-flex tw-flex-col tw-p-4 tw-relative tw-w-full tw-text-center">
                        ...
                        <p class="tw-text-white tw-font-extrabold tw-text-xl tw-font-bold font-primary tw-text-center tw-my-2">
                    ...
                    <div class="tw-w-full lg:tw-w-2/3 tw-mx-auto">
                        <div class="tw-w-full md:tw-w-3/4 tw-mx-auto tw-flex tw-justify-around">
                            ...
                            <div class="tw-flex tw-flex-col tw-items-center">
                                ...
                                <h3 class="tw-text-7xl w-text-white tw-font-bold tw-text-white font-roboto-condensed-bold">{{ ($totalCompletedLessons ?? 0) + 1 }}</h3>
                            </div>
                            ...
                            <div class="tw-flex tw-flex-col tw-items-center">
                                ...
                                <h3 class="tw-text-7xl tw-text-white tw-font-bold tw-text-white font-roboto-condensed-bold">{{ $totalCompletedLevels ?? 0 }}</h3>
                            </div>
                        </div>
                    </div>
                </section>
