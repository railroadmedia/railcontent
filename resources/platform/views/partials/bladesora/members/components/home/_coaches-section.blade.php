@if($hasSubscribedCoaches)
    <section class="tw-w-full tw-flex tw-flex-row tw-mb-6 md:tw-mb-8">
        <div class="tw-w-full tw-flex tw-flex-col tw-grow">
            ...
            <div class="tw-px-4 lg:tw-px-0 tw-flex tw-items-center tw-mb-4 tw-w-full tw-justify-between">
                ...
                <a href="{{ $subscribedCoachesUrl }}"
                    ...
                    class="tw-text-base xl:tw-text-lg xl:tw-leading-none tw-flex-shrink-0 tw-uppercase tw-leading-none tw-font-bebas-neue tw-text-[#00101D] dark:tw-text-white tw-border-b tw-border-transparent tw-transition-all hover:tw-border-current"
                >
                    See All
                </a>
            </div>
            <div class="tw-w-full tw-relative tw-flex tw-gap-3 tw-overflow-x-auto tw-no-scrollbar tw-px-4 lg:tw-px-0 tw-snap-x">
                @foreach($subscribedCoaches->results() as $coach)
                    <a href="{{ $coach->fetch('url','') }}"
                        class="tw-no-underline tw-min-w-[200px] lg:tw-min-w-0 lg:tw-w-1/5 tw-inline-flex last-of-type:tw-inline-flex lg:last-of-type:tw-hidden 2xl:tw-w-1/6 2xl:last-of-type:tw-inline-flex">
