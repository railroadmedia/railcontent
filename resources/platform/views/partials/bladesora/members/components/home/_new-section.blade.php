    ...
    <div class="tw-flex tw-flex-col tw-w-full">
        ...
        <div class="tw-flex tw-items-center tw-mb-4 tw-w-full tw-justify-between tw-px-4 lg:tw-px-0">
            <a href="{{ $allLessonsUrl }}"
                ...
                <h2 class="tw-font-bold tw-text-2xl tw-leading-none lg:tw-leading-none lg:tw-text-3xl">New Releases</h2>
            </a>
            <a href="{{ $allLessonsUrl }}" aria-label="See All New Lessons"
        ...
        <div>
            <transition appear name="fade">
                <catalogue-card-container theme-color="{{ $brand }}" :use-theme-color="true"
                    content-endpoint="{{ $contentEndpoint ? $contentEndpoint : '/railcontent/content' }}"
                    catalogue-type="grid" no-results-icon="happy"
                    ...
                    limit="16" :lock-unowned="true" :six-wide="true" :force-wide-thumbs="true"
