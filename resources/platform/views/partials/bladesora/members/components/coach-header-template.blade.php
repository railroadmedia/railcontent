...
<section class="tw-grid xs:tw-grid-cols-1 sm:tw-grid-cols-1 md:tw-grid-cols-1 lg:tw-grid-cols-2 tw-gap-0 tw-relative">
    <div class="lg:tw-hidden tw-bg-top tw-bg-cover tw-text-white tw-min-h-[25vh]"
        style="
            ...
            background-image: url(https://www.musora.com/cdn-cgi/image/quality=95/{{ $backgroundImage }});">
    ...
    <div class="tw-hidden lg:tw-flex tw-bg-top tw-bg-cover tw-text-white"
         style="
            background-color: {{ $colors["$brand"]['solidBg'] }};
            background-image: url(https://www.musora.com/cdn-cgi/image/quality=95/{{ !empty($backgroundImage) ? $backgroundImage : 'https://d3fzm1tzeyr5n3.cloudfront.net/headers/'.$brand.'-header.jpg' }});">
