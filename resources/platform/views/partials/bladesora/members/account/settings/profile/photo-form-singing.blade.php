...
<div class="tw-flex tw-flex-col tw-grow">
                    ...
                    <div class="flex flex-row flex-wrap align-center tw-relative">
                        ...
                        >
                            ...
                            <img class="tw-w-full tw-absolute tw-top-0 tw-left-0 {{ empty($gearPhotoUrl) ? 'tw-hidden' : ''}}"
                                 src="{{ !empty($gearPhotoUrl) ? $gearPhotoUrl : 'https://www.musora.com/musora-cdn/image/quality=95/https://dmmior4id2ysr.cloudfront.net/assets/images/default-gear-photo.jpg' }}"
                                 data-singeo-gear-update="true"
                            >
                        </button>
                        @if( !empty($gearPhotoUrl) )
                            <span data-clear-gear-photo="singing" class="rounded clear-button tw-top-1 tw-right-1">
    ...
    {{-- Photo Modal --}}
    <div id="singingGearPhotoModal" class="modal">
        <div class="flex flex-column bg-white corners-10 shadow">
            <div class="flex flex-row pa-3">
                <h2 class="subheading">Edit: Singing Gear Photo</h2>
            </div>
