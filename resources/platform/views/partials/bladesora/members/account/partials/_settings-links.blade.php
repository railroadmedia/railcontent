<div class="flex flex-row pv flex-wrap account-links">
    @foreach($sections as $section)
        <div class="account-link flex flex-column xs-6 sm-4 md-3 pa {{ $brand }}">
            <a href="{{ $section['url'] }}"
               class="flex-center ba-black-2 corners-10 heading no-decoration tw-text-[#3F3F46] dark:tw-text-[#9EC0DC] pv-3 ph-1 tw-transition-all dark:tw-border-[#445F74] dark:hover:tw-bg-[#102230] hover:tw-bg-[#F5F5F6]"
