<div class="flex flex-column tw-max-w-3xl tw-mx-auto tw-px-4">
    ...
    <section class="tw-flex tw-flex-col tw-text-center tw-mb-12 tw-text-[#00101D] dark:tw-text-white">
        ...
        <p class="tw-text-base">For current available positions at our company, please visit <a href="/careers" title="go to help center" class="tw-font-bold tw-no-underline text-{{ $themeColor }}">Musora.com/Careers</a>.</p>
    </section>
</div>