        ...
        <div class="slider-container tw-overflow-hidden tw-w-full tw-mb-5 md:tw-mb-7" style="font-size: 0;@if(!empty($interactiveBanner)) max-height:1500px @endif">
            ...
            @if(!empty($interactiveBanner))
                <div class="tw-rounded-b tw-p-4 tw-flex tw-justify-between tw-items-center bg-drumeo sm:tw-py-1 sm:tw-px-5">
                    <img class="tw-w-full sm:tw-w-2/3" src="https://cdn.musora.com/image/fetch/w_1000,q_auto:best/https://s3.amazonaws.com/drumeo-packs/interactive-edition-logo-white.png">
                    <img class="tw-w-40 tw-hidden sm:tw-inline lg:tw-w-48" src="https://cdn.musora.com/image/fetch/w_1000,q_auto:best/{{ $interactiveBanner }}">
                </div>
            @elseif(!empty($packBanner))
                <div class="tw-rounded-b tw-p-4 tw-w-full tw-flex tw-justify-between tw-items-center bg-drumeo sm:tw-py-1 sm:tw-px-5">
                    <img class="tw-w-full sm:tw-w-2/3" src="https://cdn.musora.com/image/fetch/w_1000,q_auto:best/https://s3.amazonaws.com/drumeo-packs/drumeo-training-pack-white.png">
