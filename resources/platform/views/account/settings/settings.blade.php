...
@section('edit-forms')
    <div class="tw-flex tw-flex-row tw-pt-[30px] tw-pb-0 tw-flex-auto">
    ...
    <div class="tw-flex tw-flex-col">
        <form method="POST" action="/railnotifications/user-notification-settings/update">
            ...
            <div class="tw-flex tw-flex-row tw-flex-auto tw-mt-3 tw-py-3 tw-text-[#00101D] dark:tw-text-white">
            ...
            <div class="tw-flex tw-flex-col tw-pb-[30px] tw-mb-[30px] tw-border-b tw-border-gray-300 dark:tw-border-[#223F57]">
            ...
            <div class="tw-flex tw-flex-row tw-flex-auto tw-text-[#00101D] dark:tw-text-white tw-mb-3">
...
{{--                </div>--}}
            ...
            <div class="tw-flex tw-flex-row tw-pb-[30px] tw-flex-wrap sm:tw-flex-nowrap">
