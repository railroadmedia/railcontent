        ...
        <div v-cloak>
            ...
            @if(session()->has('error-message'))
                <div class="form-success-message tw-container tw-mx-auto tw-mt-3">
                    <div class="tw-flex tw-flex-column bg-error tw-shadow corners-10 pa">
            ...
            @if(session()->has('success'))
                <div class="form-success-message tw-container tw-mx-auto tw-mt-3">
                    <div class="tw-flex tw-flex-column bg-singeo tw-shadow corners-10 pa">
            ...
            <div class="tw-container tw-mx-auto tw-px-4 dark:tw-text-white tw-pt-8 tw-pb-14">
                <div class="tw-flex tw-flex-row mt-4">
                    <div class="tw-flex tw-flex-column grow">
