...
@section('content')
    <div class="tw-w-full tw-mx-auto 3xl:tw-max-w-screen-3xl 4xl:tw-max-w-screen-4xl tw-px-4 md:tw-px-8">
        ...
        @if(session()->has('success-message-unsubscribe'))
            <div class="dark:tw-text-white tw-pt-8 tw-pb-14">
        ...
        <div class="tw-pt-8 tw-pb-14">
            <div class="tw-flex tw-flex-row">
                <div class="tw-flex tw-flex-col grow">
                    <div id="filterPillContainer" class="tw-flex tw-overflow-x-scroll tw-scrolling-touch tw-no-scrollbar tw-gap-[4px] md:tw-gap-[10px]">
