...
@section('edit-forms')
    ...
    <div id="editForm" class="flex flex-row">
...
{{--            <div class="flex flex-row pa-3 flex-auto bt-grey-1-1">--}}
{{--                @include('bladesora::members.account.settings.profile.piano-gear-form', [--}}
{{--                    'brand' => 'singeo',--}}
...
{{--            <div class="flex flex-row pa-3 flex-auto bt-grey-1-1">--}}
{{--                @include('bladesora::members.account.settings.profile.gear-photo-form', [--}}
{{--                    'brand' => 'singeo',--}}
{{--                    'method' => 'POST',--}}
...
{{--            </div>--}}
            ...
            <div class="flex flex-row pa-3 flex-auto bt-grey-1-1">
                ...
                @include('bladesora::members.account.settings.profile.signature-form', [
                    'brand' => 'singeo',
                    'method' => 'patch',
