...
@section('meta')
    <title>{{ ucfirst($brand) }} Cancel | Musora</title>
@endsection
        ...
        <div class="tw-flex tw-flex-col tw-items-center tw-p-10 tw-max-w-screen-md tw-mx-auto lg:tw-max-w-[600px]">
            ...
            <div class="tw-flex tw-flex-col md:tw-flex-row tw-mt-1 tw-w-full">
                <form method="post"
                    ...
                    <div class="tw-flex tw-flex-col tw-items-center tw-flex-row tw-justify-between tw-mx-auto  md:tw-px-10 md:tw-px-3">
                        <div class="tw-flex tw-flex-col tw-items-start tw-mt-8 tw-mb-2">

                            @foreach(config('cancellation.reason-map') as $key => $wording)
                                <label for="{{ $key }}" class="tw-mt-4 tw-text-[#00101D] dark:tw-text-white tw-transition-colors">
                    ...
                    <textarea placeholder="Type your feedback here..."
                              class="tw-mt-6 tw-rounded-lg md:tw-w-full tw-px-10"
                              name="additional-feedback"></textarea>
