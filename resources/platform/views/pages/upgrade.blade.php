...
@section('content')
    <div class="tw-container tw-mx-auto tw-px-4 md:tw-px-8 tw-mt-10 dark:tw-text-white">
        <static-header
            ...
            img="https://www.musora.com/musora-cdn/image/width=720,quality=95/https://cdn.musora.com/image/fetch/c_fill,w_1920,h_1080,q_auto:good/https://d1923uyy6spedc.cloudfront.net/coaches-2022/pianote/Lisa-Witt-Pianote-ACTION.jpg"
        />
    </div>
@endsection
