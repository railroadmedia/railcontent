        ...
        @slot('content')
            <div class="tw-flex tw-w-full tw-flex-row tw-justify-between">
                <div class="tw-flex tw-flex-col tw-pr-4">
                    ...
                    <p class="tw-text-white tw-text-[18px] tw-mb-4 tw-max-w-4xl tw-pr-12 tw-text-base tw-uppercase tw-font-open-sans">
                        <!-- TODO: GET THIS INFO FROM BACKEND -->
                        813 ARTISTS | 23,327 SONGS
                    </p>
                </div>
                <div class="tw-flex tw-flex-row tw-text-white tw-text-[20px] tw-font-bebas-neue">
                    <div class="tw-flex tw-flex-col tw-justify-center tw-items-center">
                        ...
                        <div>ABOUT MOISES</div>
                    </div>
                    <div class="tw-flex tw-flex-col tw-justify-center tw-items-center lg:tw-ml-[64px] tw-ml-[12px]">
