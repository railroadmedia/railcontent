...
@section('global-head')
    ...
    <meta property="og:image" content="https://www.musora.com/musora-cdn/image/width=1200,quality=85/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/30-day-drummer/30DD2-share-image.jpg" style="display: none;">
...
@section('global-body')
    ...
    @include('drumeo.products.partials.promo-banner', [
                "name" => "30 Day Drummer",
                "fullPrice" => 122, //floatval($productPrices['30-day-drummer-2']->price),
                "price" => 120, //floatval($productPrices['30-day-drummer-2']->discounted_price),
                "noBreadcrumb" => true
            ])
    @php
            ...
            <div class="relative">
                ...
                <table class="w-full mx-auto comparison max-w-4xl mx-auto mb-10 private">
                    ...
                    <tr>
                        ...
                        @else
                            <td class="rounded-b-xl"><strong>120</strong></td>
                        @endif
