                        ...
                        <div class="flex flex-column sm-4">
                            <a href="{{ $nextLessonUrl }}">
                                <img style="align-self: center;"
                                     src="https://www.musora.com/cdn-cgi/image/width=450,quality=95/{{ $nextLesson->fetch('data.thumbnail_url') }}">
                            </a>
                        </div>
            ...
            <div class="tw-w-full lg:tw-w-2/3 tw-mx-auto">
                <div class="tw-w-full md:tw-w-3/4 tw-mx-auto tw-flex tw-justify-around">
                    ...
                    <div class="tw-flex tw-flex-col tw-items-center">
                        <img class="tw-w-24 sm:tw-w-32 md:tw-w-44 tw-block" src="https://www.musora.com/cdn-cgi/image/width=180,quality=95/https://d122ay5chh2hr5.cloudfront.net/guitarquest/assets/coin-lessons-crushed.png">
                    ...
                    <div class="tw-flex tw-flex-col tw-items-center">
                        <img class="tw-w-24 sm:tw-w-32 md:tw-w-44 tw-block" src="https://www.musora.com/cdn-cgi/image/width=180,quality=95/https://d122ay5chh2hr5.cloudfront.net/guitarquest/assets/coin-challenges-completed.png">
