        ...
        @slot('content')
            <div class="tw-inline-flex tw-w-full tw-flex-col sm:tw-pr-4 sm:tw-mt-10">
                <h1 class="tw-text-white tw-flex tw-items-center tw-mb-2">
                    <i class="fas fa-comments tw-text-singeo tw-mr-3 tw-text-3xl"></i>
                    <span class="tw-text-32">Singeo Forums</span>
                </h1>

                <p class="tw-text-white tw-mb-6 sm:tw-mb-4 tw-max-w-4xl sm:tw-pr-12 tw-text-base">
                    The Singeo Forum is a great place for members and instructors alike to hang out, chat singing,
        ...
        <div class="flex flex-column  mv-3">
            <div class="flex flex-row">
                <forum-threads-table
                        ...
                        :thread-count="{{ $threadCount }}"></forum-threads-table>
            </div>
        </div>
    </div>
@endsection
