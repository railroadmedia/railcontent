    ...
    <div class="tw-container tw-mx-auto tw-pt-[32px] tw-px-4 md:tw-px-8 dark:tw-text-white">
        ...
        <div class="tw-w-full tw-pb-[36px]">
            <static-header
                ...
                img="https://www.musora.com/musora-cdn/image/width=720/https://cdn.musora.com/image/fetch/c_fill,w_1920,h_1080,q_auto:good/https://d3fzm1tzeyr5n3.cloudfront.net/carousel/pre-launch-header-image-jpg.jpg"
            ></static-header>
        </div>
