...
<template>
  ...
  >
    <div class="tw-row tw-flex tw-items-center">
      ...
      <!-- Logo -->
      <a :href="`/${brand}`"
        class="tw-hidden tw-w-[140px] tw-h-full lg:tw-flex tw-text-[#00101D] dark:tw-text-white tw-mr-16"
      >
        <svg class="tw-transition" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 11878.76 2760.46">
