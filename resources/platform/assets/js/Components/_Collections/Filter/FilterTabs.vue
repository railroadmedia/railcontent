    ...
    <div class="tw-flex tw-overflow-x-auto tw-no-scrollbar">
        <div class="tw-flex tw-flex-nowrap tw-gap-[7px] md:tw-gap-[10px] tw-text-sm">
            <button v-if="isMultipleTabs" v-for="(option, i) in tabOptions" :key="i" @click="onTabClick(option)"
                class="tw-btn-primary tw-flex tw-items-center tw-justify-center tw-text-center tw-border tw-text-[#000C17] dark:tw-text-white dark:tw-border-[#445F74] tw-px-4 lg:tw-px-6 tw-mb-0 tw-leading-[1px] tw-text-sm md:tw-text-base"
