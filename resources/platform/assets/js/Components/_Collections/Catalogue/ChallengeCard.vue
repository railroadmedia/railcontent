<template>
    <a :href="urlPath" class="tw-block tw-shrink-0 tw-text-primary-2 tw-text-[11px] lg:tw-text-xs tw-mb-[14px] lg:tw-mb-4 catalogue-card lg:tw-w-1/4 xl:tw-w-1/5 3xl:tw-w-1/6 tw-pr-1 lg:tw-pr-[15px]" :class="widthStyles">
        <div class="tw-rounded-[0.5px] tw-rounded-lg tw-overflow-hidden tw-border tw-border-primary-7 tw-relative tw-group">
            ...
            <!-- Community Icon -->
            <div v-if="!isSolo" class="tw-bg-[#374151] tw-rounded-xl tw-absolute tw-left-2 lg:tw-left-[13px] tw-top-2 lg:tw-top-[13px] tw-px-1 sm:tw-px-1.5 tw-py-0.5 sm:tw-py-1">
            ...
            <div class="tw-flex tw-flex-col tw-justify-end tw-items-center tw-absolute tw-left-0 tw-bottom-0 tw-w-full tw-h-full">
                <!-- Logo -->
                <img class="tw-mb-5 tw-w-full tw-px-5 tw-max-h-[90px] md:tw-max-h-[120px] tw-object-contain" :src="item.logo_image_url" />
                <!-- Date Label -->
