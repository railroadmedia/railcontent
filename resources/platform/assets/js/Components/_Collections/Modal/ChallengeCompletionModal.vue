<template>
    <ModalRenderer :black-background="true">
        <!-- Desktop/Tablet -->
        <div class="tw-hidden md:tw-flex tw-flex-col tw-justify-center tw-items-center tw-text-white">
            <h1 class="tw-text-2xl tw-font-bold tw-mb-2">You're done for the day!</h1>
            <p>Return tomorrow to maintain your streak!</p>

            <div class="tw-border tw-border-[#081825] tw-rounded-[10px] tw-overflow-hidden tw-bg-[linear-gradient(90deg,_#131A27_0%,_#182132_100%)] tw-max-w-[700px] lg:tw-max-w-[758px] tw-w-full tw-flex tw-px-8 lg:tw-px-12 tw-pb-5 tw-relative tw-overflow-hidden tw-my-5">
                <!-- Animation -->
                <Vue3Lottie class="tw-absolute tw-w-full tw-h-[500px] -tw-top-[100px] tw-left-0 tw-z-10 tw-object-cover tw-bg-cover" animation-link="https://lottie.host/d2c57df2-f221-4054-a5db-22f12e1a659a/kTBSCOj8tW.json" width="100%" height="100%" :loop="false" />
                <!-- Left -->
                    ...
                    <div class="tw-pl-6 tw-relative tw-pt-7">
                        <div class="tw-mx-5 tw-rounded-[10px] tw-overflow-hidden tw-aspect-video tw-mb-5 tw-relative">
                            ...
                            <div class="tw-absolute tw-w-full tw-h-full tw-top-0 tw-left-0 tw-bg-black/60 tw-flex tw-flex-col tw-justify-center tw-items-center">
                                <i class="fa-solid fa-lock tw-mb-2 tw-text-3xl"></i>
                                <div class="tw-font-bold tw-text-sm">Unlocks in 22:12</div>
                            </div>
                        </div>
                        <div class="tw-flex tw-gap-2 tw-text-[13px] tw-relative tw-z-20">
                            <!-- Streak -->
                            <div class="tw-flex-1 tw-rounded-[10px] tw-border tw-border-[#223F57] tw-py-1 tw-pr-1 tw-flex tw-items-center tw-relative">
                                <!-- Bubble speech -->
                                <div class="tw-absolute tw-right-0 tw-bg-[#E1EFFE] tw-rounded-[10px] tw-text-[#1E429F] tw-text-sm tw-px-2 tw-py-0.5 tw-font-semibold tw-transition-all tw-duration-700" :class="showAnimation ? '-tw-top-3' : 'tw-opacity-0 tw-top-2'">Nice!</div>
                            ...
                            <!-- Rest Days -->
                            <div class="tw-flex-1 tw-rounded-[10px] tw-border tw-border-[#223F57] tw-py-1 tw-pl-2 tw-pr-1 tw-flex tw-items-center tw-relative">
                                <!-- Bubble speech -->
                                <div class="tw-absolute tw-right-0 tw-bg-[#E1EFFE] tw-rounded-[10px] tw-text-[#1E429F] tw-text-sm tw-px-2 tw-py-0.5 tw-font-semibold tw-transition-all tw-duration-700" :class="showAnimation ? '-tw-top-3' : 'tw-opacity-0 tw-top-2'">+1</div>
                                <img class="tw-mr-3 tw-w-4 lg:tw-w-5" src="https://www.musora.com/musora-cdn/image/width=30,quality=95/https://d3fzm1tzeyr5n3.cloudfront.net/challenge-completion-modal/rest_icon.svg" />
        ...
        <!-- Mobile -->
        <div class="tw-flex tw-flex-col tw-items-center tw-h-full tw-pt-11 md:tw-hidden tw-text-white tw-px-4">
            ...
            <h1 class="tw-text-2xl tw-font-bold tw-mb-1 tw-text-center">You're done for the day!</h1>
            <p class="tw-text-center">Return tomorrow to maintain your streak!</p>
            <div class="tw-rounded-[10px] tw-bg-[#182132] tw-max-w-[300px] tw-w-full tw-flex tw-flex-col tw-py-6 tw-px-2 tw-relative tw-overflow-hidden tw-my-4">
                <!-- Animation -->
                <Vue3Lottie class="tw-absolute tw-w-full tw-h-full tw-top-0 tw-left-0 tw-z-10" animation-link="https://lottie.host/45d3a312-3d96-4827-89f1-e522d0086a65/i5udgslkg8.json" :loop="false" />
                <div class="tw-relative tw-w-full tw-mb-5">
                    <!-- Musora Logo -->
                    <img class="tw-absolute tw-w-full tw-h-full tw-top-0 tw-left-0 tw-z-0" src="https://www.musora.com/musora-cdn/image/width=400,quality=95/https://d3fzm1tzeyr5n3.cloudfront.net/challenge-completion-modal/musora.png" />
                    <div class="tw-flex tw-justify-center tw-items-center tw-relative tw-z-10">
                        <svg class="tw-transform -tw-rotate-90 tw-w-[300px] tw-h-[284px]">
                            <circle cx="142" cy="143" r="120" stroke="currentColor" stroke-width="20" fill="transparent"
                ...
                <div class="tw-flex tw-justify-center tw-gap-2 tw-text-[11px] tw-w-full tw-px-3 tw-relative tw-z-20">
                    <!-- Streak -->
                    <div class="tw-rounded-[10px] tw-border tw-border-[#223F57] tw-py-2 tw-pr-2 -tw-pl-2 tw-flex tw-items-center tw-relative">
                        <!-- Bubble speech -->
                        <div class="tw-absolute tw-right-0 tw-bg-[#E1EFFE] tw-rounded-[10px] tw-text-[#1E429F] tw-text-sm tw-px-2 tw-py-0.5 tw-font-semibold tw-transition-all tw-duration-700" :class="showAnimation ? '-tw-top-3' : 'tw-opacity-0 tw-top-2'">Nice!</div>
                        <!-- Streak Lottie -->
                    ...
                    <!-- Rest Days -->
                    <div class="tw-rounded-[10px] tw-border tw-border-[#223F57] tw-p-2 tw-flex tw-items-center tw-relative">
                        <!-- Bubble speech -->
                        <div class="tw-absolute tw-right-0 tw-bg-[#E1EFFE] tw-rounded-[10px] tw-text-[#1E429F] tw-text-sm tw-px-2 tw-py-0.5 tw-font-semibold tw-transition-all tw-duration-700" :class="showAnimation ? '-tw-top-3' : 'tw-opacity-0 tw-top-2'">+1</div>
                        <!-- Rest Icon -->
                        <img class="tw-mr-3 tw-w-4" src="https://www.musora.com/musora-cdn/image/width=30,quality=95/https://d3fzm1tzeyr5n3.cloudfront.net/challenge-completion-modal/rest_icon.svg" />
                        <!-- Rest Text -->
                        <div>
                            <div class="tw-font-extrabold">2</div>
                            <div class="tw-flex tw-items-center">
