        ...
        <div class="tw-absolute tw-w-full tw-h-full tw-left-0 tw-top-0 tw-flex tw-justify-center tw-items-center tw-transition-all tw-duration-200" :class="!showAchievement ? 'tw-opacity-1' : 'tw-opacity-0'">
            ...
            <div class="tw-hidden md:tw-flex tw-flex-col tw-justify-center tw-items-center tw-text-white">
                ...
                <div class="tw-border tw-border-[#081825] tw-rounded-[10px] tw-overflow-hidden tw-bg-[linear-gradient(90deg,_#131A27_0%,_#182132_100%)] tw-max-w-[700px] lg:tw-max-w-[758px] tw-w-full tw-flex tw-px-8 lg:tw-px-12 tw-pb-5 tw-relative tw-overflow-hidden tw-my-5">
                    <!-- Animation -->
                    <Vue3Lottie class="tw-absolute tw-w-full tw-h-[500px] -tw-top-[100px] tw-left-0 tw-z-10 tw-object-cover tw-bg-cover" animation-link="https://lottie.host/74bf25dd-376e-4ee4-b2d7-24c1a4bfaa13/jrmL6ilgZX.json" width="100%" height="100%" />
                    <!-- Left -->
                        ...
                        <div class="tw-pl-6 tw-relative tw-pt-7">
                            ...
                            <div class="tw-flex tw-gap-2 tw-text-[13px] tw-relative tw-z-20">
                                ...
                                <div class="tw-flex-1 tw-rounded-[10px] tw-border tw-border-[#223F57] tw-py-1 tw-pr-1 tw-flex tw-items-center tw-relative">
                                    <!-- Bubble speech -->
                                    <div class="tw-absolute tw-right-0 tw-bg-[#E1EFFE] tw-rounded-[6px] tw-text-[#1E429F] tw-text-sm tw-px-2 tw-py-0.5 tw-font-semibold tw-transition-all tw-duration-700" :class="showAnimation ? '-tw-top-3' : 'tw-opacity-0 tw-top-2'">Nice!</div>
                                ...
                                <div class="tw-flex-1 tw-rounded-[10px] tw-border tw-border-[#223F57] tw-py-1 tw-pl-2 tw-pr-1 tw-flex tw-items-center tw-relative">
                                    <!-- Bubble speech -->
                                    <div class="tw-absolute tw-right-0 tw-bg-[#E1EFFE] tw-rounded-[6px] tw-text-[#1E429F] tw-text-sm tw-px-2 tw-py-0.5 tw-font-semibold tw-transition-all tw-duration-700" :class="showAnimation ? '-tw-top-3' : 'tw-opacity-0 tw-top-2'">+1</div>
            ...
            <div class="tw-flex tw-flex-col tw-items-center tw-h-full tw-pt-11 md:tw-hidden tw-text-white tw-px-4">
                ...
                <div class="tw-rounded-[10px] tw-bg-[#182132] tw-max-w-[330px] tw-mx-2 tw-w-full tw-flex tw-flex-col tw-py-6 tw-px-2 tw-relative tw-overflow-hidden tw-my-4">
                    <!-- Animation -->
                    <Vue3Lottie class="tw-absolute tw-w-full tw-h-full tw-top-0 tw-left-0 tw-z-10" animation-link="https://lottie.host/74bf25dd-376e-4ee4-b2d7-24c1a4bfaa13/jrmL6ilgZX.json" />
