<template>
    <div class="tw-w-full tw-mx-auto 3xl:tw-max-w-screen-3xl 4xl:tw-max-w-screen-4xl tw-px-4 md:tw-px-8">
        ...
        <!-- ABOUT YOU -->
        <section class="tw-flex tw-flex-col tw-py-[30px] tw-border-b tw-border-gray-300 dark:tw-border-[#223F57]">
            <div class="tw-flex tw-mb-4 tw-flex-grow-0 tw-items-center" >
            ...
            <div class="tw-flex tw-flex-col tw-text-[#00101D] dark:tw-text-white">
                <!-- Full Name -->
                <div class="tw-flex tw-mb-2 tw-w-full tw-items-center">
        ...
        <!-- GEAR PHOTOS -->
        <section class="tw-w-full tw-flex tw-flex-col tw-py-[30px] tw-border-b tw-border-gray-300 dark:tw-border-[#223F57]">
            <div class="tw-flex tw-flex-row tw-mb-4 tw-flex-grow-0 tw-items-center" >
        ...
        <!-- FORUM SIGNATURE -->
        <section class="tw-flex tw-flex-col tw-py-[30px]">
            <div class="tw-flex tw-flex-row tw-mb-4 tw-flex-grow-0 tw-items-center" >
