            ...
            <div class="flex flex-column player-buttons">
                <div class="flex flex-row">
                    ...
                    >
                        ...
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" aria-labelledby="metronome" version="1.1" width="36" height="35" viewBox="0 0 36 35" class="tw-w-[20px]" fill="none">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M19.0243 23.6295H28.1505L23.6755 16.1825L19.0243 23.6295ZM23.8224 12.046L20.6592 6.78189C19.2551 4.44535 15.7449 4.44535 14.3409 6.78189L2.49419 26.4965C1.09007 28.833 2.84519 31.7537 5.65333 31.7537H29.3467C32.1549 31.7537 33.91 28.833 32.5059 26.4965L25.0172 14.0343L30.2258 5.69489C30.5282 5.21084 30.3808 4.57337 29.8968 4.27105C29.4128 3.96873 28.7753 4.11605 28.473 4.60009L23.8224 12.046ZM22.4807 14.1942L16.5877 23.6295H6.84952L15.9205 8.53429C16.6225 7.36601 18.3776 7.36601 19.0796 8.53429L22.4807 14.1942ZM4.86349 26.9346L5.60763 25.6962H29.3924L30.1366 26.9346C30.8386 28.1028 29.961 29.5632 28.557 29.5632H6.44305C5.03904 29.5632 4.16148 28.1028 4.86349 26.9346Z" fill="currentColor"/>
                            </svg>
                        </span>
                    </button>
                    ...
                    >
                        ...
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" aria-labelledby="drum-set" version="1.1" width="36" height="35" viewBox="0 0 36 35" class="tw-w-[20px]" fill="none">
