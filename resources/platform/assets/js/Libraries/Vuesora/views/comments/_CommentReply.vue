<template>
    <div class="tw-flex tw-flex-row comment-post pv mv-1 dark:tw-text-white -tw-ml-[28px] sm:-tw-ml-[70px] sm:tw-ml-[-60] md:tw-ml-0 tw-group/reply"
        ...
        <div class="tw-flex tw-flex-col avatar-column tw-max-w-[33px] sm:tw-max-w-[75px] tw-mr-[6px] sm:tw-mr-[15px]">
            ...
            <!-- User Avatar -->
            <img v-if="!hasPublicProfiles" :src="comment.user['fields.profile_picture_image_url']" loading="lazy"
                ...
                <div class="tw-flex tw-flex-col tw-mb-1 tw-w-full">
                    <div class="tw-flex tw-flex-row tw-items-center">
                        ...
                        <button
                            ...
                            dusk="reply-button" @click="openReply">
                            <MusoraIcon icon-name="comment-outline" class="tw-inline tw-h-[22px] tw-w-[22px]" width="22"
                        ...
                        <!-- Dropdown -->
                        <div
                            class="lg:tw-hidden group-hover/reply:lg:tw-flex tw-flex tw-items-center tw-text-[#3F3F46] dark:tw-text-white tw-cursor-pointer tw-relative tw-h-[20px]">
        ...
        deleteComment() {
            window.showconfirmationmodal({
                ...
                callbacks: {
                    ...
                    cancel: () => {
                        console.log('Delete reply cancelled');
                    }
                }
            });
        },
