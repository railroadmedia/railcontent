<template>
    <div class="lg:tw-container tw-mx-auto lg:tw-px-8 dark:tw-text-white">
        ...
        >
            <template #label>
                <a :href="recommendationLinks[brand]" class="tw-flex tw-ml-2 tw-text-[#00101D] tw-text-sm tw-border tw-border-[#FFAE00] tw-rounded-md tw-px-[10px] tw-py-0.5 tw-font-semibold tw-bg-[#FFAE00] hover:tw-border-[#DC9600] hover:tw-bg-[#DC9600]">
                    <musora-icon icon-name="info" class="tw-w-5 tw-h-5 tw-mr-1" /> Experimental Feature
                </a>
            </template>
            <template #icon>
