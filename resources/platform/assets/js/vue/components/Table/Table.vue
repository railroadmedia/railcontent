...
<template>
    <div class="tw-w-full tw-relative tw-overflow-x-auto tw-shadow-md" :class="classOverride">
        <table class="tw-w-full tw-text-left tw-text-[#0D0D0D] dark:tw-text-white">
            <thead class=" tw-h-[37px] tw-text-[16px] tw-text-[#0D0D0D] tw-bg-[#E6E7E9] dark:tw-bg-[#031d32] dark:tw-text-white tw-font-bold tw-rounded-t tw-overflow-hidden">
                <tr>
            ...
            <tbody class="tw-text-[14px]">
                <tr v-for="([firstCol, ...cols], index) in rows" :key="index" :class="`${index%2 === 0 ? 'tw-bg-[#F9F9F9] dark:tw-bg-[#071826]' : 'dark:tw-bg-[#00101D]'}`">
                        ...
                        <div class="tw-flex tw-flex-row tw-w-full tw-h-full tw-items-center">
                            <div class="tw-relative tw-overflow-hidden tw-bg-white dark:tw-bg-[#081825] tw-aspect-square tw-h-[48px] tw-w-[48px] tw-rounded tw-shrink-0">
                                ...
                                <div class="tw-relative tw-w-full tw-h-full" v-if="firstCol.thumb">
                                    <img
                                        :src="`https://musora.com/cdn-cgi/image/width=200/${firstCol.thumb}`"
                                    ...
                                    <div class="tw-z-10 tw-absolute tw-w-full tw-h-full tw-left-0 tw-top-0 tw-bg-black/70 tw-flex tw-justify-center">
                                        <img class="tw-h-full tw-object-contain" :src="`https://musora.com/cdn-cgi/image/width=330/${firstCol.thumb}`" alt="playlist thumbnail">
                                    </div>
                                </div>
