    ...
    <div class="tw-flex">
      <div v-for="(chapter, index) in chapters" :key="index"
        ...
        <div class="tw-flex tw-justify-between">
          ...
          <div class="tw-flex">
            <button id="video-chapter-song" class="tw-text-black dark:tw-text-white tw-mr-[16px]"
              @click="onIconClick('left', chapter)">
            ...
            <button id="video-chapter-loop" class="tw-text-black dark:tw-text-white"
              @click="onIconClick('right', chapter)">
              <svg width="19" height="24" viewBox="0 0 19 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <div class="tw-flex tw-flex-col tw-text-[12px] tw-leading-[18px] tw-font-bold">
          {{ chapter.title }}
        </div>
      </div>
    </div>
