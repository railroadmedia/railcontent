    ...
    <section :id="id" v-if="this.isVisible" class="tw-my-8 tw-text-[#00101D] dark:tw-text-white">
        ...
        <div class="tw-flex tw-items-center tw-mb-4 tw-w-full tw-justify-between">
            ...
            <a href="https://www.drumeo.com/laravel/public/members/profile" 
                ...
                class="tw-text-base lg:tw-text-lg lg:tw-leading-none lg:tw-leading-none tw-uppercase tw-leading-none tw-font-bebas-neue tw-text-[#00101D] dark:tw-text-white tw-border-b tw-border-transparent tw-transition-all hover:tw-border-current"
            >
                See All
            </a>
        </div> 
