...
onBeforeMount(() => {
    buildDescription(props.yearUpgradeCost);
});
...
<template>
    <ModalRenderer>
        ...
        intervalTierPrices[selectedTier].year.description
                                    ...
                                    <button @click="() => handleSelectedInterval('year')" class="tw-btn-primary tw-bg-[#00101D]">PAY ANNUALLY</button>
                                </div>
        ...
        intervalTierPrices[selectedTier].month.description
                                    ...
                                    <button @click="() => handleSelectedInterval('month')" class="tw-btn-primary tw-bg-[#00101D]">PAY MONTHLY</button>
                                </div>
