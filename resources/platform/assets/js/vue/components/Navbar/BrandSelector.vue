...
<template>
    <div>
        <ModalRenderer v-if="isSelectorOpen" @onClose="() => handleBrandOpen(false)"
            ...
            <button @click="handleClose" class="tw-text-white tw-absolute tw-right-0  md:tw-top-[32px] md:tw-right-[48px]"><XIcon class="tw-w-[26px] tw-h-[26px] md:tw-w-[48px] md:tw-h-[48px]" /></button>
