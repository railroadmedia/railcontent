...
<template>
  <nav class="tw-z-100 tw-fixed tw-top-0 tw-flex tw-h-[58px] tw-w-full tw-justify-between tw-bg-white tw-px-[12px] dark:tw-bg-[#081825]/90">
    <div class="tw-row tw-flex">
