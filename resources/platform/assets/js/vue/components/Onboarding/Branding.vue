<template>
    <div class="tw-pt-[28px] tw-flex tw-justify-center tw-items-center tw-w-full tw-self-end tw-pb-[40px] tw-hidden xl:tw-flex" :class="classOverride">
...
<script setup>
import { whiteLogos } from "../../../constants/brands";
