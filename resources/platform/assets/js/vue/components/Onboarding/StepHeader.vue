<script setup>
import { ArrowSmLeftIcon, XIcon } from "@heroicons/vue/solid";
...
<template>
  <div class="tw-flex tw-flex-col tw-w-full tw-items-center tw-relative xl:tw-static tw-justify-center">
    ...
    <button @click="goToPrevPage" class="tw-text-white tw-absolute lg:tw-top-[32px] tw-top-0 tw-right-[12px]  md:tw-right-[32px]"><XIcon class="tw-w-[26px] tw-h-[26px] md:tw-w-[48px] md:tw-h-[48px]" /></button> 
    <h2
      class="
        md:tw-mb-[5px]
        tw-px-[48px]
