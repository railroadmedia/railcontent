...
<template>
    ...
    >
        <img :src="list.thumbnail_url" 
             class="tw-w-full" 
             :class="props.isListView ? 'tw-max-w-[48px] tw-mb-0' : 'tw-mb-1.5'"
        >
        <div class="tw-flex tw-items-center">
            ...
            <div class="tw-relative" v-click-outside="()=>{ state.dropdownOpen = false }">
                <button class="" @click.prevent="state.dropdownOpen = !state.dropdownOpen" :class="props.isListView ? 'tw-rotate-90' : 'tw-rotate-0'">
