<template>
  <div
    class="tw-text-black tw-text-[#3F3F46] dark:tw-text-[#A1A1A9]  tw-flex tw-justify-center tw-items-center tw-w-full tw-h-[40px] dark:tw-bg-black tw-bg-[#e5e7eb] tw-text-center tw-uppercase tw-text-sm">
    <a :href="homeUrl"
    ...
    <span v-if="lastLevelTitle">&nbsp;/&nbsp;
      <span class="tw-font-bold tw-text-[#3F3F46] dark:tw-text-[#A1A1A9] tw-text-sm">{{ lastLevelTitle
      }}</span></span>
  </div>
</template>
