<template>
  ...
  <script>
  // Code copied from https://github.com/dobromir-hristov/vue-vimeo-player/blob/next/src/VimeoPlayer.vue
  // The repo is not being maintained
  ...
  export default {
    ...
    setup (props, { emit }) {
      ...
      if (!props.videoId && !props.videoUrl) {
        console.warn('[VimeoVideo: videoId or videoUrl prop missing]');
      }
