<template>
    ...
    <div v-if="!isMiniCard"
        ...
        :class="[
            class_object,
            forceListView || breakToListView ? 'tw-py-3 tw-w-full' : 'tw-w-[267px] lg:tw-w-1/4 2xl:tw-w-1/5 tw-shrink-0 lg:tw-mb-6 tw-pr-[8px] xl:tw-pr-[12px] 3xl:tw-pr-[18px]',
        ...
        <div class="tw-flex" :class="[
            ...
            <a :href="renderLink  && !forceNoLinks ? item.url : null" class="tw-no-underline tw-flex tw-flex-col" :class="[
                { 'tw-w-[210px] tw-flex-shrink-0 tw-mr-3 ': forceListView || breakToListView },
