<template>
    ...
    <div v-if="!isMiniCard"
        ...
        :class="[
            class_object,
            forceListView || breakToListView ? 'tw-py-3 tw-w-full' : 'tw-w-[267px] lg:tw-w-1/4 2xl:tw-w-1/5 4xl:tw-w-1/6 tw-mb-4 lg:tw-mb-6 tw-shrink-0 tw-pr-[8px] xl:tw-pr-[12px] 3xl:tw-pr-[18px]',
