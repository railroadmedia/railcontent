...
import DownloadsCatalogue from "../../vuesora/views/catalogues/DownloadsCatalogue.vue";
import GridCatalogue from "../../vuesora/views/catalogues/GridCatalogue.vue";
import CoachGridCatalogue from "../../vuesora/views/catalogues/CoachGridCatalogue.vue";
import CoachesGridCatalogue from "../../vuesora/views/catalogues/CoachesGridCatalogue.vue";
import RoutinesCatalogue from "../../vuesora/views/catalogues/RoutinesCatalogue.vue";
import ListCatalogue from "../../vuesora/views/catalogues/ListCatalogue.vue";
import CatalogueFilters from "../../vuesora/views/catalogues/_CatalogueFilters.vue";
