<template>
    <div ref="tooltipContainer" class="tw-relative tw-flex tw-justify-center tw-items-center">
        ...
        <div v-if="show"
            :class="[tooltipPosition, 'tw-absolute tw-px-2 tw-py-1 tw-text-sm tw-text-[#00101D] dark:tw-text-white tw-border tw-border-[#B2B2B5] dark:tw-border-[#444447] tw-bg-[#F4F4F5] dark:tw-bg-[#232327] tw-z-30 tw-min-w-max']">
