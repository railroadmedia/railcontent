                ...
                <div class="flex flex-row">
                    <div class="flex flex-column grow pr-2">
                        <input
                            ...
                            autocomplete="off"
                            placeholder="Search..."
                            class="no-label dark:placeholder:tw-text-white tw-bg-transparent tw-py-0 tw-h-[50px] tw-px-[25px] tw-rounded-full tw-border focus:tw-ring-0 focus:tw-outline-none tw-text-[#00101D] tw-border-[#D4D4D8] dark:tw-border-[#9EC0DC] dark:tw-text-white"
