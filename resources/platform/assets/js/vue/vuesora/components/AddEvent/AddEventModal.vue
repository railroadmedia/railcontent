  ...
  <div :id="modalId" class="modal small">
    <div class="
        ...
        <div class="tw-relative tw-p-4 md:tw-p-7 modal-container">
          ...
          <p v-if="subscriptionCalendarId" class="tw-text-xs tw-italic tw-text-center tw-mb-2 tw-text-[#00101D]">
          ...
          <div v-if="hasSingleEvent" class="tw-text-sm tw-leading-normal pointer tw-relative" style="width: 100%">
