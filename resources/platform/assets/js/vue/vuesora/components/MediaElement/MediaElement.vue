    ...
    methods: {
        ...
        updateSvgUseElements() {
            ...
            useElements.forEach(el => {
                ...
                if (hrefValue && hrefValue.startsWith('mejs-controls.svg')) {
                    el.setAttribute('xlink:href', hrefValue.replace('mejs-controls.svg', ''));
                }
            });
        },
        playVideo() {
