...
{{--        <a href="/shop/"><img src="https://www.musora.com/musora-cdn/image/width=400,quality=95/https://d122ay5chh2hr5.cloudfront.net/sales/promos/november/holiday-guitar.png"></a>--}}
...
{{--    <a href="/shop" class="promo-banner tw-text-center tw-text-white tw-w-full tw-block tw-fixed" style="background: #000 url(https://dpwjbsxqtam5n.cloudfront.net/promos/christmas/snow-dark.gif) center center/250px;box-shadow: 0 0 100px inset #000;">--}}
{{--        <div class="noise-wrap">--}}
{{--            <div class="row tw-container tw-mx-auto">--}}
{{--                <div class="text tw-text-left">--}}
{{--                    <img class="logo" src="https://www.musora.com/musora-cdn/image/width=400,quality=95/https://d122ay5chh2hr5.cloudfront.net/sales/promos/november/holiday-guitar.png">--}}
{{--                    <p>--}}
{{--                        @if(!empty($price))--}}
{{--                            @if(round(100 - (100 * ($price / $fullPrice))) > 1)--}}
