<div @if(!empty($assignmentID)) id="{{ $assignmentID }}" @endif
    ...
    <div class="w-full flex text-left items-center justify-between">
        ...
        <div class="pl-3 sm:pl-4 max-w-2xl mr-auto">
            <p class="mb-0" style="font-size:15px;"><strong>{!! $title !!}</strong></p>

            @if(!empty($subTitle))
                <p class="flex-grow mt-1 sm:mt-2" style="font-size:15px;">{!!  $subTitle  !!}</p>
            @endif
        </div>
