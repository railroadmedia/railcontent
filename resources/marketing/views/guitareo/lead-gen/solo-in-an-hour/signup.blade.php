...
@section('meta')
    ...
    <style>
        ...
        .header-bg {
            ...
            background-image: url('https://www.musora.com/cdn-cgi/image/width=750,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/solo-in-an-hour/bg.jpg');
        }
        .teacher-gradient {
            background:linear-gradient(to top, #04111d 40%, transparent 75%);
        }
        .teacher-section {
            background: #04111d 50% top/530px no-repeat url('https://www.musora.com/cdn-cgi/image/width=750,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/solo-in-an-hour/coach-bg.jpg');;
        }
        @media (min-width: 768px) {
            .header-bg {
                background-size:1140px;
                background-image:url('https://www.musora.com/cdn-cgi/image/width=1250,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/solo-in-an-hour/bg.jpg');
            }
            .teacher-gradient {
            ...
            .teacher-section {
                ...
                background-image:url('https://www.musora.com/cdn-cgi/image/width=850,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/solo-in-an-hour/coach-bg.jpg');
            }
        ...
        @media (min-width: 1024px) {
            .header-bg {
                ...
                background-image: url('https://www.musora.com/cdn-cgi/image/width=1600,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/solo-in-an-hour/bg.jpg');
            }
            .teacher-gradient {
            ...
            .teacher-section {
                ...
                background-image:url('https://www.musora.com/cdn-cgi/image/width=1250,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/solo-in-an-hour/coach-bg.jpg');
            }
        }
    </style>
@stop
...
@section('body')
    @include('guitareo.lead-gen.partials._header1', [
        "bgColor" => "#00101d",
        "imgs" => [
            '<img class="w-full h-24 md:h-32 lg:h-36" src="https://www.musora.com/cdn-cgi/image/width=500,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/solo-in-an-hour/logo.png" alt="logo">',
        ],
        "playButton" => "down",
            ...
            <div class="flex flex-wrap items-start max-w-4xl mx-auto">
                @foreach ($steps as $key => $step)
                    <div class="w-full md:w-1/3 px-3 mb-8 md:mb-0">
                        <img class="h-12" src="https://www.musora.com/cdn-cgi/image/width=60,quality=95/{{ $step['icon'] }}" alt="step-icon-{{ $key + 1 }}">
    ...
    @include('guitareo.lead-gen.partials._enter-email', [
        ...
        "img" => '
            <picture>
                <source media="(min-width: 1024px)" srcset="https://www.musora.com/cdn-cgi/image/width=350,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/solo-in-an-hour/logo.png">
                <source media="(min-width: 768px)" srcset="https://www.musora.com/cdn-cgi/image/width=500,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/solo-in-an-hour/logo.png">
                <img class="h-28 md:h-40 lg:h-52 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=700,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/solo-in-an-hour/logo.png" alt="logo">
            </picture>
        ',
