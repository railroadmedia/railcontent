...
@section('assets')
    @include('guitareo.lead-gen.partials._assignment-resources', [
        ...
        "mp3URL" => "https://d122ay5chh2hr5.cloudfront.net/guitarquest/2-Simple-Guitar-Tricks/ShampooJingle-Playthrough.mp3"
    ])
    @include('guitareo.lead-gen.partials._assignment-resources', [
        "title" => "Full Ad MP3",
        "mp3URL" => "https://d122ay5chh2hr5.cloudfront.net/guitarquest/2-Simple-Guitar-Tricks/ShampooJingle-FullAd.mp3"
    ])

    @include('guitareo.lead-gen.partials._assignment-resources', [
        "title" => "Sheet Music PDF",
        "pdfURL" => "https://d122ay5chh2hr5.cloudfront.net/guitarquest/2-Simple-Guitar-Tricks/ShampooJingle-SheetMusic.pdf"
    ])
@endsection
