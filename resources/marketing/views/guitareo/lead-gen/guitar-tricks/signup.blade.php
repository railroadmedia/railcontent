...
@section('meta')
    ...
    <style>
        .header-bg {
            background-image:url('https://www.musora.com/cdn-cgi/image/width=800,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/guitar-tricks/header.jpg');
        ...
        @media (min-width:768px) {
            .header-bg {
                background-image:url('https://www.musora.com/cdn-cgi/image/width=1200,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/guitar-tricks/header.jpg');
        ...
        @media (min-width:1024px) {
            .header-bg {
                background-image:url('https://www.musora.com/cdn-cgi/image/width=2000,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/guitar-tricks/header.jpg');
            }
        }
    </style>
@stop
                ...
                @foreach ($steps as $step)
                    <div class="w-full step @if(empty($lesson['last'])) mb-10 @endif sm:w-1/2 lg:w-1/3 lg:mb-12">
                        <div class="pic-wrap relative mx-auto">
                            <img src="https://www.musora.com/cdn-cgi/image/width=1300,quality=95/{{ $step['img'] }}">
                            @if ($step['exclusive'])
