...
@section('meta')
    ...
    <style>
        ...
        .header {
            background-image: url('https://www.musora.com/cdn-cgi/image/width=700,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/clean-up-chords/header_bg_m.png');
        ...
        .footer {
            background-image: url('https://www.musora.com/cdn-cgi/image/width=700,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/clean-up-chords/footer-bg-m.png');
        }
        ...
        @media (min-width:768px) {
            ...
            .header {
                background-image: url('https://www.musora.com/cdn-cgi/image/width=2000,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/clean-up-chords/header_bg.jpg');
            ...
            .footer {
                background-image: url('https://www.musora.com/cdn-cgi/image/width=1500,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/clean-up-chords/Footer_bg.jpg');
            }
        }
            ...
            <div class="flex flex-wrap items-center">
                <div class="w-full md:w-8/12 lg:w-2/3 md:text-left">
                    <div class="mt-40 md:mt-0 sm:pl-3">
                        <img class="h-28 lg:h-36 mx-auto md:mx-0 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=350,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/clean-up-chords/logo.png" alt="logo">
...
{{--                        </p>--}}
    ...
    <section class="text-white py-12 sm:py-20 px-4 sm:px-6 bg-musora-black">
        <div class="max-w-sm md:max-w-3xl lg:max-w-4xl mx-auto">
            <div class="md:grid md:grid-cols-2 sm:gap-6 md:gap-10 items-center justify-center flex flex-col mx-auto">
                <img class="md:order-1 rounded-md mb-7 md:mb-0 md:w-auto mx-auto lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=500,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/clean-up-chords/collage.png" alt="intro image">
        ...
        <div class="max-w-md sm:max-w-3xl lg:max-w-6xl mx-auto">
            <div class="sm:grid sm:grid-cols-2 items-center text-center gap-14">
                <div class="md:text-right">
                    <img class="inline-block rounded-md h-72 sm:h-80 lg:h-96 mb-7 sm:mb-0 mx-auto lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=400,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/clean-up-chords/ui.png" alt="intro image">
                </div>
    ...
    <section class="px-4 py-14 sm:py-20 md:pb-32 bg-musora-black">
        ...
        <div class="max-w-3xl lg:max-w-4xl mx-auto relative mt-6 md:mt-14">
            <div class="w-3/4 sm:w-2/3 mx-auto relative md:static text-center mb-2 md:mb-8">
                <picture>
                    <source media="(min-width: 768px)" srcset="https://www.musora.com/cdn-cgi/image/width=500,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/clean-up-chords/Ayla.png">
                    <img class="md:w-80 lg:w-96 md:absolute md:top-20 lg:-top-2 -right-0 lg:-right-2 lg:border-8 md:rounded-3xl lg:border-solid border-musora-black lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=500,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/clean-up-chords/Ayla_m.png" alt="coach image">
                </picture>
            </div>
        ...
        <div class="max-w-3xl lg:max-w-4xl mx-auto relative mt-6 md:mt-40 md:text-right">
            <div class="w-3/4 sm:w-2/3 mx-auto relative md:static text-center mb-6 md:mb-8">
                <picture>
                    <source media="(min-width: 768px)" srcset="https://www.musora.com/cdn-cgi/image/width=500,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/clean-up-chords/Kent.png">
                    <img class="md:w-80 lg:w-96 md:absolute -top-20 -left-0 lg:-left-2 md:rounded-3xl border-musora-black lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=500,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/clean-up-chords/Kent_m.png" alt="coach image">
                </picture>
            </div>
    ...
    <section class="py-20 sm:py-28 bg-cover lazyload footer" style="background-color:#3d151a;background-position: 25% 50%;">
        <div class="max-w-md md:max-w-2xl lg:max-w-3xl mx-auto text-center text-white px-4">
            <img class="lazyload h-32 mx-auto" data-src="https://www.musora.com/cdn-cgi/image/width=350,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/clean-up-chords/logo.png" alt="logo">
