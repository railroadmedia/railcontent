<header class="text-center py-8 md:py-14 px-4 text-white" style="background:{{ $bgColor }} @isset($bgImg) url(https://www.musora.com/musora-cdn/image/width=1500,quality=85/{{ $bgImg }}) center center/cover; @endisset ">
        ...
        <div class="list-wrapper w-full overflow-auto">
                @foreach($bonuses as $bonus)
                    <a href="{{ $rootLink }}{{ $bonus['URL'] }}" class="lesson-row float-left w-full text-center">
                        ...
                        <div class="lesson-thumb float-left hidden md:inline-block"><img src="https://www.musora.com/musora-cdn/image/width=250,quality=85/{{ $bonus['thumbUrl'] }}"></div>
