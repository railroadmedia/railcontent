<section class="pt-10 px-4 pb-5 md:py-16 md:px-0 lg:py-24">
    <div class="flex max-w-6xl mx-auto">
        ...
        <div class="px-3 md:px-4 sm:w-2/3">
            ...
            <p>Secretly, we’re hoping to start a relationship with you. This is our way of saying “Hey we create awesome guitar lessons, can we show you?” Don’t worry, we won’t send you spam or share your email address with anybody else. You’ll get exactly what’s promised on this page along with ongoing guitar videos, free lessons, and some special offers. And if you don’t like our emails, you can unsubscribe at any time.</p>
        </div>
    </div>
</section>
