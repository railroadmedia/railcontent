        ...
        <div class="text-center sm:px-3">
            ...
            <div class="video-row relative my-4 sm:my-7">
                @hasSection('prev-thumb')
                    <img class="absolute top-1/2 opacity-30" style="transform: translate(-100%, -50%); left: -10%;width: 80%;" src="https://cdn.musora.com/image/fetch/w_800,q_auto:best/@yield('prev-thumb')">
                @endif
                ...
                @hasSection('next-thumb')
                    <img class="absolute top-1/2 opacity-30" style="transform: translateY(-50%);left: 110%;width: 80%;" src="https://cdn.musora.com/image/fetch/w_800,q_auto:best/@yield('next-thumb')">
                @endif
            </div>
        </div>
