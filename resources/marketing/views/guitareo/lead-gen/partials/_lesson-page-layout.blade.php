            ...
            <div class="text-center sm:px-3">
                ...
                <div class="video-row relative my-4 sm:my-7">
                    @hasSection('prev-thumb')
                        <img class="hidden lg:block absolute top-1/2 opacity-30" style="transform: translate(-100%, -50%); left: -10%;width: 80%;" src="https://www.musora.com/musora-cdn/image/width=800,quality=95/@yield('prev-thumb')">
                    @endif
                    ...
                    @hasSection('next-thumb')
                        <img class="hidden lg:block absolute top-1/2 opacity-30" style="transform: translateY(-50%);left: 110%;width: 80%;" src="https://www.musora.com/musora-cdn/image/width=800,quality=95/@yield('next-thumb')">
                    @endif
                </div>
            </div>
