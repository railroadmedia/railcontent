                ...
                <div class="mb-4 px-3 md:px-4 md:w-1/2 lg:w-1/3 lesson-thumbnail @if(!empty($lesson['details'])) with-details @endif">
                    <div @if(empty($lesson['locked'])) class="cursor-pointer" @endif @if(!empty($lesson['Url'])) href="{{ $lesson['Url'] }}" @endif>
                        <div class="thumb">
                            ...
                            @endif
                            <picture>
                                <source media="(min-width: 1024px)" srcset="https://www.musora.com/cdn-cgi/image/width=550,quality=95/{{ $lesson['imgUrl'] }}">
                                <source media="(min-width: 768px)" srcset="https://www.musora.com/cdn-cgi/image/width=500,quality=95/{{ $lesson['imgUrl'] }}">
                                <img class="w-full" src="https://www.musora.com/cdn-cgi/image/width=400,quality=95/{{ $lesson['imgUrl'] }}" alt="lesson-{{ $key + 1 }}">
                            </picture>
                        </div>
                    </div>
