...
@section('body')
    <header class="header blue" style="background:#1a1c1d;">
        <div class="container clearfix mx-auto max-w-6xl flex flex-col">
            <picture>
                <source media="(min-width: 1024px)" srcset="https://www.musora.com/cdn-cgi/image/width=900,quality=95/https://d122ay5chh2hr5.cloudfront.net/toolbox/logo.svg">
                <source media="(min-width: 768px)" srcset="https://www.musora.com/cdn-cgi/image/width=550,quality=95/https://d122ay5chh2hr5.cloudfront.net/toolbox/logo.svg">
                <img class="logo" src="https://www.musora.com/cdn-cgi/image/width=350,quality=95/https://d122ay5chh2hr5.cloudfront.net/toolbox/logo.svg" alt="logo">
            </picture>
            <div class="flex flex-col sm:flex-row">
                <div class="text-center sm:w-5/12 preview-circle">
                    <picture>
                        <source media="(min-width: 1024px)" srcset="https://www.musora.com/cdn-cgi/image/width=500,quality=95/https://d122ay5chh2hr5.cloudfront.net/toolbox/nate-savage.jpg">
                        <source media="(min-width: 768px)" srcset="https://www.musora.com/cdn-cgi/image/width=300,quality=95/https://d122ay5chh2hr5.cloudfront.net/toolbox/nate-savage.jpg">
                        <img class="circle-nate" src="https://www.musora.com/cdn-cgi/image/width=270,quality=95/https://d122ay5chh2hr5.cloudfront.net/toolbox/nate-savage.jpg" alt="nate-savage">
                    </picture>
                </div>
        ...
        <div class="container clearfix mx-auto max-w-6xl">
            <div class="logo">
                <picture>
                    <source media="(min-width: 1024px)" srcset="https://www.musora.com/cdn-cgi/image/width=900,quality=95/https://d122ay5chh2hr5.cloudfront.net/toolbox/logo.svg">
                    <source media="(min-width: 768px)" srcset="https://www.musora.com/cdn-cgi/image/width=550,quality=95/https://d122ay5chh2hr5.cloudfront.net/toolbox/logo.svg">
                    <img src="https://www.musora.com/cdn-cgi/image/width=350,quality=95/https://d122ay5chh2hr5.cloudfront.net/toolbox/logo.svg" alt="logo">
                </picture>
            </div>
            <p>
