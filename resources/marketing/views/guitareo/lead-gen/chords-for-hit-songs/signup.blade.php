...
@section('meta')
    ...
    <style>
        ...
        header {
            background-image: url('https://www.musora.com/cdn-cgi/image/width=650,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/chords-for-hit-songs/header-bg-m.jpg');
        ...
        .footer {
            background-image: url('https://www.musora.com/cdn-cgi/image/width=650,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/chords-for-hit-songs/footer-bg-m.jpg');
        }

        @media (min-width:768px){
            header {
                background-image: url('https://www.musora.com/cdn-cgi/image/width=2000,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/chords-for-hit-songs/header-bg.jpg');
            ...
            .footer {
                background-image: url('https://www.musora.com/cdn-cgi/image/width=2000,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/chords-for-hit-songs/footer-bg.jpg');
    ...
    <header class="pt-3 pb-6 md:py-20 bg-no-repeat bg-musora-black">
        <div class="max-w-md md:max-w-5xl mx-auto md:flex px-4">
            <div class="md:w-1/2 text-center md:text-left">
                <img class="h-24 md:h-40 md:mb-8 md:pl-3 inline-block lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=500,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/chords-for-hit-songs/logo.png" alt="logo">
        ...
        <div class="max-w-md md:max-w-5xl px-4 mx-auto">
            ...
            <div class="md:flex md:flex-wrap md:items-center mb-10">
                <div class="md:w-1/2 md:pr-10 mb-6 md:mb-0">
                    <img class="lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=700,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/chords-for-hit-songs/collage.png" alt="collage image">
                </div>
            ...
            <picture>
                <source media="(min-width: 768px)" srcset="https://www.musora.com/cdn-cgi/image/width=650,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/chords-for-hit-songs/chords.png">
                <img class="w-full lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=1500,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/chords-for-hit-songs/chords-m.png" alt="chords">
            </picture>
        </div>
    </section>
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-6 mb-14">
                @foreach ($albums as $key => $album)
                    <div @if($key === 0) class="md:mb-6" @endif>
                        <img class="lazyload rounded-md" data-src="https://www.musora.com/cdn-cgi/image/width=500,quality=95/{{ $album['img'] }}" alt="{{ $album['title'] }}">
                        <p>
        ...
        <div class="max-w-md md:max-w-5xl px-4 mx-auto md:flex">
            <div class="md:w-1/2">
                <div class="md:pl-3 text-white text-center md:text-left">
                    <img class="h-32 mb-8 inline-block lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=500,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/chords-for-hit-songs/logo.png" alt="logo">
