...
@section('body')
    <header class="hero-header text-white text-center px-3 py-5 md:py-12 relative" style="background-image:url(https://www.musora.com/cdn-cgi/image/width=2000,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/Fretboard+Cheatsheet/header-3.jpg);">
        <div class="container mx-auto relative z-10">
            <img class="h-6 md:h-11 lg:h-12 w-auto mx-auto" src="https://www.musora.com/cdn-cgi/image/width=900,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/Fretboard+Cheatsheet/logo.png"><br>
