...
<section class="text-center absolute top-1/2 left-1/2 w-full px-5" style="transform:translate(-50%,-50%)">
    ...
    <form id=" ajaxFormFooter " accept-charset="UTF-8" action="/customer-io/submit-email-form" method="POST"
          class="clearfix infusion-form max-w-3xl mx-auto" onsubmit="emailSignUpConversionTrackerForImpactProvider()">
