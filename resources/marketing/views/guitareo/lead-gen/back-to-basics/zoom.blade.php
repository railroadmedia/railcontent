            ...
            <div class="flex flex-wrap items-center">
                <div class="w-full md:w-7/12 lg:w-2/3 md:text-left">
                    <div class="mt-56 md:mt-0 pl-2 sm:pl-3">
                        <img class="h-28 lg:h-36 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=350,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/back-to-basics/logo.png" alt="logo">
