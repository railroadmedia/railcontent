...
@section('body')
    <div class="overflow-hidden text-white px-3 py-5 sm:py-7" style="background-image: url(https://www.musora.com/musora-cdn/image/width=300,q_60,quality=95/https://d122ay5chh2hr5.cloudfront.net/guitarquest/assets/star-pattern.svg);background-color:#000718;">
        <div class="container mx-auto clearfix" style="max-width:940px">
            <div class="text-center sm:px-3">
                <img class="logo mx-auto inline-block w-40 sm:w-56" src="https://www.musora.com/musora-cdn/image/width=448,q_60,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/song-in-an-hour/logo-purple.png">
        ...
        <div class="container mx-auto" style="max-width:890px">
            ...
            @else
                ...
                <div class="flex items-center">
                    ...
                    <img class="hidden sm:inline-block w-36 mr-6" src="https://www.musora.com/musora-cdn/image/width=290,q_60,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/song-in-an-hour/logo-white.png">
