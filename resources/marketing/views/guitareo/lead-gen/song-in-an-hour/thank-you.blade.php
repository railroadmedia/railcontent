...
@section('body')
    <header class="hero-header text-center px-3 py-5 md:py-6 lg:py-16 relative text-white" style="background: linear-gradient(180deg, #010611, #10052b);">
        <div class="container mx-auto relative z-10">
            <img class="logo guitar-quest mx-auto mb-2 sm:mb-5" src="https://www.musora.com/cdn-cgi/image/width=220,q_60,quality=95/https://d122ay5chh2hr5.cloudfront.net/shop/logos/guitar-quest-logo.png"><br>
            <img class="logo mx-auto mb-7 md:mb-10" src="https://www.musora.com/cdn-cgi/image/width=640,q_60,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/song-in-an-hour/logo-purple.png"><br>
