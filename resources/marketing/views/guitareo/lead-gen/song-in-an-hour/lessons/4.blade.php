...
@section('prev-thumb', 'https://www.musora.com/cdn-cgi/image/width=800,q_60,quality=95/https://d1923uyy6spedc.cloudfront.net/Guitar-Quest-1-3.png')

@section('next-thumb', 'https://www.musora.com/cdn-cgi/image/width=800,q_60,quality=95/https://d1923uyy6spedc.cloudfront.net/Guitar-Quest-1-5.png')
...
@section('assets')
    @include('guitareo.lead-gen.song-in-an-hour._assignment-resources', [
        "title" => "Sheet Music",
        "pdfURL" => "https://www.musora.com/cdn-cgi/image/width=1760,q_60,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/song-in-an-hour/4.png"
    ])
    @include('guitareo.lead-gen.song-in-an-hour._assignment-resources', [
