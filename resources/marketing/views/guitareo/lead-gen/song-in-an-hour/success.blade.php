...
@section('body')
    <header class="hero-header text-center px-3 py-5 md:py-6 lg:py-16 relative text-white" style="background: linear-gradient(180deg, #010611, #10052b);">
        <div class="container mx-auto relative z-10">
            ...
            <h5 class="leading-tight"><strong>CONTINUE YOUR JOURNEY <i class="fas fa-long-arrow-right mx-1 text-purple"></i> <br class="inline sm:hidden"> SAVE {{ round(100 - (100 * (GuitareoPrices::$guitarQuestSpecial / floatval($productPrices['guitar-quest']->price)))) }}% ON GUITARQUEST</strong></h5>
            <p class="mt-4 mb-8 leading-relaxed md:leading-loose text-left mx-auto" style="max-width: 590px;">
                ...
                <br><br>
                <em>Song In An Hour</em> is actually the FIRST level of GuitarQuest. And because we hope you’ll keep learning with us, we’re giving you a {{ round(100 - (100 * (GuitareoPrices::$guitarQuestSpecial / floatval($productPrices['guitar-quest']->price)))) }}% discount to make things a little easier. Just click any of the big buttons on this page to continue your journey.
            </p>
