...
@section('meta')
    ...
    <style>
        ...
        .header-bg {
            background-image:url('https://www.musora.com/cdn-cgi/image/width=800,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/free-electric-guitar-lessons/electric-header.jpg');
        }

        .meet-rob {
            background-size: 960px;
            background-position: 25% 6%;
            background-image: url('https://www.musora.com/cdn-cgi/image/width=800,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/free-electric-guitar-lessons/electric-coach.jpg');
        }
        ...
        @media (min-width:768px) {
            .header-bg {
                background-image:url('https://www.musora.com/cdn-cgi/image/width=1200,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/free-electric-guitar-lessons/electric-header.jpg');
            }

            .meet-rob {
                background-size: 1300px;
                background-position: 50% top;
                background-image: url('https://www.musora.com/cdn-cgi/image/width=1200,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/free-electric-guitar-lessons/electric-coach.jpg');
            }
        }
        @media (min-width:1024px) {
            .header-bg {
                background-image:url('https://www.musora.com/cdn-cgi/image/width=2000,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/free-electric-guitar-lessons/electric-header.jpg');
            }

            .meet-rob {
                background-size: 1550px;
                background-image: url('https://www.musora.com/cdn-cgi/image/width=2000,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/free-electric-guitar-lessons/electric-coach.jpg');
            }
...
@section('body')
    @include('guitareo.lead-gen.partials._header1', [
        "bgColor" => "#010416",
        "imgs" => ['<img class="h-14 sm:h-20 lg:h-28 mt-64 sm:mt-80 lg:mt-96 mb-5 lg:mb-8" src="https://www.musora.com/cdn-cgi/image/width=600,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/free-electric-guitar-lessons/electric-logo.png" alt="logo">'],
    ...
    @include('guitareo.lead-gen.partials._enter-email', [
        ...
        "img" => '<img class="h-14 sm:h-20 lg:h-28 mx-auto" src="https://www.musora.com/cdn-cgi/image/width=1000,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/free-electric-guitar-lessons/electric-logo.png" alt="logo" />',
