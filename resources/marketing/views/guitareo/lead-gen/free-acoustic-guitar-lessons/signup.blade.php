...
@section('meta')
    ...
    <style>
        ...
        .header-bg {
            background-image: url('https://www.musora.com/cdn-cgi/image/width=700,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/free-acoustic-guitar-lessons/header-bg.jpg');
        }
        ...
        .meet-rob {
            ...
            background-image: url('https://www.musora.com/cdn-cgi/image/width=1000,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/free-acoustic-guitar-lessons/coach-bg.jpg');
        }
        ...
        @media (min-width:768px) {
            .header-bg {
                background-image: url('https://www.musora.com/cdn-cgi/image/width=1200,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/free-acoustic-guitar-lessons/header-bg.jpg');
            }

            .meet-rob {
                background-size: cover;
                background-position: 45% top;
                background-image: url('https://www.musora.com/cdn-cgi/image/width=1200,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/free-acoustic-guitar-lessons/coach-bg.jpg');
            }
        }
        @media (min-width:1024px) {
            .header-bg {
                background-image: url('https://www.musora.com/cdn-cgi/image/width=2000,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/free-acoustic-guitar-lessons/header-bg.jpg');
            }

            .meet-rob {
                background-size: cover;
                background-position: 50% top;
                background-image: url('https://www.musora.com/cdn-cgi/image/width=2000,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/free-acoustic-guitar-lessons/coach-bg.jpg');
            }
...
@section('body')
    @include('guitareo.lead-gen.partials._header1', [
        ...
        "imgs" => ['
            <picture>
                <source media="(min-width: 1024px)" srcset="https://www.musora.com/cdn-cgi/image/width=850,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/free-acoustic-guitar-lessons/logo.png">
                <img class="h-14 sm:h-20 lg:h-28 mb-5 lg:mb-8" src="https://www.musora.com/cdn-cgi/image/width=600,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/free-acoustic-guitar-lessons/logo.png" alt="logo">
            </picture>
        '],
        "playButton" => "up",
    ...
    @include('guitareo.lead-gen.partials._enter-email', [
        ...
        "img" => '<img class="h-14 sm:h-20 lg:h-28 mx-auto" src="https://www.musora.com/cdn-cgi/image/width=800,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/free-acoustic-guitar-lessons/logo.png" alt="logo" />',
