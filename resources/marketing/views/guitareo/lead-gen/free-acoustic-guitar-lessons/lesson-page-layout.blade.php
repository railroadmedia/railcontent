...
@section('lesson-logo')
    <img class="tw-mx-auto tw-inline-block tw-h-10 sm:tw-h-20" src="https://www.musora.com/cdn-cgi/image/width=448,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/free-acoustic-guitar-lessons/logo.png" alt="lesson-logo">
@endsection
