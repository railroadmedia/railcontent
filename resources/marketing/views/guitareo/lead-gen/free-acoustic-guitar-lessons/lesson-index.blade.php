...
@section('body')
    ...
    @include('guitareo.lead-gen.partials._course-lessons1', [
        ...
        "img" => '<img class="h-12 md:h-20 lg:h-36 inline-block" src="https://www.musora.com/cdn-cgi/image/width=1500,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/free-acoustic-guitar-lessons/logo.png">',
