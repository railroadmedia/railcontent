...
@section('body')
    ...
    @include('guitareo.lead-gen.partials._course-lessons1', [
        ...
        "img" => '<img class="h-12 md:h-20 lg:h-36 inline-block" src="https://www.musora.com/musora-cdn/image/width=1500,quality=85/https://guitareo.s3.amazonaws.com/lead-gen/free-acoustic-guitar-lessons/logo.png">',
