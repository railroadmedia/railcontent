...
@section('head-includes')
    ...
    <title>{{ 'todo' }} gifted you 30 days of free guitar lessons! | Guitareo</title>
    <meta property="og:title" content="Guitareo | The Ultimate Online Guitar Lesson Experience">

    <meta name="description" content="Learn tp play the guitar faster with organized video lessons, legendary teachers, and better practice tools. 90-Day Guarantee. ">
        ...
        <div class="container mx-auto max-w-6xl">
            ...
            <div class="flex flex-wrap lg:flex-nowrap items-center px-4">
                <div class="flex-shrink-0 w-full lg:w-auto my-5 md:my-6 lg:my-0">
                    <div class="relative">
                        <img class="inline-block w-full max-w-xs md:max-w-sm lg:max-w-xl" src="https://guitareo-assets.s3.amazonaws.com/redeem/referral/30-day-guest-pass.png">
                    </div>
                    <ul class="fa-ul text-left mb-0 mt-4 md:mt-6 lg:mt-14 ml-6 md:ml-7 lg:ml-8 w-auto inline-block">
                        <li class="mb-4 lg:mb-6 leading-tight"><i class="fas fa-li fa-check text-guitareo"></i> Organized step-by-step lessons for all skill levels.</li>
                        <li class="mb-4 lg:mb-6 leading-tight"><i class="fas fa-li fa-check text-guitareo"></i> Play your favorite songs with better practice tools.</li>
                        <li class="leading-tight"><i class="fas fa-li fa-check text-guitareo"></i> Get your questions answered by helpful guitar teachers.</li>
                    </ul>
                </div>

                <div class="lg:pl-10 max-w-md lg:max-w-none mx-auto">
                    <form id="commentform" name="guitareo" method="post" action="{{ URL::route('access-codes.form-claim') }}">
            ...
            <div class="flex flex-wrap lg:flex-nowrap items-center px-4">
                ...
                <div class="lg:pl-10 w-full max-w-md lg:max-w-none mx-auto">
                    <h5 class="leading-tight">Give a friend unlimited access <br>
                        to Guitareo, free for 30 days</h5>
                    <div class="my-7">
                        <p class="inline-block w-full mb-1"><strong>Share your link</strong></p>
                        <a class="social-bubble copy transition-opacity duration-300 py-4 w-16 h-16 text-3xl leading-none rounded-full inline-block text-center mx-1 md:mx-3 hover:opacity-70 cursor-pointer bg-gray-500" id="copyClipboard" data-clipboard-text="{{ 'https://www.guitareo.com/cf/todolink' }}"><i class="fas fa-link"></i></a>
                        <a class="social-bubble facebook transition-opacity duration-300 py-4 w-16 h-16 text-3xl leading-none rounded-full inline-block text-center mx-1 md:mx-3 hover:opacity-70" style="background-color:#3b5998;" target="_blank" rel="noopener" href="https://www.facebook.com/sharer/sharer.php?u={{ 'https://www.guitareo.com/cf/todolink' }}"><i class="fab fa-facebook-f"></i></a>
                        <a class="social-bubble twitter transition-opacity duration-300 py-4 w-16 h-16 text-3xl leading-none rounded-full inline-block text-center mx-1 md:mx-3 hover:opacity-70" style="background-color:#1DA1F2;" target="_blank" rel="noopener" href="https://twitter.com/intent/tweet?url={{ 'https://www.guitareo.com/cf/todolink' }}"><i class="fab fa-twitter"></i></a>
                        <a class="social-bubble email transition-opacity duration-300 py-4 w-16 h-16 text-3xl leading-none rounded-full inline-block text-center mx-1 md:mx-3 hover:opacity-70 bg-yellow-500" target="_blank" rel="noopener" href="mailto:?&amp;subject=I'm gifting you 30 days of free guitar lessons!&amp;body={{ 'https://www.guitareo.com/cf/todolink' }}"><i class="fas fa-envelope"></i></a>
                    </div>
                    <form id="commentform" name="guitareo" method="post" action="{{ URL::route('access-codes.form-claim') }}">
                        ...
                        <div class="flex flex-wrap lg:flex-nowrap items-center justify-center mt-1">
                            ...
                            <input name="button" type="submit" id="button" class="bg-guitareo leading-none text-base font-bold border-0 rounded-full select-none cursor-pointer text-center py-4 px-6 uppercase font-roboto" value="Send Guest Pass"/>
                        </div>
                    </form>
                </div>
            </div>
