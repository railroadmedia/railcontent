...
<footer class="bottom-footer clearfix">
    ...
    <div class="footer-bottom" @if(!empty($minimal)) style="border-top: 0;padding-top: 0;" @endif>
        <div class="container">
            ...
            <a rel="noopener" href="https://www.youtube.com/user/guitarlessonscom" target="_blank" class="inline-flex items-center justify-center "><i class="fab fa-youtube"></i></a>
