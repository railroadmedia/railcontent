<section class="content-section px-4 lg:px-6 relative overflow-hidden text-center customize" style="background:linear-gradient(to bottom, #01050f 40%, #021225);">
    <div class="container mx-auto">
        ...
        <div class="flex flex-wrap items-end justify-center 2-full max-w-sm md:max-w-2xl lg:max-w-3xl my-5 sm:my-7 mx-auto">
                ...
                <a href="/ecommerce/add-to-cart?products[GUITAREO-1-MONTH-MEMBERSHIP]=1&redirect=/order&locked=true" class="text-black overflow-hidden rounded-2xl block mx-auto mb-5 md:mb-0 group">
                    <div class="bg-white px-3 pt-6 md:pt-8 pb-5 md:pb-8">
                        ...
                        <h1 class="inline-block leading-none">
                            @if(App\Prices::$guitareoMembershipMonthlyFull > App\Prices::$guitareoMembershipMonthly)
                                <s class="opacity-60">${{ App\Prices::$guitareoMembershipMonthlyFull }}</s>
                            @endif
                            <strong>${{ App\Prices::$guitareoMembershipMonthly }}</strong></h1> <p class="inline-block -mr-16">per month</p>
                        <p class="text-sm my-4"><em>Recurring Payment</em></p>
            ...
            <div class="w-full md:w-1/2 px-2 md:px-3 relative">
                <p class="w-full px-4 pt-2 pb-4 -mb-3 bg-guitareo text-black rounded-t-2xl"><strong>BEST DEAL</strong></p>
                <a href="{{ App\Prices::$guitareoMembershipAnnualLink }}" class="text-black overflow-hidden rounded-2xl block mx-auto mb-4 md:mb-0 group">
                    <div class="bg-white px-3 pt-6 md:pt-8 pb-5 md:pb-8">
                        <h5 class="leading-none mb-3"><strong>ANNUAL</strong></h5>
                        @if(App\Prices::$guitareoMembershipAnnualFull > App\Prices::$guitareoMembershipAnnual)
                            <h3 class="inline-block"><s class="opacity-60">${{ App\Prices::$guitareoMembershipAnnualFull }}</s></h3>
                        @endif
                        <h1 class="inline-block leading-none"><strong>${{ App\Prices::$guitareoMembershipAnnual }}</strong></h1> <p class="inline-block mr-2">per year</p>
                        <p class="text-guitareo text-sm my-4"><em>Plus Get $254 In Free Bonuses</em></p>
                        <div class="join smaller w-full transition-opacity duration-300 group-hover:opacity-80" style="max-width: 230px;">Get Started</div>
                    </div>
                    <div class="px-3 pt-5 md:pt-6 pb-9 md:pb-10" style="background: #f1f8ff;border-top: 2px solid #e6f2ff;">
                ...
                <h4 class="bg-guitareo font-bebas rounded-full absolute top-0 right-0 -m-3 py-3 sm:py-3.5 px-4 sm:px-5 border-4 border-white">Save<br> {{ round(100 - (100 * (App\Prices::$guitareoMembershipAnnual / App\Prices::$guitareoMembershipAnnualFull))) }}%</h4>
            </div>
            {{--<div class="w-full md:w-1/2 px-2 md:px-3 relative">--}}
                ...
                {{--<a href="/ecommerce/add-to-cart?products[GUITAREO-LIFETIME-MEMBERSHIP]=1&redirect=/order&locked=true" class="text-black overflow-hidden rounded-2xl block mx-auto mb-4 md:mb-0 group">--}}
                    {{--<div class="bg-white px-3 pt-6 md:pt-8 pb-5 md:pb-8">--}}
                        ...
                        {{--<h1 class="inline-block leading-none">--}}
                            {{--<strong>${{ App\Prices::$guitareoMembershipLifetime }}</strong></h1>--}}
        ...
        {{--<a class="methodcta monthly-alt" href="/ecommerce/add-to-cart?products[GUITAREO-1-MONTH-MEMBERSHIP]=1&redirect=/order"><p><u><em>Or click here to start a monthly membership for <br class="inline md:hidden">${{ \App\Prices::$guitareoMembershipMonthly }}/month.</em></u></p></a>--}}
