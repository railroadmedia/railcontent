        ...
        @if(!empty($fullSubscriptionVersion))
            <div class="relative">
                <div class="edge-wrap show-for-medium">
                    ...
                    @else
                        <a style="color: #fe006b;" class="@if(strpos(url()->full(), 'shop')) active @endif" href="{{ get_legacy_brand_base_url('guitareo') }}/shop" ><div class="hidden lg:inline">Cyber Monday</div> Deals</a>
                    @endif
