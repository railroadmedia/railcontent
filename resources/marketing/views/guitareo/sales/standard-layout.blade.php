...
@section('layout-body')
    ...
    <header class="header text-white relative overflow-hidden" style="background-color:#032829;">
        <div class="transform -translate-y-1/2 top-3/4 md:top-1/2 left-0 w-full absolute z-20 px-4 lg:px-6 text-center md:text-left">
            <div class="container mx-auto max-w-6xl">
                <h1 class="leading-tight max-w-xs md:max-w-md lg:max-w-2xl mx-auto md:mx-0 md:text-3xl lg:text-4xl"><strong>Online guitar lessons<br> that care about you.</strong></h1>
                <h6 class="leading-normal text-light-navy text-shadow-4 mt-3 md:mt-5 mb-5 md:mb-7">
                    More than online lessons, you'll always<br class="inline md:hidden"> have access <br class="hidden md:inline">
                    to real coaches to answer your<br class="inline md:hidden"> biggest questions, keep <br class="hidden md:inline">
                    you motivated,<br class="inline md:hidden"> and make sure you reach your goals.</h6>
                <a
        ...
        <div class="header-image relative mx-auto w-full h-full relative z-0" style="max-width: 1536px;background-image:url(https://cdn.musora.com/image/fetch/w_2500,q_auto:best/q_auto:best/https://guitareo.s3.amazonaws.com/sales/2022/header-bg2.jpg);">
    ...
    <section class="px-2 lg:px-4 py-10 md:py-14 md:py-20 text-white text-center overflow-hidden" style="background:linear-gradient(to bottom, #01050f 60%, #021124);">
        <div class="container mx-auto max-w-6xl">
            ...
            <p class="text-light-navy mt-2 md:mt-4 mb-8 md:mb-10">Online video lessons you can watch anytime along with real teachers who'll support you every step of the way.</p>
            <div class="md:grid md:grid-cols-3 md:gap-4 max-w-xs md:max-w-full mx-auto">
                ...
                <div class="relative rounded-xl overflow-hidden" style="background-color:#051124;">
                    <div class="w-full aspect-16:9 bg-cover bg-center lazyload" data-bg="https://cdn.musora.com/image/fetch/w_700,q_auto:best/https://guitareo.s3.amazonaws.com/sales/2022/coaches-thumb.jpg"></div>
                    <div class="px-4 lg:px-6 py-5 lg:py-7">
            ...
            <p class="text-light-navy text-sm"><em>Just ${{ number_format(App\Prices::$guitareoMembershipAnnual / 12, 2) }} per month, 90-day guarantee.</em></p>

            <div class="{{--slick--}} mx-auto max-w-xs md:max-w-xl lg:max-w-4xl my-9 md:mb-0">
                <div class="px-3 md:px-6">
                    <p class="leading-normal text-sm"><em>“I think it’s a great way to learn guitar and learn faster because you’re having a good time.”</em></p>
                    <div class="flex flex-wrap md:flex-nowrap items-center justify-center mt-1.5">
                        <img class="rounded-full h-10 lazyload" data-src="https://cdn.musora.com/image/fetch/w_80,q_auto:best/https://pianote.s3.amazonaws.com/sales/2022/feature-testimonial-ali.jpg"><br class="inline md:hidden">
        ...
        <div class="container mx-auto max-w-6xl">
            ...
            @php
                $coaches = [
                    ...
                    [
                    'image' => 'https://guitareo.s3.amazonaws.com/sales/2022/coaches/dean-lamb.jpg',
                    'date' => 'May',
                    'name' => 'Dean <br> Lamb',
                    ...
                    [
                    'image' => 'https://guitareo.s3.amazonaws.com/sales/2022/coaches/pete-thorn.jpg',
                    'date' => 'Summer',
                    'name' => 'Pete <br> Thorn',
            ...
            @php
                $altSlider = [
                    ...
                    'subtitle' => 'With Kent Shores',
                    'smallInfo' => 'Go beyond the pentatonic scale and learn Kent’s secrets to making impressive sounds in any key.',
                    ],
                    [
                    'image' => 'https://guitareo.s3.amazonaws.com/sales/2022/coach-cards/started-electric.jpg',
                    'name' => 'Getting Started On<br> The Electric Guitar',
                    'subtitle' => 'With Ayla Tesler-Mabe',
                    'smallInfo' => 'This six-lesson Course will give you everything you need to get started on the electric guitar and playing along with jam tracks.',
                    ],
                    [
                    'image' => 'https://guitareo.s3.amazonaws.com/sales/promos/march/ayla.jpg',
                    'name' => 'You Can Start <br>Soloing, Like Now!',
                    'subtitle' => 'With Ayla Tesler-Mabe',
                    'smallInfo' => 'Build your speed, dexterity, and learn the important scales for soloing. By the end, you’ll be able to take a guitar solo confidently just by knowing the key of any song!',
                    ],
                    [
                    ...
                    [
                    'image' => 'https://guitareo.s3.amazonaws.com/sales/2022/coach-cards/picks.jpg',
                    'name' => 'Guitar<br> Picks',
                    'subtitle' => '24 Episodes',
                    'smallInfo' => 'Featuring stories from veteran guitar players to manufacturers like Gibson and Fender, as they share stories and reveal their passion for all things guitar.',
                    ],
                    [
    ...
    <section class="py-10 md:py-16 lg:py-20 px-3 lg:px-6 text-white text-center" style="background:linear-gradient(to bottom, #00c9ac, #00816e);">
        <div class="container mx-auto max-w-6xl">
            ...
            <div class="mx-auto w-full opacity-80">
                ...
                <img class="inline-block h-7 md:h-9 mr-3 md:mr-8 lazyload" data-src="https://cdn.musora.com/image/fetch/w_230,q_auto:best/https://guitareo.s3.amazonaws.com/sales/2021/partner-guitar-world.png">
                <img class="inline-block h-14 md:h-16 lazyload" data-src="https://cdn.musora.com/image/fetch/w_130,q_auto:best/https://guitareo.s3.amazonaws.com/sales/2021/partner-guiness-world-records.png">
                <img class="inline-block h-10 md:h-14 ml-3 md:ml-8 lazyload" data-src="https://cdn.musora.com/image/fetch/w_270,q_auto:best/https://guitareo.s3.amazonaws.com/sales/2021/partner-american-songwriter.png">
            </div>
        </div>
    </section>
    ...
    <section class="content-section text-center px-4 lg:px-5" style="padding-top: 0;background:linear-gradient(to bottom, #01050f 60%, #021225);">
        <div class="container mx-auto clearfix max-w-6xl">
            <h4 class="mb-6 md:mb-7 lg:mb-10 mt-8 md:mt-10 lg:mt-14 leading-normal">
                ...
                <em>On-demand access to <strong class="text-guitareo">{{ \App\Prices::$courses }}+<br class="inline md:hidden"> courses</strong> and<br class="hidden md:inline">
                    <strong class="text-guitareo">{{ \App\Prices::$lessons }}+ lessons</strong> to <br class="inline md:hidden">improve any skill, anytime.</em></h4>
            ...
            <div class="w-full flex flex-wrap justify-center md:mb-2 mx-auto max-w-xs md:max-w-full">
                ...
                @php
                    $topics = [
                        ...
                        [
                        'image' => 'https://guitareo.s3.amazonaws.com/sales/2022/fingerstyle-card.jpg',
                        'title' => 'Fingerstyle',
                        'description' => 'Improve your fingerpicking and start exploring open and altered tunings',
                        'artist' => 'DON ROSS',
                        'credit' => '2x Fingerstyle Champion',
                        ],
                        [
                        'image' => 'https://guitareo.s3.amazonaws.com/sales/2022/guitar-scales-card.jpg',
                        ...
                        [
                        'image' => 'https://guitareo.s3.amazonaws.com/sales/2022/ear-training-card.jpg',
                            ...
                            <div class="text-center relative md:w-full md:h-full md:absolute cursor-pointer" style="transform-style: preserve-3d;">
                                <div class="front relative z-20 overflow-hidden rounded-xl md:w-full md:h-full md:absolute transition-transform duration-700" style="backface-visibility: hidden;">
                                    ...
                                    <div class="absolute uppercase w-full bottom-3 md:bottom-5 z-10 text-shadow-4">
                                        @if(!empty($topic['logo']))
                                            <div class="px-6">
                                                <img class="w-full h-12 md:h-16 object-contain lazyload" data-src="https://cdn.musora.com/image/fetch/w_460,q_auto:best/{{ $topic['logo'] }}">
                                            </div>
                                        @else
            ...
            <div class="container mx-auto relative z-10 max-w-6xl">
                ...
                <div class="feature-rotater w-full max-w-md md:max-w-full flex flex-wrap md:flex-nowrap items-center mx-auto mt-4 md:mt-14 lg:mt-20 mb-8 md:mb-10 px-2">
                    <div class="pic-wrap md:order-1 mx-auto my-5 md:my-0 pl-0 md:pl-5 lg:pl-10 flex-shrink-0">
                        <img class="lazyload side-pic songs w-full hidden" data-src="https://cdn.musora.com/image/fetch/w_800,q_auto:best/https://guitareo.s3.amazonaws.com/sales/2022/guitareo-site-screens-03.png">
                        <img class="lazyload side-pic songs w-full hidden" data-src="https://cdn.musora.com/image/fetch/w_800,q_auto:best/https://guitareo.s3.amazonaws.com/sales/2022/guitareo-site-screens-1.png">
                        <img class="lazyload side-pic songs w-full md:hidden" data-src="https://cdn.musora.com/image/fetch/w_800,q_auto:best/https://guitareo.s3.amazonaws.com/sales/2022/guitareo-site-screens-05.png">
                        <img class="lazyload side-pic songs w-full hidden" data-src="https://cdn.musora.com/image/fetch/w_800,q_auto:best/https://guitareo.s3.amazonaws.com/sales/2022/guitareo-site-screens-04.png">
                        <img class="lazyload side-pic songs w-full hidden" data-src="https://cdn.musora.com/image/fetch/w_800,q_auto:best/https://guitareo.s3.amazonaws.com/sales/2022/guitareo_site_screens-6.png">
                    </div>
        ...
        <div class="container mx-auto max-w-6xl">
            ...
            <div class="feature-rotater w-full max-w-md md:max-w-full flex flex-wrap md:flex-nowrap items-center mx-auto mb-8 md:mb-10">
                <div class="pic-wrap md:order-0 mx-auto my-5 md:my-0 pr-0 md:pr-5 lg:pr-10 flex-shrink-0">
                    <img class="lazyload side-pic coaches w-full hidden" data-src="https://cdn.musora.com/image/fetch/w_800,q_auto:best/https://guitareo.s3.amazonaws.com/sales/2022/coaches-guitareo-ui-01.png">
                    <img class="lazyload side-pic coaches w-full md:hidden" data-src="https://cdn.musora.com/image/fetch/w_800,q_auto:best/https://guitareo.s3.amazonaws.com/sales/2022/coaches-guitareo-ui-02.png">
                    <img class="lazyload side-pic coaches w-full hidden" data-src="https://cdn.musora.com/image/fetch/w_800,q_auto:best/https://guitareo.s3.amazonaws.com/sales/2022/coaches-guitareo-ui-03.png">
                </div>
                <div class="text-left text-light-navy">
    ...
    <section class="content-section text-center">
        ...
        <div class="container mx-auto relative z-10">
            <img class="h-32 md:h-48 lg:h-56 mb-14 lazyload" data-src="https://cdn.musora.com/image/fetch/w_800,q_auto:best/https://guitareo.s3.amazonaws.com/sales/2022/guitareo-method-coaches-songs.png">
            ...
            <div class="device-spread relative w-full mx-auto mb-5 md:mb-0">
                <div class="z-10 text-arrow w-1/4 md:w-auto transform md:-translate-x-1/2 -translate-y-1/2 absolute uppercase text-xs md:text-sm lg:text-md desktop">
                    ...
                    <img class="hidden md:inline mt-1 w-7 lg:w-10 lazyload" data-src="https://cdn.musora.com/image/fetch/q_auto:best/https://guitareo.s3.amazonaws.com/sales/2021/arrow-right-alt.png">
                </div>
                ...
                <div class="z-10 text-arrow w-1/4 md:w-auto transform md:-translate-x-1/2 -translate-y-1/2 absolute uppercase text-xs md:text-sm lg:text-md ipad">
                    ...
                    <img class="hidden md:inline mt-1 h-7 lg:h-9 lazyload" data-src="https://cdn.musora.com/image/fetch/q_auto:best/https://guitareo.s3.amazonaws.com/sales/2021/arrow-left-down.png">
                </div>
                <div class="z-10 text-arrow w-1/4 md:w-auto transform md:-translate-x-1/2 -translate-y-1/2 absolute uppercase text-xs md:text-sm lg:text-md iphone">
                    ...
                    <img class="hidden md:inline mt-1 w-7 lg:w-10 lazyload" data-src="https://cdn.musora.com/image/fetch/q_auto:best/https://guitareo.s3.amazonaws.com/sales/2021/arrow-left.png">
                </div>
                <img class="w-full lazyload" data-src="https://cdn.musora.com/image/fetch/w_1500,q_auto:best/https://guitareo.s3.amazonaws.com/sales/2022/guitareo-device-spread.png">
            ...
            <table class="w-full mx-auto border-separate comparison">
                ...
                <tr style="background-color:transparent!important;">
                    ...
                    <td class="rounded-t-xl">
                        <img class="h-6 md:h-11 lazyload"  data-src="https://cdn.musora.com/image/fetch/w_300,q_auto:best/https://guitareo.s3.amazonaws.com/sales/guitareo-logo.png">
                    </td>
            ...
            <div class="flex flex-wrap items-start justify-center mx-auto">
                <div class="w-1/3 px-1 md:px-2 mb-2 md:mb-4">
                    <div class="py-4 md:py-5 lg:py-6 rounded-xl w-full" style="color:#cd201f;background: #051124;">
                        <a href="https://www.youtube.com/user/guitarlessonscom" target="_blank"> <i class="fab fa-youtube text-3xl md:text-4xl"></i>
                        </a>
                        <h2 class="hidden sm:block count font-black leading-none my-2 md:my-3 text-white" id="youtube-count" data-total-count="902000">0</h2>
                        <h2 class="count block sm:hidden font-black leading-none my-2 md:my-3 text-white">902M</h2>
                ...
                <div class="w-1/3 px-1 md:px-2 mb-2 md:mb-4">
                    <div class="py-4 md:py-5 lg:py-6 rounded-xl w-full" style="color:#3b5998;background: #051124;">
                        <a href="https://www.facebook.com/guitareoofficial" target="_blank"> <i class="fab fa-facebook-f text-3xl md:text-4xl"></i> </a>
                        <h2 class="hidden sm:block count font-black leading-none my-2 md:my-3 text-white" id="likes-count" data-total-count="341000">0</h2>
                        <h2 class="count block sm:hidden font-black leading-none my-2 md:my-3 text-white">341K</h2>
                ...
                <div class="w-1/3 px-1 md:px-2 mb-2 md:mb-4">
                    <div class="instagram py-4 md:py-5 lg:py-6 rounded-xl w-full" style="background: #051124;">
                        <a href="https://www.instagram.com/guitareoofficial/" target="_blank"> <i class="fab fa-instagram text-3xl md:text-4xl" style="background: linear-gradient(30deg, #FFD521 17%, #F20008 50%, #B900B4 83%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;"></i>
                        </a>
                        <h2 class="hidden sm:block count font-black leading-none my-2 md:my-3 text-white" id="follower-count" data-total-count="14000">0</h2>
                        <h2 class="count block sm:hidden font-black leading-none my-2 md:my-3 text-white">14K</h2>
            ...
            <div class="testimonials flex flex-wrap justify-center items-start mx-auto w-full max-w-xs md:max-w-full">
                ...
                @foreach($testimonials as $testimonial)
                    <div class="testimonial w-full md:w-1/3 lg:w-1/4 md:px-2 pb-2 md:pb-4">
                        <div class="w-full rounded-xl overflow-hidden cursor-pointer" data-open="{!!  str_replace(' ', '', $testimonial['name'])  !!}" style="background: #051124;">
                ...
                @endforeach
                <div class="w-full -mt-14 lg:mt-0 block lg:hidden">
    ...
    <section class="content-section text-center px-6" style="background:linear-gradient(to bottom, #01050f, #021225);overflow:visible">
        <div class="container mx-auto max-w-4xl">
            <img class="h-28 md:h-32 lazyload" data-src="https://cdn.musora.com/image/fetch/w_250,q_auto:best/https://guitareo.s3.amazonaws.com/sales/2022/guitareo-guarantee.png">
...
@section('layout-scripts')
    ...
    <script>
        $(document).ready(function () {
            $('.tzcd-full').countdown('2022/03/01')
            ...
            $('.tzcd-days').countdown('2022/03/01')
                .on('update.countdown', function (event) {
                    var format = '';
            ...
            $('.tzcd-small').countdown('2022/03/01')
                .on('update.countdown', function (event) {
                    var format = '%-MM %-SS';
                    if (event.offset.totalHours > 0) {
                        format = '%-HH ' + format;
