...
@section('meta')
    <title>Terms Of Use | Guitareo</title>
...
@section('content')
    ...
    <div class="hero-header px-4 py-12 md:py-20 lg:py-32 bg-black bg-center bg-cover" style="background-image:url(https://dmmior4id2ysr.cloudfront.net/assets/images/guitareo-header.jpg);">
    ...
    <div class="container mx-auto py-12 px-3 md:px-4">
        ...
        <p class="py-2">Please read these Terms of Use ("Terms", "Terms of Use") carefully before using the www.guitareo.com website (the "Service") operated by Musora Media Inc., (“Musora”, “us”, "we", or "our").</p>

        <p class="py-2">Your access to and use of the Service is conditioned upon your acceptance of and compliance with these Terms. These Terms apply to all visitors, users and others who wish to access or use the Service.  We want you to have an enjoyable, educational experience using the Service, so we offer a 90-day Money Back Guarantee on all purchases made through the Service.</p>
        ...
        <p class="py-2">If you believe that your intellectual property rights are being violated and/or that any work belonging to you has been reproduced on the Site or in any content in any way, you may <a class="text-blue-600" href="{{ get_musora_brand_base_url() }}/contact">contact us here</a>.  Please provide your name and contact information, the nature of your work and how it is being violated, all relevant copyright and/or trademark registration information, the location/URL of the violation, and any other information you believe is relevant.</p>
