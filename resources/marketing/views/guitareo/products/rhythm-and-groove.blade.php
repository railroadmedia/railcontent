...
@section('content')
    ...
    <header class="px-5 sm:px-6 py-8 lg:py-10 text-white text-center bg-cover bg-center relative lazyload" style="background-color:#020b17;" data-bg="https://www.musora.com/cdn-cgi/image/width=2500,quality=95/https://d122ay5chh2hr5.cloudfront.net/shop/rhythm-and-groove/header.jpg">
        <div class="container mx-auto max-w-5xl relative z-10">
            <img class="h-16 sm:h-20 lg:h-24" src="https://www.musora.com/cdn-cgi/image/width=1200,quality=95/https://d122ay5chh2hr5.cloudfront.net/shop/rhythm-and-groove/Logo.svg" alt="Rhythm and groove logo"><br>
...
{{--                    <a href="/" class="text-guitareo">(OR FREE WITH A GUITAREO MEMBERSHIP)</a><br>--}}
    ...
    <section class="px-5 sm:px-6 py-10 sm:py-14 lg:py-20 text-white" style="background-color:#020b17;">
        <div class="container mx-auto max-w-4xl">
            <div class="sm:flex justify-center items-center">
                <img class="float-right h-24 sm:h-44 lg:h-60 mb-4 sm:mb-0 ml-3 sm:ml-0 sm:order-1 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=620,quality=95/https://d122ay5chh2hr5.cloudfront.net/shop/rhythm-and-groove/music_guitar.png" alt="Guitar icon">
        ...
        <div class="container mx-auto max-w-5xl">
            ...
            <div class="flex flex-wrap items-start justify-center text-left">
                <div class="w-full sm:w-1/2 lg:w-1/3 px-3 mb-8 sm:mb-6">
                    <div data-open="meetSami" class="cursor-pointer autoplay-video relative bg-cover bg-center rounded-xl mb-2 sm:mb-3 bg-black lazyload" style="padding-bottom: 65%;" data-bg="https://www.musora.com/cdn-cgi/image/width=640,quality=95/https://d122ay5chh2hr5.cloudfront.net/shop/rhythm-and-groove/thumb_meet.jpg">
                ...
                <div class="w-full sm:w-1/2 lg:w-1/3 px-3 mb-8 sm:mb-6">
                    <div class="relative bg-cover bg-center rounded-xl mb-2 sm:mb-3 bg-black lazyload" style="padding-bottom: 65%;" data-bg="https://www.musora.com/cdn-cgi/image/width=640,quality=95/https://d122ay5chh2hr5.cloudfront.net/shop/rhythm-and-groove/thumb_feel.jpg"></div>
                ...
                <div class="w-full sm:w-1/2 lg:w-1/3 px-3 mb-8 sm:mb-6">
                    <div class="relative bg-cover bg-center rounded-xl mb-2 sm:mb-3 bg-black lazyload" style="padding-bottom: 65%;" data-bg="https://www.musora.com/cdn-cgi/image/width=640,quality=95/https://d122ay5chh2hr5.cloudfront.net/shop/rhythm-and-groove/thumb_learn.jpg"></div>
                ...
                <div class="w-full sm:w-1/2 lg:w-1/3 px-3 mb-8 sm:mb-6">
                    <div class="relative bg-cover bg-center rounded-xl mb-2 sm:mb-3 bg-black lazyload" style="padding-bottom: 65%;" data-bg="https://www.musora.com/cdn-cgi/image/width=640,quality=95/https://d122ay5chh2hr5.cloudfront.net/shop/rhythm-and-groove/thumb_strum.jpg"></div>
                ...
                <div class="w-full sm:w-1/2 lg:w-1/3 px-3 mb-8 sm:mb-6">
                    <div class="relative bg-cover bg-center rounded-xl mb-2 sm:mb-3 bg-black lazyload" style="padding-bottom: 65%;" data-bg="https://www.musora.com/cdn-cgi/image/width=640,quality=95/https://d122ay5chh2hr5.cloudfront.net/shop/rhythm-and-groove/thumb_spice.jpg"></div>
                ...
                <div class="w-full sm:w-1/2 lg:w-1/3 px-3 mb-8 sm:mb-6">
                    <div class="relative bg-cover bg-center rounded-xl mb-2 sm:mb-3 bg-black lazyload" style="padding-bottom: 65%;" data-bg="https://www.musora.com/cdn-cgi/image/width=640,quality=95/https://d122ay5chh2hr5.cloudfront.net/shop/rhythm-and-groove/thumb_triplets.jpg"></div>
                ...
                <div class="w-full sm:w-1/2 lg:w-1/3 px-3 mb-8 sm:mb-6">
                    <div class="relative bg-cover bg-center rounded-xl mb-2 sm:mb-3 bg-black lazyload" style="padding-bottom: 65%;" data-bg="https://www.musora.com/cdn-cgi/image/width=640,quality=95/https://d122ay5chh2hr5.cloudfront.net/shop/rhythm-and-groove/thumb_changing.jpg"></div>
                ...
                <div class="w-full sm:w-1/2 lg:w-1/3 px-3 mb-8 sm:mb-6">
                    <div class="relative bg-cover bg-center rounded-xl mb-2 sm:mb-3 bg-black lazyload" style="padding-bottom: 65%;" data-bg="https://www.musora.com/cdn-cgi/image/width=640,quality=95/https://d122ay5chh2hr5.cloudfront.net/shop/rhythm-and-groove/thumb_creating.jpg"></div>
                ...
                <div class="w-full sm:w-1/2 lg:w-1/3 px-3 mb-8 sm:mb-6">
                    <div class="relative bg-cover bg-center rounded-xl mb-2 sm:mb-3 bg-black lazyload" style="padding-bottom: 65%;" data-bg="https://www.musora.com/cdn-cgi/image/width=640,quality=95/https://d122ay5chh2hr5.cloudfront.net/shop/rhythm-and-groove/thumb_bonus.jpg"></div>
    ...
    <section class="text-center px-5 sm:px-6 pb-10 sm:pb-14 lg:pb-20" style="background-color:#00101d;">
        <div class="container max-w-5xl mx-auto">
            ...
            <div class="flex flex-wrap sm:flex-nowrap items-start justify-center sm:mt-8 mb-20">
                <img class="border-8 border-white rounded-3xl shadow-xl w-52 sm:w-72 lg:w-96 relative -mb-8 sm:mb-0 sm:-mt-8 sm:-mr-8 z-10 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=760,quality=95/https://d122ay5chh2hr5.cloudfront.net/shop/rhythm-and-groove/coach.jpg" alt="Coach profile">
    ...
    <section class="text-center px-5 sm:px-6 py-10 sm:py-14 lg:py-20 relative">
        <div class="max-w-4xl mx-auto px-4">
            <div class="-mt-24 sm:-mt-28 lg:-mt-36">
                <img class="h-28 md:h-32 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=250,quality=95/https://d122ay5chh2hr5.cloudfront.net/sales/2022/guitareo-guarantee.png" alt="gurantee badge">
            </div>
    ...
    <section class="text-center px-5 sm:px-6 py-14 sm:py-20 lg:py-28 text-center text-white bg-center bg-cover lazyload" style="background-color:#051626;" data-bg="https://www.musora.com/cdn-cgi/image/width=1500,quality=95/https://d122ay5chh2hr5.cloudfront.net/shop/rhythm-and-groove/footer.jpg">
        <div class="container mx-auto">
            <img class="h-14 sm:h-20 lg:h-24" src="https://www.musora.com/cdn-cgi/image/width=1200,quality=95/https://d122ay5chh2hr5.cloudfront.net/shop/rhythm-and-groove/Logo.svg" alt="Rhythm and groove logo"><br>
