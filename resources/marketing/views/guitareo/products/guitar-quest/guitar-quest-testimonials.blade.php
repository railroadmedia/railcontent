...
@section('styles')
    ...
    <style>
        ...
        .header {
            background:#000512 url(https://www.musora.com/musora-cdn/image/width=750,q_60,quality=85/https://guitareo.s3.amazonaws.com/guitarquest/assets/testimonials/gq-testimonial-header-mobile.png) center center/cover;
            padding-bottom:120%;
        }

        @media (min-width:40em) {
            .header {
                background-image:url(https://www.musora.com/musora-cdn/image/width=2500,q_60,quality=85/https://guitareo.s3.amazonaws.com/guitarquest/assets/testimonials/gq-testimonial-header.png);
