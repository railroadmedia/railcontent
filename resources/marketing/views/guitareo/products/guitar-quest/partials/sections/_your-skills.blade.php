...
<section id="your_skills" class="py-28 bg-top bg-cover" style="background-image: url( {{ imgix("https://d122ay5chh2hr5.cloudfront.net/guitarquest/assets/6-bullets-background.jpg", ["auto" => "format", "w" => 1280]) }})">
    <div class="max-w-screen-xl m-auto px-6 flex text-white flex-wrap md:flex-no-wrap">
        <div class="text-center flex-col w-full sm:w-1/2 md:w-1/3 lg:w-1/4">
            <div class="mb-10 m-auto w-5/6 sm:mb-20 sm:w-full sm:px-4">
                <img src="{{ imgix("https://d122ay5chh2hr5.cloudfront.net/guitarquest/assets/icon-playing-first-song.svg", ["auto" => "format", "w" => 45]) }}" width="45px" class="m-auto mb-2">
                <h3 class="font-bison-bold uppercase text-3xl">Play Your First Song</h3>
                <p class="font-semibold md:text-lg">If you can walk and talk, then you can do this way sooner than you’d think. We promise!</p>
            </div>
            <div class="mb-10 m-auto w-5/6 sm:mb-20 sm:w-full sm:px-4">
                <img src="{{ imgix("https://d122ay5chh2hr5.cloudfront.net/guitarquest/assets/icon-play-campfire-songs.svg", ["auto" => "format", "w" => 45]) }}" width="45px" class="m-auto mb-2">
            ...
            <div class="mb-10 sm:mb-0 m-auto w-5/6 sm:w-full sm:px-4">
                <img src="{{ imgix("https://d122ay5chh2hr5.cloudfront.net/guitarquest/assets/icon-play-any-song.svg", ["auto" => "format", "w" => 45]) }}" width="45px" class="m-auto mb-2">
        ...
        <div class="order-first w-9/12 mx-auto items-center inline-flex justify-center mb-12 sm:px-4 md:mb-0 md:order-none md:w-1/3 lg:w-2/4">
            <img src="{{ imgix("https://d122ay5chh2hr5.cloudfront.net/guitarquest/assets/guitar-quest-logo-stack.png", ["auto" => "format", "w" => 300]) }}" width="300px" class="">
        </div>
        <div class="text-center flex-col m-auto w-full sm:w-1/2 md:w-1/3 lg:w-1/4">
            <div class="mb-10 m-auto w-5/6 sm:mb-20 sm:w-full sm:px-4">
                <img src="{{ imgix("https://d122ay5chh2hr5.cloudfront.net/guitarquest/assets/icon-jamming-with-band.svg", ["auto" => "format", "w" => 45]) }}" width="45px" class="m-auto mb-2">
                <h3 class="font-bison-bold uppercase text-3xl">Gain Insane Momentum</h3>
                <p class="font-semibold md:text-lg">Practice just became FUN with exciting missions and challenges to keep you motivated. </p>
            </div>
            <div class="mb-10 m-auto w-5/6 sm:mb-20 sm:w-full sm:px-4">
                <img src="{{ imgix("https://d122ay5chh2hr5.cloudfront.net/guitarquest/assets/icon-write-first-song.svg", ["auto" => "format", "w" => 45]) }}" width="45px" class="m-auto mb-2">
