{{-- Guitar Quest: Fixed Image Features --}}

<!-- Guitar Quest Fixed Image: Play Your First Song -->
<section class="sticky-section relative sticky-1">
    <div class="sticky-a bg-cover bg-top bg-no-repeat"></div>
    <div class="max-w-screen-xl m-auto px-6 flex z-10 sticky top-0 h-screen justify-center lg:justify-end" >
        <!-- Sticky Section -->
...
<!-- Guitar Quest Fixed Image: Start Jamming Right Away -->
<section class="sticky-section relative sticky-2">
    <div class="sticky-a bg-cover bg-top bg-no-repeat"></div>
    <div class="max-w-screen-xl m-auto px-6 flex z-10 sticky top-0 h-screen justify-center lg:justify-start" >
        <!-- Sticky Section -->
...
<!-- Guitar Quest Fixed Image: Express Yourself On The Guitar -->
<section class="sticky-section relative sticky-3">
    <div class="sticky-a bg-cover bg-top bg-no-repeat"></div>
    <div class="max-w-screen-xl m-auto px-6 flex z-10 sticky top-0 h-screen justify-center lg:justify-end" >
        <!-- Sticky Section -->
