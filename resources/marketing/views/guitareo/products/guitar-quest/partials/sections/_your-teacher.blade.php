...
<section id="your_teacher" class="py-28 bg-top bg-contain bg-no-repeat" style="background-image: url( {{ imgix("https://d122ay5chh2hr5.cloudfront.net/guitarquest/assets/rob-scallon-guide-background.png", ["auto" => "format", "w" => 2000]) }}); background-color: hsl(222, 100%, 3.92%);">
    <div class="max-w-screen-xl m-auto px-6 pb-6 flex text-white flex-col">
        ...
        <div class="w-full m-auto relative -mt-7 md:-mt-11 md:w-9/12 lg:w-7/12">
            <img src="{{ imgix("https://d122ay5chh2hr5.cloudfront.net/guitarquest/assets/rob-scallon-guide.png", ["auto" => "format", "w" => 700]) }}">
        ...
        <div class="w-full m-auto text-white relative -mt-24 md:w-3/4 lg:w-1/2">
            ...
            <div class="flex flex-col items-center mb-6">
                <img src="{{ imgix("https://d122ay5chh2hr5.cloudfront.net/guitarquest/assets/rob-scallon-headshot.jpg", ["auto" => "format", "w" => 65]) }}" width="65px" class="rounded-full mb-2">
                <div class="block w-40 mx-auto">
                    <img class="w-full" src="{{ imgix("https://d122ay5chh2hr5.cloudfront.net/guitarquest/assets/rob-signature-2.png", ["auto" => "format", "w" => 200]) }}">
                </div>
            </div>
            <!-- Social Links -->
