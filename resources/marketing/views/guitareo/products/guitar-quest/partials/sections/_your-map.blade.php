...
<section id="your_map" class="py-24 relative md:py-28" style="background-image: url( {{ imgix("https://d122ay5chh2hr5.cloudfront.net/guitarquest/assets/star-pattern.svg", ["auto" => "format", "w" => 1500]) }} ); background-color: #000718;">
    ...
    <!-- Level Modals -->
    @include("products.guitar-quest.partials.map._level-modals")
</section>