    ...
    >
        ...
        <div class="w-screen max-w-xl p-3 h-screen overflow-auto flex scrollbar-none"
            ...
            <div x-show="levelModalOpen === 1"
                ...
                <img src="{{ imgix("https://d122ay5chh2hr5.cloudfront.net/guitarquest/assets/Guitar-Quest-1-0.png", ["auto" => "format", "w" => 2000]) }}" />
                <div class="p-6">
            ...
            <div x-show="levelModalOpen === 2"
                x-on:click.stop
                class="container my-auto max-w-xl overflow-hidden rounded-2xl bg-white font-primary text-gray-700">
                <img src="{{ imgix("https://d122ay5chh2hr5.cloudfront.net/guitarquest/assets/Guitar-Quest-2-0.png", ["auto" => "format", "w" => 2000]) }}" />
                <div class="p-6">
            ...
            <div x-show="levelModalOpen === 3"
                x-on:click.stop
                class="container my-auto max-w-xl overflow-hidden rounded-2xl bg-white font-primary text-gray-700">
                <img src="{{ imgix("https://d122ay5chh2hr5.cloudfront.net/guitarquest/assets/Guitar-Quest-3-0.png", ["auto" => "format", "w" => 2000]) }}" />
                <div class="p-6">
            ...
            <div x-show="levelModalOpen === 4"
                x-on:click.stop
                class="container my-auto max-w-xl overflow-hidden rounded-2xl bg-white font-primary text-gray-700">
                <img src="{{ imgix("https://d122ay5chh2hr5.cloudfront.net/guitarquest/assets/Guitar-Quest-4-0.png", ["auto" => "format", "w" => 2000]) }}" />
                <div class="p-6">
            ...
            <div x-show="levelModalOpen === 5"
                x-on:click.stop
                class="container my-auto max-w-xl overflow-hidden rounded-2xl bg-white font-primary text-gray-700">
                <img src="{{ imgix("https://d122ay5chh2hr5.cloudfront.net/guitarquest/assets/Guitar-Quest-5-0.png", ["auto" => "format", "w" => 2000]) }}" />
                <div class="p-6">
            ...
            <div x-show="levelModalOpen === 6"
                x-on:click.stop
                class="container my-auto max-w-xl overflow-hidden rounded-2xl bg-white font-primary text-gray-700">
                <img src="{{ imgix("https://d122ay5chh2hr5.cloudfront.net/guitarquest/assets/Guitar-Quest-6-0.png", ["auto" => "format", "w" => 2000]) }}" />
                <div class="p-6">
            ...
            <div x-show="levelModalOpen === 7"
                x-on:click.stop
                class="container my-auto max-w-xl overflow-hidden rounded-2xl bg-white font-primary text-gray-700">
                <img src="{{ imgix("https://d122ay5chh2hr5.cloudfront.net/guitarquest/assets/Guitar-Quest-7-0.png", ["auto" => "format", "w" => 2000]) }}" />
                <div class="p-6">
            ...
            <div x-show="levelModalOpen === 8"
                x-on:click.stop
                class="container my-auto max-w-xl overflow-hidden rounded-2xl bg-white font-primary text-gray-700">
                <img src="{{ imgix("https://d122ay5chh2hr5.cloudfront.net/guitarquest/assets/Guitar-Quest-8-0.png", ["auto" => "format", "w" => 2000]) }}" />
                <div class="p-6">
            ...
            <div x-show="levelModalOpen === 9"
                x-on:click.stop
                class="container my-auto max-w-xl overflow-hidden rounded-2xl bg-white font-primary text-gray-700">
                <img src="{{ imgix("https://d122ay5chh2hr5.cloudfront.net/guitarquest/assets/Guitar-Quest-9-0.png", ["auto" => "format", "w" => 2000]) }}" />
                <div class="p-6">
