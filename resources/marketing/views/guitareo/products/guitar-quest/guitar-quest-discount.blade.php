...
@section('promo-banner')
    <section class="tw-py-8 md:tw-py-12 tw-relative tw-text-white tw-text-center" style="z-index: 51;margin: 0 auto -70px; background:#000612;">
        <div class="tw-max-w-screen-xl tw-m-auto tw-px-6 lg:tw-flex lg:tw-items-start">
            <img class="tw-inline-block tw-w-3/4 sm:tw-w-full sm:tw-max-w-sm tw-mb-5 lg:tw-mb-0 tw-mx-auto lg:tw-mx-0" src="{{ imgix("https://guitareo.s3.amazonaws.com/lead-gen/song-in-an-hour/logo-purple-discount.png", ["auto" => "format", "w" => 770]) }}">
            <div class="lg:tw-pl-10 tw-max-w-lg lg:tw-max-w-2xl tw-mx-auto lg:tw-mx-0">
                <p class="font-primary tw-text-lg sm:tw-text-xl"><strong class="tw-font-black">CONTINUE YOUR JOURNEY <i class="fas fa-long-arrow-right tw-mx-1" style="color:#6100a6;"></i> <span class="tw-inline-block"> SAVE {{ round(100 - (100 * (\App\Prices::$guitarQuestSpecial / \App\Prices::$guitarQuestFull))) }}% ON GUITAR QUEST</span></strong></p>
                <p class="font-primary tw-text-sm sm:tw-text-base tw-my-4 tw-leading-relaxed tw-text-left">
                    ...
                    <br><br>
                    Song In An Hour is actually the FIRST level of GuitarQuest. And because we hope you’ll keep learning with us, we’re giving you a {{ round(100 - (100 * (\App\Prices::$guitarQuestSpecial / \App\Prices::$guitarQuestFull))) }}% discount to make things a little easier. Just click any of the big buttons on this page to continue your journey.
                </p>
    ...
    <a href="{{ $orderLink }}" class="tw-w-full bg-gq-purple tw-py-2 tw-text-center tw-sticky tw-z-50 tw-block tw-text-white"
            style="top: 56px;"
    >
        <img class="tw-inline-block tw-w-32" src="https://guitareo.s3.amazonaws.com/lead-gen/song-in-an-hour/logo-white.png">
