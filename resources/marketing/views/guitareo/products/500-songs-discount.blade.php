    ...
    <a href="@yield('order-link')" class="artist-promo-banner fixed">
        <div class="noise-wrap">
            <div class="container">
                ...
                <div class="text">
                    <p><strong>
                            Save {{ round(100 - (100 * ($productPrice / App\Prices::$songs500Full))) }}% on 500 Songs in 5 Days</strong><br>
    ...
    <section class="messenger-slice" style="background: #051529;">
        <div class="container mx-auto">
            <a href="@yield('order-link')">
                ...
                <h2 class="leading-normal"><strong>Exclusive Offer Only For<br class="inline md:hidden">  <img style="padding: 0 23px;margin: 0 -23px;" class="logo" width="230px" src="https://cdn.musora.com/image/fetch/w_448,q_auto:best/https://guitareo.s3.amazonaws.com/lead-gen/free-acoustic-guitar-lessons/logo.png"> Students</strong></h2>
            </a>
        </div>
    </section>
@endsection