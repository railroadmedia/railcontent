    ...
    <a href="@yield('order-link')" class="artist-promo-banner fixed">
        <div class="noise-wrap">
            <div class="container mx-auto">
                <img class="logo" src="https://www.musora.com/cdn-cgi/image/width=448,quality=95/https://d122ay5chh2hr5.cloudfront.net/lead-gen/free-acoustic-guitar-lessons/logo.png">
                <div class="text">
                    <p><strong>
