                    ...
                    @foreach ($images as $key => $image)
                        <div style="display:none;">
                            <img
                                ...
                                src="https://www.musora.com/musora-cdn/image/width=1000,quality=85/@if(str_contains($image->path, 'amazonaws') || str_contains($image->path, 'cloudfront') || str_contains($image->path, 'vimeocdn')){{$image->path}}@else{{'https://d1fyshwdvi6fth.cloudfront.net/'.$image->path}}@endif" alt="image {{ $key+1 }}">
                        </div>
                    @endforeach
                @endif
            </div>
