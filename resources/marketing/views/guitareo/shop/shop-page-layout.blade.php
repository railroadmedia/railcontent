...
@section('styles')
    ...
    <link href="{{ asset('/marketing/parcel/drumeo/shop-product-guitareo.css') }}" rel="stylesheet">
    <style>
        * {
...
@section('scripts')
    ...
    <script type="text/javascript" src="{{ asset('/marketing/parcel/drumeo/shop-product-guitareo.js') }}"></script>
@endsection
