    ...
    <section class="py-6 md:py-20 text-2xl">
        ...
        <div class="grid md:grid-cols-3 gap-4 md:gap-2 lg:gap-4 max-w-xl md:max-w-5xl mx-auto px-4 lg:px-0">
            <div data-open="step1" class="cursor-pointer autoplay-video">
                <img class="rounded-xl w-full" src="https://www.musora.com/musora-cdn/image/width=500,quality=95/https://d122ay5chh2hr5.cloudfront.net/shop/survival-kit/survival-kit-thumb-01.jpg" alt="thumb 1">
            ...
            <div data-open="step2" class="cursor-pointer autoplay-video">
                <img class="rounded-xl w-full" src="https://www.musora.com/musora-cdn/image/width=500,quality=95/https://d122ay5chh2hr5.cloudfront.net/shop/survival-kit/survival-kit-thumb-02.jpg" alt="thumb 2">
            ...
            <div data-open="step3" class="cursor-pointer autoplay-video">
                <img class="rounded-xl w-full" src="https://www.musora.com/musora-cdn/image/width=500,quality=95/https://d122ay5chh2hr5.cloudfront.net/shop/survival-kit/survival-kit-thumb-03.jpg" alt="thumb 3">
