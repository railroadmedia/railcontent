...
@section('banner')
    <section class="tw-pb-60 tw-bg-cover tw-bg-center" style="background-image: url('https://www.musora.com/musora-cdn/image/width=2000,quality=95/https://d122ay5chh2hr5.cloudfront.net/shop/survival-kit/survival-kit-tutorial-header.jpg')">
    </section>
    ...
    <section class="tw-py-6 md:tw-py-20 tw-text-2xl">
        ...
        <div class="tw-grid md:tw-grid-cols-3 tw-gap-4 md:tw-gap-2 lg:tw-gap-4 tw-max-w-xl md:tw-max-w-5xl tw-mx-auto tw-px-4 lg:tw-px-0">
            <div data-open="step1" class="tw-cursor-pointer autoplay-video">
                <img class="tw-rounded-xl tw-w-full" src="https://www.musora.com/musora-cdn/image/width=500,quality=95/https://d122ay5chh2hr5.cloudfront.net/shop/survival-kit/survival-kit-thumb-01.jpg" alt="thumb 1">
            ...
            <div data-open="step2" class="tw-cursor-pointer autoplay-video">
                <img class="tw-rounded-xl tw-w-full" src="https://www.musora.com/musora-cdn/image/width=500,quality=95/https://d122ay5chh2hr5.cloudfront.net/shop/survival-kit/survival-kit-thumb-02.jpg" alt="thumb 2">
            ...
            <div data-open="step3" class="tw-cursor-pointer autoplay-video">
                <img class="tw-rounded-xl tw-w-full" src="https://www.musora.com/musora-cdn/image/width=500,quality=95/https://d122ay5chh2hr5.cloudfront.net/shop/survival-kit/survival-kit-thumb-03.jpg" alt="thumb 3">
