    ...
    <header class="hero-header">
        <div class="container clearfix lg:mx-auto max-w-6xl">
            <div class="video-wrap autoplay-video" @click="trailer = true;">
                ...
                <img class="logo" src="https://www.musora.com/cdn-cgi/image/width=900,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-technique-made-easy/logo-white.png" alt="Drum Technique Made Easy Logo" fetchpriority="high">
            </div>
...
{{--                <br>--}}
    ...
    <section class="three-benefits">
        <div class="container clearfix lg:mx-auto max-w-6xl">
            ...
            <div class="float-left benefit-row practice">
                <div class="sm:w-1/2 float-right">
                    <div class="arrow-outline">
                        <img class="transition-all opacity-0" src="https://www.musora.com/cdn-cgi/image/width=550,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-technique-made-easy/bubble1.jpg" alt="Bubble 1" loading="lazy" onload="this.classList.remove('opacity-0')">
                    </div>
                </div>
            ...
            <div class="float-left benefit-row play">
                <div class="sm:w-1/2 float-left">
                    <div class="arrow-outline right">
                        <img class="transition-all opacity-0" src="https://www.musora.com/cdn-cgi/image/width=550,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-technique-made-easy/bubble2.jpg" alt="Bubble 2" loading="lazy" onload="this.classList.remove('opacity-0')">
                    </div>
                </div>
            ...
            <div class="float-left benefit-row support">
                <div class="sm:w-1/2 float-right">
                    <div class="arrow-outline">
                        <img class="transition-all opacity-0" src="https://www.musora.com/cdn-cgi/image/width=550,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-technique-made-easy/bubble3.jpg" alt="Bubble 3" loading="lazy" onload="this.classList.remove('opacity-0')">
                    </div>
                </div>
                <div class="sm:w-1/2 text-wrap">
        ...
        <div class="container clearfix lg:mx-auto max-w-6xl">
            ...
            <div class="float-left w-full half-padding sm:w-1/3">
                <div class="path-point">
                    <img class="mx-auto transition-all opacity-0" src="https://www.musora.com/cdn-cgi/image/width=450,quality=95/https://dzryyo1we6bm3.cloudfront.net/independence-made-easy/sales/path-1.png" alt="Path 1" loading="lazy" onload="this.classList.remove('opacity-0')">
            ...
            <div class="float-left w-full half-padding sm:w-1/3">
                <div class="path-point">
                    <img class="mx-auto transition-all opacity-0" src="https://www.musora.com/cdn-cgi/image/width=450,quality=95/https://dzryyo1we6bm3.cloudfront.net/independence-made-easy/sales/path-2.png" alt="Path 2" loading="lazy" onload="this.classList.remove('opacity-0')">
            ...
            <div class="float-left w-full half-padding sm:w-1/3">
                <div class="path-point">
                    <img class="mx-auto transition-all opacity-0" src="https://www.musora.com/cdn-cgi/image/width=450,quality=95/https://dzryyo1we6bm3.cloudfront.net/independence-made-easy/sales/path-3.png" alt="Path 3" loading="lazy" onload="this.classList.remove('opacity-0')">
    ...
    <section class="bruce-bio">
        <div class="container clearfix lg:mx-auto max-w-6xl">
            ...
            <div class="px-3 md:px-4 timeline-pic">
                <img class="hidden lg:inline-block transition-all opacity-0" src="https://www.musora.com/cdn-cgi/image/width=1300,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-technique-made-easy/timeline.jpg" alt="Timeline" loading="lazy" onload="this.classList.remove('opacity-0')">
                <img class="hidden sm:inline-block lg:hidden transition-all opacity-0" src="https://www.musora.com/cdn-cgi/image/width=800,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-technique-made-easy/timeline-tablet.jpg" alt="Timeline" loading="lazy" onload="this.classList.remove('opacity-0')">
                <img class="inline-block sm:hidden transition-all opacity-0" src="https://www.musora.com/cdn-cgi/image/width=500,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-technique-made-easy/timeline-mobile.jpg" alt="Timeline" loading="lazy" onload="this.classList.remove('opacity-0')">
            </div>
        </div>
    </section>
        ...
        <div class="container clearfix lg:mx-auto max-w-6xl">
            ...
            <div class="drummer-testimonial featured-testimonial">
                <div class="float-left w-full px-3 md:px-4 sm:w-5/12 picture">
                    <img class="drummer-pic transition-all opacity-0" src="https://www.musora.com/cdn-cgi/image/width=850,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-technique-made-easy/jojo-mayer.jpg" alt="Jojo Mayer" loading="lazy" onload="this.classList.remove('opacity-0')">
                </div>
            ...
            <div class="float-left drummer-testimonial">
                <div class="float-left px-3 md:px-4 sm:w-1/3">
                    <img class="drummer-pic transition-all opacity-0" src="https://www.musora.com/cdn-cgi/image/width=550,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-technique-made-easy/steve-smith.jpg" alt="Steve Smith" loading="lazy" onload="this.classList.remove('opacity-0')">
                ...
                <div class="float-left px-3 md:px-4 sm:w-1/3">
                    <img class="drummer-pic transition-all opacity-0" src="https://www.musora.com/cdn-cgi/image/width=550,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-technique-made-easy/mark-schulman.jpg" alt="Mark Schulman" loading="lazy" onload="this.classList.remove('opacity-0')">
                ...
                <div class="float-left px-3 md:px-4 sm:w-1/3">
                    <img class="drummer-pic transition-all opacity-0" src="https://www.musora.com/cdn-cgi/image/width=550,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-technique-made-easy/david-garibaldi.jpg" alt="David Garibaldi" loading="lazy" onload="this.classList.remove('opacity-0')">
            ...
            <div class="float-left drummer-testimonial featured-testimonial">
                <div class="float-right sm:float-left w-full px-3 md:px-4 sm:w-5/12 picture">
                    <img class="drummer-pic transition-all opacity-0" src="https://www.musora.com/cdn-cgi/image/width=800,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-technique-made-easy/dave-weckl.jpg" alt="Dave Weckl" loading="lazy" onload="this.classList.remove('opacity-0')">
                </div>
                <div class="float-right px-3 md:px-4 sm:w-7/12 text">
            ...
            <div class="float-left drummer-testimonial">
                <div class="float-left px-3 md:px-4 sm:w-1/3">
                    <img class="drummer-pic transition-all opacity-0" src="https://www.musora.com/cdn-cgi/image/width=550,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-technique-made-easy/daniel-glass.jpg" alt="Daniel Glass" loading="lazy" onload="this.classList.remove('opacity-0')">
                ...
                <div class="float-left px-3 md:px-4 sm:w-1/3">
                    <img class="drummer-pic transition-all opacity-0" src="https://www.musora.com/cdn-cgi/image/width=550,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-technique-made-easy/ralph-johnson.jpg" alt="Ralph Johnson" loading="lazy" onload="this.classList.remove('opacity-0')">
                ...
                <div class="float-left px-3 md:px-4 sm:w-1/3">
                    <img class="drummer-pic transition-all opacity-0" src="https://www.musora.com/cdn-cgi/image/width=550,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-technique-made-easy/tris-imboden.jpg" alt="Tris Imboden" loading="lazy" onload="this.classList.remove('opacity-0')">
        ...
        <div class="container clearfix lg:mx-auto max-w-6xl">
            ...
            <table>
                ...
                <tr>
                    <td></td>
                    <td>
                        <img src="https://www.musora.com/cdn-cgi/image/width=550,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-technique-made-easy/macbook.png" class="macbook transition-all opacity-0" alt="Macbook" loading="lazy" onload="this.classList.remove('opacity-0')"><br>
                        <img src="https://www.musora.com/cdn-cgi/image/width=550,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-technique-made-easy/logo-black.png" class="blue-logo transition-all opacity-0" alt="Drum Technique Made Easy Logo" loading="lazy" onload="this.classList.remove('opacity-0')">
                    </td>
    ...
    <section class="text-center guarantee">
        <div class="container clearfix lg:mx-auto max-w-6xl">
            <img class="guarantee-badge inline-block sm:hidden transition-all opacity-0" style="filter: hue-rotate(305deg) brightness(1.13);" src="https://www.musora.com/cdn-cgi/image/width=200,quality=95/https://dpwjbsxqtam5n.cloudfront.net/sales/guarantee-badge.png" loading="lazy" onload="this.classList.remove('opacity-0')">
            <div class="flex-container">
                <img class="guarantee-badge hidden sm:inline-block transition-all opacity-0" style="filter: hue-rotate(305deg) brightness(1.13);" src="https://www.musora.com/cdn-cgi/image/width=550,quality=95/https://dpwjbsxqtam5n.cloudfront.net/sales/guarantee-badge.png" alt="Guarantee Badge" loading="lazy" onload="this.classList.remove('opacity-0')">
    ...
    <section class="final">
        <div class="container clearfix lg:mx-auto max-w-6xl">
            <div class="logo"><img class="transition-all opacity-0" src="https://www.musora.com/cdn-cgi/image/width=850,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-technique-made-easy/logo-white.png" alt="Drum Technique Made Easy Logo" loading="lazy" onload="this.classList.remove('opacity-0')"></div>
