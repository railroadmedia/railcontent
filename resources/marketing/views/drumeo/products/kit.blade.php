        ...
        <div class="container mx-auto max-w-5xl">
            <picture>
                <source
                    ...
                    type="image/png">
                <img class="transition-opacity opacity-0 h-4 md:h-6" alt="icon" loading="lazy"
            ...
            <h1 class="leading-tight my-5 uppercase"><strong>Everything you need to<br class="hidden sm:inline"> start
    ...
    <div class="container mx-auto z-10 relative max-w-4xl text-white">
        ...
        <picture>
            <source
                ...
                type="image/png">
            <img class="transition-opacity opacity-0 h-10 md:h-14" alt="icon" loading="lazy"
                onload="this.classList.remove('opacity-0')"
    ...
    <section class="px-3 sm:px-0 text-center relative z-50 overflow-hidden" style="background:linear-gradient(to bottom, #fff, #f0f6fc 66%);">
        ...
        <div class="container max-w-5xl mx-auto relative z-50">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full mx-2 text-black">
                <h5 class="leading-normal text-left p-2" style="width: 100%"><strong>Free shipping in North America</strong><br>
