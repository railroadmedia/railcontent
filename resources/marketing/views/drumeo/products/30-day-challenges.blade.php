...
<div class="container max-w-7xl mx-auto p-4 md:p-6 lg:flex">
        ...
        <div class="lg:w-2/6 py-2 md:p-4">
            ...
            $lessons = [
                'Day 1 - Introduction',
                'Day 2 - Basics of Drumming',
                'Day 3 - Rhythms and Patterns',
                'Day 4 - Advanced Techniques',
                'Day 5 - Grooves and Fills',
                'Day 6 - Introduction',
                'Day 7 - Basics of Drumming',
                'Day 8 - Rhythms and Patterns',
                'Day 9 - Advanced Techniques',
                'Day 10 - Grooves and Fills',
            ];
            @endphp
...
{{--                    </div>--}}
{{--                </div>--}}
{{--                <div class="bg-white rounded-xl border border-drumeo py-8 px-4">--}}
{{--                    <div class="text-center -mt-11">--}}
...
{{--                            <b class="text-drumeo">Free</b> Best Beginner Drum Book<br>--}}
{{--                            <b class="text-drumeo">Free</b> 3 Bonus Training Packs--}}
{{--                        </p>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </div>--}}
