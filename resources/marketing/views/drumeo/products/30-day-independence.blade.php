            ...
            <div class="flex flex-wrap sm:flex-nowrap items-center">
                <div class="w-full sm:w-7/12 text-center lg:text-left">
                    <img class="h-20 sm:h-24 lg:h-28 -mb-3 sm:mb-0 lg:mb-3 transition-opacity opacity-0"
                        ...
                        src="https://d21q7xesnoiieh.cloudfront.net/fit-in/770x0/marketing/drumeo/products/30-day-independence/icon-logo-dark.webp" alt="30DD logo season3 logo">
...
{{--                            <a href="#final" class="join blue medium w-full anchor-slide">ENROLL NOW</a>--}}
                        ...
                        <div class="w-full sm:w-1/2 lg:pb-5">
                            <img class="h-7 sm:mb-1 lg:mb-0 mr-1 sm:mr-0 lg:mr-1 transition-opacity opacity-0"
                                loading="lazy" onload="this.classList.remove('opacity-0')"
                                src="https://d21q7xesnoiieh.cloudfront.net/fit-in/900x0/filters:quality(95)/marketing/drumeo/products/30-day-independence/joined-profiles.png" alt="Image of joined student profiles in 30-Day Independence">
                ...
                <div class="w-full sm:w-5/12 hidden sm:block">
                    <div class="rounded-xl overflow-hidden relative {{-- bg-cover --}} bg-contain bg-center bg-no-repeat cursor-pointer autoplay-video"
                        style="padding-bottom: 98%; background-image:url('https://d21q7xesnoiieh.cloudfront.net/fit-in/850x0/filters:quality(95)/marketing/drumeo/products/30-day-independence/header-thumb.webp');" x-on:click="trailer = true;">
        ...
        <div class="container max-w-5xl mx-auto">
            ...
            @php
                $gettings = [
                    [
                    'position' => 'left',
                    'img' => 'https://d21q7xesnoiieh.cloudfront.net/fit-in/900x0/filters:quality(95)/marketing/drumeo/products/30-day-independence/practice.webp',
                    ...
                    [
                    'position' => 'right',
                    'img' => 'https://d21q7xesnoiieh.cloudfront.net/fit-in/900x0/filters:quality(95)/marketing/drumeo/products/30-day-independence/schedule.webp',
                    ...
                    [
                    'position' => 'left',
                    'img' => 'https://d21q7xesnoiieh.cloudfront.net/fit-in/900x0/filters:quality(95)/marketing/drumeo/products/30-day-independence/music.webp',
                    ...
                    [
                    'position' => 'right',
                    'img' => 'https://d21q7xesnoiieh.cloudfront.net/fit-in/900x0/filters:quality(95)/marketing/drumeo/products/30-day-independence/q%26a.webp',
                    ...
                    [
                    'position' => 'left',
                    'img' => 'https://d21q7xesnoiieh.cloudfront.net/fit-in/900x0/filters:quality(95)/marketing/drumeo/products/30-day-independence/lifetime.webp',
            ...
            <div class="timeline-container max-w-4xl lg:max-w-4xl mx-auto relative px-4 sm:pb-14 lg:pb-20 mt-5">
                @foreach ($gettings as $key => $getting)
                    @if($getting['position'] === 'right')
                        <div class="timeline relative flex flex-col-reverse md:grid md:grid-cols-2 gap-4 md:gap-14 lg:gap-20 mb-16 @if($key !== 4) md:mb-20 @else md:mb-0 @endif">
                            ...
                            <img class="-mt-7 rounded-lg transition-opacity opacity-0"
                                loading="lazy" onload="this.classList.remove('opacity-0')"
                                src="{{ $getting['img'] }}" alt="{{ $getting['title'] }}" />
                        </div>
                    @else
                        <div class="timeline relative flex flex-col md:grid md:grid-cols-2 gap-4 md:gap-14 lg:gap-20 mb-16 md:mb-20">
                            @if(empty($getting['special']))
                                <img class="-mt-7 rounded-lg transition-opacity opacity-0"
                                    loading="lazy" onload="this.classList.remove('opacity-0')"
                                    src="{{ $getting['img'] }}" alt="{{ $getting['title'] }}" />
                            @else
                                <div class="-mt-7 rounded-lg bg-cover bg-center relative aspect-16:9" style="background-image:url('{{ $getting['img'] }}')"></div>
                            @endif
        ...
        <div class="container max-w-4xl mx-auto">
            <div class="flex flex-wrap sm:flex-nowrap items-center justify-center">
                <img class="h-28 sm:h-36 lg:h-48 transition-opacity opacity-0"
                    loading="lazy" onload="this.classList.remove('opacity-0')"
                    src="https://d21q7xesnoiieh.cloudfront.net/fit-in/770x0/marketing/drumeo/products/30-day-independence/icon-logo-dark.webp" alt="30-Day Independence Logo">
...
{{--                <a href="#final" class="join blue medium w-3/4 sm:w-1/2 mt-6 sm:mt-12 mb-3 anchor-slide">ENROLL NOW</a><br>--}}
        ...
        <div class="container max-w-4xl mx-auto">
            <div class="flex flex-wrap sm:flex-nowrap justify-center items-center">
                <img class="w-48 sm:w-64 lg:w-80 -mt-12 mb-4 sm:-mb-24 transition-opacity opacity-0"
                    loading="lazy" onload="this.classList.remove('opacity-0')"
                    src="https://d21q7xesnoiieh.cloudfront.net/fit-in/900x0/filters:quality(95)/marketing/drumeo/products/30-day-independence/screen.webp" alt="Mobile Screen with 30-Day Independence">
    ...
    <section class="text-center px-5 sm:px-6 py-10 sm:py-14 lg:py-20">
        <div class="container max-w-6xl mx-auto">
            <h2 class="mb-6 sm:mb-10 lg:mb-14"><img class="h-16 sm:h-24 -mb-2 sm:-mb-4 align-bottom transition-opacity opacity-0"
                    loading="lazy" onload="this.classList.remove('opacity-0')"
                    src="https://d21q7xesnoiieh.cloudfront.net/fit-in/770x0/filters:quality(95)/marketing/drumeo/products/30-day-independence/icon-logo-dark.webp" alt="30-Day Independence Logo"> <strong>...is designed for:</strong></h2>
            
            @php
                $drummers = [
                    [
                        'image' => 'https://d21q7xesnoiieh.cloudfront.net/fit-in/900x0/filters:quality(95)/marketing/drumeo/products/30-day-independence/intermediate.webp',
                        'title' => 'Intermediate Drummers',
                        'description' => '30-Day Independence will help you take your drumming to the next level by pushing your 4-way coordination. This is the key to unlocking your creativity on the drums.'
                    ],
                    [
                        'image' => 'https://d21q7xesnoiieh.cloudfront.net/fit-in/900x0/filters:quality(95)/marketing/drumeo/products/30-day-independence/advanced.webp',
                        'title' => 'Advanced Drummers',
                        'description' => 'You’ve been playing for a while, holding down gigs and feeling confident in your drumming. 30-Day Indpendence will boost your 4-way coordination that will help you play new styles, create your own drum parts, and play everything easier. '
                    ],
                    [
                        'image' => 'https://d21q7xesnoiieh.cloudfront.net/fit-in/900x0/filters:quality(95)//marketing/drumeo/products/30-day-independence/beginner.webp',
                        'title' => 'Ambitious Beginners',
                        'description' => 'Maybe you’re fairly early in your drumming journey but are ready for a challenge. You might struggle to complete 30-Day Independence but you’re welcome to give it a try. '
                    ],
            ...
            <div class="flex flex-col sm:flex-row text-left justify-center">
                @foreach($drummers as $drummer)
                    <div class="w-full sm:w-1/4 px-2 mb-6 sm:mb-0 mx-auto sm:mx-0">
                        <div class="pb-44 sm:pb-36 lg:pb-52 text-center text-white bg-cover bg-center relative overflow-hidden rounded-xl" style="background-image:url('{{ $drummer['image'] }}'); object-position: 60% 0">
                            <h6 class="leading-tight lg:leading-relaxed absolute bottom-1 w-full z-10"><strong><img class="h-8 transition-opacity opacity-0"
                                        loading="lazy" onload="this.classList.remove('opacity-0')"
                                        src="https://www.musora.com/musora-cdn/image/width=150,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/30-day-drummer/plus.svg" alt="plus icon"><br>{{ $drummer['title'] }}</strong></h6>
                ...
                <table class="w-full mx-auto comparison max-w-4xl mx-auto mb-10 private">
                    ...
                    <tr style="background-color:transparent!important;">
                        ...
                        <td class="rounded-t-xl"><img class="h-8 sm:h-14 transition-opacity opacity-0"
                                loading="lazy" onload="this.classList.remove('opacity-0')"
                                src="https://d21q7xesnoiieh.cloudfront.net/fit-in/770x0/filters:quality(95)/marketing/drumeo/products/30-day-independence/icon-logo-white.webp" alt="30 day drummer logo"></td>
                    ...
                    <tr>
                        <td>Investment</td>
                            <td class="rounded-b-xl"><strong>${{ floatval($productPrices['30-day-drummer-4']->discounted_price) }}</strong><br> <span class="text-xs">Single Payment</span></td>
                        <td class="rounded-bl-xl"><strong>$30-$100</strong><br> <span class="text-xs">Per Lesson</span></td>
    ...
    <section style="background: #EFF7FF" class="pb-10 md:pb-20">
        <div class="container max-w-2xl mx-auto pb-10 sm:py-10">
            <div class="p-6 text-center">
                <h4 class="uppercase leading-relaxed text-gray-300 py-4">No theory. No homework.</h4>
                <img class="w-full sm:max-w-md" src="https://d21q7xesnoiieh.cloudfront.net/fit-in/770x0/filters:quality(95)/marketing/drumeo/products/30-day-independence/play-image.jpg" alt="Just Press Play Image"/>   
            </div>
            <div class="aspect-16:9 cursor-pointer sm:rounded-xl autoplay-video overflow-hidden w-full relative" x-on:click="trailer = true;" role="button">
                <i class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 fas fa-play play-button z-10"></i>
                <video class="sm:rounded-xl overflow-hidden object-cover w-full h-full absolute z-0" data-src="https://dpwjbsxqtam5n.cloudfront.net/drum-shop/30-day-drummer/season3/video-reel.mp4" type="video/mp4" loop playsinline muted controls></video>
                <img class="absolute inset-0 sm:rounded-xl overflow-hidden object-cover w-full h-full absolute z-0" src="https://d21q7xesnoiieh.cloudfront.net/fit-in/770x0/filters:quality(95)/marketing/drumeo/products/30-day-independence/press-play.jpg" alt="Press Play"/>
            </div>
        </div>
    </section>
    ...
    <section class="text-white text-center px-5 sm:px-6 py-10 sm:py-14 lg:py-20" style="background:linear-gradient(to bottom, #d70b3b, #9d1032);">
        <div class="container max-w-2xl mx-auto">
            ...
            <h6 class="leading-normal  mt-4">330-Day Independence is a daily guided workout program for drummers — where you’ll get a new video each weekday and a live session each weekend throughout the month. Because of this, students will not be able to join midway — <strong>and you need to register before the course begins on May 6th.</strong></h6>
        ...
        <div class="container max-w-5xl mx-auto mb-14 lg:mb-16">
            <div class="flex flex-wrap sm:flex-nowrap items-start justify-center sm:mt-8">
                <div class="w-52 sm:w-72 lg:w-96 relative -mb-8 sm:mb-0 sm:-mt-8 sm:-mr-8">
                    ...
                    <img class="hidden sm:inline-block absolute top-0 left-0 w-full z-20 transition-all opacity-0" src="https://d21q7xesnoiieh.cloudfront.net/fit-in/900x0/filters:quality(95)/marketing/drumeo/products/30-day-independence/coach-image.webp" loading="lazy" onload="this.classList.remove('opacity-0')">
                ...
                <div class="text-white text-left z-10 rounded-xl pt-14 pb-8 sm:py-10 lg:py-12 px-6 sm:pr-10 sm:pl-14 lg:px-24 max-w-xl sm:mt-8 w-full sm:w-auto sm:flex-grow" style="background-color:#00101d;">
                    ...
                    <h6 class="leading-normal mt-4 lg:mt-6">Estepario Siberiano has pushed the boundaries of drumming.
                        <br><br>
                        He’s inspired millions of people with his dedication, talent, and innovation. He’s created viral videos performing complex 4-way patterns with control. And he always applies these patterns in a musical context. 
                        <br><br>
                        Estepario is the perfect teacher to help you improve your drum set independence so you can unlock your creativity on the kit.
                    </h6>
    ...
    <section class="text-white text-center px-5 sm:px-6 py-10 sm:py-14 lg:py-20" style="background-color:#2a2f34;">
        <div class="container max-w-4xl mx-auto">
            <img class="h-28 sm:h-40 lg:h-52 block mx-auto -mt-24 sm:-mt-36 lg:-mt-48 transition-opacity opacity-0"
                loading="lazy" onload="this.classList.remove('opacity-0')"
                src="https://d21q7xesnoiieh.cloudfront.net/fit-in/250x0/filters:quality(95)/marketing/drumeo/membership/homepage/2023/guarantee.png" alt="guarantee badge">
    ...
    <section class="text-center relative z-50 overflow-hidden px-5 sm:px-6 py-10 sm:py-14 lg:py-20" style="background-color:#eff7ff;">
        <div class="container mx-auto relative z-50 text-center">
            <img class="h-20 sm:h-28 transition-opacity opacity-0"
                loading="lazy" onload="this.classList.remove('opacity-0')"
                src="https://d21q7xesnoiieh.cloudfront.net/fit-in/770x0/filters:quality(95)/marketing/drumeo/products/30-day-independence/icon-logo-dark.webp" alt="30DD season 2">
            <h2 class="leading-tight mt-2 mb-3 sm:my-3 lg:my-4"><strong>20 Play-Along Lessons + 4 Live Q&A Sessions</strong></h2>
            ...
            <h6 class="leading-normal mb-4">
                ...
                loading="lazy" onload="this.classList.remove('opacity-0')"
                src="https://d21q7xesnoiieh.cloudfront.net/fit-in/900x0/filters:quality(95)/marketing/drumeo/products/30-day-independence/joined-profiles.png" alt="Image of joined student profiles in 30-Day Independence">
                <p class="inline-block leading-tight text-sm align-middle">Join {{ number_format($nPackOwners ?? 0) }} drummers who<br class="sm:hidden"> have already registered.</p>

                @include('drumeo.products.partials._promo-cards', [
        // first deal
        'firstDeal'=> "30-Day Independence",
        'firstDealImage' => 'https://d21q7xesnoiieh.cloudfront.net/fit-in/550x0/filters:quality(95)/marketing/drumeo/products/30-day-independence/30DI-bundle.webp',
        'firstImageHeight' => 'h-28',
        'firstDealPrice' => 97,
        ...
        'secondDealImage' => 'https://d21q7xesnoiieh.cloudfront.net/fit-in/550x0/filters:quality(95)/marketing/drumeo/products/30-day-independence/membership-bundle.webp',
        'secondImageHeight' => 'h-28',
