...
@section('global-head')
    <title>E-Kit Bundle | Drumeo </title>
    <meta property="og:title" content="E-Kit Bundle | Drumeo">
...
@section('global-body')
    ...
    <header class="text-white relative overflow-hidden z-10 object-cover object-center" style="height:800px; background: url('https://d21q7xesnoiieh.cloudfront.net/fit-in/1200x0/filters:quality(95)/marketing/drumeo/promos/november/2024/e-kit-bundle/ekit-bundle-bg.webp') no-repeat center center; background-size: cover;">
