...
@section('content')
    ...
    <header class="header text-center" style="background-image:url(https://dpwjbsxqtam5n.cloudfront.net/drum-shop/four-weeks-to-better-drum-fills/header.jpg);">
        <div class="row">
            ...
            <a href="{{$orderUrl}}" class="join blue">Get Started &raquo;</a>
            <p>
                @if(floatval($productPrices['four-weeks-to-better-drum-fills']->price) > floatval($price))
                    <strong>ONLY <s>${{ floatval($productPrices['four-weeks-to-better-drum-fills']->price) }}</s>
                        @if(number_format(floatval($price), 2) == intval(floatval($price)))
                            ${{  floatval($price)  }}.
                        @else
                            ${{  number_format(floatval($price), 2)  }}.
                        @endif
                    </strong> (SAVE {{ round(100 - (100 * (floatval($price) / floatval($productPrices['four-weeks-to-better-drum-fills']->price)))) }}%)
                @else
...
{{--                        <br><a href="/" class="text-blue smaller">(OR FREE WITH A DRUMEO MEMBERSHIP)</a>--}}
    ...
    @component('_partials.components.video-modal',[
        ...
        @slot('button')
            <div class="text-center bg-white rounded-b-xl py-4">
                <a href="{{$orderUrl}}" class="join blue">Get Started »</a>
            </div>
        @endslot
    @endcomponent
    ...
    <section class="final" style="background-image:url(https://dpwjbsxqtam5n.cloudfront.net/drum-shop/four-weeks-to-better-drum-fills/order-section-background.jpg);">
        ...
        <div class="row">
            ...
            <div class="columns"><a href="{{$orderUrl}}" class="join blue">Get Started &raquo;</a></div>
