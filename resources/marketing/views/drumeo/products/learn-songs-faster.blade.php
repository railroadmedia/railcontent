...
@section('content')
    ...
    <header class="header text-center">
        <div class="row">
            <img class="logo" src="https://www.musora.com/cdn-cgi/image/width=750,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/learn-songs-faster/learn-songs-faster-logo.png" alt="Learn Songs Faster Logo" fetchpriority="high"><br>
            <img @click="trailer = true;" class="play-button autoplay-video" src="https://www.musora.com/cdn-cgi/image/width=400,quality=95/https://dpwjbsxqtam5n.cloudfront.net/sales/play-button.png" alt="Play Button" fetchpriority="high">
...
{{--            <a href="/" style="color:inherit;"><h6>OR click here to get this pack FREE<br class="hide-for-medium"> with a Drumeo membership.</h6></a>--}}
    ...
    <section class="content-section teachers text-center">
        <div class="row">
            ...
            <div class="columns medium-6">
                <img src="https://www.musora.com/cdn-cgi/image/width=400,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/learn-songs-faster/jared-falk.jpg" alt="Jared Falk">
            ...
            <div class="columns medium-6">
                <img src="https://www.musora.com/cdn-cgi/image/width=500,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/learn-songs-faster/dave-atkinson.jpg" alt="Dave Atkinson">
            ...
            <div class="topic-wrap large-up-4 medium-up-3 max-w-sm sm:max-w-none">
                <div class="columns half-padding">
                    <div class="thumb relative">
                        <img class="absolute inset-0 object-cover transition-all opacity-0" src="https://www.musora.com/cdn-cgi/image/width=500,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/learn-songs-faster/topic-ear-training.jpg" alt="ear training" loading="lazy" onload="this.classList.remove('opacity-0')" />
                        <h1>EAR TRAINING</h1>
                    </div>
                    <p>
                ...
                <div class="columns half-padding">
                    <div class="thumb">
                        <img class="absolute inset-0 object-cover transition-all opacity-0" src="https://www.musora.com/cdn-cgi/image/width=500,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/learn-songs-faster/topic-timing-tempo.jpg" alt="timing and tempo" loading="lazy" onload="this.classList.remove('opacity-0')" />
                        <h1>TIMING & TEMPO</h1>
                    </div>
                    <p>
                ...
                <div class="columns half-padding">
                    <div class="thumb">
                        <img class="absolute inset-0 object-cover transition-all opacity-0" src="https://www.musora.com/cdn-cgi/image/width=500,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/learn-songs-faster/topic-backbeat.jpg" alt="the backbeat" loading="lazy" onload="this.classList.remove('opacity-0')" />
                        <h1>THE BACKBEAT</h1>
                    </div>
                    <p>
                ...
                <div class="columns half-padding">
                    <div class="thumb">
                        <img class="absolute inset-0 object-cover transition-all opacity-0" src="https://www.musora.com/cdn-cgi/image/width=500,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/learn-songs-faster/topic-downbeat.jpg" alt="the downbeat" loading="lazy" onload="this.classList.remove('opacity-0')" />
                        <h1>THE DOWNBEAT</h1>
                    </div>
                    <p>
                ...
                <div class="columns half-padding">
                    <div class="thumb">
                        <img class="absolute inset-0 object-cover transition-all opacity-0" src="https://www.musora.com/cdn-cgi/image/width=500,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/learn-songs-faster/topic-better-feel.jpg" alt="better feel" loading="lazy" onload="this.classList.remove('opacity-0')" />
                        <h1>BETTER FEEL</h1>
                    </div>
                    <p>
                ...
                <div class="columns half-padding">
                    <div class="thumb">
                        <img class="absolute inset-0 object-cover transition-all opacity-0" src="https://www.musora.com/cdn-cgi/image/width=500,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/learn-songs-faster/topic-effective-fills.jpg" alt="effective fills" loading="lazy" onload="this.classList.remove('opacity-0')" />
                ...
                <div class="columns half-padding">
                    <div class="thumb">
                        <img class="absolute inset-0 object-cover transition-all opacity-0" src="https://www.musora.com/cdn-cgi/image/width=500,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/learn-songs-faster/topic-improv.jpg" alt="improvisation" loading="lazy" onload="this.classList.remove('opacity-0')" />
                        <h1>IMPROVISATION</h1>
                    </div>
                    <p>
                ...
                <div class="columns half-padding">
                    <div class="thumb">
                        <img class="absolute inset-0 object-cover transition-all opacity-0" src="https://www.musora.com/cdn-cgi/image/width=500,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/learn-songs-faster/topic-fine-tuning.jpg" alt="fine tuning" loading="lazy" onload="this.classList.remove('opacity-0')" />
                        <h1>FINE TUNING</h1>
                    </div>
                    <p>
    ...
    <section class="content-section text-center question-answered">
        <div class="row">
            <img src="https://www.musora.com/cdn-cgi/image/width=700,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/learn-songs-faster/question-answer.png" alt="Question Answer Image">
    ...
    <section class="content-section final text-center">
        <div class="row">
            <img class="logo" src="https://www.musora.com/cdn-cgi/image/width=900,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/learn-songs-faster/learn-songs-faster-logo.png" alt="Learn Songs Faster Logo">
