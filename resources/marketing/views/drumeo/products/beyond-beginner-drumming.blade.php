...
@section('global-head')
    ...
    <meta property="og:image" content="https://www.musora.com/musora-cdn/image/width=1200,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/beyond-beginner-drummer/Title+Banner.jpg" style="display: none;">
...
@section('global-body')
    ...
    <header class="text-center text-white py-5 md:py-10 px-4 bg-top bg-no-repeat relative" style="background-color:#00101d;background-image: url(https://www.musora.com/musora-cdn/image/width=2500,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/beyond-beginner-drummer/Header_BG.jpg);">
        <div class="container mx-auto relative z-10">
            <img class="h-12 sm:h-16 lg:h-20" src="https://www.musora.com/musora-cdn/image/width=1200,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/beyond-beginner-drummer/BeyondBeginnerDrumming_Logo.svg" alt="Beyond Beginner Drumming Logo"><br>
    ...
    <section class="text-white py-8 sm:py-14 lg:py-20 px-4 sm:px-10 relative lazyload bg-cover bg-center" style="background-color:#020d1f;" data-bg="https://www.musora.com/musora-cdn/image/width=2000,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/beyond-beginner-drummer/Intro_BG.jpg">
    ...
    <section class="text-white py-7 md:py-10 lg:py-16 relative" style="background-color:#00101d;">
        <div class="absolute inset-0 z-0 bg-top bg-no-repeat jared-bio lazyload hidden md:block" data-bg="https://www.musora.com/musora-cdn/image/width=3000,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/beyond-beginner-drummer/Coach_BG.jpg" style="background-size: cover;background-color:#020d1f;"></div>
        {{--<div class="absolute inset-0 z-0 bg-top bg-no-repeat jared-bio lazyload block md:hidden" data-bg="https://www.musora.com/musora-cdn/image/width=800,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/beyond-beginner-drummer/Coach_BG.jpg" style="background-color:#020d1f;"></div>--}}
    ...
    <section class="final text-center text-white py-10 md:py-20 lg:py-24 px-4 bg-center bg-cover lazyload" style="background-color:#051626;" data-bg="https://www.musora.com/musora-cdn/image/width=1500,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/beyond-beginner-drummer/Order_BG.jpg">
        <div class="container mx-auto">
            <img class="logo" src="https://www.musora.com/musora-cdn/image/width=1200,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/beyond-beginner-drummer/BeyondBeginnerDrumming_Logo.svg" alt="Beyond Beginner Drumming Logo"><br>
