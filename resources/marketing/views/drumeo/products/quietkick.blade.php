...
@section('global-body')
    ...
    <header class="header text-white relative overflow-hidden z-10" style="background-color:#011434;">
        <div class="transform -translate-y-1/2 top-1/2 left-0 w-full absolute z-20 px-4 lg:px-6 text-center">
            <div class="container mx-auto max-w-6xl">
                <img alt="quietkick" class="h-16 sm:h-24 lg:h-28" src="https://www.musora.com/cdn-cgi/image/width=600,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/quietkick/drumeo-quietkick.png"><br>
    ...
    <section class="text-left px-5 sm:pl-5 sm:pr-0 bg-cover lazyload" style="background-color: #c1c6ca; color: #203e59;" data-bg="https://www.musora.com/cdn-cgi/image/width=1500,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/quietkick/bg.jpg">
        <div class="container mx-auto max-w-6xl relative pb-8 md:py-10 lg:py-16">
            <div class="mx-auto mb-4 sm:mb-0 sm:absolute sm:top-0 sm:right-0 z-10 max-w-xs sm:max-w-full w-full sm:w-1/2 lg:w-7/12">
                <img class="w-full img-toggle hidden active" src="https://www.musora.com/cdn-cgi/image/width=1300,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/quietkick/Kick-up2.png" alt="quietkick pedal">
                <img class="w-full img-toggle hidden" src="https://www.musora.com/cdn-cgi/image/width=1300,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/quietkick/Kick-down2.png" alt="quietkick pedal">
            </div>
    ...
    <section class="text-left text-white px-3 sm:px-5 py-8 sm:py-16 lg:py-20 relative overflow-hidden lazyload" style="background:linear-gradient(to bottom, #000f1c 25%, #01192f);">
        <div class="container mx-auto z-10 relative max-w-5xl">
            ...
            <div class="flex flex-wrap sm:flex-nowrap items-center mb-8 sm:mb-16">
                <img  alt="quietkick double pedal" class="h-44 sm:h-56 lg:h-80 mx-auto sm:mx-0 rounded-xl mb-3 sm:mb-0 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=1000,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/quietkick/double-kick.jpg">
            ...
            <div class="flex flex-wrap sm:flex-nowrap items-center mb-6 sm:mb-16">
                <img  alt="quietkick in library" class="sm:order-1 h-44 sm:h-56 lg:h-80 mx-auto sm:mx-0 rounded-xl mb-3 sm:mb-0 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=1000,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/quietkick/anywhere.jpg">
            ...
            <div class="flex flex-wrap sm:flex-nowrap items-center {{--mb-8 sm:mb-16--}}">
                <img  alt="quietkick pedal" class="h-44 sm:h-56 lg:h-80 mx-auto sm:mx-0 rounded-xl mb-3 sm:mb-0 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=1000,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/quietkick/any-pedal.jpg">
                <div class="w-full sm:w-1/2 sm:pl-10">
    ...
    <section class="content-section text-center customize px-4 lg:px-6 lazyload" style="background-color:#132332;background-size: cover;" data-bg="https://www.musora.com/cdn-cgi/image/width=1500,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/quietkick/final.jpg">
        <div class="container mx-auto">
            <img alt="quietkick logo" class="h-14 sm:h-20 lg:h-28" src="https://www.musora.com/cdn-cgi/image/width=600,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/quietkick/drumeo-quietkick.png"><br>
