...
{{--</style>--}}
{{--<div class="big-promo-banner" style="background: #ddf7ff;">--}}
    {{--<div class="noise-wrap">--}}
        {{--<div class="row container mx-auto">--}}
                {{--<a href="/drumshop/"><img src="https://cdn.musora.com/image/fetch/w_200,q_auto:best/https://drumeo-assets.s3.amazonaws.com/promos/july/drumeo-summer-sale-dark.png"></a>--}}
...
{{--@if(!empty($noBreadcrumb))--}}
    {{--<a href="/drumshop" class="promo-banner fixed" style="background: #ddf7ff;">--}}
        {{--<div class="noise-wrap">--}}
            {{--<div class="row container mx-auto">--}}
                {{--<div class="text text-left">--}}
                    {{--<img class="logo" src="https://cdn.musora.com/image/fetch/w_200,q_auto:best/https://drumeo-assets.s3.amazonaws.com/promos/july/drumeo-summer-sale-dark.png">--}}
                    {{--<p>--}}
                        {{--@if(!empty($price))--}}
                            {{--@if(round(100 - (100 * ($price / $fullPrice))) > 1)--}}
