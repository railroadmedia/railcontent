<div class="testimonial-box clearfix">
    ...
    <div class="quote-wrap">
        ...
        <p>{!! $fullTestimonial !!}</p>
        <img class="inline-block sm:hidden transition-all opacity-0" src="https://www.musora.com/cdn-cgi/image/width=400,quality=95/{{ $avatarURL }}" alt="{{ $name }}" loading="lazy" onload="this.classList.remove('opacity-0')">
