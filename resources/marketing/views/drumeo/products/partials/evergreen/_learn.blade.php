<section class="px-3 sm:px-0 text-center customize relative z-50 overflow-hidden lazyload" style="background: #eff7ff;">
        <div class="container max-w-6xl mx-auto relative z-50" style="background: #eff7ff;" data-bg={{ $mainImage }}>
            <div class="flex flex-wrap items-center px-6 py-10">
                ...
                <div class="text-center md:text-left md:text-xl font-normal leading-10 py-3 md:py-5">
                        <ul>
                            @foreach ($points as $index => $point)
                                @if ($loop->last)
                                <p>
                                    <li class="text-{{ $brand }}"><i class="fas fa-sharp fa-solid fa-certificate"></i> <strong>{{ $point }}</strong></li>
                                </p>  
                                @else
                                <p>
                    ...
                    <div class="w-full text-center sm:pr-2 my-1">
                        <a href="#final" class="join blue medium w-full anchor-slide">{{ $buttonTxt }}</a>
                    </div>
                    <div class="w-full sm:flex py-2 md:py-0">
