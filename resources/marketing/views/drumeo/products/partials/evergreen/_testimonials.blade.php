                        ...
                        <li class="splide__slide bg-[#F4F8FB] rounded-xl pb-6 px-8 mr-4 text-center">
                            <div class="-mt-10 mb-6">
                                <img class="rounded-full w-[90px] h-[90px] object-cover"
                                    data-splide-lazy="https://www.musora.com/cdn-cgi/image/width=130,quality=95/{{ $testimonial['img'] }}"
                            ...
                            @endif
                            <img class="my-4"
                                data-splide-lazy="https://www.musora.com/cdn-cgi/image/width=200,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/30-day-drummer/season3/stars.svg"
                                alt="stars" />
