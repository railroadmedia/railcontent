<section class="{{ $bgClass }}" aria-label="Items">
    <div class="container max-w-5xl mx-auto px-4 text-white py-4 sm:py-10" x-data="{ openItem: 0 }">
                    ...
                    <div role="button" @click="openItem === {{ $i }} ? openItem = null : openItem = {{ $i }}"
                        ...
                        <div class="w-4/5 sm:w-full text-left sm:text-center">
                            ...
                            <div x-show="openItem === {{ $i }}" x-cloak
                                class="text-sm sm:hidden text-lg bg-gradient-to-b from-slate-900 to-slate-900 md:bg-none">
                                {!! $songItem['desc'] !!}
                            </div>
                        </div>
                    </div>
