            ...
            @if( $products['quietkick']->getStockAvailability() > 1 && !empty($products['quietkick']->getStockAvailability()))
                <div class="flex flex-wrap items-end justify-center 2-full max-w-sm md:max-w-2xl lg:max-w-3xl my-5 sm:my-10 mx-auto">
                    <div class="w-full md:w-1/2 px-2 md:px-3 relative">
                        ...
                        <a href="/ecommerce/add-to-cart?products[quietkick]=1&promo-code=members" class="text-black overflow-hidden rounded-2xl block mx-auto mb-4 md:mb-0 group">
                    ...
                    <div class="w-full md:w-1/2 px-2 md:px-3 relative">
                        {{--<p class="w-full px-4 pt-2 pb-4 -mb-3 text-white rounded-t-2xl" style="background:linear-gradient(to bottom, #0a73d8, #10518f);"><strong>LAUNCH SPECIAL</strong></p>--}}
                        <a href="/ecommerce/add-to-cart?products[quietkick]=1&products[quietkick-beater]=1&promo-code=members" class="text-black overflow-hidden rounded-2xl block mx-auto mb-4 md:mb-0 group">
                            <div class="bg-white px-3 pt-6 md:pt-8 pb-5 md:pb-8">
                ...
                <a style="color: #00bc75;" class="inline-block cursor-pointer" href="/ecommerce/add-to-cart?products[DLM-1-year]=1&products[quietkick]=1&locked=true"><h4><strong><u>Or get it FREE with an Annual Membership</u></strong></h4></a>
            @else
