...
@section('content')
    ...
    <header class="hero-header">
        <div class="row xlarge">
            <img class="logo" src="https://www.musora.com/cdn-cgi/image/width=450,quality=95/https://dzryyo1we6bm3.cloudfront.net/independence-made-easy/sales/logo.png" alt="Independence made easy logo" fetchpriority="high">

            <br>
            <div class="watch-badge">
                <span>WATCH<br> PREVIEW</span>
                <img src="https://www.musora.com/cdn-cgi/image/width=180,quality=95/https://dpwjbsxqtam5n.cloudfront.net/sales/arrow-left-white.png" alt="Arrow right" fetchpriority="high">
            </div>
            <img @click="trailer = true;" class="play-button autoplay-video" src="https://www.musora.com/cdn-cgi/image/width=150,quality=95/https://dpwjbsxqtam5n.cloudfront.net/sales/play-button.png" alt="Play button" fetchpriority="high">
...
{{--                    <u class="text-green"><a href="/" style="color:inherit;">(Or get it free with Drumeo)</a></u>--}}
            ...
            <div class="medium-4 columns half-padding">
                <div class="benefit">
                    <div class="image">
                        ...
                        <img src="https://www.musora.com/cdn-cgi/image/width=550,quality=95/https://dzryyo1we6bm3.cloudfront.net/independence-made-easy/sales/jared1.jpg" alt="Jared 1">
                    </div>
            ...
            <div class="medium-4 columns half-padding">
                <div class="benefit">
                    <div class="image">
                        ...
                        <img src="https://www.musora.com/cdn-cgi/image/width=550,quality=95/https://dzryyo1we6bm3.cloudfront.net/independence-made-easy/sales/jared2.jpg" alt="Jared 2">
                    </div>
                    <div class="text text-left">
            ...
            <div class="medium-4 columns half-padding">
                <div class="benefit">
                    <div class="image">
                        ...
                        <img src="https://www.musora.com/cdn-cgi/image/width=550,quality=95/https://dzryyo1we6bm3.cloudfront.net/independence-made-easy/sales/jared3.jpg" alt="Jared 3">
                    </div>
                    <div class="text text-left">
        ...
        <div class="row">
            ...
            <div class="letter-wrap">
                <div class="columns medium-4 float-right">
                    <img class="hide-for-medium bruce-jared-small" src="https://www.musora.com/cdn-cgi/image/width=550,quality=95/https://dzryyo1we6bm3.cloudfront.net/independence-made-easy/sales/jared4.jpg" alt="Jared 4">
                ...
                <div class="columns number-paths">
                    <div class="columns path-point no-padding">
                        <div class="icon">
                            <img src="https://www.musora.com/cdn-cgi/image/width=250,quality=95/https://dzryyo1we6bm3.cloudfront.net/independence-made-easy/sales/path-1.png" alt="Path 1">
                        </div>
                        <div class="text">
                    ...
                    <div class="columns path-point no-padding">
                        <div class="icon">
                            <img src="https://www.musora.com/cdn-cgi/image/width=250,quality=95/https://dzryyo1we6bm3.cloudfront.net/independence-made-easy/sales/path-2.png" alt="Path 2">
                        </div>
                        <div class="text">
                    ...
                    <div class="columns path-point no-padding">
                        <div class="icon">
                            <img src="https://www.musora.com/cdn-cgi/image/width=250,quality=95/https://dzryyo1we6bm3.cloudfront.net/independence-made-easy/sales/path-3.png" alt="Path 3">
                        </div>
                        <div class="text">
                ...
                <div class="columns no-padding">
                    <div class="columns signature">
                        <img src="https://www.musora.com/cdn-cgi/image/width=450,quality=95/https://dzryyo1we6bm3.cloudfront.net/independence-made-easy/sales/signature.png" alt="Jared Signature">
                    </div>
                    <div class="columns">
                        <div class="sig-point">
                            <span class="icon"><img src="https://www.musora.com/cdn-cgi/image/width=50,quality=95/https://dzryyo1we6bm3.cloudfront.net/independence-made-easy/sales/sig-icon-1.png" alt="Icon D"></span>
                            <p>Co-Founder of Drumeo.com</p>
                        </div>
                        <div class="sig-point">
                            <span class="icon"><img src="https://www.musora.com/cdn-cgi/image/width=50,quality=95/https://dzryyo1we6bm3.cloudfront.net/independence-made-easy/sales/sig-icon-2.png" alt="Icon SD"></span>
                            <p>Author of Successful Drumming</p>
                        </div>
                        <div class="sig-point">
                            <span class="icon"><img src="https://www.musora.com/cdn-cgi/image/width=50,quality=95/https://dzryyo1we6bm3.cloudfront.net/independence-made-easy/sales/sig-icon-3.png" alt="Icon Trophy"></span>
        ...
        <div class="row">
            ...
            <table>
                ...
                <tr>
                    <td></td>
                    <td>
                        <img src="https://www.musora.com/cdn-cgi/image/width=450,quality=95/https://dzryyo1we6bm3.cloudfront.net/independence-made-easy/sales/laptop.png" class="macbook" alt="Macbook">
                        <img src="https://www.musora.com/cdn-cgi/image/width=450,quality=95/https://dzryyo1we6bm3.cloudfront.net/independence-made-easy/sales/logo-b.png" class="blue-logo" alt="Independence made easy logo">
                    </td>
    ...
    <section class="text-center guarantee">
        <div class="row">
            <img class="guarantee-badge hide-for-medium" style="filter: hue-rotate(305deg) brightness(1.13);" src="https://www.musora.com/cdn-cgi/image/width=450,quality=95/https://dpwjbsxqtam5n.cloudfront.net/sales/guarantee-badge.png" alt="Guarantee Badge">
            <div class="flex-container">
                <img class="guarantee-badge show-for-medium" style="filter: hue-rotate(305deg) brightness(1.13);" src="https://www.musora.com/cdn-cgi/image/width=450,quality=95/https://dpwjbsxqtam5n.cloudfront.net/sales/guarantee-badge.png" alt="Guarantee Badge">
    ...
    <section class="final" style="background-image:url(https://dpwjbsxqtam5n.cloudfront.net/drum-technique-made-easy/customize-bg.jpg);">
        <div class="row">
            <div class="columns logo"><img src="https://www.musora.com/cdn-cgi/image/width=950,quality=95/https://dzryyo1we6bm3.cloudfront.net/independence-made-easy/sales/logo.png" alt="Independence made easy logo"></div>
