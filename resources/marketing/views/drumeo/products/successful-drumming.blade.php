...
@section('content')
        ...
        <div class="container max-w-6xl mx-auto">
            ...
            <div class="flex flex-wrap items-start justify-center text-left mb-2 sm:mb-6">
                <div class="flex flex-wrap items-start w-full sm:w-1/2 lg:w-1/3 pb-4 sm:pb-0 sm:px-3 mb-4 sm:mb-8 border-b sm:border-b-0">
                    <img class="w-1/3 sm:w-full rounded-xl mb-3 transition-opacity" src="https://www.musora.com/cdn-cgi/image/width=640,quality=95/https://dpwjbsxqtam5n.cloudfront.net/tripwires/sd/1.jpg" alt="grid1" loading="lazy" onload="this.classList.remove('opacity-0')">
                ...
                <div class="flex flex-wrap items-start w-full sm:w-1/2 lg:w-1/3 pb-4 sm:pb-0 sm:px-3 mb-4 sm:mb-8 border-b sm:border-b-0">
                    <img class="w-1/3 sm:w-full rounded-xl mb-3 transition-opacity" src="https://www.musora.com/cdn-cgi/image/width=640,quality=95/https://dpwjbsxqtam5n.cloudfront.net/tripwires/sd/2.jpg" alt="grid1" loading="lazy" onload="this.classList.remove('opacity-0')">
                    <p class="w-2/3 sm:w-full pl-3 sm:pl-0 leading-normal">
                ...
                <div class="flex flex-wrap items-start w-full sm:w-1/2 lg:w-1/3 pb-4 sm:pb-0 sm:px-3 mb-4 sm:mb-8 border-b sm:border-b-0">
                    <img class="w-1/3 sm:w-full rounded-xl mb-3 transition-opacity" src="https://www.musora.com/cdn-cgi/image/width=640,quality=95/https://dpwjbsxqtam5n.cloudfront.net/tripwires/sd/3.jpg" alt="grid1" loading="lazy" onload="this.classList.remove('opacity-0')">
                    <p class="w-2/3 sm:w-full pl-3 sm:pl-0 leading-normal">
                ...
                <div class="flex flex-wrap items-start w-full sm:w-1/2 lg:w-1/3 pb-4 sm:pb-0 sm:px-3 mb-4 sm:mb-8 border-b sm:border-b-0">
                    <img class="w-1/3 sm:w-full rounded-xl mb-3 transition-opacity" src="https://www.musora.com/cdn-cgi/image/width=640,quality=95/https://dpwjbsxqtam5n.cloudfront.net/tripwires/sd/4.jpg" alt="grid1" loading="lazy" onload="this.classList.remove('opacity-0')">
                    <p class="w-2/3 sm:w-full pl-3 sm:pl-0 leading-normal">
                ...
                <div class="flex flex-wrap items-start w-full sm:w-1/2 lg:w-1/3 pb-4 sm:pb-0 sm:px-3 mb-4 sm:mb-8 border-b sm:border-b-0">
                    <img class="w-1/3 sm:w-full rounded-xl mb-3 transition-opacity" src="https://www.musora.com/cdn-cgi/image/width=640,quality=95/https://dpwjbsxqtam5n.cloudfront.net/tripwires/sd/5.jpg" alt="grid1" loading="lazy" onload="this.classList.remove('opacity-0')">
                    <p class="w-2/3 sm:w-full pl-3 sm:pl-0 leading-normal">
                ...
                <div class="flex flex-wrap items-start w-full sm:w-1/2 lg:w-1/3 pb-4 sm:pb-0 sm:px-3 mb-4 sm:mb-8 border-b sm:border-b-0">
                    <img class="w-1/3 sm:w-full rounded-xl mb-3 transition-opacity" src="https://www.musora.com/cdn-cgi/image/width=640,quality=95/https://dpwjbsxqtam5n.cloudfront.net/tripwires/sd/6.jpg" alt="grid1" loading="lazy" onload="this.classList.remove('opacity-0')">
                    <p class="w-2/3 sm:w-full pl-3 sm:pl-0 leading-normal">
                ...
                <div class="flex flex-wrap items-start w-full sm:w-1/2 lg:w-1/3 pb-4 sm:pb-0 sm:px-3 mb-4 sm:mb-8 border-b sm:border-b-0">
                    <img class="w-1/3 sm:w-full rounded-xl mb-3 transition-opacity" src="https://www.musora.com/cdn-cgi/image/width=640,quality=95/https://dpwjbsxqtam5n.cloudfront.net/tripwires/sd/7.jpg" alt="grid1" loading="lazy" onload="this.classList.remove('opacity-0')">
                    <p class="w-2/3 sm:w-full pl-3 sm:pl-0 leading-normal">
                ...
                <div class="flex flex-wrap items-start w-full sm:w-1/2 lg:w-1/3 pb-4 sm:pb-0 sm:px-3 mb-4 sm:mb-8 border-b sm:border-b-0">
                    <img class="w-1/3 sm:w-full rounded-xl mb-3 transition-opacity" src="https://www.musora.com/cdn-cgi/image/width=640,quality=95/https://dpwjbsxqtam5n.cloudfront.net/tripwires/sd/8.jpg" alt="grid1" loading="lazy" onload="this.classList.remove('opacity-0')">
                    <p class="w-2/3 sm:w-full pl-3 sm:pl-0 leading-normal">
                ...
                <div class="flex flex-wrap items-start w-full sm:w-1/2 lg:w-1/3 pb-4 sm:pb-0 sm:px-3 mb-4 sm:mb-8 border-b sm:border-b-0">
                    <img class="w-1/3 sm:w-full rounded-xl mb-3 transition-opacity" src="https://www.musora.com/cdn-cgi/image/width=640,quality=95/https://dpwjbsxqtam5n.cloudfront.net/tripwires/sd/9.jpg" alt="grid1" loading="lazy" onload="this.classList.remove('opacity-0')">
                    <p class="w-2/3 sm:w-full pl-3 sm:pl-0 leading-normal">
    ...
    <section class="text-center px-5 sm:px-6 py-10 sm:py-14 lg:py-20" style="background-color:#f4f8fb;">
        <div class="container max-w-5xl mx-auto">
            <div class="flex flex-wrap sm:flex-nowrap items-start justify-center sm:mt-8">
                <img class="border-solid border-8 border-white rounded-3xl shadow-xl w-52 sm:w-72 lg:w-96 relative -mb-8 sm:mb-0 sm:-mt-8 sm:-mr-8 z-10 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=550,quality=95/https://dpwjbsxqtam5n.cloudfront.net/tripwires/sd/meet-jared-3.jpg" alt="profile picture">
            ...
            <div class="flex flex-wrap text-left">
                <div class="w-full lg:w-1/2 py-2 sm:px-2 lg:p-3">
                    <div class="flex items-start p-5 bg-white rounded-lg">
                        <img class="h-16 lg:h-20 rounded-full lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=160,quality=95/https://dpwjbsxqtam5n.cloudfront.net/tripwires/sd/dave-mccoy.jpg" alt="Larnell lewis" >
                ...
                <div class="w-full lg:w-1/2 py-2 sm:px-2 lg:p-3">
                    <div class="flex items-start p-5 bg-white rounded-lg">
                        <img class="h-16 lg:h-20 rounded-full lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=160,quality=95/https://dpwjbsxqtam5n.cloudfront.net/tripwires/sd/fred-rose.jpg" alt="Matt Mcguire" >
                ...
                <div class="w-full lg:w-1/2 py-2 sm:px-2 lg:p-3">
                    <div class="flex items-start p-5 bg-white rounded-lg">
                        <img class="h-16 lg:h-20 rounded-full lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=160,quality=95/https://dpwjbsxqtam5n.cloudfront.net/tripwires/sd/rich-behe.jpg" alt="Dorothea Taylor" >
                ...
                <div class="w-full lg:w-1/2 py-2 sm:px-2 lg:p-3">
                    <div class="flex items-start p-5 bg-white rounded-lg">
                        <img class="h-16 lg:h-20 rounded-full lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=160,quality=95/https://dpwjbsxqtam5n.cloudfront.net/tripwires/sd/ken-voller.jpg" alt="Dorothea Taylor">
    ...
    <section class="text-white text-center px-5 sm:px-6 py-10 sm:py-14 lg:py-20" style="background-color:#2a2f34;">
        <div class="container max-w-4xl mx-auto">
            <img class="h-28 sm:h-40 lg:h-52 block mx-auto -mt-24 sm:-mt-36 lg:-mt-48 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=410,quality=95/https://dpwjbsxqtam5n.cloudfront.net/sales/2022/guarantee.png" alt="guarantee badge" src="https://www.musora.com/cdn-cgi/image/width=410,quality=95/https://dpwjbsxqtam5n.cloudfront.net/sales/2022/guarantee.png">
    ...
    <section class="pt-32 pb-20 px-2 sm:px-4 relative" style="background: #F2F8FB;">
        <div class="max-w-4xl mx-auto text-center">
            <img class="filter invert h-20 sm:h-24 mb-5 lazyload" src="https://www.musora.com/cdn-cgi/image/width=800,quality=95/https://dpwjbsxqtam5n.cloudfront.net/tripwires/sd/sd-logo.png" alt="logo centered">
