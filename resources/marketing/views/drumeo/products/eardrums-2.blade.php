    ...
    <header class="text-white relative overflow-hidden z-10" style="height:700px;background-color:#011434;">
        <div class="transform -translate-y-1/2 top-1/2 left-0 w-full absolute z-20 px-4 lg:px-6 text-center">
            <div class="container mx-auto max-w-5xl">
                <img alt="quietkick" class="h-20 sm:h-24" src="https://www.musora.com/musora-cdn/image/width=550,quality=95/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/eardrums/Logo.png"><br>
                <h6 class="leading-tight my-3">Protect your ears + play your favorite songs.</h6>
...
{{--            src="https://musora-image-processing-cdn.s3.us-east-2.amazonaws.com/marketing/drumeo/products/eardrums-black/header.jpg"></video>--}}
    ...
    <section class="text-center px-5 md:px-6 py-10 md:py-12 lg:py-14" style="background-color:#F4F8FB;">
        <div class="container mx-auto relative z-10 max-w-5xl">
            ...
            <div class="flex flex-wrap sm:flex-nowrap text-left">
                ...
                <div class="w-full sm:w-1/4 px-3">
                    <img class="rounded-xl h-56 object-cover" src="https://d21q7xesnoiieh.cloudfront.net/fit-in/450x0/filters:quality(95)/marketing/drumeo/products/eardrums-black/features-04.webp">
                ...
                <div class="w-full sm:w-1/4 px-3">
                    <img class="rounded-xl h-56 object-cover" src="https://d21q7xesnoiieh.cloudfront.net/fit-in/450x0/filters:quality(95)/marketing/drumeo/products/eardrums-black/features-02.webp">
                ...
                <div class="w-full sm:w-1/4 px-3">
                    <img class="rounded-xl h-56 object-cover" src="https://d21q7xesnoiieh.cloudfront.net/fit-in/450x0/filters:quality(95)/marketing/drumeo/products/eardrums-black/features-03.webp">
    ...
    <section class="text-center px-5 md:px-0 py-10 md:py-16 lg:py-20">
        <div class="container mx-auto relative z-10 max-w-4xl">
            <img class="h-12 sm:h-24" src="https://d21q7xesnoiieh.cloudfront.net/fit-in/840x0/filters:quality(95)/marketing/drumeo/products/eardrums-black/drums-are-loud.webp" alt="Drums Are Loud">
