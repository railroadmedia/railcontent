...
{{--            <span class="join sold-out medium w-3/4 sm:w-1/2 mt-6 sm:mt-12 mb-3" data-open="waitlistModal">JOIN WAITLIST</span><br>--}}
    ...
    <section class="text-center px-5 sm:px-6 py-10 sm:py-14 lg:py-20" style="background-color:#EFF7FF;">
        <div class="container max-w-4xl mx-auto mb-10">
            ...
            <img class="cursor-pointer rounded-xl autoplay-video overflow-hidden w-full transition-all opacity-0" data-open="trailer" src="https://www.musora.com/musora-cdn/image/width=1200,quality=85/https://dpwjbsxqtam5n.cloudfront.net/drum-shop/30-day-chops/video-thumbnail.jpg" alt="video thumbnail" loading="lazy" onload="this.classList.remove('opacity-0')">
