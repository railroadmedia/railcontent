...
@section('global-head')
    ...
    <script defer src="https://cdn.jsdelivr.net/npm/@alpinejs/focus@3.x.x/dist/cdn.min.js"></script>     <!-- Alpine Plugin Modal Focus -->
...
{{--                    <a style="color: #00bc75;" class="inline-block cursor-pointer" href="/ecommerce/add-to-cart?products[DLM-1-year]=1&products[padstand]=1&locked=true"><h4><strong><u>Or get it FREE when you join Drumeo.</u></strong></h4></a>--}}
    ...
    <div
        ...
        x-on:keydown.escape.prevent.stop="trailer = false; "
        role="dialog"
        aria-modal="true"
        class="fixed inset-0 overflow-y-auto"
    >
        <!-- Overlay -->
        <div x-show="trailer" x-transition.opacity class="fixed inset-0 bg-black bg-opacity-80" style="z-index: 1005;"></div>

        <!-- Panel -->
        <div
            x-show="trailer" x-transition
            x-on:click="trailer = false;"
