    ...
    <section class="instructor-bio">
        <div class="row">
            ...
            <div class="columns timeline-pic">
                <img class="show-for-large" src="https://dpwjbsxqtam5n.cloudfront.net/rock-drumming-masterclass/awards.png">
                <img class="hide-for-large" src="https://dpwjbsxqtam5n.cloudfront.net/rock-drumming-masterclass/awards-m.png">
            </div>
        </div>
    </section>
...
{{--                {{ Prices::$rdmRegular }}--}}
    ...
    <section class="final">
        ...
        <div class="row">
            <div class="columns logo"><img src="https://dpwjbsxqtam5n.cloudfront.net/rock-drumming-masterclass/logo-white.png"></div>
