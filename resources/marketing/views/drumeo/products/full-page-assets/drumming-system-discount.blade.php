...
@section('content')
    ...
    <header class="header stacked">
        <div class="container mx-auto clearfix xlarge" style="background-image:url(https://dpwjbsxqtam5n.cloudfront.net/tripwires/ds/mike-bg.jpg);">
            ...
            <div class="float-left w-full px-3 sm:px-4 text-container">
                ...
                <a href="{{ URL::Route('shopping-cart.to-cart.api') }}?products[DSYS2-DIGI]=1" class="join blue">Get Started &raquo;</a>
    ...
    <section class="lesson-breakdown">
        <div class="container mx-auto clearfix">
            ...
            <a class="join blue" href="{{ URL::Route('shopping-cart.to-cart.api') }}?products[DSYS2-DIGI]=1">Get Everything <span class="show-for-medium">Above </span>For Just ${{ Prices::$dsOnlineRegular }} &raquo;</a>
    ...
    <section class="final">
        <div class="container mx-auto clearfix">
            ...
            <div class="float-left w-full px-3 sm:px-4"><a href="{{ URL::Route('shopping-cart.to-cart.api') }}?products[DSYS2-DIGI]=1" class="join blue">Get Started &raquo;</a></div>
