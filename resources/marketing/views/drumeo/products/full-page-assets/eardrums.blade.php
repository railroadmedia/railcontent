...
@section('layout-body')
            ...
            <div class="relative">
                ...
                <tr style="background-color:transparent!important;">
                    ...
                    <td class="rounded-t-xl">
                        <img class="h-5 md:h-12 filter saturate-0 brightness-200 lazyload"  data-src="https://cdn.musora.com/image/fetch/w_550,q_auto:best/https://drumeo-assets.s3.amazonaws.com/drum-shop/eardrums/Logo.png" alt="logo-white">
                    </td>
    ...
    <section class="text-center px-1 sm:px-5 py-10 md:py-16 lg:py-20">
        <div class="container mx-auto relative z-10 max-w-5xl">
            ...
            <div class="flex flex-wrap">
                <div class="p-1 w-full sm:w-7/12"><div class="h-56 sm:h-64 lg:h-80 w-full bg-center bg-cover rounded-xl lazyload" data-bg="https://cdn.musora.com/image/fetch/w_1100,q_auto:best/https://drumeo-assets.s3.amazonaws.com/drum-shop/eardrums/Product_Image04.jpg"></div></div>
                <div class="p-1 w-full sm:w-5/12"><div class="h-56 sm:h-64 lg:h-80 w-full bg-center bg-cover rounded-xl lazyload" data-bg="https://cdn.musora.com/image/fetch/w_800,q_auto:best/https://drumeo-assets.s3.amazonaws.com/drum-shop/eardrums/Product_Image03.jpg"></div></div>

                <div class="p-1 w-full sm:w-5/12"><div class="h-56 sm:h-64 lg:h-80 w-full bg-center bg-cover rounded-xl lazyload" data-bg="https://cdn.musora.com/image/fetch/w_800,q_auto:best/https://drumeo-assets.s3.amazonaws.com/drum-shop/eardrums/drumeo-eardrums-6.jpg"></div></div>
                <div class="p-1 w-full sm:w-7/12"><div class="h-56 sm:h-64 lg:h-80 w-full bg-center bg-cover rounded-xl lazyload" data-bg="https://cdn.musora.com/image/fetch/w_1100,q_auto:best/https://drumeo-assets.s3.amazonaws.com/drum-shop/eardrums/drumeo-eardrums-1.jpg"></div></div>

                <div class="p-1 w-full sm:w-7/12"><div class="h-56 sm:h-64 lg:h-80 w-full bg-center bg-cover rounded-xl lazyload" data-bg="https://cdn.musora.com/image/fetch/w_1100,q_auto:best/https://drumeo-assets.s3.amazonaws.com/drum-shop/eardrums/Product_Image02.jpg"></div></div>
                <div class="p-1 w-full sm:w-5/12"><div class="h-56 sm:h-64 lg:h-80 w-full bg-center bg-cover rounded-xl lazyload" data-bg="https://cdn.musora.com/image/fetch/w_800,q_auto:best/https://drumeo-assets.s3.amazonaws.com/drum-shop/eardrums/drumeo-eardrums-8alt.jpg"></div></div>
            </div>
        </div>
    </section>
    <div id="customize-anchor" class="anchor"></div>
    <section class="content-section text-center customize px-4 lg:px-6 lazyload" style="background-color:#253b53;background-size: cover;" data-bg="https://cdn.musora.com/image/fetch/w_1500,q_auto:best/https://drumeo-assets.s3.amazonaws.com/drum-shop/eardrums/Order_Image.jpg">
    ...
    <div class="reveal coach-wrap relative rounded-xl text-center overflow-visible select-none max-w-xs md:max-w-md" id="membershipModal" style="max-width: 530px;" data-reveal data-reset-on-close="false">
        ...
        <div class="p-3 sm:p-5">
            ...
            <a href="{{ URL::Route('shopping-cart.to-cart.api') }}?products[DLM]=1,year,1&products[drumeo-eardrums]=1&locked=true" class="join blue smaller w-full max-w-xs">Join Drumeo</a>
        </div>
    </div>
