...
{{--                                <a x-on:click="waitlistModal = true;" class="join sold-out medium w-full">JOIN WAITLIST</a>--}}
                                <a href="#final" class="join blue smaller medium w-full anchor-slide">@if(empty($platformVersion)) GET STARTED @else LEARN MORE &raquo; @endif</a>
            ...
            <div class="container max-w-6xl mx-auto relative z-50" style="background: #eff7ff;">
                <div class="flex flex-wrap items-center justify-center px-4 sm:px-6 py-10 md:py-10 lg:py-20">
                    <div class="text-center w-full sm:w-1/2 lg:w-5/12 sm:pl-5" style="background: #eff7ff;">
                        <img class="h-20 sm:h-24 lg:h-26 -mb-3 sm:mb-0 lg:mb-3 transition duration-300 ease-in-out" src="https://d21q7xesnoiieh.cloudfront.net/fit-in/440x0/filters:quality(95)/marketing/drumeo/products/30-day-jazz/logo.webp" loading="lazy" onload="this.classList.remove('opacity-0')" alt="30 day double bass logo">
                        <h1 class="py-6 sm:py-4"><strong>Learn jazz drumming in an immersive 30-day experience.</strong></h1>
