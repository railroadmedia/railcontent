...
@section('global-head')
    ...
    <meta property="og:image" content="https://drumeo-assets.s3.amazonaws.com/drum-shop/affiliate-share.jpg">
        ...
        <div class="container mx-auto relative z-10">
            ...
            <div class="flex flex-wrap items-center justify-center max-w-3xl mx-auto">
                <div class="w-1/2 md:w-1/4 px-1 mb-3 md:mb-0">
                    <a target="_blank" class="join with-logo w-full" style="background-color:#0074c1;" href="https://www.sweetwater.com/shop/drumeo/?irgwc=1&utm_source=Impact&utm_medium=Musora%20Media%20Inc.&utm_campaign=Online%20Tracking%20Link&irclickid=yebUGaXrWxyLRxLSdcy%3AOQDDUkBy5aVpITh7V40"><img class="h-6 md:h-7" src="https://drumeo-assets.s3.amazonaws.com/drum-shop/sweetwater-logo.png"></a>
                </div>
                <div class="w-1/2 md:w-1/4 px-1 mb-3 md:mb-0">
                    <a target="_blank" class="join with-logo w-full" style="background-color:#ff9400;" href="https://www.amazon.com/shop/drumeo"><img class="h-6 md:h-7" src="https://drumeo-assets.s3.amazonaws.com/drum-shop/amazon-logo.png"></a>
                </div>
                <div class="w-1/2 md:w-1/4 px-1">
                    <a target="_blank" class="join with-logo w-full" style="background-color:#00b8c0;" href="https://www.thomann.de/intl/thlpg_2etep3mtdg.html?offid=1&affid=857"><img class="h-6 md:h-7" style="padding: 1px 0 4px;" src="https://drumeo-assets.s3.amazonaws.com/drum-shop/thomann-logo.png"></a>
                </div>
                <div class="w-1/2 md:w-1/4 px-1">
                    <a target="_blank" class="join with-logo w-full" style="background-color:#cd2418;" href="https://guitar-center.pxf.io/za4zxW"><img class="h-6 md:h-7" src="https://drumeo-assets.s3.amazonaws.com/drum-shop/guitar-center-logo.png"></a>
                </div>
            </div>
        </div>
