        ...
        <div class="sm:flex items-center justify-between">
            <div class="text-left whitespace-nowrap overflow-x-scroll sm:overflow-x-auto mb-4 sm:mb-0">
                <h4
                    ...
                    x-bind:class="filter === 'all' && 'active text-gray-900 font-black border-b-2 border-drumeo'"
                ...
                <h4
                    class="px-2 sm:px-4 py-3 sm:py-4 inline-block cursor-pointer text-gray-400"
                    x-bind:class="filter === 'lessons' && 'active text-gray-900 font-black border-b-2 border-drumeo'"
                ...
                <h4
                    class="px-2 sm:px-4 py-3 sm:py-4 inline-block cursor-pointer text-gray-400"
                    x-bind:class="filter === 'accessories' && 'active text-gray-900 font-black border-b-2 border-drumeo'"
                ...
                <h4
                    class="px-2 sm:px-4 py-3 sm:py-4 inline-block cursor-pointer text-gray-400"
                    x-bind:class="filter === 'clothing' && 'active text-gray-900 font-black border-b-2 border-drumeo'"
