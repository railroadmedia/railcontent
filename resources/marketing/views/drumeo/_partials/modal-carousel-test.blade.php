...
x-init="$watch('open', value => { if (value) initSplide(); })">
   ...
   {{ $slot }}
    ...
    <div x-show="open"
        ...
        class="fixed inset-0 top-20 overflow-y-auto">
        <!-- Overlay -->
        ...
        <div x-show="open" x-transition.opacity x-on:click="open = false"
            class="relative mx-auto bg-transparent rounded-lg shadow-lg max-w-2xl"
            style="z-index: 1006;">
            <!-- Close button -->
                                        ...
                                        <picture>
                                            @if(!empty($squareImage))
                                                ...
                                                <img x-bind:src="'https://d21q7xesnoiieh.cloudfront.net/750x750/filters:quality(95)/' + slide"
                                                    alt="product image" class="w-full h-full bg-transparent object-cover overflow-hidden rounded-xl">
                                            @else
