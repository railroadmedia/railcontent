@php
    switch ($bundle) {
        ...
        case 'gift':
            ...
            $bundlePrice = '<s class="opacity-50"> $341.94</s><strong> $240</strong> <span class="text-[#41F70F] text-xl md:text-3xl">(Save 31%)</span>';
            break;
        case 'challenge':
                            ...
                            <div class="text-center flex flex-col md:flex-row md:justify-center space-y-4 md:space-y-0 md:space-x-4">
                                ...
                                <div class="flex-1 relative overflow-hidden rounded-xl"
                                    ...
                                    x-on:click="
                                        flipped = !flipped;
                                        if(flipped){
                                            $refs.secondFront.classList.add('rotate-y-180');
                                            $refs.secondBack.classList.remove('-rotate-y-180');
                                            $refs.secondBack.classList.add('rotate-y-0');
                                        }
                                        else {
                                            $refs.secondFront.classList.remove('rotate-y-180');
                                            $refs.secondBack.classList.add('-rotate-y-180');
                                            $refs.secondBack.classList.remove('rotate-y-0');
                                        }">
                                            ...
                                            <div x-ref="secondBack"
                                                ...
                                                <div class="w-full h-full mx-auto text-center text-white flex flex-wrap justify-center items-center content-center p-2 md:p-3 rounded-xl border-2"
                                                    ...
                                                    <p class="leading-normal mx-auto text-sm">
                                                        @if($theme == 'drumeo') Transform your room, apartment or townhouse into a drum studio. @elseif($theme == 'pianote') A handcrafted premium leather satchel for your music books, laptop, and life. @endif
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
