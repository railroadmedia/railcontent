...
@section('head-includes')
    ...
    <link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@400;600;700;800&family=Roboto+Condensed:wght@300;400;700&display=swap" rel="stylesheet">
...
{{--    <script src="{{ _mix('js/order-form.js') }}"></script>--}}
    <script>
...
<!-- Main -->
@section('layout-body')
    <header id="nav" class="bg-drumeo">
        <div class="flex flex-row ph-2">
            <a href="/" class="logo flex flex-column align-center">
                <img src="https://dpwjbsxqtam5n.cloudfront.net/logos/logo-blue.png" style="padding: 0 0 10px;">
            </a>
            <div class="flex flex-column align-h-right align-v-center">
                <a href="/drumshop" class="btn text-white collapse-150">Shop</a>
            </div>
        </div>
    </header>
