    ...
    <div class="py-8 sm:py-12 px-4 sm:px-6 bg-black bg-cover bg-center text-white text-center"
        ...
        <div class="container mx-auto max-w-3xl">
            ...
            <picture>
                ...
                <img class="h-40 sm:h-72 lg:h-96 transition-opacity" src="https://d21q7xesnoiieh.cloudfront.net/fit-in/700x0/filters:quality(95)/marketing/musora/membership/redeem/redeem-laptop2.webp" alt="laptop spread" loading="lazy" onload="this.classList.remove('opacity-0')">
            </picture>
        </div>
    </div>
