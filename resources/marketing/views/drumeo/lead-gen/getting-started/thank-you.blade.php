    ...
    <div class="overflow-hidden text-white px-3 py-5 sm:py-7 lg:py-12" style="background-color:#000a1e;">
        <div class="container mx-auto max-w-2xl clearfix">
            <div class="text-center sm:px-3">
                <img class="h-12 sm:h-16 lg:h-20" src="https://drumeo-assets.s3.amazonaws.com/lead-gen/getting-started/logo_centre_white.png">
                ...
                <div class="aspect-16:9 w-full relative mx-auto inline-block rounded-xl my-7 bg-cover bg-center lazyload" data-bg="https://cdn.musora.com/image/fetch/w_1200,q_auto:best/https://drumeo-assets.s3.amazonaws.com/lead-gen/getting-started/E-mail.jpg"></div>
