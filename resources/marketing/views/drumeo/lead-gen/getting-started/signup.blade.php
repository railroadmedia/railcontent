...
@section('global-body')
            ...
            <div class="w-full sm:w-1/2 max-w-xl mx-auto sm:max-w-full">
                <div class="px-2 sm:pl-3 lg:pr-6 xl:pr-20">
                    <img
                        ...
                        src="https://www.musora.com/cdn-cgi/image/width=500,quality=95/https://dpwjbsxqtam5n.cloudfront.net/lead-gen/gsotd/updated/GSOTD-dark-blue.png"
                        alt="GSOTD logo"
                        fetchpriority="high"
                    />
    ...
    <section class="py-8 sm:py-14 text-center relative">
        ...
        <div class="max-w-3xl mx-auto z-50 relative">
            <img class="h-16 lg:h-24 transition-all opacity-0" src="https://www.musora.com/cdn-cgi/image/width=400,quality=95/https://dpwjbsxqtam5n.cloudfront.net/lead-gen/gsotd/updated/GSOTD-dark-blue.png" alt="GSTOD logo" loading="lazy" onload="this.classList.remove('opacity-0')" />
