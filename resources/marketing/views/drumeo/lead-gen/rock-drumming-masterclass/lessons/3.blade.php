...
@section('title')
    The Most Epic Drum Video We’ve Ever Made (Todd Sucherman)
@stop
...
@section('prev-thumb', 'https://dpwjbsxqtam5n.cloudfront.net/rock-drumming-masterclass/prelaunch/technique-fails.jpg')
