...
@section('content')
    ...
    <section class="text-center px-3 py-5 sm:py-7" style="background-color:#FFAC00;">
        <div class="container mx-auto max-w-5xl">
            <h5 class="mb-4">
                Enter drumming hyperspeed with<br class="inline sm:hidden">
                a free 30-day trial to Drumeo.</h5>
...
{{--                                    <img alt="point icon" src="https://www.musora.com/musora-cdn/image/{{ $songItem['icon'] }}" class="h-6 sm:h-10">--}}
    ...
    @include('musora.sales.components.card-selection-section', [
        ...
        "plusAnnualLink" => "/faster/ty-annual",
        "plusMonthlyLink" => "/faster/ty-monthly",
    ])
