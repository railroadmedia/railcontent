    ...
    <section class="py-12 md:py-20 px-4 sm:px-6" style="background:linear-gradient(180deg, #01050F 60.48%, #07132C 100%);">
        <div class="max-w-2xl lg:max-w-5xl mx-auto text-center text-white">
            ...
            @php
                $bonuses = [
                    [
                    'image' => 'https://drumeo-assets.s3.amazonaws.com/promos/drumeo_annual.jpg',
            ...
            <h3 class="text-coaches mb-8"><strong>ONLY <s class="opacity-60">${{ Prices::$drumeoEdgeAnnualFull }}</s> $200</strong></h3>
