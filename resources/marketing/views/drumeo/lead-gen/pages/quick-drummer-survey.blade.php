...
@section('global-head')
    ...
    <meta name="description" content="We’ll be using the responses to create better videos that make a bigger difference to YOU in the future.">
    <!-- Social Media -->
...
@section('global-body')
    ...
    <div class="row title-wrap">
        <div class="columns">
            <h1>Thank You For<br class="hide-for-medium">
                 Your Feedback!</h1>
            <p>We’ll be using the responses to create better videos that make a bigger difference <br class="show-for-medium">
               to YOU in the future. In the meantime, make sure to give us a follow on your <br class="show-for-medium">
