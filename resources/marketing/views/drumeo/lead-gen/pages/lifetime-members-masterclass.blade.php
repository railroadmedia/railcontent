...
@section('global-body')
    ...
    <header class="header text-white text-center px-4 sm:px-6 py-14 md:py-20 lg:py-32 relative bg-no-repeat bg-cover bg-top lazyload" style="background-color:#031e3b;" data-bg="https://www.musora.com/cdn-cgi/image/width=1500,quality=95/https:/dpwjbsxqtam5n.cloudfront.net/drum-shop/header-background.jpg">
    ...
    <section class="text-center text-white py-8 md:py-24 px-5 md:px-7" style="background:#00101d ;">
        <div class="container mx-auto text-center max-w-2xl">
            ...
            <a target="_blank" class=" @if(Carbon\Carbon::create(2023, 1, 14, 12, 0, 0, 'America/Vancouver') < Carbon\Carbon::now()) sold-out @endif join blue smaller" href="https://www.musora.com/drumeo/live">Morning Session - 10am PDT</a>
            <hr class="my-7">
            ...
            <a target="_blank" class=" @if(Carbon\Carbon::create(2023, 1, 14, 18, 0, 0, 'America/Vancouver') < Carbon\Carbon::now()) sold-out @endif join blue smaller" href="https://www.musora.com/drumeo/live">Evening Session - 4pm PDT</a>
        </div>
    </section>
