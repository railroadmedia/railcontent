        ...
        <div class="max-w-md md:max-w-4xl mx-auto px-4 lg:px-2">
            ...
            <div class="md:grid md:grid-cols-3 md:gap-4">
                <div class="relative rounded-xl overflow-hidden mb-3 md:mb-0" style="background-color:#071023;">
                    <div class="w-full aspect-16:9 bg-cover bg-center" style="background-image:url('https://www.musora.com/cdn-cgi/image/width=700,quality=95/https://dpwjbsxqtam5n.cloudfront.net/sales/2022/thumb-method.jpg');"></div>
                    <div class=" px-3 lg:px-4 py-5 lg:py-7 text-center">
                        <i class="text-4xl align-middle icon-drumeo-method text-drumeo"></i>
                        <img class="h-5 ml-2 imgfilter-method" src="https://www.musora.com/cdn-cgi/image/width=200,quality=95/https://dpwjbsxqtam5n.cloudfront.net/sales/2021/method-text.svg" alt="method-text">
                        <p class="mt-2">
                ...
                <div class="relative rounded-xl overflow-hidden mb-3 md:mb-0" style="background-color:#071023;">
                    <div class="w-full aspect-16:9 bg-cover bg-center" style="background-image:url('https://www.musora.com/cdn-cgi/image/width=700,quality=95/https://dpwjbsxqtam5n.cloudfront.net/sales/2022/thumb-songs2.jpg');"></div>
                    <div class="px-3 lg:px-4 py-5 lg:py-7 text-center">
                        <i class="text-4xl align-middle icon-songs text-songs"></i>
                        <img class="h-5 ml-2 imgfilter-songs" src="https://www.musora.com/cdn-cgi/image/width=150,quality=95/https://dpwjbsxqtam5n.cloudfront.net/sales/2021/songs-text.svg" alt="songs-text">
                        <p class="mt-2">
                ...
                <div class="relative rounded-xl overflow-hidden" style="background-color:#071023;">
                    <div class="w-full aspect-16:9 bg-cover bg-center" style="background-image:url('https://www.musora.com/cdn-cgi/image/width=700,quality=95/https://dpwjbsxqtam5n.cloudfront.net/sales/2022/thumb-coaches2.jpg');"></div>
                    <div class="px-3 lg:px-4 py-5 lg:py-7 text-center">
                        <img class="h-8 icon imgfilter-coaches" src="https://www.musora.com/cdn-cgi/image/width=100,quality=95/https://dpwjbsxqtam5n.cloudfront.net/sales/2021/coaches-icon.svg" alt="coaches-icon">
                        <img class="h-5 ml-2 imgfilter-coaches" src="https://www.musora.com/cdn-cgi/image/quality=95/https://dpwjbsxqtam5n.cloudfront.net/sales/2021/coaches-text.svg" alt="coaches-text">
                        <p class="mt-2">
    ...
    <section class="py-6 md:py-10" style="background-color:#F1F7FE;">
        <div class="mx-auto md:max-w-3xl lg:max-w-4xl grid grid-cols-1 sm:grid-cols-3 gap-6 px-4 lg:px-0">
            <div class="max-w-xs mx-auto">
                <img class="rounded-xl" src="https://www.musora.com/cdn-cgi/image/width=450,quality=95/https://dpwjbsxqtam5n.cloudfront.net/sales/social-proof/John_Stamos.jpg" alt="John Stamos" style="filter: drop-shadow(0px 4px 4px rgba(0, 0, 0, 0.25));">
