...
@section('global-body')
    ...
    <header class="py-12 sm:py-20 text-white" style="background: linear-gradient(to right, #020f1b 0%, #08559c 100%);">
            ...
            <div class="w-full sm:w-1/2 max-w-xl mx-auto sm:max-w-full">
                <div class="px-2 sm:pl-3 lg:pr-6 xl:pr-20">
                    <img
                        ...
                        fetchpriority="high"
                    />
                    <h3 class="leading-tight mb-5">Learn your first double bass grooves <strong>and play along with REAL music.</strong></h3>
