                        ...
                        <div class="post-tile columns">
                            <a href="{{ $drumFillLesson['url'] }}">
                                <div class="image-fill">
                                    <div class="thumbnail-pic" style="background-image:url(https://www.musora.com/cdn-cgi/image/width=450,quality=95/{{ $drumFillLesson['thumb'] }})"></div>
                    ...
                    @foreach($bassDrumLessons as $bassDrumLesson)
                        <div class="post-tile columns">
                            <a href="{{ $bassDrumLesson['url'] }}">
                                <div class="image-fill">
                                    <div class="thumbnail-pic" style="background-image:url(https://www.musora.com/cdn-cgi/image/width=450,quality=95/{{ $bassDrumLesson['thumb'] }})"></div>
                                    <i class="fas fa-arrow-circle-right"></i>
                                </div>
                                <p>
                    ...
                    @foreach($drumTechniqueLessons as $drumTechniqueLesson)
                        <div class="post-tile columns">
                            <a href="{{ $drumTechniqueLesson['url'] }}">
                                <div class="image-fill">
                                    <div class="thumbnail-pic" style="background-image:url(https://www.musora.com/cdn-cgi/image/width=450,quality=95/{{ $drumTechniqueLesson['thumb'] }})"></div>
                                    <i class="fas fa-arrow-circle-right"></i>
                                </div>
                                <p>
                    ...
                    @foreach($extraLessons as $extraLesson)
                        <div class="post-tile columns">
                            <a href="{{ $extraLesson['url'] }}">
                                <div class="image-fill">
                                    <div class="thumbnail-pic" style="background-image:url(https://www.musora.com/cdn-cgi/image/width=450,quality=95/{{ $extraLesson['thumb'] }})"></div>
                                    <i class="fas fa-arrow-circle-right"></i>
                                </div>
                                <p>
                    ...
                    @foreach($warmupLessons as $warmupLesson)
                        <div class="post-tile columns">
                            <a href="{{ $warmupLesson['url'] }}">
                                <div class="image-fill">
                                    <div class="thumbnail-pic" style="background-image:url(https://www.musora.com/cdn-cgi/image/width=450,quality=95/{{ $warmupLesson['thumb'] }})"></div>
                                    <i class="fas fa-arrow-circle-right"></i>
                                </div>
                                <p>
                    ...
                    @foreach($songLessons as $songLesson)
                        <div class="post-tile columns">
                            <a href="{{ $songLesson['url'] }}">
                                <div class="image-fill">
                                    <div class="thumbnail-pic" style="background-image:url(https://www.musora.com/cdn-cgi/image/width=450,quality=95/{{ $songLesson['thumb'] }})"></div>
                                    <i class="fas fa-arrow-circle-right"></i>
                                </div>
                                <p>
                    ...
                    @foreach($stickTrickLessons as $stickTrickLesson)
                        <div class="post-tile columns">
                            <a href="{{ $stickTrickLesson['url'] }}">
                                <div class="image-fill">
                                    <div class="thumbnail-pic" style="background-image:url(https://www.musora.com/cdn-cgi/image/width=450,quality=95/{{ $stickTrickLesson['thumb'] }})"></div>
                                    <i class="fas fa-arrow-circle-right"></i>
                                </div>
                                <p>
                    ...
                    @foreach($rockDrummingLessons as $rockDrummingLesson)
                        <div class="post-tile columns">
                            <a href="{{ $rockDrummingLesson['url'] }}">
                                <div class="image-fill">
                                    <div class="thumbnail-pic" style="background-image:url(https://www.musora.com/cdn-cgi/image/width=450,quality=95/{{ $rockDrummingLesson['thumb'] }})"></div>
                                    <i class="fas fa-arrow-circle-right"></i>
                                </div>
                                <p>
                    ...
                    @foreach($jazzDrummingLessons as $jazzDrummingLesson)
                        <div class="post-tile columns">
                            <a href="{{ $jazzDrummingLesson['url'] }}">
                                <div class="image-fill">
                                    <div class="thumbnail-pic" style="background-image:url(https://www.musora.com/cdn-cgi/image/width=450,quality=95/{{ $jazzDrummingLesson['thumb'] }})"></div>
                                    <i class="fas fa-arrow-circle-right"></i>
                                </div>
                                <p>
                    ...
                    @foreach($drummerLessons as $drummerLesson)
                        <div class="post-tile columns">
                            <a href="{{ $drummerLesson['url'] }}">
                                <div class="image-fill">
                                    <div class="thumbnail-pic" style="background-image:url(https://www.musora.com/cdn-cgi/image/width=450,quality=95/{{ $drummerLesson['thumb'] }})"></div>
                                    <i class="fas fa-arrow-circle-right"></i>
                                </div>
                                <p>
