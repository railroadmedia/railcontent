...
<section class="text-center absolute top-1/2 left-1/2 w-full px-5" style="transform:translate(-50%,-50%)">
    <form id="DrumeoEngagementTriggerGroovesOfJohnBonhamWebForm" accept-charset="UTF-8" action="/laravel/public/customer-io/submit-email-form"
        ...
        <input type="hidden" name="form_name" value="Grooves Of John Bonham">
        ...
        <input name="inf_form_xid" type="hidden" value="DrumeoEngagementTriggerGroovesOfJohnBonhamWebForm">
        <input name="tag_names_to_add[]" type="hidden" value="Drumeo - Engagement - Trigger - Grooves Of John Bonham - Web Form">
