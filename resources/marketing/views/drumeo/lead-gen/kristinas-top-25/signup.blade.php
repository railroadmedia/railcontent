...
@section('global-body')
    ...
    <header class="text-white text-center lg:text-left px-6 lg:px-8 py-10 sm:py-12 lg:py-24 bg-cover bg-center" style="background: #000f5c url('https://www.musora.com/cdn-cgi/image/width=2000,quality=95/https://dpwjbsxqtam5n.cloudfront.net/lead-gen/kristinas-top-25/header-bg.jpg');">
            ...
            <div class="flex flex-wrap justify-center items-start lg:items-center">
                <div class="w-full sm:w-7/12 xl:w-1/2">
                    <img
                        ...
                        src="https://www.musora.com/cdn-cgi/image/width=640,quality=95/https://dpwjbsxqtam5n.cloudfront.net/lead-gen/kristinas-top-25/logo.svg"
                        alt="logo"
                        fetchpriority="high"
                    />
                    <img
                        class="rounded-xl sm:hidden mb-5 transition-opacity opacity-0"
                        src="https://www.musora.com/cdn-cgi/image/width=660,quality=95/https://dpwjbsxqtam5n.cloudfront.net/lead-gen/kristinas-top-25/header-image-m.png"
                ...
                <div class="w-full sm:w-5/12 xl:w-1/2 sm:pl-5 xl:px-12 hidden sm:block">
                    <img
                        ...
                        src="https://www.musora.com/cdn-cgi/image/width=830,quality=95/https://dpwjbsxqtam5n.cloudfront.net/lead-gen/kristinas-top-25/header-image.png"
...
{{--    </section>--}}
    ...
    <section class="text-center py-14 md:py-24 text-white bg-cover bg-center" style="background: #000f5c url('https://www.musora.com/cdn-cgi/image/width=2000,quality=95/https://dpwjbsxqtam5n.cloudfront.net/lead-gen/kristinas-top-25/bottom-bg.jpg');">
        <div class="container mx-auto">
            <div class="w-full px-2 md:px-3 text-center">
                <img class="h-32 sm:h-36 lg:h-44" src="https://www.musora.com/cdn-cgi/image/width=640,quality=95/https://dpwjbsxqtam5n.cloudfront.net/lead-gen/kristinas-top-25/logo.svg" alt="FWTGF logo" />
