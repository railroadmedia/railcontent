...
@section('content')
    <header class="pt-8 sm:pt-20">
        <div class="max-w-xl md:max-w-4xl mx-auto flex flex-col md:flex-row px-3 sm:px-4 lg:px-0 text-center md:text-left md:items-center">
            <div class="w-full md:w-7/12 lg:w-1/2">
                <div class="md:px-2">
                    <picture>
                        <source media="(min-width:768px)" srcset="https://www.musora.com/musora-cdn/image/width=650,quality=95/https://dpwjbsxqtam5n.cloudfront.net/lead-gen/hand-technique/logo_left.png">
            ...
            <div class="w-full sm:w-5/12 lg:w-1/2">
                <div class="px-4 lg:px-10 h-full w-full">
                    <img class="hidden md:inline-block object-cover h-full w-full rounded-lg lazyload" data-src="https://www.musora.com/musora-cdn/image/width=860,quality=95/https://dpwjbsxqtam5n.cloudfront.net/lead-gen/hand-technique/intro.jpg" alt="intro image">
                </div>
            </div>
        ...
        <div class="max-w-lg sm:max-w-4xl lg:max-w-6xl mx-auto">
            ...
            <div class="flex flex-wrap mb-14 sm:px-2">
                <div class="w-full sm:w-1/2 lg:w-1/3 px-4 sm:px-2 mb-6">
                    <img class="rounded-lg mb-2 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=740,quality=95/https://dpwjbsxqtam5n.cloudfront.net/lead-gen/hand-technique/Lesson1.jpg" alt="thumb1">
                </div>
                <div class="w-full sm:w-1/2 lg:w-1/3 px-4 sm:px-2 mb-6">
                    <img class="rounded-lg mb-2 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=720,quality=95/https://dpwjbsxqtam5n.cloudfront.net/lead-gen/hand-technique/Lesson2.jpg" alt="thumb2">
                </div>
                <div class="w-full sm:w-1/2 lg:w-1/3 px-4 sm:px-2 mb-6">
                    <img class="rounded-lg mb-2 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=720,quality=95/https://dpwjbsxqtam5n.cloudfront.net/lead-gen/hand-technique/Lesson3.jpg" alt="thumb3">
                </div>
                <div class="w-full sm:w-1/2 lg:w-1/3 px-4 sm:px-2 mb-6 sm:mb-0">
                    <img class="rounded-lg mb-2 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=720,quality=95/https://dpwjbsxqtam5n.cloudfront.net/lead-gen/hand-technique/Lesson4.jpg" alt="thumb4">
                </div>
                <div class="w-full sm:w-1/2 lg:w-1/3 px-4 sm:px-2 mb-6 sm:mb-0">
                    <img class="rounded-lg mb-2 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=720,quality=95/https://dpwjbsxqtam5n.cloudfront.net/lead-gen/hand-technique/Lesson5.jpg" alt="thumb5">
                </div>
                <div class="w-full sm:w-1/2 lg:w-1/3 px-4 sm:px-2">
                    <img class="rounded-lg mb-2 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=720,quality=95/https://dpwjbsxqtam5n.cloudfront.net/lead-gen/hand-technique/Lesson6.jpg" alt="thumb6">
                </div>
            </div>
    ...
    <section class="pt-32 pb-20 px-2 sm:px-4 relative" style="background: #F2F8FB;">
        ...
        <div class="max-w-xl md:max-w-3xl mx-auto text-center">
            <img class="h-20 sm:h-24 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=800,quality=95/https://dpwjbsxqtam5n.cloudfront.net/lead-gen/hand-technique/logo_center.png" alt="logo centered">
