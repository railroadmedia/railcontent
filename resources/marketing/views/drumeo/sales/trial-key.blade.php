...
<div class="h-10 w-full block"></div>
    <a href="/ecommerce/add-to-cart?products[DLM-Trial-Annual-7-Day]=1&products[Drumeo-Key]=1&promo-code=key-trial&locked=true" class="promo-banner flex items-center justify-center py-1.5 px-2 sm:px-0 w-full z-[100] -mt-10 transition-none" style="background: linear-gradient(330deg, #79EE9A, #12E3FF, #79EE9A);">
        <h4 class="inline-block ml-0 mr-4 bg-white rounded-md font-bebas py-0.5 px-2 leading-none text-black">First 1000</h4>
        <p class="mx-0 leading-tight text-black font-black text-sm">
             Get a FREE Drum Key when<br>
            you try Drumeo for 7 days.
        </p>
    </a>
@endsection
        ...
        <div class="container mx-auto">
            <div class="flex flex-wrap sm:flex-nowrap items-center justify-center">
                ...
                <div class="text-center w-full sm:w-auto">
                    ...
                    <p class="leading-normal my-4 sm:my-5">Click below to start your plan that will continue on<br class="hidden sm:inline">
                        {{ Carbon\Carbon::now()->addDays(7)->format('F jS') }} (after your free trial). Cancel anytime.</p>
                    ...
                    <p class="inline-block w-full text-sm"><em>$240/year after 7 days. Cancel anytime.</em></p>
                </div>
