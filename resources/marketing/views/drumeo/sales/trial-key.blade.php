...
<div class="h-10 w-full block"></div>
    <a href="#customize-anchor" class="promo-banner anchor-slide flex items-center justify-center py-1.5 px-2 sm:px-0 w-full z-[100] -mt-10 transition-none" style="background: linear-gradient(330deg, #79EE9A, #12E3FF, #79EE9A);">
        ...
        <div class="container max-w-3xl mx-auto">
            <div class="flex flex-wrap sm:flex-nowrap items-center justify-center">
                ...
                <div class="text-center sm:text-left w-full sm:w-auto">
                    ...
                    <a class="sm:mx-1 join smaller black anchor-slide" href="#customize-anchor">START FOR FREE <i class="fas fa-arrow-right" style="line-height: 0;"></i></a>
