...
@section('global-body')
        ...
        <header class="sm:px-6 pb-14 pt-6 sm:pt-20 sm:pb-28 lg:py-24 text-white" style="background:linear-gradient(to left, #0B76DB, #6500B4);">
        ...
        <section class="pt-12 md:pt-20">
            <div class="max-w-5xl mx-auto px-4 lg:px-2">
                <h2 class="font-extrabold text-center">Drumeo membership<br class="inline sm:hidden"> special pricing.</h2>
                ...
                <div class="md:grid md:grid-cols-3 md:gap-4">
                    ...
                    <div class="relative rounded-xl overflow-hidden" style="background-color:#F6F8FC;">
                        ...
                        <div class="px-3 lg:px-4 py-5 lg:py-7 text-center">
                            ...
                            <p class="leading-normal">
                                Your favorite drummers and teachers will share their tips, cheer you along, and help you learn by playing!
                            </p>
                        </div>
                    </div>
                </div>
