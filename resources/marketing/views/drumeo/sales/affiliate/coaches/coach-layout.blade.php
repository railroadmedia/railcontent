    ...
    <div class="text-white px-4 sm:px-6 py-6 sm:py-8 relative z-10" style="background-color:#000318;">
        <div class="container max-w-4xl mx-auto">
            <div class="sm:flex mx-auto items-start text-center">
                <img class="rounded-full bg-drumeo border-drumeo border-4 sm:border-8 mx-auto mb-3 sm:mb-0 w-36 sm:w-56 lg:w-72" src="https://www.musora.com/musora-cdn/image/width=540,quality=95/https://dpwjbsxqtam5n.cloudfront.net/sales/2021/avatar/@yield('url').jpg">
