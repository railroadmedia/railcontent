    ...
    >
        <div class="container max-w-4xl mx-auto">
            <div class="flex flex-wrap sm:flex-nowrap mx-auto items-start lg:items-center text-center justify-center">
                ...
                @else
                    @isset($img2)
                        <img class="rounded-full bg-drumeo border-drumeo border-4 sm:border-8 mx-auto mb-3 sm:mb-0 w-36 sm:w-56 lg:w-72" src="https://www.musora.com/musora-cdn/image/width=540,quality=95/https://dpwjbsxqtam5n.cloudfront.net/sales/trials/{{ $img2 }}.jpg">
                    @else
