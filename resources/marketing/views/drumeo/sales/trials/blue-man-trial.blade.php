...
@section('promo-banner')
    <div class="text-white px-4 py-8 md:py-16 relative z-10 bg-cover bg-center" style="background-image:url('https://d21q7xesnoiieh.cloudfront.net/fit-in/2000x0/filters:quality(95)/marketing/drumeo/lead-gen/blue-man/bg.jpg');">
        <div class="container mx-auto">
            <div class="sm:flex mx-auto items-start text-center" style="max-width: 900px;">
                <img class="avatar mx-auto mb-3 sm:mb-0 w-48 md:w-52 lg:w-72" src="https://d21q7xesnoiieh.cloudfront.net/fit-in/600x0/filters:quality(95)/marketing/drumeo/lead-gen/blue-man/logo3.png">
                <div class="md:text-left px-2 md:pl-7 lg:pl-10">
                    <h3 class="leading-tight"><strong>Unlimited Drum Lessons<br class="sm:hidden"> For 30 Days</strong></h3>
