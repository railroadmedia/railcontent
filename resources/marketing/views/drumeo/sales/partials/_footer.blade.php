    ...
    <div class="footer-bottom" @if(!empty($minimal)) style="border-top: 0;padding-top: 0;" @endif>
        <div class="row">
            ...
            @if(empty($minimal))
                ...
                <a aria-label="Youtube" rel="noopener" href="https://www.youtube.com/freedrumlessons/" target="_blank" class="inline-flex items-center justify-center social-media youtube" aria-label="youtube"><i class="fab fa-youtube"></i></a>
                <a aria-label="Facebook" rel="noopener" href="https://facebook.com/drumeo/" target="_blank" class="inline-flex items-center justify-center social-media facebook" aria-label="facebook"><i class="fab fa-facebook-f"></i></a>
                <a aria-label="Instagram" rel="noopener" href="https://instagram.com/drumeoofficial/" target="_blank" class="inline-flex items-center justify-center social-media instagram" aria-label="instagram"><i class="fab fa-instagram"></i></a>
                <a aria-label="Tiktok" rel="noopener" href="https://www.tiktok.com/@drumeoofficial" target="_blank" class="inline-flex items-center justify-center social-media tiktok" aria-label="tiktok"><i class="fab fa-tiktok"></i></a>
            @endif
