...
<footer id="footer" class="bottom-footer clearfix relative sales-footer">
    ...
    <div class="footer-bottom" @if(!empty($minimal)) style="border-top: 0;padding-top: 0;" @endif>
        <div class="row">
            <img class="logo" src="https://www.musora.com/musora-cdn/image/quality=95,width=250,metadata=none/https://dpwjbsxqtam5n.cloudfront.net/logos/logo-white.png" alt="Drumeo">
            @if(empty($minimal))
