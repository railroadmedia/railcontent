@php
    $annualLink = '/laravel/public/shopping-cart/api/query?products[DLM]=1,year,1&products[rudiments-poster]=1&products[quietpad]=1&products[Drumeo-VaterSticks]=1&products[drum-technique-made-easy-pack]=1&products[GHFAL-DIGI]=1&locked=true';
@endphp
...
<section class="content-section text-center customize px-4 lg:px-6 relative z-50 overflow-hidden bg-cover bg-top lazyload" {{--data-bg="https://cdn.musora.com/image/fetch/w_2000,q_auto:best/https://drumeo-assets.s3.amazonaws.com/promos/september/bg.jpg"--}} {{--style="background: linear-gradient(to bottom, #01050f, #021022);"--}} style="padding:0;">
    <div class="bg-black text-center pt-10 md:pt-12 lg:pt-16">
        ...
        <h4 class="my-3">
            <strong>Develop silky-smooth hands around the kit.</strong>
        </h4>
    ...
    <div class="pt-4 pb-10 md:pb-12 lg:pb-16" style="background: linear-gradient(to bottom, #01050f, #021022);">
        <div class="container mx-auto relative z-50">
            <div class="mx-auto max-w-sm sm:max-w-md md:max-w-2xl lg:max-w-3xl" style="font-size: 0;">
                ...
                <div class="bonus-wrap relative hidden md:inline-block align-top mx-auto mb-3 px-1 md:px-3 w-1/2 md:w-1/4">
                    <div class="flip-div inline-block relative w-full group" style="padding-bottom: 133%;">
                ...
                <div class="bonus-wrap relative inline-block align-top mx-auto mb-3 px-1 md:px-3 w-full md:w-1/2 ">
                    <div class="flip-div inline-block relative w-full group" style="padding-bottom: 60%; perspective: 1000px;">
                        <div class="text-center w-full h-full absolute cursor-pointer" style="transform-style: preserve-3d;">
                            <div class="border-2 border-drumeo front absolute z-20 overflow-hidden rounded-xl w-full h-full transition-transform duration-700" style="overflow: visible; backface-visibility: hidden;">
                                {{--<h6 class="absolute text-white top-0 left-0 w-full py-0.5 bg-drumeo rounded-t-xl font-bebas uppercase">{{ $bonus['shipping'] }}</h6>--}}
                                <h6 class="absolute text-white -top-3 -right-3  py-7 px-2.5 rounded-full transform rotate-12 bg-drumeo" style="line-height: 0.6;"><strong>NEW</strong></h6>
                                <div class="overflow-hidden rounded-xl h-full w-full bg-black bg-top bg-cover lazyload" data-bg="https://cdn.musora.com/image/fetch/w_600,q_auto:best/https://drumeo-assets.s3.amazonaws.com/promos/black-friday/rudiments_poster.jpg"></div>
                                <div class="absolute z-40 text-center top-1/2 left-1/2 text-white transition-opacity duration-300 transform -translate-x-1/2 -translate-y-1/2 visible opacity-0 group-hover:opacity-100 text-shadow-2">
                                    <i class="fas fa-arrow-right text-4xl"></i><br>
                                    <p class="text-sm"><strong>DETAILS</strong></p>
                                </div>
                            ...
                            <div class="back border-2 border-drumeo absolute z-40 overflow-hidden rounded-xl w-full h-full transition-transform duration-700" style="backface-visibility: hidden;">
                                <div class="w-full h-full mx-auto text-center text-white flex flex-wrap justify-center items-center content-center p-2 md:p-3" style="background:linear-gradient(to bottom, #01050f, #021225);">
                                    <p class="leading-normal mx-auto text-sm">Rudiments are the ABCs of drumming and learning your rudiments will help you effortlessly express yourself on the drums.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <p class="uppercase w-full leading-normal mt-2">
                        {{--<strong class="font-black leading-tight inline-block mb-1">{!!  $bonus['title']  !!}</strong><br>--}}
                        <span style="text-transform:uppercase; display:inline-block;"><s>$7</s> <strong class="text-promo">FREE</strong></span><br>
                            Free Shipping
                    </p>
                </div><br class="hidden md:inline">
                <div class="bonus-wrap relative inline-block align-top mx-auto mb-3 px-1 md:px-3 w-1/2 md:w-1/4 md:hidden">
                    <div class="flip-div inline-block relative w-full group" style="padding-bottom: 133%;">
                        <div class="text-center w-full h-full absolute cursor-pointer" style="transform-style: preserve-3d;">
                            <div class="border-2 border-drumeo front absolute z-20 overflow-hidden rounded-xl w-full h-full transition-transform duration-700" style="backface-visibility: hidden;">
                                <div class="overflow-hidden rounded-xl h-full w-full bg-black bg-top bg-cover lazyload" data-bg="https://cdn.musora.com/image/fetch/w_460,q_auto:best/https://drumeo-assets.s3.amazonaws.com/promos/drumeo_annual.jpg"></div>
                ...
                @foreach($bonuses as $bonus)
                    <div class="bonus-wrap relative inline-block align-top mx-auto mb-3 px-1 md:px-3 w-1/2 md:w-1/4 ">
