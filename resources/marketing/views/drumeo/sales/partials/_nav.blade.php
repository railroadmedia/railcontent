...
{{--                    <a class="" href="/beat" title="Read our Blog">Blog</a>--}}
                ...
                <div id="features-dd" class="features-dd hidden shadow-md bg-white rounded-xl p-2 absolute flex flex-col left-44 lg:left-48 top-10 lg:top-12 w-44 z-[70]" tabindex="0">
                    ...
                    <a class="font-bebas uppercase select-none text-base tracking-wider rounded-lg px-2 py-1 hover:bg-gray-100 w-full @if(strpos(url()->full(), 'coaches')) active @endif" href="/coaches" ><i class="mr-1 text-lg fa-fw far fa-whistle"></i> Coaches</a>
{{--                    <a class="font-bebas uppercase select-none text-base tracking-wider rounded-lg px-2 py-1 hover:bg-gray-100 w-full @if(strpos(url()->full(), 'songs')) active @endif" href="/songs" ><i class="mr-1 text-lg fa-fw far fa-headphones"></i> Songs</a>--}}
                </div>
                <div id="instruments-dd" class="instruments-dd hidden shadow-md bg-white rounded-xl p-2 absolute flex flex-col left-72 lg:left-80 -ml-3 top-10 lg:top-12 w-44 z-[70]" tabindex="0">
                    <a class="font-bebas uppercase select-none text-base tracking-wider rounded-lg px-2 py-1 hover:bg-gray-100 w-full text-drumeo" href="/" ><i class="mr-1 text-lg fa-fw far fa-drum"></i> Drums</a>
