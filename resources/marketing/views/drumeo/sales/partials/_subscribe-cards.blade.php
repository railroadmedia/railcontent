...
<section class="content-section text-center customize px-4 lg:px-6" style="background:#000;">
    <div class="container mx-auto">
        ...
        <div class="flex flex-wrap items-end justify-center 2-full max-w-sm md:max-w-2xl lg:max-w-3xl my-5 sm:my-7 mx-auto">
            ...
            {{--<div class="w-full md:w-1/2 px-2 md:px-3 relative">--}}
                {{--<p class="w-full px-4 pt-2 pb-4 -mb-3 --}}{{----}}{{--bg-guitareo--}}{{----}}{{-- text-black rounded-t-2xl" style="background: linear-gradient(to bottom, #feab01, #fd7a00);"><strong>ONLY <s class="opacity-60">100</s> {{ $products['DLM-Lifetime']->getPublicStockCount() }} SPOTS LEFT!</strong></p>--}}
