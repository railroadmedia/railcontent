...
@section('global-body')
    ...
    <section class="text-center text-white px-4 sm:px-6 py-2 sm:py-6 lg:py-8 bg-cover bg-center" style="background-color: #0f4783;background-image:url(https://www.musora.com/cdn-cgi/image/width=2000,quality=95/https://dpwjbsxqtam5n.cloudfront.net/festival/vdf/header-banner.jpg);">
        <div class="container max-w-6xl mx-auto">
            <img class="h-28 sm:h-40 lg:h-48" src="https://www.musora.com/cdn-cgi/image/width=400,quality=95/https://dpwjbsxqtam5n.cloudfront.net/festival/vdf/VDF-logo.png">
        </div>
    </section>
        ...
        <div class="container max-w-4xl mx-auto">
            <div class="flex flex-wrap sm:flex-nowrap items-center">
                <div class="w-full sm:w-5/12">
                    <div class="bg-cover rounded-xl aspect-1:1 overflow-hidden relative bg-top cursor-pointer" style="background-image:url(https://www.musora.com/cdn-cgi/image/width=850,quality=95/https://dpwjbsxqtam5n.cloudfront.net/festival/vdf/intro-side.png);"></div>
                </div>
