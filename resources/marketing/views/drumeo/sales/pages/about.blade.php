...
@section('global-body')
    ...
    <section class="text-white relative z-10 overflow-hidden px-4 md:px-8 py-8 md:py-40 lg:py-52 bg-cover bg-center lazyload" style="background-color:#163146;" data-bg="https://www.musora.com/cdn-cgi/image/width=2000,quality=95/https://dpwjbsxqtam5n.cloudfront.net/sales/about/Header_BG.jpg">
        ...
        <div class="container mx-auto relative z-10 max-w-5xl">
            <div class="flex flex-wrap sm:flex-nowrap lg:items-center">
                <div class="coaches w-full sm:w-5/12 lg:w-1/2 mb-5 sm:mb-0 sm:pl-5 mx-auto sm:order-1 text-center">
                    <img class="h-64 sm:h-auto" src="https://www.musora.com/cdn-cgi/image/width=1200,quality=95/https://dpwjbsxqtam5n.cloudfront.net/sales/about/Collage_1.png">
                </div>
            ...
            <div class="flex flex-wrap sm:flex-nowrap items-center">
                <div class="coaches w-full sm:w-1/2 sm:pr-5 mb-5 sm:mb-0 text-center">
                    <img class="h-52 sm:h-auto" src="https://www.musora.com/cdn-cgi/image/width=1200,quality=95/https://dpwjbsxqtam5n.cloudfront.net/sales/about/Collage_2.png">
                </div>
                        ...
                        <div class="inside-scroll-element mx-auto w-11/12">
                            <div class="timeline-line relative px-1.5 lg:px-2.5">
                                <div class="relative z-10 rounded-xl text-center py-3" style="background-color:#1d232f;">
                                    ...
                                    <img class="my-2.5" src="https://www.musora.com/cdn-cgi/image/width=430,quality=95/https://dpwjbsxqtam5n.cloudfront.net/sales/about/BreakSticks.jpg" alt="timeline">
                            ...
                            <div class="timeline-line relative px-1.5 lg:px-2.5">
                                <div class="relative z-10 rounded-xl text-center py-3" style="background-color:#1d232f;">
                                    ...
                                    <img class="my-2.5" src="https://www.musora.com/cdn-cgi/image/width=430,quality=95/https://dpwjbsxqtam5n.cloudfront.net/sales/about/RailRoad+Media.jpg" alt="timeline">
                            ...
                            <div class="timeline-line relative px-1.5 lg:px-2.5">
                                <div class="relative z-10 rounded-xl text-center py-3" style="background-color:#1d232f;">
                                    ...
                                    <img class="my-2.5" src="https://www.musora.com/cdn-cgi/image/width=430,quality=95/https://dpwjbsxqtam5n.cloudfront.net/sales/about/DrumLesson.jpg" alt="timeline">
                            ...
                            <div class="timeline-line relative px-1.5 lg:px-2.5">
                                <div class="relative z-10 rounded-xl text-center py-3" style="background-color:#1d232f;">
                                    ...
                                    <img class="my-2.5" src="https://www.musora.com/cdn-cgi/image/width=430,quality=95/https://dpwjbsxqtam5n.cloudfront.net/sales/about/Drumeo.jpg" alt="timeline">
                            ...
                            <div class="relative px-1.5 lg:px-2.5">
                                <div class="relative z-10 rounded-xl text-center py-3" style="background-color:#1d232f;">
                                    ...
                                    <img class="my-2.5" src="https://www.musora.com/cdn-cgi/image/width=430,quality=95/https://dpwjbsxqtam5n.cloudfront.net/sales/about/musora.png" alt="timeline">
        ...
        <div class="container mx-auto max-w-6xl">
            ...
            <div class="flex flex-wrap sm:flex-nowrap">
                <div class="mb-4 sm:mb-0 w-full sm:w-1/3 px-3">
                    ...
                    <img class="h-40 sm:h-auto lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=1100,quality=95/https://dmmior4id2ysr.cloudfront.net/homepage/2021/pianote-graphic.png">
                </div>
                <div class="mb-4 sm:mb-0 w-full sm:w-1/3 px-3">
                    ...
                    <img class="h-40 sm:h-auto lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=1100,quality=95/https://dmmior4id2ysr.cloudfront.net/homepage/2021/guitareo-graphic.png">
                </div>
                <div class="w-full sm:w-1/3 px-3">
                    ...
                    <img class="h-40 sm:h-auto lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=1100,quality=95/https://dmmior4id2ysr.cloudfront.net/homepage/2021/singeo-graphic.png">
                </div>
            </div>
        </div>
    </section>
                        ...
                        <div class="flip-div teacher inline-block relative w-full group" style="perspective: 1000px;">
                            <div class="text-center w-full h-full absolute cursor-pointer" style="transform-style: preserve-3d;">
                                <div class="front absolute z-20 overflow-hidden rounded-xl w-full h-full transition-transform duration-700" style="backface-visibility: hidden;">
                                    <div class="bg-image w-full bg-black bg-top bg-cover absolute left-0 top-0 img-toggle opacity-0 transition-all duration-700 active lazyload" data-bg="https://www.musora.com/cdn-cgi/image/width=1000,quality=95/{{ $altSlide['image'] }}"></div>
                                    <div class="bg-image w-full bg-black bg-top bg-cover absolute left-0 top-0 img-toggle opacity-0 transition-all duration-700 lazyload" data-bg="https://www.musora.com/cdn-cgi/image/width=1000,quality=95/{{ $altSlide['image2'] }}"></div>
                        ...
                        <div class="mx-auto" style="max-width:215px">
                            <div class="flip-div inline-block relative w-full group" style="perspective: 1000px;">
                                <div class="text-center w-full h-full absolute" style="transform-style: preserve-3d;">
                                    <div class="front absolute z-20 overflow-hidden rounded-xl w-full h-full transition-transform duration-700" style="backface-visibility: hidden;">
                                        <div class="bg-image w-full bg-black bg-top bg-cover lazyload" data-bg="https://www.musora.com/cdn-cgi/image/width=600,quality=95/{{ $slide['image'] }}"></div>
                                        <div class="absolute uppercase w-full bottom-3 lg:bottom-4 z-10 text-shadow-4">
    ...
    <section class="text-white text-center relative z-10 overflow-hidden px-4 md:px-5 py-8 md:py-20 bg-cover bg-center lazyload" data-bg="https://www.musora.com/cdn-cgi/image/width=2000,quality=95/https://dpwjbsxqtam5n.cloudfront.net/sales/about/Order_BG.jpg">
