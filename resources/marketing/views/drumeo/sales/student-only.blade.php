        ...
        <div class="container mx-auto">
            <div class="sm:flex mx-auto items-center text-center" style="max-width: 890px;">
                ...
                <div class="md:text-left px-2 md:pl-8 lg:pl-10">
                    <h6 class="leading-normal mb-3"><strong>Musora Students</strong> To thank you for already being a Musora student, you’ll save {{ round(100 - (100 * (197 / Prices::$plusSubscriptionAnnualFull))) }}% when you add a Drumeo membership to your existing account. (Normally ${{ Prices::$plusSubscriptionAnnualFull }} per year, yours for just $197.)</h6>
    ...
    <a href="#customize-anchor" class="promo-banner bg-black w-full py-1 mx-auto -mt-10 block z-10 whitespace-nowrap shadow-md overflow-hidden leading-none text-xs transition-colors duration-300 text-center text-white hover:text-gray-50 bg-black text-white">
        <div class="container mx-auto">
            <div class="text text-center">
                <p class="leading-tight uppercase"><strong>Musora Students Join Drumeo<br> For Just <s class="opacity-60">${{ Prices::$plusSubscriptionAnnualFull }}</s> $197 per year</strong></p>
            </div>
        </div>
    </a>
@endsection
...
@section('comparison')
    <td><s>${{ Prices::$plusSubscriptionAnnualFull }}</s> <strong>$197</strong><br>PER YEAR</td>
@endsection
...
@section('final')
    ...
    <section class="content-section grey text-center customize trial" style="background-color:#000;">
        <div class="container mx-auto">
            ...
            <h1 class="uppercase text-2xl md:text-4xl lg:text-5xl"><strong>{{ round(100 - (100 * (197 / Prices::$plusSubscriptionAnnualFull))) }}%-OFF MUSORA DISCOUNT</strong></h1>
            <h2 class="mt-4 md:mt-7"><strong>Join Drumeo for just<br class="inline md:hidden"> <s class="opacity-60">${{ Prices::$plusSubscriptionAnnualFull }}</s> <span class="text-drumeo">$197</span> per year.</strong></h2>
