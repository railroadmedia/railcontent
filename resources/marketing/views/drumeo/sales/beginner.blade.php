...
@section('final')
    ...
    <section class="content-section grey text-center customize trial" style="background-color:#000;">
        <div class="container mx-auto">
            ...
            <br>
            <a class="join" href="{{ URL::Route('shopping-cart.to-cart.api') }}?products[DLM]=1,year,1&products[practicepad]=1&products[Drumeo-VaterSticks]=1&locked=true">Click Here To Get Started &raquo;</a>
