...
@section('global-body')
    ...
    @endif
    <a href="/new-piano-players" class="flex items-center justify-center py-1.5 px-2 sm:px-0 w-full z-[100]" style="background: linear-gradient(330deg, #05937C 0%, #007DD8, #9AFF89 100%);">
