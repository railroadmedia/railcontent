...
@section('global-body')
    ...
    @php
        $songItems = [
            ...
            [
                'icon' => 'https://d21q7xesnoiieh.cloudfront.net/fit-in/100x0/filters:quality(95)/marketing/pianote/membership/homepage/2023/play-it-right-icon.svg',
    ...
    @include('musora.sales.components.songs-section', [
        ...
        'video' => 'https://d21q7xesnoiieh.cloudfront.net/fit-in/1200x0/filters:quality(95)/marketing/pianote/membership/homepage/2023/device.png',
        'brandName' => 'Pianote',
...
{{--    @include('pianote.sales.headphones-section')--}}
    ...
    @include('musora.sales.components.app-section', [
        'image' => 'https://d21q7xesnoiieh.cloudfront.net/fit-in/0x0/filters:quality(95)/marketing/pianote/membership/homepage/2023/devices.png',
