...
@section('global-body')
    ...
    @endif
    <a href="/shop/30-day-blues-piano" class="flex text-white items-center justify-center py-1.5 px-2 sm:px-0 w-full z-[100]" style="background: linear-gradient(to bottom, #f41a30, #79080b);">
