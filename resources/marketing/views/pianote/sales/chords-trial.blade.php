        ...
        <div class="container max-w-5xl mx-auto">
            ...
            <div class="text-left flex flex-wrap sm:flex-nowrap justify-center items-start mb-5">
                <p class="leading-normal max-w-xl pr-5 lg:pr-8 mx-0">Chords and Scales are the building blocks of ALL music. Sign up for a free 7-day trial of Pianote and we’ll ship you our best-selling Chords & Scales book FREE of charge. No matter where you live in the world.
                    ...
                    <br>
                    <a class="join smaller musora my-3 w-1/2" href="/ecommerce/add-to-cart?products[PIANOTE-MEMBERSHIP-TRIAL-7-DAY-ANNUAL]=1&products[piano-chords-and-scales-guide]=1&promo-code=annual-trial&redirect=/order&locked=true">GET Started &raquo;</a>
                    <br>
    ...
    <section class="py-14 sm:py-20 lg:py-24 relative overflow-hidden text-white text-center customize px-4 lg:px-6"
            ...
            <div class="container mx-auto max-w-6xl relative z-50">
                <div class="w-full">
                    ...
                    <a class="join {{ $theme }} my-4 md:my-6 w-full max-w-xs md:max-w-lg lg:max-w-xl" style="padding: 20px 10px;" href="/ecommerce/add-to-cart?products[PIANOTE-MEMBERSHIP-TRIAL-7-DAY-ANNUAL]=1&products[piano-chords-and-scales-guide]=1&promo-code=annual-trial&redirect=/order&locked=true">CLICK HERE TO GET STARTED</a>
                </div>
