<nav class="top-bar">
    <div class="logo">
        <a href="{{ get_legacy_brand_base_url('pianote') }}">
            <img src="https://www.musora.com/musora-cdn/image/width=250,quality=85/https://pianote.s3.amazonaws.com/logo/pianote-logo-red.png" alt="Pianote">
        </a>
    </div>
    ...
    @if(!empty($cartVersion))
        <div class="button-wrap" id="app">
            <a href="{{ !empty($product) && $product->is_seasonal ? get_legacy_brand_base_url('musora').'/merch' : get_legacy_brand_base_url('pianote').'/shop' }}" class="join outline-button hover:no-underline">Shop</a>
