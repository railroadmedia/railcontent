...
{{--                    <a class=" @if(strpos(url()->full(), 'choose-plan')) active @endif" href="{{ get_legacy_brand_base_url('pianote') }}/choose-plan" >Pricing</a>--}}
                    ...
                    @else
                        <a style="color: #b30c15;" class="@if(strpos(url()->full(), 'shop')) active @endif" href="{{ get_legacy_brand_base_url('pianote') }}/shop" ><div class="hidden lg:inline">Cyber Monday</div> Deals</a>
                    @endif
