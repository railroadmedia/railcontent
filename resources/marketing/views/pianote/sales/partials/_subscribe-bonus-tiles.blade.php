    ...
    <div class="container max-w-6xl mx-auto relative z-50">
        <div class="flex flex-wrap items-center">
            <div class="text-center sm:text-left w-full sm:w-1/2 lg:w-5/12 sm:pl-5">
                ...
                <h4 class="leading-tight mt-2 md:mt-3"><strong>Start playing beautiful music <br> for just <span class="text-pianote">${{ round((PianotePrices::$pianoteMembershipAnnualRegular / 12), 2) }}</span> a month.</strong></h4>
                <p class="leading-tight mx-auto inline-block my-4 md:my-5"><em>Billed at ${{ PianotePrices::$pianoteMembershipAnnualRegular }} per year.</em></p>
                <div class="w-full mx-auto sm:mx-0">
                    ...
                    <p class="text-center text-sm text-gray-300">
                        <em><a href="/ecommerce/add-to-cart?products[PIANOTE-MEMBERSHIP-1-MONTH]=1&redirect=%2Forder">Or start a monthly membership <br class="inline sm:hidden"> for ${{ PianotePrices::$pianoteMembershipMonthlyRegular }}/month.</a></em>
                    </p>
                </div>
            </div>
