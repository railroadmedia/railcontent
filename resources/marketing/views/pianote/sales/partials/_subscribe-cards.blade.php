...
<section class="content-section text-center customize relative z-50 overflow-hidden" style="background: linear-gradient(to bottom, #01050f 40%, #02152a);">
    <div class="container mx-auto">
        ...
        <h2 class="my-3 md:my-5 leading-normal"><strong>Start learning piano <br>for just <span class="text-pianote">${{ round((PianotePrices::$pianoteMembershipAnnualRegular / 12), 2) }}</span> a month.</strong></h2>
        ...
        {{--@if(PianotePrices::$pianoteMembershipMonthlyFull > PianotePrices::$pianoteMembershipMonthlyRegular)--}}
        {{--<s class="opacity-60">${{ PianotePrices::$pianoteMembershipMonthlyFull }}</s>--}}
        {{--@endif--}}
        {{--<strong>${{ PianotePrices::$pianoteMembershipMonthlyRegular }}</strong></h1> <p class="inline-block -mr-16">per month</p>--}}
        ...
        {{--<h1 class="inline-block leading-none">--}}
        {{--@if(PianotePrices::$pianoteMembershipAnnualFull > PianotePrices::$pianoteMembershipAnnualRegular)--}}
        {{--<s class="opacity-60">${{ PianotePrices::$pianoteMembershipAnnualFull }}</s>--}}
        {{--@endif--}}
        {{--<strong>${{ PianotePrices::$pianoteMembershipAnnualRegular }}</strong></h1><p class="inline-block -mr-5">per year</p>--}}
        {{--<p class="text-pianote text-sm my-4"><em>Save {{ round(100 - (100 * (PianotePrices::$pianoteMembershipAnnualRegular / PianotePrices::$pianoteMembershipAnnualFull))) }}%</em></p>--}}
        {{--<div class="join smaller w-full transition-opacity duration-300 group-hover:opacity-80" style="max-width: 230px;">Get Started</div>--}}
        {{--</div>--}}
        {{--<div class="px-3 pt-5 md:pt-6 pb-9 md:pb-10" style="background: #f1f8ff;border-top: 2px solid #e6f2ff;">--}}
        ...
        {{--</div>--}}
        {{--<div class="w-full md:w-1/2 px-2 md:px-3 relative">--}}
        {{--<p class="w-full px-4 pt-2 pb-4 -mb-3 --}}{{----}}{{----}}{{----}}{{--bg-guitareo--}}{{----}}{{----}}{{----}}{{-- text-black rounded-t-2xl" style="background: linear-gradient(to bottom, #feab01, #fd7a00);"><strong>ONLY <s class="opacity-60">50</s> {{ $products['PIANOTE-MEMBERSHIP-LIFETIME']->getStock() }} SPOTS LEFT!</strong></p>--}}
        ...
        {{--<h1 class="inline-block leading-none">--}}
        {{--@if(PianotePrices::$pianoteMembershipLifetimeFull > PianotePrices::$pianoteMembershipLifetime)--}}
        {{--<s class="opacity-60">${{ PianotePrices::$pianoteMembershipLifetimeFull }}</s>--}}
        {{--@endif--}}
        {{--<strong>${{ PianotePrices::$pianoteMembershipLifetime }}</strong></h1>--}}
        ...
        {{--</div>--}}
        {{--</div>--}}
        <h4 class="leading-tight mt-5 md:mt-7 lg:mt-10"><strong>Billed annually at ${{ PianotePrices::$pianoteMembershipAnnualRegular }} per year.</strong></h4>
        <a class="join bigger" href="{{ $annualLink }}">Get Started &raquo;</a>
        <br><br class="inline-block md:hidden">
        <a class="text-drumeo monthly-alt" href="/ecommerce/add-to-cart?products[PIANOTE-MEMBERSHIP-1-MONTH]=1&redirect=%2Forder"><p><u><em>Or start a monthly membership for <br class="inline-block md:hidden">${{ PianotePrices::$pianoteMembershipMonthlyRegular }}/month.</em></u></p></a>
    </div>
</section>
