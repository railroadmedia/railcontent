    ...
    <section
        ...
        <div class="container mx-auto max-w-5xl">
            ...
            <div class="px-3 mx-auto w-full max-w-2xl">
                ...
                <a class="join pianote my-4 sm:my-6 w-full max-w-md uppercase" href="/ecommerce/add-to-cart?products[PIANOTE-MEMBERSHIP-1-YEAR]=1&products[pianote-new-years-bundle]=1&promo-code=NYPHP25,new-year&locked=true">Save 20%</a>
