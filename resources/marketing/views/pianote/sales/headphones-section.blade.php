    ...
    <section class="py-12 md:py-20">
        <div class="max-w-4xl mx-auto text-center px-4 lg:px-0">
            ...
            <div class="flex flex-wrap sm:flex-nowrap items-center justify-center text-left my-6 sm:my-8">
                <div class="block rounded-xl bg-contain bg-center w-full sm:w-1/2 pb-72 sm:pb-96 lg:py-48 mb-4 sm:mb-0 bg-no-repeat" style="background-image:url(https://www.musora.com/musora-cdn/image/width=900,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/promos/anniversary/2023/headphones-collage.png);"></div>
...
{{--            <p class="leading-tight mt-2 sm:mt-3 mb-6">Scroll down to see everything that’s included.</p>--}}
            <img
                ...
                src="https://www.musora.com/musora-cdn/image/width=1200,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/products/concert-headphones/montage-04.png"
                alt="montage 4"
...
{{--                <img class="w-full md:w-2/3 rounded-xl md:pr-1 mb-2" src="https://www.musora.com/musora-cdn/image/width=900,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/products/concert-headphones/montage-01.jpg" alt="montage 1">--}}
{{--                <img class="w-1/2 md:w-1/3 rounded-xl md:pl-1 mb-2 pr-1 md:pr-0" src="https://www.musora.com/musora-cdn/image/width=500,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/products/concert-headphones/montage-05.jpg" alt="montage 5">--}}
{{--                <img class="w-1/2 md:w-1/3 rounded-xl md:pr-1 mb-2 md:mb-0 pl-1 md:pl-0" src="https://www.musora.com/musora-cdn/image/width=500,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/products/concert-headphones/montage-06.jpg" alt="montage 6">--}}
{{--                <img class="w-full md:w-2/3 rounded-xl md:pl-1" src="https://www.musora.com/musora-cdn/image/width=900,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/products/concert-headphones/montage-02.jpg" alt="montage 2">--}}
{{--            </div>--}}
{{--            <div class="relative">--}}
{{--                <img class="rounded-xl" src="https://www.musora.com/musora-cdn/image/width=1200,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/products/concert-headphones/montage-03.png" alt="montage 3">--}}
