...
@section('global-body')
    ...
    <section class="trailer-section text-center">
        <div class="container mx-auto">
            <p><img src="https://d2vyvo0tyx8ig5.cloudfront.net/app/pianote-app-icon.png"> The New Pianote App</p>
            ...
            <div class="ipad-phone">
                <img src="https://d2vyvo0tyx8ig5.cloudfront.net/app/header.png">
    ...
    <section class="learn-play-watch text-center">
        <div class="container mx-auto clearfix">
            <div class="float-left w-full topic-wrap learn">
                ...
                <img src="https://d2vyvo0tyx8ig5.cloudfront.net/app/learn.png">
            </div>
            <div class="float-left w-full topic-wrap watch">
                ...
                <img src="https://d2vyvo0tyx8ig5.cloudfront.net/app/practice.png">
            </div>
            <div class="float-left w-full topic-wrap play">
                ...
                <img src="https://d2vyvo0tyx8ig5.cloudfront.net/app/play.png">
            </div>
            <div class="float-left w-full topic-wrap connection">
                ...
                <img src="https://d2vyvo0tyx8ig5.cloudfront.net/app/no-connection.png">
            </div>
        </div>
    </section>
