               ...
               {{-- @if($stock > 0) --}}
                    <h2 class="leading-none my-4 md:my-6">
                        ...
                        @else
                            ...
                            <a class="text-white underline" href="/ecommerce/add-to-cart?products[PIANOTE-MEMBERSHIP-LIFETIME-3-pay]=1&products[LTM-songs-access-3-years]=1&promo-code=lifetime-3yr-songs,lifetime-existing-3p&locked=true"><p class="leading-tight text-sm pt-4"><em>Prefer a payment plan? Click here to order with 3 monthly payments.</em></p></a>
                @endif
               {{-- @else
