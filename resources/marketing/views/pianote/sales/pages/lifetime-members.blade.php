...
@section('global-body')
    ...
    {{--<img class="logo"--}}
    {{--src="https://www.musora.com/musora-cdn/image/width=200,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/promos/march/logo.png">--}}
    {{--<p>--}}
        ...
        <div class="container mx-auto">
            ...
            <div class="w-full mx-auto mt-10 mb-20 px-3" style="max-width:920px;">
                <img
                    ...
                    src="https://www.musora.com/musora-cdn/image/width=1300,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/promos/anniversary/2023/thumb.jpg"
                    alt="Video thumbnail"
                    loading="lazy"
...
{{--                    <img class="w-full rounded-xl mb-2 cursor-pointer autoplay-video lazyloaded" data-src="https://www.musora.com/musora-cdn/image/width=1200,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/products/concert-headphones/montage-04.png" alt="montage 4" data-open="unbox" aria-haspopup="true" tabindex="0" src="https://www.musora.com/musora-cdn/image/width=1200,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/products/concert-headphones/montage-04.png">--}}
{{--                </div>--}}
{{--            </div>--}}
        </div>
    </section>
    <section class="text-center text-white py-10 md:py-20 lg:py-24 px-4 md:px-6 relative overflow-hidden" style="background:#020610;">
        <div class="container mx-auto z-10 relative max-w-4xl">
            ...
            <div class="flex flex-wrap sm:flex-nowrap items-center justify-center">
                ...
                <img class="mb-4 sm:mb-0 order-0 sm:order-1 w-36 sm:w-72 lg:w-80" src="https://www.musora.com/musora-cdn/image/width=650,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/promos/june/Live_Chat_Screen.png" alt="Lisa">
            </div>
        </div>
    </section>
