...
@section('promo-banner')
    <header class="text-center text-white" style="background-color:#0e1213;">
        <div class="container relative mx-auto px-2 md:px-0 pb-7 md:pb-12 lg:pb-16 pt-3 lg:pt-5 bg-cover bg-top" style="background-image:url(https://www.musora.com/musora-cdn/image/width=1920,quality=85/q_auto:best/https://d2vyvo0tyx8ig5.cloudfront.net/sales/trials/roland/header.jpg);">
