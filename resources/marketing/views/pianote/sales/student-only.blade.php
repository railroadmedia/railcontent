        ...
        <div class="container mx-auto">
            <div class="sm:flex mx-auto items-center text-center" style="max-width: 890px;">
                ...
                <div class="md:text-left px-2 md:pl-8 lg:pl-10">
                    <h6 class="leading-normal"><strong>Musora Students</strong> To thank you for already being a Musora student, you’ll save {{ round(100 - (100 * (147 / Prices::$pianoteMembershipAnnualFull))) }}% when you add a Pianote membership to your existing account. (Normally ${{ Prices::$pianoteMembershipAnnualFull }} per year, yours for just $147.)</h6>
                </div>
            </div>
        </div>
    </div>
    <a href="#customize-anchor" style="background:#0c1429;"
        ...
        <div class="container mx-auto">
            <div class="text text-center">
                <p class="leading-tight uppercase"><strong>Musora Students Join Pianote<br> For Just <s class="opacity-60">${{ Prices::$pianoteMembershipAnnualFull }}</s> $147 per year</strong></p>
            </div>
        </div>
    </a>
@endsection
...
@section('comparison')
    <td><s>${{ Prices::$pianoteMembershipAnnualFull }}</s> <strong>$147</strong><br>PER YEAR</td>
@endsection
...
@section('final')
    ...
    <section class="content-section grey text-center customize trial" style="background-color:#000;">
        <div class="container mx-auto">
            ...
            <h1 class="font-roboto uppercase text-2xl md:text-4xl lg:text-5xl"><strong>{{ round(100 - (100 * (147 / Prices::$pianoteMembershipAnnualFull))) }}%-OFF MUSORA DISCOUNT</strong></h1>
            <h2 class="mt-4 md:mt-7"><strong>Join Pianote for just<br class="inline md:hidden"> <s class="opacity-60">${{ Prices::$pianoteMembershipAnnualFull }}</s> <span class="text-pianote">$147</span> per year.</strong></h2>
