...
@section('global-body')
    ...
    <header class="text-center px-5 sm:px-6 py-16 sm:py-24 lg:py-32 relative overflow-hidden text-white bg-cover bg-center"
        ...
        <div class="container max-w-6xl mx-auto relative z-20">
            ...
            <h6 class="font-bold my-5 sm:my-6"><em>Reach your musical goals with Pianote.</em></h6>
            <p class="text-sm leading-normal mb-5 lg:mb-7">
                <i class="fas fa-check text-{{ $theme }}"></i> Song Breakdowns
                <i class="fas fa-check lg:ml-5 text-{{ $theme }}"></i> Unlimited Piano Lessons
                <br class="sm:hidden">
            ...
            <div class="flex flex-wrap text-left">
                <div class="flex flex-wrap items-start justify-center text-left mb-2 sm:mb-0 w-full sm:w-1/2">
                    <div class="flex flex-wrap items-start w-full sm:px-3 mb-5 sm:mb-8" x-data="{ open: false }">
                        <div class="pb-[70%] sm:pb-[60%] overflow-hidden text-white relative w-full rounded-xl opacity-100" :class="{'opacity-0': !lazyLoad, 'opacity-100': lazyLoad}" x-intersect.once="lazyLoad = true; $refs.image.src = $refs.image.dataset.src;">
                            <picture class="absolute inset-0 w-full h-full object-cover bg-center rounded-xl" style="background: linear-gradient(180deg, transparent, rgba(246, 248, 252, 0.9));">
                                <source srcset="https://d21q7xesnoiieh.cloudfront.net/fit-in/980x0/filters:quality(95)/marketing/pianote/membership/welcome-back/1.webp" media="(min-width: 640px)">
                                <img x-ref="image" data-src="https://d21q7xesnoiieh.cloudfront.net/fit-in/980x0/filters:quality(95)/marketing/pianote/membership/welcome-back/1.webp" alt="Handy Practice Tools" class="w-full h-full object-cover rounded-xl transition-opacity" onload="this.classList.remove('opacity-0')">
                            </picture>
                    ...
                    <div class="flex flex-wrap items-start w-full sm:px-3 mb-5 sm:mb-8" x-data="{ open: false }">
                        <div class="pb-[70%] sm:pb-[80%] overflow-hidden text-white relative w-full rounded-xl opacity-100" :class="{'opacity-0': !lazyLoad, 'opacity-100': lazyLoad}" x-intersect.once="lazyLoad = true; $refs.image.src = $refs.image.dataset.src;">
                            <picture class="absolute inset-0 w-full h-full object-cover bg-center rounded-xl" style="background: linear-gradient(180deg, transparent, rgba(246, 248, 252, 0.9));">
                                <source srcset="https://d21q7xesnoiieh.cloudfront.net/fit-in/980x0/filters:quality(95)/marketing/pianote/membership/welcome-back/3.webp" media="(min-width: 640px)">
                                <img x-ref="image" data-src="https://d21q7xesnoiieh.cloudfront.net/fit-in/980x0/filters:quality(95)/marketing/pianote/membership/welcome-back/3.webp" alt="Step-By-Step Clarity" class="w-full h-full object-cover rounded-xl transition-opacity" onload="this.classList.remove('opacity-0')">
                            </picture>
                            <div class="absolute bottom-0 left-0 right-0 px-4 sm:px-3 lg:px-5 pb-4 lg:pb-7 pt-10 flex items-start">
                                ...
                                <div class="pl-3">
                                    ...
                                    <p class="leading-normal text-sm transition-all duration-300 overflow-hidden max-w-sm mx-0">Get free access to all our latest piano challenges.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex flex-wrap items-start justify-center text-left mb-2 sm:mb-0 w-full sm:w-1/2">
                    <div class="flex flex-wrap items-start w-full sm:px-3 mb-5 sm:mb-8" x-data="{ open: false }">
                        <div class="pb-[70%] sm:pb-[80%] overflow-hidden text-white relative w-full rounded-xl opacity-100" :class="{'opacity-0': !lazyLoad, 'opacity-100': lazyLoad}" x-intersect.once="lazyLoad = true; $refs.image.src = $refs.image.dataset.src;">
                            <picture class="absolute inset-0 w-full h-full object-cover bg-center rounded-xl" style="background: linear-gradient(180deg, transparent, rgba(246, 248, 252, 0.9));">
                                <source srcset="https://d21q7xesnoiieh.cloudfront.net/fit-in/980x0/filters:quality(95)/marketing/pianote/membership/welcome-back/2.webp" media="(min-width: 640px)">
                                <img x-ref="image" data-src="https://d21q7xesnoiieh.cloudfront.net/fit-in/980x0/filters:quality(95)/marketing/pianote/membership/welcome-back/2.webp" alt="World-Class Teachers" class="w-full h-full object-cover rounded-xl transition-opacity" loading="lazy" onload="this.classList.remove('opacity-0')">
                            </picture>
                            <div class="absolute bottom-0 left-0 right-0 px-4 sm:px-3 lg:px-5 pb-4 lg:pb-7 pt-10 flex items-start">
                    ...
                    <div class="pb-[70%] sm:pb-96 overflow-hidden text-white relative w-full rounded-xl opacity-100" :class="{'opacity-0': !lazyLoad, 'opacity-100': lazyLoad}" x-intersect.once="lazyLoad = true">
                        ...
                        <div class="absolute bottom-0 left-0 right-0 px-4 sm:px-5 pb-5 sm:pb-7 pt-10 flex items-start">
                            ...
                            <div class="pl-3">
                                ...
                                <p class="leading-normal text-sm transition-all duration-300 overflow-hidden max-w-sm mx-0">Taking a break on the piano? Try Drums, Guitar, or Singing lessons anytime.</p>
                            </div>
                        </div>
                    </div>
                </div>
