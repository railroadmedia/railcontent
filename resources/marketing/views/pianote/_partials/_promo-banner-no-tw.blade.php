...
{{-- <div class="big-promo-banner text-white text-center lg:text-left uppercase relative py-4" style="background: #000 url(https://drumeo-assets.s3.amazonaws.com/promos/christmas/snow-dark.gif) center center/250px;box-shadow: 0 0 100px inset #000;">
    <div class="row container mx-auto px-3 sm:flex items-center justify-between">
        <a href="/shop/"><img src="https://cdn.musora.com/image/fetch/w_200,q_auto:best/https://pianote.s3.amazonaws.com/sales/promos/christmas/holiday-piano.png"></a>
...
@if(!empty($noBreadcrumb))
    <a href="/shop" class="promo-banner text-center text-white w-full block fixed" style="background: #000 url(https://drumeo-assets.s3.amazonaws.com/promos/christmas/snow-dark.gif) center center/250px;box-shadow: 0 0 100px inset #000;">
