...
@section('global-head')
    ...
    <meta property="og:image" content="https://www.musora.com/cdn-cgi/image/width=1200,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/products/the-power-of-chords/share-image.jpg">
        ...
        <div class="max-w-5xl mx-auto md:flex relative items-center px-4">
            <div class="flex-1 text-center lg:text-right">
                <div class="md:inline-block text-center md:text-left">
                    <img class="h-20 md:h-24 mb-6 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=400,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/products/the-power-of-chords/Logo_left.png" alt="logo left">
...
{{--                            <a class="join small w-full text-base" href="@yield('order-link')">get started</a>--}}
                        ...
                        <div class="flex-1 flex items-center pl-2">
                            <img class="h-6 mr-1 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=80,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/products/the-power-of-chords/profiles.png" alt="profiles">
            ...
            <div class="flex-1 text-center md:pl-6 lg:pl-0">
                <div class="inline-block relative max-w-lg">
                    <img class="hidden md:inline-block rounded-xl cursor-pointer header-thumb lazyload autoplay-video" data-src="https://www.musora.com/cdn-cgi/image/width=760,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/products/the-power-of-chords/header_thumb.png" data-open="sample" alt="header thumb">
                    <img class="md:hidden rounded-xl mb-6 cursor-pointer lazyload autoplay-video" data-src="https://www.musora.com/cdn-cgi/image/width=800,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/products/the-power-of-chords/header_thumb_m.png" data-open="sample" alt="mobile header thumb">
    ...
    <section class="py-10 md:py-20 relative px-4 lg:px-0">
        <div class="max-w-5xl mx-auto md:flex relative z-40">
            ...
            <div class="flex-1 md:pl-4 lg:pl-10 text-center">
                <img class="music-sheet -mb-16 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=1050,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/products/the-power-of-chords/sheet_music.png" alt="sheet music">
            </div>
        </div>
                    ...
                    @if($step['position'] === 'right')
                        <div class="timeline relative flex flex-col-reverse md:grid md:grid-cols-2 {{--gap-2 md:gap-12 lg:gap-20--}} mb-16 md:mb-0 md:mb-16 lg:mb-28 pl-6 md:pl-0">
                            ...
                            <div class="pl-1 md:pl-9 lg:pl-10">
                                <img class="timeline-img rounded-xl lazyload mb-4 md:mb-0" data-src="https://www.musora.com/cdn-cgi/image/width=800,quality=95/{{ $step['img'] }}" alt="step {{$key+1}}" />
                            </div>
                        </div>
                    @else
    ...
    <section class="pt-10 md:pt-20 pb-20 md:pb-40 relative">
        <div class="max-w-xl md:max-w-5xl mx-auto">
            ...
            <div class="md:flex gap-5 px-4">
                ...
                <div class="flex-1 mb-10 md:mb-0">
                    <div class="bg-cover bg-top w-full aspect-16:9 rounded-xl mb-4 lazyload shadow-md" data-bg="https://www.musora.com/cdn-cgi/image/width=690,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/products/the-power-of-chords/downloadable.jpg"></div>
                    <h5 class="font-extrabold mb-2">
                ...
                <div class="flex-1">
                    <div class="bg-cover bg-top w-full aspect-16:9 rounded-xl mb-4 lazyload shadow-md" data-bg="https://www.musora.com/cdn-cgi/image/width=690,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/products/the-power-of-chords/personal_support.jpg"></div>
                    <h5 class="font-extrabold mb-2">
                        Personal Support
                    </h5>
                    <p style="color:#2A2F34;">
