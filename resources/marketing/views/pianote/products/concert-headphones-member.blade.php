...
@section('global-head')
    ...
    <style>
        ...
        .header-bg {
            background-image: url('https://www.musora.com/musora-cdn/image/width=500,quality=85/https://pianote.s3.amazonaws.com/products/concert-headphones/header-m.jpg');
        }
        ...
        @media (min-width: 768px) {
            .header-bg {
                background-image: url('https://www.musora.com/musora-cdn/image/width=1800,quality=85/https://pianote.s3.amazonaws.com/products/concert-headphones/header.png');
...
@section('global-body')
    ...
    <section class="py-4 md:py-10 bg-center bg-cover bg-no-repeat header-bg bg-black">
        <div class="max-w-md md:max-w-2xl mx-auto text-center px-2 md:px-0">
            <img class="h-20 md:h-40 mb-0.5 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=600,quality=85/https://pianote.s3.amazonaws.com/products/concert-headphones/logo-header.png" alt="headphone logo">
    ...
    <section class="pt-12 md:pt-20 pb-48">
        <div class="max-w-2xl mx-auto text-center px-4 md:px-0">
            ...
            <div class="relative max-w-sm md:max-w-md lg:max-w-lg mx-auto">
                <img class="absolute left-0 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=800,quality=85/https://pianote.s3.amazonaws.com/products/concert-headphones/headphones-overlap.png" alt="headphone">
            </div>
        </div>
    </section>
    ...
    <section class="pb-12 md:py-20 lg:py-0 bg-black">
        <div class="max-w-4xl mx-auto md:flex md:items-center">
            <div class="order-1 flex-1 mb-6 md:mb-0">
                <img class="lazyload" data-src="https://www.musora.com/musora-cdn/image/width=700,quality=85/https://pianote.s3.amazonaws.com/products/concert-headphones/feature-01.jpg" alt="feature 1">
                <img class="lazyload" data-src="https://www.musora.com/musora-cdn/image/width=700,quality=85/https://pianote.s3.amazonaws.com/products/concert-headphones/feature-02.jpg" alt="feature 2">
            </div>
    ...
    <section class="py-12 md:py-20">
        <div class="max-w-4xl mx-auto text-center px-4 lg:px-0">
            ...
            <img class="rounded-xl mb-2 cursor-pointer lazyload autoplay-video" data-src="https://www.musora.com/musora-cdn/image/width=1200,quality=85/https://pianote.s3.amazonaws.com/products/concert-headphones/montage-04.png" alt="montage 4" data-open="unbox">
            <div class="flex flex-wrap mb-2">
                <img class="w-full md:w-2/3 rounded-xl md:pr-1 mb-2 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=900,quality=85/https://pianote.s3.amazonaws.com/products/concert-headphones/montage-01.jpg" alt="montage 1">
                <img class="w-1/2 md:w-1/3 rounded-xl md:pl-1 mb-2 pr-1 md:pr-0 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=500,quality=85/https://pianote.s3.amazonaws.com/products/concert-headphones/montage-05.jpg" alt="montage 5">
                <img class="w-1/2 md:w-1/3 rounded-xl md:pr-1 mb-2 md:mb-0 pl-1 md:pl-0 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=500,quality=85/https://pianote.s3.amazonaws.com/products/concert-headphones/montage-06.jpg" alt="montage 6">
                <img class="w-full md:w-2/3 rounded-xl md:pl-1 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=900,quality=85/https://pianote.s3.amazonaws.com/products/concert-headphones/montage-02.jpg" alt="montage 2">
            </div>
            <div class="relative">
                <img class="rounded-xl lazyload" data-src="https://www.musora.com/musora-cdn/image/width=1200,quality=85/https://pianote.s3.amazonaws.com/products/concert-headphones/montage-03.png" alt="montage 3">
    ...
    <section class="py-6 md:py-8" style="background-color:#f6f7f9;">
        <div class="max-w-xl mx-auto text-center px-4 lg:px-0">
            ...
            <img class="w-full rounded-xl my-3 sm:my-5 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=900,quality=85/https://pianote.s3.amazonaws.com/products/concert-headphones/estyschmitz.jpg" alt="Testimonial">
...
{{--        <a href="/new-year#customize-anchor" class="text-pianote"><h6><strong><u>OR FREE WITH A PIANOTE MEMBERSHIP</u></strong></h6></a>--}}
    ...
    <div class="reveal large relative coach-wrap rounded-xl select-none max-w-xs md:max-w-md" id="specsModal" data-reveal data-reset-on-close="false" style="max-width:510px">
        <div class="relative rounded-t-lg pb-56 md:pb-96 bg-top md:bg-center bg-cover bg-black lazyload" data-bg="https://www.musora.com/musora-cdn/image/width=1100,quality=85/https://pianote.s3.amazonaws.com/products/concert-headphones/specs_image.jpg"></div>
