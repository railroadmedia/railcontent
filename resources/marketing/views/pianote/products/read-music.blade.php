            ...
            <div class="flex flex-col container max-w-5xl mx-auto px-4">
                <div class="flex flex-col-reverse md:flex-row items-center w-full lg:pt-10">
                    <div class="w-full md:w-7/12 lg:w-1/2 text-justify px-6 lg:px-6">
                        ...
                        <p class="leading-normal">Read Music in 30 Days is an online Challenge that will have you reading and playing music each day.  <br><br>
                            Enroll before June 23rd and you’ll also get the Read Music in 30 Days Companion Book for FREE (with free shipping). <br><br>
                            TThis 74-page book has every exercise used in the course PLUS a reference guide, practice notes for each day, and a ton of bonus sight-reading exercises. <br><br>
                            ...
                            Or -- choose the Annual Membership and you’ll get the book along with 7 other bonuses ($364 value).
                        </p>
                    </div>
