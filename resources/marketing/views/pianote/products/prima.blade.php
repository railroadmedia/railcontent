        ...
        <div class="container mx-auto z-10 relative max-w-5xl">
            ...
            @php
                $items = [
                    ...
                    'desc' => 'With four distinct metronomes, the Prima helps you develop a strong sense of rhythm, a critical skill for every pianist.<br><br>Choose from different metronomes to keep your practice engaging and help you stay on beat, no matter what style of music you’re playing.',
                    ],
                ];
            @endphp
