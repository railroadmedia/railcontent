    ...
    <a href="@yield('order-link')" class="artist-promo-banner fixed">
        <div class="noise-wrap">
            <div class="container">
                ...
                <div class="text">
                    <p><strong class="text-yellow">Beatles Fans</strong><br>Start Today & Save 50%</p>
                </div>
            </div>
        </div>
    </a>
...
@section('albums-url', 'https://d2vyvo0tyx8ig5.cloudfront.net/500-songs/sales/the-beatles-album-covers.png')

@section('name', 'The Beatles')
...
@section('video')
    <iframe class="embed-responsive-item reset-on-close" src="" data-lazy-load-url="//player.vimeo.com/video/441468733?autoplay=1" frameborder="0" allowfullscreen allow="autoplay"></iframe>
@endsection
