...
@section('global-body')
        ...
        <div class="transform -translate-y-1/2 top-1/2 left-0 w-full absolute z-20 px-4 lg:px-6 text-center">
            <div class="container mx-auto max-w-6xl lg:pt-10">
               ...
               <div class="px-3 mx-auto w-full max-w-2xl">
                    <h2 class="leading-none my-1 md:my-4"><s class="opacity-50"> $240</s><strong> $140</strong> <span class="text-[#FF8FB4] text-xl md:text-3xl">(Save 41%)</span></h2>
                    @if($stock > 0)
    ...
    @php
        $videoTargetSkus = ['pianote-membership', 'new-piano-players-start-here', 'easy-chords', '30-day-blues-piano', '30-days-to-better-technique', 'classical-piano-collection'];
    @endphp
