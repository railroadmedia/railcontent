@php
    require_once(resource_path('marketing/views/pianote/products/5-for-3-bundle-data.php'))
@endphp
...
@section('layout-body')
    <header class="py-20 text-center text-white px-4 md:px-0" style="background: linear-gradient(180deg, #DC3848 0%, #5E0239 100%);">
        ...
        <h2 class="leading-tight mb-10"><strong>Get 5 years of Pianote for the price of 3.</strong></h2>
...
{{--        </a>--}}
    ...
    <section class="py-20" style="background: linear-gradient(180deg, #DC3848 0%, #5E0239 100%);">
        <div class="max-w-5xl mx-auto text-center text-white px-4 md:px-0">
            ...
            <h2 class="leading-tight mb-7"><strong>Get 5 years of Pianote for the price of 3.</strong></h2>

            @include('pianote.products.5-for-3-bundle-order-section', [
