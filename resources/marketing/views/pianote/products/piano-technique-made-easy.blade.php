...
@section('global-head')
    ...
    <style>
        ...
        .header {
            color:#fff;
            background:#000c17 top/cover no-repeat;
            position:relative
        }
        ...
        .header:after {
            content:" ";
            z-index:0;
            background:linear-gradient(#0000 50%, #000c17 100%);
            display:block;
            position:absolute;
            inset:0
        }
        ...
        .header p.breakdown {
            margin:0 auto;
            font:400 13px/1.5em Bebas Neue, sans-serif
        }
        ...
        .header p.breakdown .red {
            color:#f61a30
        }

        .header p.breakdown .yellow {
            color:#f6bd52
        }
        ...
        @media (width >= 768px) {
            .five-skills .subnav.stick-to-top {
                background:#05060b;
                margin-top:0;
                position:fixed;
                top:112px;
                left:0;
                right:0;
                box-shadow:0 0 30px 15px #05060b
            }
        }

        .five-skills .subnav .col-xs-12 {
            float:none;
            width:33.33%;
            padding:3px;
            display:inline-block
        ...
        .five-skills .subnav .col-xs-12 .topic-link {
            color:#fff;
            background:#192c3d;
            border-radius:200px;
            width:100%;
        ...
        .five-skills .subnav .col-xs-12 .topic-link:hover, .five-skills .subnav .col-xs-12 .topic-link:focus {
            color:#fff;
            background:#284661;
            text-decoration:none
        }

        .five-skills .subnav .col-xs-12 .topic-link.active {
            background:#f61a30 !important
        }

        .five-skills .text-wrap {
            text-align:left;
            max-width:500px;
        ...
        .five-skills .text-wrap:nth-child(4) {
            margin-top:50px
        }
        ...
        .five-skills .text-wrap:last-child {
            margin-bottom:0
        }

        .five-skills .text-wrap h2 {
            text-align:center;
            margin:0 auto 20px
        }
        ...
        .five-skills .text-wrap p {
            line-height:1.4em
        }

        .five-skills .check-container {
            max-width:800px;
            margin:0 auto
        }

        .five-skills .check-container i {
            margin:0 auto 5px;
            font-size:40px
        }
        ...
        .five-skills .check-container h4 {
            letter-spacing:-.03em;
            margin:0 auto;
        ...
        .every-scale .image-grid-item {
            margin:0 auto 15px
        }

        .every-scale .image-grid-item img {
            border-radius:10px
        }

        .meet-teacher {
            color:#fff;
            background:#000c17 top/750px no-repeat;
            padding:30px 0;
            position:relative
        }
        ...
        .meet-teacher:after {
            content:" ";
            z-index:0;
            background:linear-gradient(#000c17 0%, #0000 5%);
            display:block;
            position:absolute;
            inset:0
        }
        ...
        @media (width >= 768px) {
            .meet-teacher:after {
                background:linear-gradient(#000c17 0%, #0000 10%)
            }
        }

        .meet-teacher .container {
            z-index:2;
            position:relative
        }

        .meet-teacher .text-wrap {
            float:right;
        ...
        .meet-teacher .text-wrap h2 {
            margin:0 auto
        }

        .meet-teacher .text-wrap h1 {
        ...
        .meet-teacher p img.no-color {
            filter:saturate(0) brightness(5)
        }

        .meet-teacher p img.avatar {
            border:4px solid #f61a30;
            border-radius:200px;
            height:70px;
            margin-right:15px
        }
        ...
        .any-device .device-spread .text-arrow {
            font:400 12px/1em Permanent Marker, sans-serif;
            position:absolute;
            top:50%;
            left:50%;
        ...
        .any-device .device-spread .text-arrow img {
            width:20px;
            margin-top:2px
        }
        ...
        .any-device .device-spread .text-arrow img.vertical {
            width:auto;
            height:19px
        }
        ...
        .any-device .device-spread .text-arrow.desktop {
            top:9%;
            left:24%
        }
        ...
        .any-device .device-spread .text-arrow.macbook {
            left:8%
        }
        ...
        .any-device .device-spread .text-arrow.ipad {
            top:28%;
            left:91%
        }
        ...
        .any-device .device-spread .text-arrow.iphone {
            top:63%;
            left:94%
        }
        ...
        .any-device .device-spread .spread {
            width:auto;
            height:134px
        }
        ...
        .smarter-practice {
            color:#fff;
            background:#00111f 50%/cover;
            border-top:4px solid #f61a30;
            padding:40px 0
        }
        ...
        .smarter-practice .song-demo-wrap {
            cursor:pointer;
        ...
        .smarter-practice .song-demo-wrap:hover .fa-play {
            opacity:.8
        }

        .smarter-practice .song-demo-wrap .text-arrow {
            color:#fff;
            font:500 13px/1.3em Permanent Marker, sans-serif;
            position:absolute;
            top:20%;
            right:10%;
        ...
        .smarter-practice .song-demo-wrap .text-arrow img {
            width:20px;
            margin-top:5px
        }
        ...
        .smarter-practice .song-demo-wrap .fa-play {
            cursor:pointer;
            background:#00000080;
            border:3px solid #fff;
            border-radius:200px;
        ...
        .benefits .benefit-tile p strong {
            color:#f61a30;
        ...
        .student-testimonials .testimonials .testimonial {
            border-radius:5px;
            padding:15px 0
        }
        ...
        .student-testimonials .testimonials .testimonial img {
            float:left;
            background:#f61a30;
            border:3px solid #f61a30;
            border-radius:500px;
            height:110px
        }
        ...
        .student-testimonials .testimonials .testimonial .text {
            float:right;
            width:100%;
            padding:20px 0 0
        }
        ...
        .student-testimonials .testimonials .testimonial .text p strong {
            font-weight:800
        }

        .student-testimonials .testimonials .testimonial .text h3 {
            margin:0 auto 15px
        }

        .student-testimonials .testimonials .testimonial .text p {
            line-height:1.5em
        }
        ...
        .final:after {
            content:" ";
            z-index:0;
            background:linear-gradient(#000c17 0%, #0000 50%);
            display:block;
            position:absolute;
            inset:0
        }
        ...
        .final .countdown p {
            ...
            color:#fff;
            margin:25px auto 0;
            font:400 14px/1.2em Bebas Neue, sans-serif
        }
        ...
        .final p.breakdown {
            margin:20px auto 0;
            font:400 13px/1.4em Bebas Neue, sans-serif
        }
        ...
        .final p.breakdown .red {
            color:#f61a30
        }

        .final p.breakdown .yellow {
            color:#f6bd52
        }
