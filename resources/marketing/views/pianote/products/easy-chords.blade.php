...
{{--                <i class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 fas fa-play play-button z-10"></i>--}}
                <img class="rounded-2xl transition-all opacity-0" src="https://d2vyvo0tyx8ig5.cloudfront.net/products/easy-chords/video-thumbnail.jpg" alt="trailer image" loading="lazy" onload="this.classList.remove('opacity-0')" />
