...
@section('global-head')
    ...
    <meta property="og:image" content="https://www.musora.com/cdn-cgi/image/width=1200,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/jesus-molina/fb_share_image.jpg" style="display: none;">
...
@section('global-body')
    ...
    <header class="header text-white relative overflow-hidden z-10" style="background: rgba(38, 13, 15, 0.7);">
        <div class="transform -translate-y-1/2 top-1/2 left-0 w-full absolute z-20 px-4 sm:px-6 text-center">
            <div class="container mx-auto max-w-6xl">
                <img class="h-20 sm:h-28 lg:h-32 mb-64 sm:mb-80" src="https://www.musora.com/cdn-cgi/image/width=900,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/jesus-molina/Logo.png" alt="Improvisation logo">
    ...
    <section class="px-5 sm:px-6 lg:px-10 py-10 md:py-12 md:py-14 text-white text-center overflow-hidden" style="background:linear-gradient(to bottom, #000c17 40%, #1e0816);">
        <div class="container mx-auto max-w-xl lg:max-w-6xl">
            ...
            {{--<img class="mb-2 sm:mb-0 h-10 sm:h-14 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=160,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/jesus-molina/pianote-coaches-logo.png">--}}
    ...
    <section class="px-4 lg:px-6 py-10 md:py-12 md:py-14 text-white text-center overflow-hidden bg-center bg-cover lazyload" style="background-color:#010d17;" data-bg="https://www.musora.com/cdn-cgi/image/width=1500,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/jesus-molina/Thumbnail_BG.jpg">
        <div class="container mx-auto max-w-6xl">
            ...
            <div class="flex flex-wrap items-center text-left mb-3">
                ...
                <div class="w-full sm:w-1/2 px-2 mt-5 sm:mt-0">
                    <div class="rounded-xl overflow-hidden" style="background-color:#061b30;">
                        <div class="relative aspect-16:9 bg-cover bg-center cursor-pointer autoplay-video lazyload" data-open="molinaTrailer" data-bg="https://www.musora.com/cdn-cgi/image/width=1000,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/jesus-molina/what-is-improv-no-play.jpg">
            ...
            <div class="flex flex-wrap text-left mb-3">
                <div class="w-full sm:w-1/2 mb-5 sm:mb-0 px-2">
                    <div class="rounded-xl overflow-hidden" style="background-color:#061b30;">
                        <div class="relative aspect-16:9 bg-cover bg-center lazyload" data-bg="https://www.musora.com/cdn-cgi/image/width=1000,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/jesus-molina/Classical.jpg"></div>
                ...
                <div class="w-full sm:w-1/2 px-2">
                    <div class="rounded-xl overflow-hidden" style="background-color:#061b30;">
                        <div class="relative aspect-16:9 bg-cover bg-center lazyload" data-bg="https://www.musora.com/cdn-cgi/image/width=1000,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/jesus-molina/Jazz_improv.jpg"></div>
            ...
            <div class="flex flex-wrap text-left">
                <div class="w-full sm:w-1/3 mb-5 sm:mb-0 px-2 sm:px-1">
                    <div class="rounded-xl overflow-hidden" style="background-color:#061b30;">
                        <div class="relative aspect-16:9 bg-cover bg-center lazyload" data-bg="https://www.musora.com/cdn-cgi/image/width=700,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/jesus-molina/Latin_improv.jpg"></div>
                        <p class="p-5">Discover the iconic rhythms and melodies unique to Latin music, and how to use them to transform any song.</p>
                    </div>
                </div>
                <div class="w-full sm:w-1/3 mb-5 sm:mb-0 px-2 sm:px-1">
                    <div class="rounded-xl overflow-hidden" style="background-color:#061b30;">
                        <div class="relative aspect-16:9 bg-cover bg-center lazyload" data-bg="https://www.musora.com/cdn-cgi/image/width=700,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/jesus-molina/Stride.jpg"></div>
                ...
                <div class="w-full sm:w-1/3 px-2 sm:px-1">
                    <div class="rounded-xl overflow-hidden" style="background-color:#061b30;">
                        <div class="relative aspect-16:9 bg-cover bg-center lazyload" data-bg="https://www.musora.com/cdn-cgi/image/width=700,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/jesus-molina/Power_ballad.jpg"></div>
    ...
    <section class="px-4 lg:px-6 py-10 md:py-12 md:py-14 text-white text-center" style="background: linear-gradient(to bottom, #000c17 60%, #021124);">
        <div class="container mx-auto max-w-5xl">
            ...
            <div class="flex flex-wrap text-left">
                <div class="w-full sm:w-1/2 mb-5 sm:mb-0 px-2">
                    <div class="rounded-xl overflow-hidden" style="background-color:#061b30;">
                        <div class="relative aspect-16:9 bg-cover bg-center lazyload" data-bg="https://www.musora.com/cdn-cgi/image/width=1000,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/jesus-molina/How_to_practice.jpg"></div>
                ...
                <div class="w-full sm:w-1/2 px-2">
                    <div class="rounded-xl overflow-hidden" style="background-color:#061b30;">
                        <div class="relative aspect-16:9 bg-cover bg-center lazyload" data-bg="https://www.musora.com/cdn-cgi/image/width=1000,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/jesus-molina/Six_month_plan.jpg"></div>
    ...
    {{--</div>--}}
    {{--</div>--}}
    {{--<div class="inset-0 absolute z-0 bg-top bg-cover block sm:hidden lazyload" data-bg="https://www.musora.com/cdn-cgi/image/width=700,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/jesus-molina/Live_BG_mobile.jpg"></div>--}}
    {{--<div class="inset-0 absolute z-0 bg-top bg-cover hidden sm:block lazyload" data-bg="https://www.musora.com/cdn-cgi/image/width=2000,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/jesus-molina/Live_chat.jpg"></div>--}}
    {{--</section>--}}
    ...
    <section class="px-4 sm:px-8 py-10 md:py-12 md:py-14 text-white text-center overflow-hidden bg-musora-black">
        <div class="container mx-auto max-w-5xl">
            ...
            <div class="flex flex-wrap sm:flex-nowrap items-center text-left mb-8 sm:mb-16">
                <img class="h-44 sm:h-56 lg:h-72 mx-auto sm:mx-0 rounded-xl mb-3 sm:mb-0 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=1000,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/jesus-molina/Fully_transcribed_lessons.jpg" alt="Fully transcribed lesson image">
    ...
    <section class="px-6 sm:px-8 py-8 md:py-10 md:py-12 text-white text-center overflow-hidden lazyload" style="background:linear-gradient(to right, #7d182c, #560314);">
        <div class="container mx-auto max-w-4xl">
            <div class="flex flex-wrap sm:flex-nowrap items-center">
                <img class="h-48 sm:h-56 lg:h-72 mx-auto border-4 lg:border-8 rounded-full" src="https://www.musora.com/cdn-cgi/image/width=550,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/jesus-molina/Jesus_Molina_profile.jpg" alt="Jesus Molina profile">
    ...
    {{--<img class="h-12 sm:h-14 lg:h-16" src="https://www.musora.com/cdn-cgi/image/width=420,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/logo/pianote-logo-red.png">--}}
    ...
    {{--<div class="w-full aspect-16:9 bg-cover bg-center lazyload" data-bg="https://www.musora.com/cdn-cgi/image/width=700,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/2022/method-thumbs.jpg"></div>--}}
    {{--<div class="px-4 lg:px-6 py-5 lg:py-7">--}}
    {{--<img class="h-8 icon imgfilter-coaches" src="https://www.musora.com/cdn-cgi/image/width=800,quality=95/https://dpwjbsxqtam5n.cloudfront.net/sales/2021/coaches-icon.svg" alt="coaches-icon">--}}
    {{--<img class="h-5 ml-2 imgfilter-coaches lazyload" data-src="https://www.musora.com/cdn-cgi/image/quality=95/https://dpwjbsxqtam5n.cloudfront.net/sales/2021/coaches-text.svg" alt="coaches-text">--}}
    ...
    {{--</div>--}}
    {{--<div class="relative rounded-xl overflow-hidden mb-3 md:mb-0" style="background-color:#051124;">--}}
    {{--<div class="w-full aspect-16:9 bg-cover bg-center lazyload" data-bg="https://www.musora.com/cdn-cgi/image/width=700,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/2022/coaches-thumbs.jpg"></div>--}}
    {{--<div class=" px-4 lg:px-6 py-5 lg:py-7">--}}
    {{--<i class="text-4xl align-middle fa-light fa-piano text-pianote"></i>--}}
    {{--<img class="h-5 ml-2 imgfilter-method lazyload" data-src="https://www.musora.com/cdn-cgi/image/quality=95/https://dpwjbsxqtam5n.cloudfront.net/sales/2021/method-text.svg" alt="method-text">--}}
    ...
    {{--<div class="w-full aspect-16:9 bg-cover bg-center lazyload" data-bg="https://www.musora.com/cdn-cgi/image/width=700,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/2022/songs-thumbs.jpg"></div>--}}
    {{--<div class="px-4 lg:px-6 py-5 lg:py-7">--}}
    {{--<i class="text-4xl align-middle icon-songs text-songs"></i>--}}
    {{--<img class="h-5 ml-2 imgfilter-songs lazyload" data-src="https://www.musora.com/cdn-cgi/image/quality=95/https://dpwjbsxqtam5n.cloudfront.net/sales/2021/songs-text.svg" alt="songs-text">--}}
    ...
    {{--</div>--}}
    {{--<div class="bg-image w-full bg-black bg-top bg-cover lazyload" data-bg="https://www.musora.com/cdn-cgi/image/width=550,quality=95/{{ $topic['image'] }}"></div>--}}
    {{--<div class="absolute uppercase w-full bottom-3 md:bottom-5 z-10 text-shadow-4">--}}
    {{--@if(!empty($topic['logo']))--}}
    {{--<div class="px-6">--}}
    {{--<img class="w-full h-12 md:h-16 object-contain lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=500,quality=95/{{ $topic['logo'] }}" alt="{!! $topic['title'] !!}">--}}
    {{--</div>--}}
    {{--@else--}}
    ...
    <section class="px-4 sm:px-6 py-10 md:py-12 md:py-14 text-white text-center overflow-hidden" style="background:linear-gradient(to bottom, #01050f, #021225);overflow:visible">
        <div class="container mx-auto max-w-4xl">
            <img class="h-28 md:h-32 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=250,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/2022/piano-guarantee.png" alt="guarantee-badge">
    ...
    <section class="content-section px-3 sm:px-0 text-center customize relative z-50 overflow-hidden lazyload" data-bg="https://www.musora.com/cdn-cgi/image/width=1500,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/jesus-molina/Order_BG.jpg">
        <div class="container max-w-6xl mx-auto relative z-50">
            <div class="flex flex-wrap items-center">
                <div class="text-center sm:text-left w-full sm:w-1/2 lg:w-5/12 sm:pl-5">
                    <img class="h-16 md:h-20 lg:h-24 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=1200,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/jesus-molina/Logo.png" alt="Improvisation logo">
                    <h4 class="leading-tight mt-2 md:mt-3"><strong>Learn from one of the world’s<br class="inline lg:hidden"> best for just <!--<s class="opacity-70">${{ floatval($productPrices['jesus-molina-improvisation-and-musical-freedom-pack']->price) }}</s>-->
                            <span class="text-pianote">
                                @if(number_format(floatval($productPrices['jesus-molina-improvisation-and-musical-freedom-pack']->discounted_price), 2) == intval(floatval($productPrices['jesus-molina-improvisation-and-musical-freedom-pack']->discounted_price)))
                                    ${{  floatval($productPrices['jesus-molina-improvisation-and-musical-freedom-pack']->discounted_price)  }}
                                @else
                                    ${{  number_format(floatval($productPrices['jesus-molina-improvisation-and-musical-freedom-pack']->discounted_price), 2)  }}
                                @endif
                            </span></strong></h4>
...
{{--                        </p>--}}
                ...
                <div class="flex w-full justify-center sm:justify-start sm:w-1/2 lg:w-7/12 sm:order-1 sm:pl-5 mt-7 sm:mt-0">
                    <img class="max-w-lg sm:max-w-2xl lg:max-w-4xl lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=1400,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/jesus-molina/order_collage.png" alt="Order collage">
                </div>
            </div>
        </div>
    </section>
