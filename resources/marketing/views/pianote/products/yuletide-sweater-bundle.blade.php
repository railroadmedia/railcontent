...
<head>
    ...
    <title>Pianote Yuletide Knit Sweater | Pianote</title>
    <meta property="og:title" content="Pianote Yuletide Knit Sweater | Pianote">
    <meta property="description" content="Bring on the holiday festivities while keeping cozy in this premium knitted sweater.">
    <meta property="og:description" content="Bring on the holiday festivities while keeping cozy in this premium knitted sweater.">
    <meta property="og:url" content="https://www.pianote.com/shop/yuletide-knit-sweater" />
    <meta property="og:image" content="https://d1fyshwdvi6fth.cloudfront.net/Pianote/Meta-images/03a15a98-011d-436f-b167-4ef2935a1eaa-pianote-christmas-sweater-shop.jpg">
            ...
            <div class="product-wrap lg:w-2/3 px-3 md:px-4">
                <div class="pack-details slider-wrap w-full mx-auto mb-1">
                    <div class="text-center pb-5 sm:pb-6 lg:pb-7">
                        <div class="clearfix">
                            <div class="w-full">
                                <div class="text-xl md:text-3xl lg:text-4xl leading-none font-bold">Yuletide Knit Sweater + Socks Bundle</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="sticky-slide" class="overflow-hidden rounded border border-solid border-gray-300">
                        <div class="buy-section active px-5 pt-2 pb-6 text-center lg:py-6">
                            ...
                            <h1 class="text-center text-3xl uppercase md:text-4xl">
                                <s class="opacity-60">$81.99</s>
                                <strong class="font-black">$<span class="chosen-variant-price-float">49</span></strong>
                            </h1>
                            <select class="pack-pick2 mx-auto mt-4 border-2 rounded-full font-bold text-xl uppercase w-full h-auto py-2 pr-7 pl-5 bg-white md:py-2 lg:py-4" style="border-color: #717D80; color:#717D80; font-family: Bebas Neue, sans-serif" title="Shirt Size" required>
                                ...
                                @php
                                    $variations = [
                                        (object)[
                                        "name" => "X-Small + Free Socks",
                                        "fullPrice" => 81.99,
                                        "price" => 49,
                                        "sku" => "pianote-yuletide-knit-sweater-xs",
                                        ],
                                        (object)[
                                        "name" => "Small + Free Socks",
                                        "fullPrice" => 81.99,
                                        "price" => 49,
                                        "sku" => "pianote-yuletide-knit-sweater-s",
                                        ],
                                        (object)[
                                        "name" => "Medium + Free Socks",
                                        "fullPrice" => 81.99,
                                        "price" => 49,
                                        "sku" => "pianote-yuletide-knit-sweater-m",
                                        ],
                                        (object)[
                                        "name" => "Large + Free Socks",
                                        "fullPrice" => 81.99,
                                        "price" => 49,
                                        "sku" => "pianote-yuletide-knit-sweater-l",
                                        ],
                                        (object)[
                                        "name" => "X-Large + Free Socks",
                                        "fullPrice" => 81.99,
                                        "price" => 49,
                                        "sku" => "pianote-yuletide-knit-sweater-xl",
                                        ],
                                        (object)[
                                        "name" => "XX-Large + Free Socks",
                                        "fullPrice" => 81.99,
                                        "price" => 49,
                                        "sku" => "pianote-yuletide-knit-sweater-xxl",
                                        ],
                                        (object)[
                                        "name" => "XXX-Large + Free Socks",
                                        "fullPrice" => 81.99,
                                        "price" => 49,
                                        "sku" => "pianote-yuletide-knit-sweater-xxxl",
                                        ],
                                        ];
                                @endphp
        ...
        <div class="product-wrap lg:w-2/3 px-3 md:px-4">
            <div class="pack-details mx-auto mb-7 pb-5 sm:pb-9 lg:pb-11">
                <div class="drumshop-accordion">
                    <p><div><p>Bring on the holiday festivities while keeping cozy in this premium knitted sweater.</p>
                    </div>
                    </p>
                </div>
                    ...
                    <div class="spec-wrap">
                        ...
                        <table class="text-sm w-full md:text-base">
                            <tr>
                                ...
                                <td class="item-info block md:table-cell pl-4 md:pl-0 pb-4">Unisex Sizing</td>
                            </tr>
                            <tr>
                                <td class="font-bold uppercase block md:tb1 md:table-cell md:w-52 md:pb-4">
                                ...
                                <td class="item-info block md:table-cell pl-4 md:pl-0 pb-4">55% Acrylic / 45% Cotton</td>
                            </tr>
                        </table>
                        <h4 class="font-bold text-lg uppercase mb-6 md:text-xl lg:text-2xl mt-10">Key Features</h4>
                        <ul class="list-disc leading-5 pl-5">
                            <li class="mb-4">This high quality knit sweater looks great, and feels even better! </li>
                        </ul>
                    </div>
                </div>
                <img class="mt-10" src="https://d1fyshwdvi6fth.cloudfront.net/Size_Chart/Sweater-Size-Chart.png" alt="size chart" />
            </div>
        </div>
    </div>
</main>
