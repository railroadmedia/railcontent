...
@section('global-head')
    ...
    <meta property="og:image" content="https://d21q7xesnoiieh.cloudfront.net/fit-in/1200x0/filters:quality(95)/marketing/pianote/shop/metronome/header-bg.jpg" style="display: none;">
...
@section('global-body')
    ...
    <header class="text-white px-5 sm:px-6 pt-80 pb-10 sm:py-20 lg:py-28 relative" style="background-color:#690808;">
        <div class="inset-0 absolute z-0 bg-top bg-cover block sm:hidden" style="background:url('https://d21q7xesnoiieh.cloudfront.net/fit-in/750x0/filters:quality(95)/marketing/pianote/shop/metronome/header-bg-m.jpg')"></div>
        <div class="inset-0 absolute z-0 bg-top bg-cover hidden sm:block" style="background:url('https://d21q7xesnoiieh.cloudfront.net/fit-in/2000x0/filters:quality(95)/marketing/pianote/shop/metronome/header-bg.jpg')"></div>
        <div class="container max-w-4xl mx-auto relative z-10">
            <div class="flex flex-wrap sm:flex-nowrap items-center">
                <div class="w-full sm:w-5/12 text-center lg:text-left">
                    <img class="h-24 lg:hidden" alt="logo" fetchpriority="high" src="https://d21q7xesnoiieh.cloudfront.net/fit-in/440x0/filters:quality(95)/marketing/pianote/shop/metronome/metronome-web-logo-center.svg">
                    <img class="h-24 lg:h-32 hidden lg:inline-block" alt="logo" fetchpriority="high" src="https://d21q7xesnoiieh.cloudfront.net/fit-in/580x0/filters:quality(95)/marketing/pianote/shop/metronome/metronome-web-logo.svg">
    ...
    <section class="text-center px-4 sm:px-6 py-8 sm:py-16 lg:py-20 relative">
        <div class="container mx-auto z-10 relative max-w-5xl">
            ...
            @php
                $gridItems = [
                    [
                    'icon' => 'marketing/pianote/shop/metronome/lightweight-icon.svg',
                    'img' => 'marketing/pianote/shop/metronome/lightweight-slide.png',
                    ...
                    [
                    'icon' => 'marketing/pianote/shop/metronome/hand-wound-icon.svg',
                    'img' => 'marketing/pianote/shop/metronome/hand-wound-slide.png',
                    ...
                    [
                    'icon' => 'marketing/pianote/shop/metronome/durable-icon.svg',
                    'img' => 'marketing/pianote/shop/metronome/durable-slide.png',
                    ...
                    [
                    'icon' => 'marketing/pianote/shop/metronome/adjustable-icon.svg',
                    'img' => 'marketing/pianote/shop/metronome/adjustable-slide.png',
                    ...
                    [
                    'icon' => 'marketing/pianote/shop/metronome/timing-icon.svg',
                    'img' => 'marketing/pianote/shop/metronome/timing-slide.png',
            ...
            <div class="hidden lg:flex">
                ...
                <div class="w-1/2">
                    <img class="transition-opacity opacity-0" alt="icon" loading="lazy" onload="this.classList.remove('opacity-0')"
                        src="https://d21q7xesnoiieh.cloudfront.net/fit-in/1000x0/filters:quality(95)/marketing/pianote/shop/metronome/metronome-features.png"
                    >
                </div>
    ...
    <section class="text-center px-5 sm:px-6 pb-10 sm:pb-14 lg:pb-20 py-10 sm:py-14 lg:pt-32 text-white" style="background-color:#000;">
        <div class="container max-w-3xl mx-auto">
            <img class="h-28 sm:h-40 lg:h-52 block mx-auto -mt-24 sm:-mt-36 lg:-mt-48 transition-all opacity-0" src="https://d21q7xesnoiieh.cloudfront.net/fit-in/410x0/filters:quality(95)/marketing/pianote/shop/metronome/repair-guarantee.png" alt="guarantee badge" loading="lazy" onload="this.classList.remove('opacity-0')">
    ...
    <section class="text-white px-5 sm:px-6 pt-80 pb-10 sm:py-18 lg:py-20 relative" style="background-color:#690808;">
        <div class="inset-0 absolute z-0 bg-top bg-cover block sm:hidden" style="background:url('https://d21q7xesnoiieh.cloudfront.net/fit-in/750x0/filters:quality(95)/marketing/pianote/shop/metronome/order-bg-m.jpg')"></div>
        <div class="inset-0 absolute z-0 bg-top bg-cover hidden sm:block" style="background:url('https://d21q7xesnoiieh.cloudfront.net/fit-in/2000x0/filters:quality(95)/marketing/pianote/shop/metronome/header-bg.jpg')"></div>
