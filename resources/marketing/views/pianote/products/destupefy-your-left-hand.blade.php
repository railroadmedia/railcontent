...
@section('head-includes')
    ...
    <link rel="stylesheet" href="/assets/marketing/destupefy.css">
@stop
...
@section('layout-body')
    ...
    @include('shop.partials._promo-banner', [
                    ...
                    "fullPrice" => App\Prices::$destupefyFull,
                    "price" => App\Prices::$destupefyRegular,
                    "noBreadcrumb" => true
                ])
    <header class="header text-center" style="background-image:url(https://d2vyvo0tyx8ig5.cloudfront.net/shop/products/destupefy-your-left-hand/header.jpg);">
        <div class="container">
            ...
            <p class="breakdown">
                @if(App\Prices::$destupefyFull > App\Prices::$destupefyRegular)
                    <s>NORMALLY ${{ App\Prices::$destupefyFull }}.</s> &nbsp;
                    <strong><u>ONLY ${{ App\Prices::$destupefyRegular }}</u></strong>&nbsp; (SAVE {{ round(100 - (100 * (App\Prices::$destupefyRegular / App\Prices::$destupefyFull))) }}%)
                @else
                    <strong><u>ONLY ${{ App\Prices::$destupefyRegular }}</u></strong>
                @endif
    ...
    <section class="faqs">
        <div class="container no-padding">
            ...
            <div class="col-xs-12">
                @include('sales.partials._week-breakdown', [
                "question" => true,
