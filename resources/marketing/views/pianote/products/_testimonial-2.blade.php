<div class="sm:flex items-start justify-center mb-10 sm:mb-16">
    <img class="rounded-full border-4 bg-pred border-pred w-24 sm:w-32 md:w-40 mb-3 sm:mb-0" src="{{ $image }}">
    <div class="text-left sm:pl-4 md:pl-6">
        ...
        <p class="text-xs sm:text-sm font-extrabold text-pred">{{ $name }}</p>
