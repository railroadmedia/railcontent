...
@section('global-body')
    ...
    <header class="text-white px-5 sm:px-6 pt-96 pb-10 sm:py-20 lg:py-36 relative" style="background-color:#0f5e8a;">
        <div class="inset-0 absolute z-0 bg-top bg-cover block sm:hidden" style="background:url('https://d21q7xesnoiieh.cloudfront.net/fit-in/0x0/filters:quality(95)/marketing/pianote/shop/christmas-songbook/header-m.png')"></div>
        <div class="inset-0 absolute z-0 bg-top bg-cover hidden sm:block" style="background:url('https://d21q7xesnoiieh.cloudfront.net/fit-in/0x0/filters:quality(95)/marketing/pianote/shop/christmas-songbook/header.jpg')"></div>
            ...
            <div class="flex flex-wrap sm:flex-nowrap items-center">
                <div class="w-full sm:w-5/12 text-center lg:text-left">
                    <img class="h-24 lg:h-36 lg:-ml-5 mx-0" alt="logo" fetchpriority="high"
                        src="https://d21q7xesnoiieh.cloudfront.net/fit-in/440x0/filters:quality(95)/marketing/pianote/shop/christmas-songbook/christmas-songbook-logo-left.png">
...
{{--    </section>--}}
    ...
    <section class="relative text-center px-3 sm:px-6 py-10 sm:py-14 lg:py-20" style="background:linear-gradient(to bottom, #F1F7FE 40%, #FFF);">
        <div class="absolute z-10 top-0 left-0 right-0 bg-cover bg-no-repeat bg-top z-10 h-1/2 lg:h-full" style="background-image:url('https://d21q7xesnoiieh.cloudfront.net/fit-in/1500x0/filters:quality(95)/marketing/pianote/shop/christmas-songbook/author-bg.png');"></div>
        <div class="container max-w-5xl mx-auto relative z-20">
            ...
            <div class="flex flex-wrap sm:flex-nowrap items-start justify-center">
                <div class="w-full sm:w-1/2 px-4 mb-20 sm:mb-0">
                    <div class="relative text-left z-10 rounded-xl py-8 sm:py-12 px-6 sm:px-10 w-full shadow-md" style="background-color:#fff;">
                        <img class="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-32 lg:w-36 z-20 rounded-full border-4 border-white shadow-md transition-all opacity-0" alt="profile picture" loading="lazy" onload="this.classList.remove('opacity-0')"
                            src="https://d21q7xesnoiieh.cloudfront.net/fit-in/550x0/filters:quality(95)/marketing/pianote/shop/christmas-songbook/kevin-profile.jpg">
                        <br>
                        <img class="h-5 mt-4 sm:mt-3 mb-3 transition-all opacity-0" alt="lisa signature" loading="lazy" onload="this.classList.remove('opacity-0')"
                            src="https://d21q7xesnoiieh.cloudfront.net/fit-in/550x0/filters:quality(95)/marketing/pianote/shop/christmas-songbook/kevin-castro.png">
                        <p class="leading-normal">
                ...
                <div class="w-full sm:w-1/2 px-4">
                    <div class="relative text-left z-10 rounded-xl py-8 sm:py-12 px-6 sm:px-10 w-full shadow-md" style="background-color:#fff;">
                        <img class="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-32 lg:w-36 z-20 rounded-full border-4 border-white shadow-md transition-all opacity-0" alt="profile picture" loading="lazy" onload="this.classList.remove('opacity-0')"
                            src="https://d21q7xesnoiieh.cloudfront.net/fit-in/550x0/filters:quality(95)/marketing/pianote/shop/christmas-songbook/carlos-profile.jpg">
                        <br>
                        <img class="h-5 mt-4 sm:mt-3 mb-3 transition-all opacity-0" alt="lisa signature" loading="lazy" onload="this.classList.remove('opacity-0')"
                            src="https://d21q7xesnoiieh.cloudfront.net/fit-in/550x0/filters:quality(95)/marketing/pianote/shop/christmas-songbook/carlos-castro.png">
                        <p class="leading-normal">
    ...
    <section class="px-5 sm:px-6 py-10 sm:py-14 lg:py-20 text-center text-white" style="background:#0f5e8a url('https://d21q7xesnoiieh.cloudfront.net/fit-in/2000x0/filters:quality(95)/marketing/pianote/shop/christmas-songbook/order-bg.jpg') center center/cover;">
        <div class="container mx-auto">
            <img alt="quietkick logo" class="h-28 sm:h-44 lg:h-52" src="https://d21q7xesnoiieh.cloudfront.net/fit-in/500x0/filters:quality(95)/marketing/pianote/shop/christmas-songbook/christmas-songbook-logo-center.png"><br>
                        ...
                        <a href="/ecommerce/add-to-cart?locked=true&product-array=christmas-songbook:1,christmas-song-book-digital:1" class="text-black overflow-hidden rounded-2xl block mx-auto mb-4 md:mb-0 group border-2 border-black">
                            <div class="bg-white px-3 py-5 md:py-7">
                                ...
                                <img class="h-28 lg:h-32 transition-opacity opacity-0"
                                    ...
                                    src="https://d21q7xesnoiieh.cloudfront.net/fit-in/310x0/filters:quality(95)/marketing/pianote/shop/christmas-songbook/book-only.png"
                        ...
                        <a href="/ecommerce/add-to-cart?locked=true&product-array=PIANOTE-MEMBERSHIP-1-YEAR:1,christmas-songbook:1,christmas-song-book-digital:1,piano-chords-and-scales-guide:1,new-piano-players-start-here:1,easy-chords:1"
                            ...
                            <div class="bg-white px-3 py-6 md:py-9">
                                ...
                                <img class="h-28 lg:h-32 transition-opacity opacity-0"
                                    loading="lazy"
                                    onload="this.classList.remove('opacity-0')"
                                    src="https://d21q7xesnoiieh.cloudfront.net/fit-in/550x0/filters:quality(95)/marketing/pianote/shop/christmas-songbook/holiday-bundle.png"
                                    alt="learn playing image"
                                >
                                <br>
