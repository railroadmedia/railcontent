...
@section('global-body')
    ...
    <header class="header overflow-hidden w-full text-white bg-black text-center fixed z-0">
        ...
        <div class="container mx-auto">
            <div class="transform -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2 w-full absolute z-30 animated fadeIn">
                <img class="h-20 md:h-40 lg:h-52 mx-auto" src="https://www.musora.com/musora-cdn/image/width=1600,quality=85/https://pianote.s3.amazonaws.com/products/play-beautiful-piano/logo-2.png" alt="Playing beautiful piano logo">
            ...
            <div class="bottom absolute bottom-0 left-0 right-0 z-30 pb-5 md:pb-8"><img class="h-14 md:h-16 lg:h-20 animated infinite pulse" src="https://www.musora.com/musora-cdn/image/width=70,quality=85/https://pianote.s3.amazonaws.com/products/play-beautiful-piano/treble-clef.png" alt="Treble clef"></div>
        </div>
    </header>

    <div class="relative w-full my-64 md:my-96 py-3 md:py-10" style="z-index: -1;"></div>

    <section class="content-section overflow-hidden relative text-white text-center lazyload" style="background-image:url(https://www.musora.com/musora-cdn/image/width=2500,quality=85/https://pianote.s3.amazonaws.com/products/play-beautiful-piano/background-main-thumb.jpg); background-size: cover;box-shadow: 0 0 50px rgba(0, 0, 0, 0.4);">
    ...
    <section class="content-section overflow-hidden relative text-white text-center lazyload" data-bg="https://www.musora.com/musora-cdn/image/width=2000,quality=85/https://pianote.s3.amazonaws.com/products/play-beautiful-piano/background-waves.jpg">
        <div class="container mx-auto">
            ...
            <p class="text-left max-w-2xl leading-relaxed mx-auto my-10 px-5 md:px-4">...you just don’t.
                ...
                <br><br>
                Not yet, anyway...</p>
            <img class="h-14 md:h-16 lg:h-20 animated infinite pulse lazyload" data-src="https://www.musora.com/musora-cdn/image/width=70,quality=85/https://pianote.s3.amazonaws.com/products/play-beautiful-piano/treble-clef.png" alt="Treble clef">
        </div>
    </section>
    <section class="content-section overflow-hidden relative text-white text-center">
        <div class="container mx-auto">
            <h2><em>Your step-by-step journey to...</em></h2>
            <img class="h-20 md:h-40 lg:h-52 mx-auto my-3 md:my-4 lg:my-5 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=1600,quality=85/https://pianote.s3.amazonaws.com/products/play-beautiful-piano/logo-2.png" alt="Playing beautiful piano logo">
        ...
        <div class="flex flex-wrap mx-auto bg-white" style="max-width:2000px;">
            <div data-open="lesson1" class="w-1/2 lg:w-1/3 bg-cover bg-center pt-32 md:pt-44 lg:pt-52 pb-5 md:pb-8 lg:pb-12 relative cursor-pointer hover:opacity-95 autoplay-video lazyload" data-bg="https://www.musora.com/musora-cdn/image/width=900,quality=85/https://pianote.s3.amazonaws.com/products/play-beautiful-piano/thumb-video-1.jpg">
            ...
            <div data-open="lesson2" class="w-1/2 lg:w-1/3 bg-cover bg-center pt-32 md:pt-44 lg:pt-52 pb-5 md:pb-8 lg:pb-12 relative cursor-pointer hover:opacity-95 autoplay-video lazyload" data-bg="https://www.musora.com/musora-cdn/image/width=900,quality=85/https://pianote.s3.amazonaws.com/products/play-beautiful-piano/thumb-video-2.jpg">
            ...
            <div data-open="lesson3" class="w-1/2 lg:w-1/3 bg-cover bg-center pt-32 md:pt-44 lg:pt-52 pb-5 md:pb-8 lg:pb-12 relative cursor-pointer hover:opacity-95 autoplay-video lazyload" data-bg="https://www.musora.com/musora-cdn/image/width=900,quality=85/https://pianote.s3.amazonaws.com/products/play-beautiful-piano/thumb-video-3.jpg">
            ...
            <div data-open="lesson4" class="w-1/2 lg:w-1/3 bg-cover bg-center pt-32 md:pt-44 lg:pt-52 pb-5 md:pb-8 lg:pb-12 relative cursor-pointer hover:opacity-95 autoplay-video lazyload" data-bg="https://www.musora.com/musora-cdn/image/width=900,quality=85/https://pianote.s3.amazonaws.com/products/play-beautiful-piano/thumb-video-4.jpg">
            ...
            <div data-open="lesson5" class="w-1/2 lg:w-1/3 bg-cover bg-center pt-32 md:pt-44 lg:pt-52 pb-5 md:pb-8 lg:pb-12 relative cursor-pointer hover:opacity-95 autoplay-video lazyload" data-bg="https://www.musora.com/musora-cdn/image/width=900,quality=85/https://pianote.s3.amazonaws.com/products/play-beautiful-piano/thumb-video-5.jpg">
            ...
            <div data-open="lesson6" class="w-1/2 lg:w-1/3 bg-cover bg-center pt-32 md:pt-44 lg:pt-52 pb-5 md:pb-8 lg:pb-12 relative cursor-pointer hover:opacity-95 autoplay-video lazyload" data-bg="https://www.musora.com/musora-cdn/image/width=900,quality=85/https://pianote.s3.amazonaws.com/products/play-beautiful-piano/thumb-video-6.jpg">
    ...
    <section class="content-section overflow-hidden relative text-white text-center lazyload" data-bg="https://www.musora.com/musora-cdn/image/width=2500,quality=85/https://pianote.s3.amazonaws.com/products/play-beautiful-piano/background-teacher-2.jpg">
        <div class="container mx-auto relative z-20">
            ...
            Put me to the test, and get ready to change your belief about what you are able to do.
                ...
                <img class="h-12 md:h-16 mt-5 md:mt-7 lazyload" data-src="https://d2vyvo0tyx8ig5.cloudfront.net/shop/products/piano-riffs-and-fills/lisa-witt-signature.png" alt="Lisa signature"></p>
        </div>
    </section>
    <section class="content-section overflow-hidden relative text-white text-center">
        <div class="container mx-auto">
    ...
    <section class="header relative overflow-hidden text-white bg-black text-center z-20">
        ...
        <div class="container mx-auto">
            <div class="transform -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2 w-full absolute z-30">
                <img class="h-20 md:h-40 lg:h-52 mx-auto lazyload" data-src="https://www.musora.com/musora-cdn/image/width=1600,quality=85/https://pianote.s3.amazonaws.com/products/play-beautiful-piano/logo-2.png" alt="Playing beautiful piano logo">
