...
@section('global-body')
    ...
    <header class="header overflow-hidden w-full text-white bg-black text-center fixed z-0">
        ...
        <div class="container mx-auto">
            <div class="transform -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2 w-full absolute z-30 animated fadeIn">
                <img class="h-20 md:h-40 lg:h-52 mx-auto" src="https://www.musora.com/cdn-cgi/image/width=1600,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/products/play-beautiful-piano/logo-2.png" alt="Playing beautiful piano logo">
            ...
            <div class="bottom absolute bottom-0 left-0 right-0 z-30 pb-5 md:pb-8"><img class="h-14 md:h-16 lg:h-20 animated infinite pulse" src="https://www.musora.com/cdn-cgi/image/width=70,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/products/play-beautiful-piano/treble-clef.png" alt="Treble clef"></div>
        </div>
    </header>

    <div class="relative w-full my-64 md:my-96 py-3 md:py-10" style="z-index: -1;"></div>

    <section class="content-section overflow-hidden relative text-white text-center lazyload" style="background-image:url(https://www.musora.com/cdn-cgi/image/width=2500,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/products/play-beautiful-piano/background-main-thumb.jpg); background-size: cover;box-shadow: 0 0 50px rgba(0, 0, 0, 0.4);">
    ...
    <section class="content-section overflow-hidden relative text-white text-center lazyload" data-bg="https://www.musora.com/cdn-cgi/image/width=2000,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/products/play-beautiful-piano/background-waves.jpg">
        <div class="container mx-auto">
            ...
            <p class="text-left max-w-2xl leading-relaxed mx-auto my-10 px-5 md:px-4">...you just don’t.
                ...
                <br><br>
                Not yet, anyway...</p>
            <img class="h-14 md:h-16 lg:h-20 animated infinite pulse lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=70,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/products/play-beautiful-piano/treble-clef.png" alt="Treble clef">
        </div>
    </section>
    <section class="content-section overflow-hidden relative text-white text-center">
        <div class="container mx-auto">
            <h2><em>Your step-by-step journey to...</em></h2>
            <img class="h-20 md:h-40 lg:h-52 mx-auto my-3 md:my-4 lg:my-5 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=1600,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/products/play-beautiful-piano/logo-2.png" alt="Playing beautiful piano logo">
        ...
        <div class="flex flex-wrap mx-auto bg-white" style="max-width:2000px;">
            <div data-open="lesson1" class="w-1/2 lg:w-1/3 bg-cover bg-center pt-32 md:pt-44 lg:pt-52 pb-5 md:pb-8 lg:pb-12 relative cursor-pointer hover:opacity-95 autoplay-video lazyload" data-bg="https://www.musora.com/cdn-cgi/image/width=900,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/products/play-beautiful-piano/thumb-video-1.jpg">
    ...
    <section class="content-section overflow-hidden relative text-white text-center lazyload" data-bg="https://www.musora.com/cdn-cgi/image/width=2500,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/products/play-beautiful-piano/background-teacher-2.jpg">
        <div class="container mx-auto relative z-20">
            ...
            <div class="testimonials w-full flex items-start justify-center flex-wrap px-3">
                ...
                @foreach($testimonials as $testimonial)
                    <div class="w-full md:w-1/2 lg:w-1/3 px-3 md:px-4 text-center flex-wrap justify-center transition-all duration-200 ease-in-out @if(!empty($testimonial['class'])) {{ $testimonial['class'] }} @endif">
                        <img class="rounded-full border-4 bg-pianote border-pianote h-28 md:h-40 lg:h-44 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=300,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/testimonials/{{ strtolower(str_replace(' ', '-', $testimonial['name'])) }}.jpg" alt="{{ $testimonial['name'] }}">
    ...
    <section class="content-section overflow-hidden relative text-white text-left" style="background:linear-gradient(to bottom, #000217, #02082c);">
        <div class="container mx-auto">
            <div class="flex items-start flex-wrap md:flex-nowrap justify-center max-w-5xl mx-auto px-5 md:px-6 lg:px-8">
                <img class="w-36 md:w-60 lg:w-80 mb-5 md:mb-0 md:order-1 inline-block lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=600,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/guarantee-badge.png" alt="Guarantee Badge">
    ...
    <section class="header relative overflow-hidden text-white bg-black text-center z-20">
        ...
        <div class="container mx-auto">
            <div class="transform -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2 w-full absolute z-30">
                <img class="h-20 md:h-40 lg:h-52 mx-auto lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=1600,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/products/play-beautiful-piano/logo-2.png" alt="Playing beautiful piano logo">
