...
@section('global-body')
    ...
    <section class="content-section overflow-hidden relative text-white text-center lazyload" data-bg="https://www.musora.com/musora-cdn/image/width=2000,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/products/play-beautiful-piano/background-waves.jpg">
        <div class="container mx-auto">
    ...
    <section class="content-section overflow-hidden relative text-white text-center lazyload" data-bg="https://www.musora.com/musora-cdn/image/width=2500,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/products/play-beautiful-piano/background-teacher-2.jpg">
        <div class="container mx-auto relative z-20">
            ...
            <div class="testimonials w-full flex items-start justify-center flex-wrap px-3">
                ...
                @foreach($testimonials as $testimonial)
                    <div class="w-full md:w-1/2 lg:w-1/3 px-3 md:px-4 text-center flex-wrap justify-center transition-all duration-200 ease-in-out @if(!empty($testimonial['class'])) {{ $testimonial['class'] }} @endif">
                        <img class="rounded-full border-4 bg-pianote border-pianote h-28 md:h-40 lg:h-44 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=300,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/testimonials/{{ strtolower(str_replace(' ', '-', $testimonial['name'])) }}.jpg" alt="{{ $testimonial['name'] }}">
    ...
    <section class="content-section overflow-hidden relative text-white text-left" style="background:linear-gradient(to bottom, #000217, #02082c);">
        <div class="container mx-auto">
            <div class="flex items-start flex-wrap md:flex-nowrap justify-center max-w-5xl mx-auto px-5 md:px-6 lg:px-8">
                <img class="w-36 md:w-60 lg:w-80 mb-5 md:mb-0 md:order-1 inline-block lazyload" data-src="https://www.musora.com/musora-cdn/image/width=600,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/guarantee-badge.png" alt="Guarantee Badge">
