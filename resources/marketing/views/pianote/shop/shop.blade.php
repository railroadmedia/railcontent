...
@section('body')
    <header class="drum-shop-header" style="background-image:url(https://www.musora.com/musora-cdn/image/width=2000,quality=85/https://pianote.s3.amazonaws.com/shop/header-background.jpg);">
    ...
    <div class="white-box">
        ...
        {{--                    <a href="/shop/book-bundle/" class="w-full --}}{{--py-20 sm:py-28 lg:py-40--}}{{-- py-5 lg:py-8 px-4 sm:px-6 lg:px-20 banner-product overflow-hidden bg-cover bg-center sm:bg-right" style="background-color:#ca1176;background-image:url(https://www.musora.com/musora-cdn/image/width=2500,quality=85/https://pianote.s3.amazonaws.com/sales/promos/november/just-the-books-shop-no-classic.jpg);">--}}
        ...
        {{--                            <img class="h-24 lg:h-32 relative z-10" src="https://www.musora.com/musora-cdn/image/width=1600,quality=85/https://pianote.s3.amazonaws.com/sales/promos/november/just-the-books-bundle-white.png">--}}
        {{--                            <p class="my-2">--}}
