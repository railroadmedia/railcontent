            ...
            <div class="pack-details mx-auto mb-7 pb-5 sm:pb-9 lg:pb-11">
                ...
                @if($product->productType->name === 'Bundles' && !empty($product->spread_img))
                    <div class="text-center">
                        ...
                        <img class="mb-4" src="https://www.musora.com/cdn-cgi/image/width=1400,quality=95/{{$product->spread_img}}" alt="bundle spread image" />
                    </div>
                @endif
                ...
                @if($product->productType->name === 'Bundles')
                    ...
                    <hr class="my-8" />
                        ...
                        <p class="mb-4">
                            ...
                            <em style="opacity: 0.5;">All digital bonuses are added to your account instantly with your membership to {{ ucfirst($brand) }}, and they’re yours forever.</em>
                        </p>
