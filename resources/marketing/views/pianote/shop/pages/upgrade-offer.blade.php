...
@section('top')
    @include('pianote.shop._partials._slider', [
        ...
        "videoSrc" => "https://player.vimeo.com/external/576893754.hd.mp4?s=b4087e2dc24785eccbab9c9838fb64ec373b3ff1&profile_id=174",
        "defaultCover" => "https://i.vimeocdn.com/video/1193387752-307c50214a83c31611ce81244b42bb676e94d2edf90fbd4d120cc51282a703a2-d_1280",
        "noSlider" => true,
    ])
    ...
    <div class="shop-sidebar sliding-function px-3 md:px-4 lg:px-4 lg:w-1/3 lg:mt-5">
        ...
        <div class="side-slide md:border md:border-solid md:rounded-md" style="width: 360px; border-color: #CCD3D3;">
            <div class="text-center md:py-6 md:px-4">
                ...
                <a class="text-pianote" href="/ecommerce/add-to-cart?products%5BPIANOTE-MEMBERSHIP-1-MONTH%5D=1&redirect=%2Forder&locked=true"><em>Or choose a monthly membership for ${{ Prices::$plusSubscriptionMonthly }}/month (no bonuses)</em></a>
                <br><br>
