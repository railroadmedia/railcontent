...
@section('page-body')
    <header class="header text-center text-white py-12 md:py-18 lg:py-20 px-4 bg-center bg-no-repeat relative" style="background-color:#010519; background-image:url(https://www.musora.com/musora-cdn/image/width=1500,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/classical-piano/final-bg.jpg);">
        <div class="container mx-auto relative z-10 max-w-4xl">
            <img class="h-10 md:h-20 lg:h-24" src="https://www.musora.com/musora-cdn/image/width=1500,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/classical-piano/logo.png">
        </div>
    </header>
    ...
    <section class="text-center py-12 md:py-20 lg:py-24 text-white bg-center bg-cover lazyload" style="background-color:#000417;" data-bg="https://www.musora.com/musora-cdn/image/width=1500,q_60,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/shop/header-background.jpg">
        <div class="container mx-auto">
            <div class="w-full px-2 md:px-3 text-center">
                <img class="h-10 sm:h-20 lg:h-24 mb-5 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=1300,q_60,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/logo/pianote-logo-red.png">
