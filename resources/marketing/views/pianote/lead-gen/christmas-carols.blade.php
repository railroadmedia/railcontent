...
@section('head')
    ...
    <style>
        .header-bg {
            ...
            background-image: url('https://www.musora.com/cdn-cgi/image/width=900,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/christmas-carols/header-bg.jpg');
        }
        .teacher-gradient {
        ...
        .enter-email {
            background-image:url('https://www.musora.com/cdn-cgi/image/width=900,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/christmas-carols/email-bg.jpg');
        }
        @media (min-width: 768px) {
            .header-bg {
                background-size:cover;
                background-image: url('https://www.musora.com/cdn-cgi/image/width=1500,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/christmas-carols/header-bg.jpg');
            }
            .teacher-gradient {
            ...
            .enter-email {
                background-image:url('https://www.musora.com/cdn-cgi/image/width=1200,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/christmas-carols/email-bg.jpg');
            }
        }
        @media (min-width: 1024px) {
            .header-bg {
                background-image: url('https://www.musora.com/cdn-cgi/image/width=2500,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/christmas-carols/header-bg.jpg');
            }
            .teacher-gradient {
            ...
            .enter-email {
                background-image:url('https://www.musora.com/cdn-cgi/image/width=1500,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/christmas-carols/email-bg.jpg');
            }
        }
    </style>
@endsection
...
@php
    $carols = [
        [
            "img" => "https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/christmas-carols/albumcover01.jpg",
            "title" => "Deck the Halls",
        ],
        [
            "img" => "https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/christmas-carols/albumcover02.jpg",
            "title" => "Joy To The World",
        ],
        [
            "img" => "https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/christmas-carols/albumcover03.jpg",
            "title" => "O Holy Night",
        ],
        [
            "img" => "https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/christmas-carols/albumcover04.jpg",
            "title" => "Silent Night",
        ],
        [
            "img" => "https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/christmas-carols/albumcover05.jpg",
            "title" => "Jingle Bells",
        ],
    ];
...
@section('page-body')
    @include('pianote.lead-gen.partials.header1',[
        "lowerImg" => '<img class="h-10 md:h-20 lg:h-24" src="https://www.musora.com/cdn-cgi/image/width=1500,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/christmas-carols/logo.png" alt="christmas-carol-logo">',
    ...
    <section class="text-center text-white px-4 py-8 md:p-12 relative" style="background:#0b1618 url(https://www.musora.com/cdn-cgi/image/width=1500,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/christmas-carols/songs-bg.png) center center/cover;">
        <div class="px-5 py-6 md:p-10 lg:p-16 rounded-3xl relative z-10" style="background:#692220 url(https://www.musora.com/cdn-cgi/image/width=350,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/christmas-carols/songs-bg-tile.jpg) center center/250px;">
            <div class="container mx-auto">
                <img class="h-9 md:h-12 lg:h-14 mb-0.5 md:mb-1.5" src="https://www.musora.com/cdn-cgi/image/width=800,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/christmas-carols/xmas-eve.png" alt="xmas-eve">
                ...
                <div class="flex flex-wrap items-start justify-center mx-auto px-2 max-w-xs md:max-w-lg lg:max-w-5xl" >
                    @foreach ($carols as $carol)
                        <div class="px-1 md:px-3 inline-block w-1/2 md:w-1/3 lg:w-1/5 mb-2 md:mb-4 lg:mb-0">
                            <div class="border-4 rounded-xl w-full md:mb-1 overflow-hidden"><div class="aspect-1:1 bg-cover bg-black bg-center lazyload" data-bg="https://www.musora.com/cdn-cgi/image/width=350,quality=95/{{ $carol['img'] }}"></div></div>
        ...
        <img class="z-20 absolute top-0 left-0 h-20 md:h-48 lg:h-64" src="https://www.musora.com/cdn-cgi/image/width=500,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/christmas-carols/top-leaf.png" alt="top-leaf">
        <img class="z-20 absolute bottom-0 right-0 h-28 md:h-44 lg:h-52" src="https://www.musora.com/cdn-cgi/image/width=300,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/christmas-carols/bottom-leaf.png" alt="bottom-leaf">
    </section>
            ...
            <div class="flex flex-wrap items-start max-w-4xl mx-auto">
                @foreach ($features as $feature)
                    <div class="w-full md:w-1/3 px-3 mb-8 md:mb-0">
                        <img class="h-12 md:12 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=80,quality=95/{{ $feature['icon'] }}" alt="help-icon">
    ...
    <section class="text-center text-white relative pt-60 pb-8 md:py-20 lg:py-24 px-4 teacher-section lazyload" data-bg="https://www.musora.com/cdn-cgi/image/width=1600,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/christmas-carols/coach-bg.jpg">
        <div class="container mx-auto relative z-10">
            <div class="flex flex-wrap items-center mx-auto max-w-sm md:max-w-5xl md:px-3">
                <div class="w-full md:w-7/12 lg:w-1/2 z-20">
                    <img class="h-16 md:h-20 lg:h-28 py-1 mb-4 lg:mb-5 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=900,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/christmas-carols/coach-name.png" alt="coach-name">
    ...
    @include('pianote.lead-gen.partials.enter-email',[
        "content" => '
            <img class="h-10 md:h-20 lg:h-24" src="https://www.musora.com/cdn-cgi/image/width=1500,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/christmas-carols/logo.png" alt="christmas-carol-logo" >
