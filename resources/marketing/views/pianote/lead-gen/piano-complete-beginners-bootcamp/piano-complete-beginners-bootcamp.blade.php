@php
    $steps = [
          [
              'position' => 'left',
              'img' => 'https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/magic-of-piano-chords/Step1alt2.jpg',
              'desc' => 'Enter your email address. It’s free. That’s right - 100% free!'
          ],
          [
              'position' => 'right',
              'img' => 'https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/magic-of-piano-chords/Step2.jpg',
              'desc' => 'You’ll be emailed the link for the LIVE Zoom session. Save it!'
          ],
          [
              'position' => 'left',
              'img' => 'https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/magic-of-piano-chords/Step3.jpg',
              'desc' => 'Log in for your LIVE lesson with Lisa.'
          ],
          [
              'position' => 'right',
              'img' => 'https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/magic-of-piano-chords/Step4.jpg',
              'desc' => 'Get your downloadable resources, practice tips, and connect with Lisa via email.'
          ],
          [
              'position' => 'left',
              'img' => 'https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/magic-of-piano-chords/Step5.jpg',
              'desc' => 'Post your progress (if you want - it’s totally up to you).'
          ],
          [
              'position' => 'right',
              'img' => 'https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/magic-of-piano-chords/Step6.jpg',
...
@section('meta')
    @parent
    <title>Piano For Complete Beginners Live Bootcamp | Pianote</title>
    ...
    <meta property="og:image" content="https://www.musora.com/cdn-cgi/image/width=1200,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/magic-of-piano-chords/share_image.jpg">
...
@section('head')
    <style>
        ...
        .header {
            ...
            background-image: url('https://www.musora.com/cdn-cgi/image/width=700,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/magic-of-piano-chords/header_m.jpg');
        }
        ...
        @media (min-width: 768px) {
            .header {
                background-image: url('https://www.musora.com/cdn-cgi/image/width=2000,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/magic-of-piano-chords/header.jpg');
...
@section('page-body')
            ...
            <div class="flex flex-wrap items-center">
                ...
                <div class="w-full md:w-7/12 lg:w-1/2 md:text-left">
                    <div class="pl-2 sm:pl-3">
                        ...
                        {{--<img class="h-12 sm:h-14 lg:h-16 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=840,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/magic-of-piano-chords/logo_left.png" alt="logo">--}}
                        ...
                        <p class="leading-tight mb-4" style="color:#fcffe3">
                            <em>Transform your piano playing in 90 minutes with<br class="hidden sm:inline">
    ...
    <section class="text-white py-12 sm:py-20 px-4 sm:px-6 bg-musora-black">
        <div class="max-w-3xl lg:max-w-4xl mx-auto">
            <div class="md:grid md:grid-cols-2 sm:gap-6 md:gap-16 lg:gap-20 items-center justify-center flex flex-col mx-auto">
                <img class="sm:order-1 rounded-md sm:w-2/3 mb-7 md:mb-0 md:w-auto mx-auto lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=810,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/magic-of-piano-chords/collage.png" alt="intro image">
                <div class="inline-flex flex-col">
                    ...
                    <p class="sm:leading-tight md:leading-normal sm:max-w-lg md:max-w-auto" style="color:#A4AFC7;">
                        ...
                        <br><br>
                        You’ll want to be at your piano for this one. Simply enter your email to save your spot.
                    </p>
                </div>
    ...
    <section class="px-4 py-12 sm:py-20">
        <div class="max-w-md sm:max-w-3xl lg:max-w-6xl mx-auto">
            <div class="sm:grid sm:grid-cols-2 sm:gap-6 md:gap-12 lg:gap-20 items-center text-center">
                <img class="rounded-md h-72 sm:h-80 lg:h-96 mb-7 sm:mb-0 mx-auto lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=660,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/magic-of-piano-chords/ui2.png" alt="intro image">
                <div class="inline-flex flex-col text-left">
                    ...
                    <p class="leading-tight" style="color:#6A6868;">
                        ...
                        <br><br>
                        You’ll also meet piano players from all over the world who are going through the same journey.
                        <br><br>
    ...
    <section class="px-4 py-14 sm:py-20 md:pb-32 bg-musora-black">
        <div class="max-w-3xl lg:max-w-4xl mx-auto text-white relative">
            <div class="w-3/4 sm:w-2/3 mx-auto relative md:static text-center mb-8">
                <img class="md:w-80 lg:w-96 md:absolute -bottom-10 right-2 md:border-8 rounded-3xl md:border-solid border-musora-black lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=700,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/magic-of-piano-chords/profile_pic.png" alt="coach image">
            </div>
    ...
    <section class="py-20 sm:py-28 bg-cover lazyload" style="background-color:#3d151a;background-position: 25% 50%;" data-bg="https://www.musora.com/cdn-cgi/image/width=1500,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/magic-of-piano-chords/footer.png">
        <div class="max-w-2xl lg:max-w-3xl mx-auto text-center text-white px-4">
            <h1 class="leading-none font-bebas uppercase" style="color:#fcffe3">PIANO FOR COMPLETE BEGINNERS</h1>
            <h3 class="tracking-widest">LIVE BOOTCAMP</h3>
            {{--<img class="mb-4 h-12 sm:h-16 lg:h-20 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=1040,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/magic-of-piano-chords/logo_centre.png" alt="logo">--}}
            <h5 class="my-2">
