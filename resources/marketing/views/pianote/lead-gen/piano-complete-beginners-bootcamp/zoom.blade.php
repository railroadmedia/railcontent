...
@section('page-body')
    ...
    <section class="text-center text-white py-8 md:py-12 lg:py-20 px-5 md:px-7" style="background:#00101d ;">
        <div class="container mx-auto text-center max-w-2xl">
            ...
            <a target="_blank" class=" @if(Carbon\Carbon::create(2022, 9, 13, 16, 0, 0, 'America/Vancouver') < Carbon\Carbon::now()) sold-out @endif join medium" href="https://us06web.zoom.us/j/5246384908?pwd=TjRIbE45N0JqK0lSSUpvUTZ3cCtqZz09">Afternoon Session - 2pm PDT &raquo;</a>
