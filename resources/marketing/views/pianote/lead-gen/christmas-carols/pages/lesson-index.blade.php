...
@section('page-body')
    <header class="header text-center text-white py-6 md:py-12 lg:py-16 px-4 bg-top bg-no-repeat relative" style="background-color:#010519; background-image:url(https://www.musora.com/musora-cdn/image/width=1500,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/christmas-carols/email-bg.jpg);">
        <div class="container mx-auto relative z-10 max-w-4xl">
            <img class="h-10 md:h-20 lg:h-24" src="https://www.musora.com/musora-cdn/image/width=1500,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/christmas-carols/logo.png">
        </div>
    </header>
            ...
            <div class="flex flex-wrap items-start justify-center mx-auto max-w-xs md:max-w-xl lg:max-w-4xl px-0 md:px-2 my-8">
                @foreach ($lessons as $lesson)
                    <a href="{{ $lesson['watchLink'] }}" class="px-2 lg:px-4 w-1/2 md:w-1/3 mb-7">
                        <div class="aspect-1:1 border-4 rounded-xl w-full bg-cover bg-black bg-center mb-2 cursor-pointer hover:opacity-90 transition-opacity duration-300 relative" style="background-image:url(https://www.musora.com/musora-cdn/image/width=500,quality=95/{{ $lesson['boxImage'] }});">
