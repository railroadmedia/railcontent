...
@section('global-body')
    ...
    <header class="text-black px-5 sm:px-6 py-10 sm:py-20 lg:py-36 relative" style="background-color:#F4F1EC;">
        ...
        <div class="container max-w-5xl mx-auto relative z-10">
            <div class="flex flex-wrap sm:flex-nowrap items-center">
                <div class="w-full sm:w-1/2 text-center lg:text-left lg:pr-6">
                    <img class="h-16 lg:h-24 lg:-ml-5 mx-0 pl-2 sm:pl-3" alt="logo" fetchpriority="high"
                        src="https://d21q7xesnoiieh.cloudfront.net/fit-in/700x0/filters:quality(95)/marketing/pianote/lead-gen/digital-christmas-songbook/logo.webp">
                        <div class="w-full sm:hidden">
                            <img class="w-full px-10" alt="logo" fetchpriority="high"
                            src="https://d21q7xesnoiieh.cloudfront.net/fit-in/700x0/filters:quality(95)/marketing/pianote/lead-gen/digital-christmas-songbook/devices.webp">
                        </div>
                    <h2 class="py-2"><strong>The Pianote Digital <br class="block"> Christmas Songbook</strong></h2>
                    <p class="leading-normal pl-2 sm:pl-3">Play 10 of the most beautiful and popular Christmas classics.</p>
                    <p class="leading-normal pl-2 sm:pl-3 py-2"><strong>Enter your email address to get your FREE E-Book instantly.</strong></p>
    ...
    <section class="text-white text-left px-5 sm:px-6 py-12 sm:py-16 relative" style="background:#F1F7FE;">
        <div class="inset-0 absolute z-0 bg-top bg-cover block sm:hidden" style="background:url('https://d21q7xesnoiieh.cloudfront.net/fit-in/0x0/filters:quality(95)/marketing/pianote/lead-gen/digital-christmas-songbook/list-bg-m.webp')"></div>
        <div class="inset-0 absolute z-0 bg-top bg-cover hidden sm:block" style="background:url('https://d21q7xesnoiieh.cloudfront.net/fit-in/0x0/filters:quality(95)/marketing/pianote/lead-gen/digital-christmas-songbook/list-bg.webp')"></div>
        <div class="container max-w-5xl mx-auto relative z-10">
            <div class="flex flex-wrap sm:flex-nowrap items-start md:items-center">
                <div class="w-full sm:w-1/2 sm:pl-5 order-1 sm:order-2 mb-5 sm:mb-0">
                    <img class="w-full" alt="list" fetchpriority="high"
                        src="https://d21q7xesnoiieh.cloudfront.net/fit-in/1000x0/filters:quality(95)/marketing/pianote/lead-gen/digital-christmas-songbook/list.webp">
                </div>
                <div class="w-full sm:w-1/2 max-w-md sm:pr-10 lg:pr-12 lg:pl-4 order-2 sm:order-1">
    ...
    <section class="text-center text-white pt-10 sm:pt-14 lg:pt-20 bg-cover bg-center" style="background-color:#2a2f34;background-image:url('https://d21q7xesnoiieh.cloudfront.net/fit-in/1500x0/filters:quality(95)/marketing/pianote/lead-gen/digital-christmas-songbook/piano-bg.webp');">
        ...
        <a target="_blank" href="https://musora-image-processing-cdn.s3.us-east-2.amazonaws.com/marketing/pianote/lead-gen/digital-christmas-songbook/pianote-christmas-songbook-sample.pdf)" class="relative">
            <img class="inline-block sm:hidden w-full transition-all opacity-0" src="https://d21q7xesnoiieh.cloudfront.net/fit-in/1500x0/filters:quality(95)/marketing/pianote/lead-gen/digital-christmas-songbook/piano-m.webp" alt="tablet piano" loading="lazy" onload="this.classList.remove('opacity-0')">
            <img class="hidden sm:inline-block w-full transition-all opacity-0" src="https://d21q7xesnoiieh.cloudfront.net/fit-in/2500x0/filters:quality(95)/marketing/pianote/lead-gen/digital-christmas-songbook/piano.webp" alt="tablet piano" loading="lazy" onload="this.classList.remove('opacity-0')">
        </a>
    </section>
