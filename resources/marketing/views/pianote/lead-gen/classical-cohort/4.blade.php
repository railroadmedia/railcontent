...
@section('global-body')
    ...
    <section class="text-center text-white py-5 md:py-10 lg:py-16 px-5 md:px-7" style="background:#00101d ;">
        <div class="container mx-auto text-center">
            <h2><strong>Classical Cohort - <br class="inline sm:hidden">Week 4 - Contemporary</strong></h2>
            <div class="flex flex-wrap my-5 sm:my-7">
                <div class="w-full lg:w-9/12">
                    <div class="w-full relative aspect-16:9">
                        <iframe class="absolute w-full h-full" src="https://www.youtube.com/embed/p2VR7l2M6uo" frameborder="0" allowfullscreen allow="autoplay" title="pianote-video"></iframe>
                    </div>
                </div>
                <div class="w-full lg:w-3/12 h-96 lg:h-auto">
                    <div class="w-full h-full relative">
                        <iframe class="absolute w-full h-full" src="https://www.youtube.com/live_chat?v=p2VR7l2M6uo&embed_domain=www.pianote.com" frameborder="0" allowfullscreen allow="autoplay" title="pianote-video"></iframe>
                    </div>
                </div>
            </div>
