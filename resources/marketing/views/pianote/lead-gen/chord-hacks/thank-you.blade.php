    ...
    <div class="overflow-hidden text-white px-3 py-5 sm:py-7 lg:py-12" style="background-color:#000a1e;">
        <div class="container mx-auto max-w-2xl clearfix">
            <div class="text-center sm:px-3">
                ...
                <div class="w-full relative mx-auto inline-block rounded-xl mb-7 bg-contain bg-top bg-no-repeat lazyload" style="padding-bottom: 77%;" data-bg="https://www.musora.com/musora-cdn/image/width=1200,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/chord-hacks/2023/header-image-m.png"></div>
