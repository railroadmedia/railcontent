...
@section('global-head')
    <title>Pianote Recital</title>
    <meta property="og:title" content="Pianote Recital">
    ...
    <meta property="og:url" content="https://www.pianote.com/recitals/">
...
@section('global-body')
            ...
            <div class="text text-center">
                ...
                <p class="leading-none">
                    <strong>Share your progress with the community!</strong> <br>
                        Submission deadline <strong class="text-pianote">May 31st, 2022.</strong></p>
            </div>
        </div>
    </div>
    <section class="text-center text-white py-5 md:py-10 lg:py-16 px-5 md:px-7" style="background:#00101d ;">
        <div class="container mx-auto max-w-5xl">
            ...
            <h3 class="leading-tight"><strong>Share your progress with Lisa, <br> Sam, and the Pianote Community!</strong></h3>
            ...
            <div class="flex flex-wrap items-start justify-center mx-auto max-w-4xl">
                <div class="flex flex-wrap items-start flex-image mx-auto w-full md:w-4/12 lg:w-5/12 md:order-1 mb-5 md:mb-0 justify-center">
                    <img class="h-60 md:h-auto" src="https://d2vyvo0tyx8ig5.cloudfront.net/sales/promos/november/recitals-spread.png">
                </div>
                <div class="text-left md:pr-3 lg:pr-8 w-full md:w-8/12 lg:w-7/12">
                    <p class="mx-auto">With close to 20,000 Pianote members, this will no doubt be our biggest Piano Recital yet!
                        <br><br>
                        This amazing community event is all about sharing your progress with your fellow community members and we cannot wait for it to start!
                        <br><br>
                        Don’t worry, we’ve made it super easy to submit your performance this year.
                        <br><br>
                        You can choose to submit ANY video clip of you playing the piano.
                        <br><br>
                        Any song, routine, riff, or fill!
                        <br><br>
                        Anything that you learned this year and you’re proud of.
                        <br><br>
                        That’s it!
                        <br><br>
                        Then all that’s left is to join Lisa, Sam, and the rest of the Pianote community to cheer on your peers at the recitals, dates to be announced soon!
                        <br><br>
    ...
    <section class="py-5 md:py-10 lg:py-16" style="background:#000 url(https://d2vyvo0tyx8ig5.cloudfront.net/sales/promos/november/recitals-bg.jpg) center center/cover;">
        <div class="container mx-auto max-w-3xl">
            <div id="form" class="anchor"></div>
            <iframe class="google-form w-full" src="https://docs.google.com/forms/d/e/1FAIpQLSfhDFwjTg-DXd3wvDgmU91KHoPGPHrynGdyDPw7YcxU85ekHg/viewform?embedded=true" height="2177" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
