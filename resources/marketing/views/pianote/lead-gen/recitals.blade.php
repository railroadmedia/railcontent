...
@section('global-body')
        ...
        <div class="container mx-auto max-w-5xl">
            ...
            <div class="flex flex-wrap items-start justify-center mx-auto max-w-4xl">
                <div class="flex flex-wrap items-start flex-image mx-auto w-full md:w-4/12 lg:w-5/12 md:order-1 mb-5 md:mb-0 justify-center">
                    <img class="h-60 md:h-auto" src="https://pianote.s3.amazonaws.com/sales/promos/november/recitals-spread.png">
                </div>
    ...
    <section class="py-5 md:py-10 lg:py-16" style="background:#000 url(https://pianote.s3.amazonaws.com/sales/promos/november/recitals-bg.jpg) center center/cover;">
