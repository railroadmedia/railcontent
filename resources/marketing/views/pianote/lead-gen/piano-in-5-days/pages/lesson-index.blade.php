...
@section('page-body')
    <header class="header text-center text-white py-12 md:py-18 lg:py-20 px-4 bg-center bg-no-repeat relative" style="background-color:#010519; background-image:url(https://www.musora.com/musora-cdn/image/width=1500,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/piano-in-5-days/bottom_bg.jpg);">
        <div class="container mx-auto relative z-10 max-w-4xl">
            <img class="h-16 md:h-20 lg:h-44" src="https://www.musora.com/musora-cdn/image/width=900,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/piano-in-5-days/logo.png">
        </div>
    </header>
