...
@section('head')
    ...
    <style>
        ...
        @media (min-width: 768px) {
            header {
                background-image: url('https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/7-days-to-sight-reading/header_lessons.jpg');
...
@section('page-body')
    <header class="bg-no-repeat bg-top py-6 md:py-20">
        <div class="max-w-md md:max-w-3xl mx-auto text-white md:pl-16 lg:pl-0 text-center md:text-left px-4 md:px-0">
            <img class="h-16 mb-96 md:mb-2 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=350,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/7-days-to-sight-reading/logo.png" alt="logo">
    ...
    <section class="text-center py-12 md:py-20 text-white bg-center bg-cover lazyload" style="background-color:#000417;" data-bg="https://www.musora.com/musora-cdn/image/width=1500,q_60,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/7-days-to-sight-reading/footer_lessons.jpg">
