            ...
            <div class="flex flex-wrap my-5 sm:my-7">
                <div class="w-full lg:w-9/12">
                    <div class="w-full relative aspect-16:9">
                        <iframe class="absolute w-full h-full" src="https://www.youtube.com/embed/pKW2HwoFUxE" frameborder="0" allowfullscreen allow="autoplay" title="pianote-video"></iframe>
                    </div>
                </div>
                <div class="w-full lg:w-3/12 h-96 lg:h-auto">
                    <div class="w-full h-full relative">
                        <iframe class="absolute w-full h-full" src="https://www.youtube.com/live_chat?v=pKW2HwoFUxE&embed_domain=www.pianote.com" frameborder="0" allowfullscreen allow="autoplay" title="pianote-video"></iframe>
                    </div>
                </div>
            </div>
