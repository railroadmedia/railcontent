...
@section('page-body')
    <header class="header text-center text-white py-6 lg:py-16 px-4 bg-top bg-no-repeat relative" style="background-color:#010519; background-image:url(https://www.musora.com/musora-cdn/image/width=2500,q_60,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/learn-3-songs/header.jpg);">
        <div class="container mx-auto relative z-10 max-w-4xl">
            <div class="flex flex-wrap items-center justify-end">
                <div class="w-full md:w-1/2">
                    <img class="w-2/3 lg:w-10/12" src="https://www.musora.com/musora-cdn/image/width=900,q_60,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/learn-3-songs/logo-vertical.png">
                </div>
            </div>
        </div>
        ...
        <div class="container mx-auto">
            ...
            <div class="flex flex-wrap items-start mx-auto max-w-xs md:max-w-xl lg:max-w-6xl px-6 md:px-2 my-12">
                ...
                <a href="/learn-songs/lessons/someone-you-loved" class="px-2 md:px-4 w-full md:w-1/2 lg:w-1/4 mb-7 lg:mb-0">
                    <div class="aspect-1:1 border-4 rounded-xl w-full bg-cover bg-black bg-center mb-2 cursor-pointer hover:opacity-90 transition-opacity duration-300 relative" style="background-image:url(https://www.musora.com/musora-cdn/image/width=350,q_60,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/learn-3-songs/album-lewis.webp);">
                        <i class="fas fa-play bg-pianote rounded-full p-3 absolute bottom-0 left-0 m-2 text-center" style="text-indent: 2px;"></i>
                    </div>
                ...
                <a href="/learn-songs/lessons/hallelujah" class="px-2 md:px-4 w-full md:w-1/2 lg:w-1/4 mb-7 lg:mb-0">
                    <div class="aspect-1:1 border-4 rounded-xl w-full bg-cover bg-black bg-center mb-2 cursor-pointer hover:opacity-90 transition-opacity duration-300 relative" style="background-image:url(https://www.musora.com/musora-cdn/image/width=350,q_60,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/learn-3-songs/album-leonard.webp);">
                        <i class="fas fa-play bg-pianote rounded-full p-3 absolute bottom-0 left-0 m-2 text-center" style="text-indent: 2px;"></i>
                    </div>
                ...
                <a href="/learn-songs/lessons/love-story" class="px-2 md:px-4 w-full md:w-1/2 lg:w-1/4 mb-7 lg:mb-0">
                    <div class="aspect-1:1 border-4 rounded-xl w-full bg-cover bg-black bg-center mb-2 cursor-pointer hover:opacity-90 transition-opacity duration-300 relative" style="background-image:url(https://www.musora.com/musora-cdn/image/width=350,q_60,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/learn-3-songs/album-taylor.webp);">
                        <i class="fas fa-play bg-pianote rounded-full p-3 absolute bottom-0 left-0 m-2 text-center" style="text-indent: 2px;"></i>
                    </div>
            ...
            <a class="join smaller mt-6" href="https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/learn-3-songs/lessons/learn-3-songs.zip">Download All PDFs</a>
        </div>
    </div>
    <section class="text-center py-14 md:py-24 lg:py-28 text-white bg-center bg-cover lazyload" style="background-color:#000417;" data-bg="https://www.musora.com/musora-cdn/image/width=1500,q_60,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/shop/header-background.jpg">
        <div class="container mx-auto">
            <div class="w-full px-2 md:px-3 text-center">
                <img class="w-full max-w-xs md:max-w-md lg:max-w-lg mb-5 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=1300,q_60,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/500-songs/sales/500-songs-logo.svg">
