...
@section('subtitle', 'Lewis Capaldi - Someone You Loved')

@section('caption', 'Start with this beautiful 4-chord ballad')

@section('video', '//player.vimeo.com/video/542728989')

@section('current-lesson-number', 2)

@section('previous')
    /learn-songs/lessons/intro
@endsection
...
@section('prev-thumb', 'https://i.vimeocdn.com/video/1123530929-9b5a5f5ff1cb24ce4a8fd6e1685a7fdc75112b59178a8510c861e933896aa9f0-d?mw=1000&mh=563')
...
@section('lesson-description')
    ...
    <p>We’ll be starting with a beautiful song that’s wildly popular, fun to play, super simple!
        ...
        <br><br> If you’re a complete beginner, it might be challenging to play a chord with 3 notes, so we’ll start by playing what I like to call a “power chord”. This chord has only 2 notes, a bottom note (which is also called the root note) and a top note.
        <br><br> Remember your musical alphabet? Because you’ll need it to find the notes that you’ll be using for your chords.
    ...
    <p>When you see a chord written above a word - that’s when you play it.
        ...
        <br><br> Put your right-hand thumb on C. And then notice how your fingers rest on top of the other white notes.
        <br><br> Now, with your pinky, play the G note. That is a C power chord. You can use this shape on ANY of the white notes in the musical alphabet to play a power chord on that note.
        <br><br> Let’s put that to work.
        <br><br> The next chord is a G. So find G on the keyboard (It’s under your pinky, remember?).
        <br><br> Now, put your thumb on G and let your fingers rest on the white notes. You’ll notice your pinky is sitting on the note D.
    ...
    <p>Dm?!
        ...
        <br><br> Then let your fingers rest on the notes so your pinky will be over the note A. That’s your power chord.
        <br><br> Simple! <br><br> <strong>A note on minor chords</strong>
        ...
        <br><br> Now go practice, and I’ll see you in the <a href="/learn-songs/lessons/hallelujah"><u>next lesson</u></a>.</p>
@endsection
