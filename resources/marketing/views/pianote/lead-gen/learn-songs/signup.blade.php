...
@section('page-body')
    <header class="header text-center text-white pt-20 pb-8 sm:py-9 px-4 bg-top bg-no-repeat relative" style="background-color:#010519; background-image:url(https://www.musora.com/musora-cdn/image/width=2500,q_60,quality=85/https://pianote.s3.amazonaws.com/lead-gen/learn-3-songs/header.jpg);">
        <div class="container mx-auto relative z-10">
            <div class="flex flex-wrap items-center md:py-10 lg:py-20">
                ...
                <div class="w-full md:w-1/2 px-10 md:px-0 my-5 md:my-0">
                    <img class="w-full max-w-xs lg:max-w-md" src="https://www.musora.com/musora-cdn/image/width=900,q_60,quality=85/https://pianote.s3.amazonaws.com/lead-gen/learn-3-songs/logo-vertical.png">
                </div>
            </div>
        ...
        <div class="container mx-auto">
            <div class="flex flex-wrap items-start max-w-xl mx-auto px-2">
                <div class="px-1 md:px-3 inline-block w-1/3">
                    <div class="aspect-1:1 border-4 rounded-xl w-full bg-cover bg-black bg-center md:mb-1 cursor-pointer hover:opacity-90 transition-opacity duration-300 autoplay-video" data-open="songLewis" style="background-image:url(https://www.musora.com/musora-cdn/image/width=350,q_60,quality=85/https://pianote.s3.amazonaws.com/lead-gen/learn-3-songs/album-lewis.webp);"></div>
                    <p class="hidden md:inline"><strong>Someone You Loved</strong><br>
                    Lewis Capaldi</p>
                </div>
                <div class="px-1 md:px-3 inline-block w-1/3">
                    <div class="aspect-1:1 border-4 rounded-xl w-full bg-cover bg-black bg-center md:mb-1 cursor-pointer hover:opacity-90 transition-opacity duration-300 autoplay-video" data-open="songLeonard" style="background-image:url(https://www.musora.com/musora-cdn/image/width=350,q_60,quality=85/https://pianote.s3.amazonaws.com/lead-gen/learn-3-songs/album-leonard.webp);"></div>
                    <p class="hidden md:inline"><strong>Hallelujah</strong><br>
                    Leonard Cohen</p>
                </div>
                <div class="px-1 md:px-3 inline-block w-1/3">
                    <div class="aspect-1:1 border-4 rounded-xl w-full bg-cover bg-black bg-center md:mb-1 cursor-pointer hover:opacity-90 transition-opacity duration-300 autoplay-video" data-open="songTaylor" style="background-image:url(https://www.musora.com/musora-cdn/image/width=350,q_60,quality=85/https://pianote.s3.amazonaws.com/lead-gen/learn-3-songs/album-taylor.webp);"></div>
        ...
        <div class="container mx-auto">
            ...
            <div class="flex flex-wrap items-center mx-auto max-w-sm md:max-w-4xl md:px-3 mt-16 md:mt-32">
                <div class="w-full md:w-5/12 lg:w-1/2 md:order-1 -mb-80 md:mb-0 relative">
                    <img class="md:border-4 md:rounded-xl lazyload w-full" data-src="https://www.musora.com/musora-cdn/image/width=900,q_60,quality=85/https://pianote.s3.amazonaws.com/lead-gen/learn-3-songs/lisa.png">
                ...
                <div class="w-full md:w-7/12 lg:w-1/2 px-4 md:pl-0 md:pr-8 lg:pr-14 z-20">
                    <img class="w-3/4 lg:w-full lazyload" data-src="https://www.musora.com/musora-cdn/image/width=750,q_60,quality=85/https://pianote.s3.amazonaws.com/lead-gen/learn-3-songs/lisa-name.png">
            ...
            <div class="flex flex-wrap items-start max-w-4xl mx-auto mt-12 md:mt-20">
                <div class="w-full md:w-1/2 px-7 lg:px-14 mb-14 md:mb-0">
                    <img class="border-4 rounded-full border-white w-28 md:w-32 lg:w-40 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=320,q_60,quality=85/https://pianote.s3.amazonaws.com/500-songs/sales/marcel.jpg">
                ...
                <div class="w-full md:w-1/2 px-7 lg:px-14">
                    <img class="border-4 rounded-full border-white w-28 md:w-32 lg:w-40 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=320,q_60,quality=85/https://pianote.s3.amazonaws.com/500-songs/sales/bernhard.jpg">
    ...
    <section class="text-center py-14 md:py-24 lg:py-28 text-white bg-black bg-center bg-cover lazyload" style="background-color:#000417;" data-bg="https://www.musora.com/musora-cdn/image/width=1500,q_60,quality=85/https://pianote.s3.amazonaws.com/shop/header-background.jpg">
        <div class="container mx-auto">
            <div class="w-full px-2 md:px-3 text-center">
                <img class="inline md:hidden w-3/4 mb-5 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=900,q_60,quality=85/https://pianote.s3.amazonaws.com/lead-gen/learn-3-songs/logo-vertical.png">
                <img class="hidden md:inline w-full max-w-lg lg:max-w-2xl mb-10 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=1300,q_60,quality=85/https://pianote.s3.amazonaws.com/lead-gen/learn-3-songs/logo-horizontal.png">
