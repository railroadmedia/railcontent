    ...
    <div class="overflow-hidden text-white px-3 py-5 sm:py-7" style="background-color:#030317;">
        <div class="container mx-auto clearfix" style="max-width:940px">
            <div class="text-center sm:px-3">
                <img class="logo mx-auto inline-block w-40 sm:w-56" src="https://cdn.musora.com/image/fetch/w_448,q_60,q_auto:best/https://pianote.s3.amazonaws.com/lead-gen/learn-3-songs/logo-horizontal.png">
