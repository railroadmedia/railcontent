...
@section('head')
    ...
    <style>
        .header-bg {
            ...
            background-image: url('https://www.musora.com/cdn-cgi/image/width=1400,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/classical-piano/header2.jpg');
        }
        .teacher-gradient {
        ...
        .enter-email {
            background-image:url('https://www.musora.com/cdn-cgi/image/width=900,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/classical-piano/final-bg.jpg');
        }
        @media (min-width: 768px) {
            .header-bg {
                background-size:cover;
                background-image: url('https://www.musora.com/cdn-cgi/image/width=1500,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/classical-piano/header2.jpg');
            }
            .teacher-gradient {
            ...
            .enter-email {
                background-image:url('https://www.musora.com/cdn-cgi/image/width=1200,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/classical-piano/final-bg.jpg');
            }
        }
        @media (min-width: 1024px) {
            .header-bg {
                background-image: url('https://www.musora.com/cdn-cgi/image/width=2500,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/classical-piano/header2.jpg');
            }
            .teacher-gradient {
            ...
            .enter-email {
                background-image:url('https://www.musora.com/cdn-cgi/image/width=1500,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/classical-piano/final-bg.jpg');
            }
        }
    </style>
@endsection
...
@section('page-body')
    @include('pianote.lead-gen.partials.header1',[
        "lowerImg" => '<img class="h-10 md:h-20 lg:h-24" src="https://www.musora.com/cdn-cgi/image/width=1500,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/classical-piano/logo.png" alt="classical-piano-logo">',
    ...
    <section class="text-center text-white px-4 py-10 md:px-10 md:py-16 lg:py-24 lg:px-16 relative" style="background:#0b1618 url(https://www.musora.com/cdn-cgi/image/width=1500,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/classical-piano/promo-bg.jpg) center center/cover;">
                ...
                <div class="flex flex-wrap items-start justify-center mx-auto max-w-xs md:max-w-2xl lg:max-w-5xl" >
                    @foreach ($features as $feature)
                        <div class="px-1.5 lg:px-3 inline-block w-1/2 md:w-1/4 mb-2 md:mb-0">
                            <div class="border-4 rounded-xl w-full md:mb-1 overflow-hidden"><div class="aspect-16:9 bg-cover bg-black bg-center" style="background-image:url(https://www.musora.com/cdn-cgi/image/width=350,quality=95/{{ $feature['img'] }});"></div></div>
                            <p class="leading-tight text-sm hidden md:inline-block"><strong>{{ $feature['title'] }}</strong></p>
                        </div>
                    @endforeach
                </div>
            </div>
            <img class="z-20 absolute transform top-0 left-0 h-14 md:h-20 lg:h-24" src="https://www.musora.com/cdn-cgi/image/width=200,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/classical-piano/corner.png" alt="corner-decoration">
            <img class="z-20 absolute transform rotate-90 top-0 right-0 h-14 md:h-20 lg:h-24" src="https://www.musora.com/cdn-cgi/image/width=200,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/classical-piano/corner.png" alt="corner-decoration">
            <img class="z-20 absolute transform -rotate-90 bottom-0 left-0 h-14 md:h-20 lg:h-24" src="https://www.musora.com/cdn-cgi/image/width=200,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/classical-piano/corner.png" alt="corner-decoration">
            <img class="z-20 absolute transform rotate-180 bottom-0 right-0 h-14 md:h-20 lg:h-24" src="https://www.musora.com/cdn-cgi/image/width=200,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/classical-piano/corner.png" alt="corner-decoration">
        </div>
    </section>
    <section class="text-center text-white relative pt-60 pb-8 md:py-20 lg:py-24 px-4 teacher-section lazyload" data-bg="https://www.musora.com/cdn-cgi/image/width=1600,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/classical-piano/victoria-bg2.jpg">
    ...
    @include('pianote.lead-gen.partials.enter-email',[
        "content" => '
            <img class="h-10 md:h-20 lg:h-24" src="https://www.musora.com/cdn-cgi/image/width=1500,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/classical-piano/logo.png" alt="classical-piano-logo">
