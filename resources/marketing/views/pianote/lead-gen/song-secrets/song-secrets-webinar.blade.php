                                ...
                                <li class="splide__slide px-2 flex">
                                    <div class="p-7 border border-black rounded-lg">
                                        <div class="sm:flex items-start justify-start mb-3">
                                            <img class="h-14 sm:h-16 rounded-full transition-all opacity-0" src="https://www.musora.com/cdn-cgi/image/width=160,quality=95/{{ $testimonial['image'] }}" alt="testimonial {{ $key }}" loading="lazy" onload="this.classList.remove('opacity-0')">
