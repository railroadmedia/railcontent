...
@section('meta')
    ...
    <meta property="og:image" content="https://www.musora.com/cdn-cgi/image/width=1200,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/piano-in-5-days/og-image.jpg" style="display: none;">
...
@section('head')
    ...
    <style>
        ...
        header {
            background-image:url('https://www.musora.com/cdn-cgi/image/width=800,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/piano-in-5-days/header-m.jpg');
        ...
        @media (min-width:768px) {
            header {
                background-image:url('https://www.musora.com/cdn-cgi/image/width=2500,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/piano-in-5-days/header.jpg');
                background-size:cover;
            }
...
@section('page-body')
        ...
        <div class="max-w-4xl mx-auto px-2 sm:px-4 lg:px-0">
            <div class="flex flex-wrap items-center">
                <div class="w-full mb-5 sm:mb-0 sm:w-2/5 sm:order-1 text-center">
                    <img class="inline-block sm:hidden h-20 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=740,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/piano-in-5-days/logo.png" alt="logo white"><br>
                ...
                <div class="w-full sm:w-3/5 text-center sm:text-left">
                    <div class="px-1">
                        <img class="hidden sm:inline-block sm:h-20 lg:h-24 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=740,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/piano-in-5-days/logo.png" alt="logo white">
        ...
        <div class="max-w-5xl mx-auto">
                <div class="flex flex-wrap flex-col md:flex-row md:items-center">
                    ...
                    <div class="flex justify-center md:justify-start w-full md:w-1/2 sm:order-1 md:pl-6 mt-7 sm:mt-0 relative">
                        <img class="max-w-2xl md:max-w-md lg:max-w-2xl lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=1300,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/piano-in-5-days/collage.png" alt="collage">
                    </div>
                </div>
            </div>
    </section>
            ...
            <div class="flex flex-wrap justify-center mb-14">
                <div class="w-full sm:w-1/3 px-4 sm:px-2 mb-6">
                    <div class="relative mb-4 autoplay-video cursor-pointer text-white" data-open="lesson">
                        ...
                        <img class="relative z-0 rounded-lg border-4 border-pianote lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=740,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/piano-in-5-days/day-1.jpg" alt="lesson-1">
                    </div>
                    <p>
                ...
                <div class="w-full sm:w-1/3 px-4 sm:px-2 mb-6">
                    <div class="relative mb-4">
                        <img class="relative z-0 rounded-lg lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=740,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/piano-in-5-days/day-2.jpg" alt="lesson-2">
                    </div>
                    <p>
                ...
                <div class="w-full sm:w-1/3 px-4 sm:px-2 mb-6">
                    <div class="relative mb-4">
                        <img class="relative z-0 rounded-lg lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=740,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/piano-in-5-days/day-3.jpg" alt="lesson-3">
                    </div>
                    <p>
                ...
                <div class="w-full sm:w-1/3 px-4 sm:px-2 mb-6">
                    <div class="relative mb-4">
                        <img class="relative z-0 rounded-lg lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=740,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/piano-in-5-days/day-4.jpg" alt="lesson-4">
                    </div>
                    <p>
                ...
                <div class="w-full sm:w-1/3 px-4 sm:px-2 mb-6">
                    <div class="relative mb-4">
                        <img class="relative z-0 rounded-lg lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=740,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/piano-in-5-days/day-5.jpg" alt="lesson-5">
                    </div>
                    <p>
        ...
        <div class="max-w-2xl mx-auto text-center">
            ...
            <div class="flex flex-wrap sm:flex-nowrap items-center text-left">
                <picture class="mb-5 md:mb-0 sm:order-1">
                    <source media="(min-width:768px)" srcset="https://www.musora.com/cdn-cgi/image/width=740,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/piano-in-5-days/3-image.png">
                    <img class="h-56 md:h-72 lg:h-80 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=300,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/piano-in-5-days/3-image-m.png" alt="3-image">
                </picture>
    ...
    <section class="py-20 relative" style="background:#01050F;">
        ...
        <div class="max-w-sm md:max-w-4xl mx-auto px-4 sm:px-0 text-white lg:gap-10 relative flex flex-col md:flex-row lg:block items-center justify-center text-right">
            <picture>
                <source media="(min-width:768px)" srcset="https://www.musora.com/cdn-cgi/image/width=740,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/getting-started-2022/coach.jpg">
                <img class="rounded-lg lg:absolute lg:left-10 lg:top-0 h-72 md:h-96 lg:h-full mb-10 md:mb-0 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=300,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/getting-started-2022/coach-m.jpg" alt="jared profile">
            </picture>
            ...
            <div class="flex flex-wrap max-w-md mx-auto sm:max-w-full">
                <div class="w-full sm:w-1/2 lg:w-1/4 flex flex-auto px-2 mb-8 md:mb-4 lg:mb-0">
                    <div class="rounded-xl overflow-hidden w-full" style="background: #051124;">
                        <div class="aspect-16:9 relative bg-top bg-cover py-10 lazyload" data-bg="https://www.musora.com/cdn-cgi/image/width=740,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/2022/testimonials/jessripley.jpg">
                        </div>
                        <div class="p-4">
                            <p class="italic mb-4">
                ...
                <div class="w-full sm:w-1/2 lg:w-1/4 flex flex-auto px-2 mb-8 md:mb-4 lg:mb-0">
                    <div class="rounded-xl overflow-hidden w-full" style="background: #051124;">
                        <div class="aspect-16:9 relative bg-top bg-cover py-10 lazyload" data-bg="https://www.musora.com/cdn-cgi/image/width=740,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/2022/testimonials/nabilabdelmoneim.jpg" >
                        </div>
                        <div class="p-4">
                            <p class="italic mb-4">
                ...
                <div class="w-full sm:w-1/2 lg:w-1/4 flex flex-auto px-2 mb-8 sm:mb-0">
                    <div class="rounded-xl overflow-hidden w-full" style="background: #051124;">
                        <div class="aspect-16:9 relative bg-top bg-cover py-10 lazyload" data-bg="https://www.musora.com/cdn-cgi/image/width=740,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/2022/testimonials/xitlalicaballero2.jpg">
                        </div>
                        <div class="p-4">
                            <p class="italic mb-4">
                ...
                <div class="w-full sm:w-1/2 lg:w-1/4 flex flex-auto px-2">
                    <div class="rounded-xl overflow-hidden w-full" style="background: #051124;">
                        <div class="aspect-16:9 relative bg-top bg-cover py-10 lazyload" data-bg="https://www.musora.com/cdn-cgi/image/width=740,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/sales/2022/testimonials/serenadorward.jpg">
                        </div>
                        <div class="p-4">
                            <p class="italic mb-4">
    ...
    <section class="text-center customize px-4 lg:px-6 relative z-50 overflow-hidden text-white py-20" style="background:#01050F;">
        <div class="max-w-5xl mx-auto flex flex-wrap flex-col md:flex-row md:items-center">
            <div class="max-w-lg mx-auto text-center sm:text-left w-full sm:w-7/12 lg:w-1/2 sm:pl-5">
                <img class="h-16 sm:h-20 lg:h-24 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=740,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/piano-in-5-days/logo.png" alt="logo">
            ...
            <div class="flex justify-center md:justify-start w-full sm:w-5/12 lg:w-1/2 sm:order-1 md:pl-6 mt-7 md:mt-0 relative">
                <img class="max-w-2xl md:max-w-md lg:max-w-2xl lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=800,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/piano-in-5-days/collage.png" alt="collage">
            </div>
        </div>
    </section>
        ...
        <div class="reveal large relative" style="background: transparent;" id="{{ str_replace(' ', '', $review['name']) }}" data-reveal data-reset-on-close="false">
            <div class="px-10 sm:px-20 relative" style="background: transparent;">
                <div class="max-w-xl mx-auto rounded-lg overflow-hidden" style="background: #051124;">
                    <img class="lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=700,quality=95/{{ $review['img'] }}" alt="{{ $review['name'] }}">
