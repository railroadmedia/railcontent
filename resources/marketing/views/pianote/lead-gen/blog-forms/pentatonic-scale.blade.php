...
<head>
    ...
    <title>Pentatonic Scale | Pianote</title>
...
<section class="text-center absolute top-1/2 left-1/2 w-full px-5" style="transform:translate(-50%,-50%)">
    <form id="PianoteEngagementTriggerPentatonicScaleWebForm" accept-charset="UTF-8" action="/customer-io/submit-email-form"
        ...
        <input type="hidden" name="form_name" value="Pentatonic Scale">
        <input type="hidden" name="leadtracker_form_name" value="Pentatonic Scale">
        ...
        <input name="inf_form_xid" type="hidden" value="PianoteEngagementTriggerPentatonicScaleWebForm">
        <input name="tag_names_to_add[]" type="hidden" value="Pianote - Engagement - Trigger - Pentatonic Scale - Web Form">
