...
@section('meta')
    ...
    <meta property="og:url" content="https://www.pianote.com/digital-chords-and-scales">
@endsection
...
@section('page-body')
    <header class="py-10 sm:py-14 bg-cover bg-center" style="background:linear-gradient(to bottom, #fcfbf9 70%, #f4f1ec);">
        <div class="max-w-5xl mx-auto sm:flex items-center container px-4 text-center sm:text-left">
            <div class="w-full sm:w-7/12 mx-auto sm:max-w-full">
                <div class="px-2 sm:px-3">
                    <img
                        class="filter invert h-24 sm:h-28 lg:h-32 mb-1 transition-opacity opacity-0"
                    ...
                    />
                    <p class="mb-4">This comprehensive e-book will help you learn every chord shape, chord variation, and scale in EVERY key.
                        <br><br>It’s the ultimate guide to mastering the building blocks of music on the piano.
                        <br><br><strong class="font-black">Enter your name and email address to get your FREE E-Book instantly.</strong></p>
                </div>
            ...
            <div class="w-full sm:w-5/12 sm:pl-5 lg:pl-7 hidden sm:block">
                <img
        ...
        <div class="container max-w-6xl mx-auto relative z-10">
            <div class="flex flex-wrap sm:flex-nowrap items-start lg:items-center">
                <div class="w-full sm:w-1/2 mb-5 sm:mb-0 sm:pr-10 lg:pr-12">
                    <h4 class="leading-tight mb-4 sm:mb-6"><strong>Master Every Chord. Every Scale. In Every Key.</strong></h4>
                ...
                <div class="w-full sm:w-1/2 sm:pl-5">
                    <h4 class="leading-tight mb-3 sm:mb-5"><strong>You’ll get:</strong></h4>
                    <style>
                    ...
                    <ul class="ml-6 fa-ul" style="column-gap: 20px;">
    ...
    <section class="final py-10 sm:py-14 bg-cover bg-center" style="background:linear-gradient(to bottom, #fcfbf9 66%, #f4f1ec);">
        <div class="max-w-5xl mx-auto sm:flex items-center container px-4 text-center sm:text-left">
            <div class="w-full sm:w-7/12 mx-auto sm:max-w-full">
                <div class="px-2 sm:px-3">
                    <img
                        ...
                        onload="this.classList.remove('opacity-0')"
                    />
                    <p class="mb-4">Enter your name and email address to get your FREE E-Book instantly.</p>
                </div>
                @include("pianote._partials.sign-up-form", [
                    "recaptchaKey" => $recaptchaKey,
                            "formName" => 'Digital Chords And Scales',
