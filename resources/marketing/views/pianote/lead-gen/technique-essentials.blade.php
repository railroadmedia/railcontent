...
@section('page-body')
        ...
        <div class="container max-w-4xl mx-auto">
            <div class="flex flex-wrap sm:flex-nowrap items-center">
                <div class="w-full sm:w-7/12 text-center md:text-left pr-0 sm:pr-6 md:pr-10">
                    <img class="h-20 md:h-28 lg:h-32 mb-4 sm:mb-2 lg:mb-3 md:pl-4" src="https://d21q7xesnoiieh.cloudfront.net/fit-in/1200x0/filters:quality(95)/marketing/pianote/lead-gen/technique-essentials/logo.webp" alt="logo" fetchpriority="high">
                ...
                <div class="w-full sm:w-6/12 hidden sm:block">
                    <div class="relative bg-contain bg-top cursor-pointer autoplay-video" style="padding-bottom: 102%;">
        ...
        <div class="container max-w-5xl mx-auto">
            ...
            <div class="flex flex-wrap justify-center mx-auto md:max-w-full text-left">
                ...
                @foreach($lessons as $key => $lesson)
                    <div class="w-full sm:w-1/2 lg:w-1/3 px-2 mb-6 sm:mb-8">
    ...
    <section class="bg-cover lg:bg-contain bg-center w-full pt-10" style="background-repeat: no-repeat; background-color: #EAE4DD; background-image:url('https://d21q7xesnoiieh.cloudfront.net/fit-in/3000x0/filters:quality(95)/marketing/pianote/lead-gen/technique-essentials/coach-bg.webp');">
        ...
        <div class="container mx-auto max-w-3xl py-4 px-4 md:px-6 pb-10 md:pb-20">
    ...
    <section class="text-center customize px-4 lg:px-6 relative z-50 overflow-hidden py-10 sm:py-20" style="background:#000000">
        <div class="max-w-5xl mx-auto flex flex-wrap flex-col md:flex-row md:items-center">
            ...
            <img class="h-20 md:h-28 lg:h-32 mb-4 sm:mb-2 lg:mb-3 md:pl-4 opacity-0 transition-opacity" loading="lazy" onload="this.classList.remove('opacity-0')" 
