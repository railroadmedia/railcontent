...
@section('page-body')
    <header class="px-5 sm:px-6 py-10 sm:py-14 lg:py-20 text-white" style="background:#000000;">
        <div class="container max-w-4xl mx-auto">
            <div class="flex flex-wrap sm:flex-nowrap items-center">
                <div class="w-full sm:w-7/12 text-center md:text-left pr-0 sm:pr-6 md:pr-10">
                    <img class="h-24 md:h-28 lg:h-32 mb-4 sm:mb-2 lg:mb-3 md:pl-4" src="https://d21q7xesnoiieh.cloudfront.net/fit-in/1200x0/filters:quality(95)/marketing/pianote/lead-gen/technique-essentials/logo.webp" alt="logo" fetchpriority="high">

                    <div class="max-w-xs sm:max-w-full mb-5 mx-auto rounded-xl overflow-hidden relative block sm:hidden bg-cover bg-top" style="padding-bottom: 75%;">
                   ...
                   <div class="md:pt-4 md:pl-4">
                        <div class="hidden md:inline">
                            <p class="pb-1 md:pb-3"><i class="fas fa-check text-pianote"></i> Build stronger fingers</p>
                            <p class="pb-1 md:pb-3"><i class="fas fa-check text-pianote"></i> Improve your coordination</p>
                            <p><i class="fas fa-check text-pianote"></i> Play piano faster</p>
                        </div>
                    </div>

                    <div class="flex inline md:hidden">
                    ...
                    "recaptchaKey" => $recaptchaKey,
                        "formId" => "Pianote - Engagement - Trigger - Technique Essentials - Web Form",
                        "formName" => 'Technique Essentials',
                        "nameInput" => true,
        ...
        <div class="container max-w-5xl mx-auto">
            ...
            <div class="flex flex-wrap justify-center mx-auto md:max-w-full text-left">
                ...
                @foreach($lessons as $key => $lesson)
                    <div class="w-full sm:w-1/3 lg:w-1/3 px-2 mb-6 sm:mb-8">
                        <img src="{{ $lesson['thumb'] }}" alt="video thumbnail" loading="lazy" class="w-full rounded-lg">
                        <h5 class="mt-3"><strong>{{ $lesson['header'] }}</strong></h5>
    ...
    <section class="text-center text-white pt-10 lg:pt-24 bg-cover bg-center" style="background-image:url('https://d21q7xesnoiieh.cloudfront.net/fit-in/1600x0/filters:quality(95)/marketing/pianote/lead-gen/technique-essentials/piano-bg.webp');">
        <div class="container mx-auto max-w-2xl pb-6">
        ...
        <div class="relative">
            ...
            <div class="absolute top-0 left-1/2 w-[85%] sm:w-[44%] pb-[63%] sm:pb-[33%] transform -translate-x-1/2 mt-3 xl:mt-4">
                <video
                    ...
                    muted="" autoplay="" loop="" playsinline="" class="w-full h-full object-cover rounded-xl"></video>
            </div>
        </div>

        <div class="flex flex-col items-center justify-center py-3" style="background: #000000">
            <h5 class="uppercase text-white tracking-wide pt-2">Learn from</h5>
            <h2 class="leading-tight uppercase text-center text-pianote">
                <strong>
                    “The greatest <br class="inline md:hidden"> keyboardist of all time”
                </strong>
            </h2>
            <p class="text-xs pt-4 text-white">
                ~ MusicRadar Magazine
            </p>
        </div>
    </section>
    ...
    <section id="coach-bg" class="w-full lg:pt-10" style="background-repeat: no-repeat; background-color: #EAE4DD; background-image:url('https://d21q7xesnoiieh.cloudfront.net/fit-in/3000x0/filters:quality(95)/marketing/pianote/lead-gen/technique-essentials/coach-bg.webp');">
        <div class="container mx-auto max-w-5xl flex flex-col justify-center items-center text-center px-4">
            <div class="max-w-2xl mt-10 md:mt-20 px-6">
                ...
                <p class="mb-2">Jordan honed his piano technique under the supervision of some of the greatest piano teachers at Juilliard. And now…</p>
                <p class="mb-2"><strong>He’s sharing those secrets with you.</strong></p>
                <p>This is a rare opportunity to learn from the world’s best.</p>
            </div>
        </div>
        <div class="container mx-auto max-w-xl lg:max-w-3xl py-4 px-4 md:px-6 pb-10 md:pb-20">
            <h6 class="uppercase text-center mb-3 mt-3">See Jordan in action</h6>
    ...
    <section class="text-center customize px-4 lg:px-6 relative z-50 overflow-hidden py-10 sm:py-20" style="background:#000000">
        <div class="max-w-5xl mx-auto flex flex-wrap flex-col md:flex-row md:items-center">
            <div class="max-w-lg mx-auto text-center md:text-left w-full md:w-1/2 md:pl-5">
                <img class="h-28 md:h-28 lg:h-32 mb-4 sm:mb-2 lg:mb-3 md:pl-4 opacity-0 transition-opacity"
                    loading="lazy" onload="this.classList.remove('opacity-0')" alt="logo"
                    src="https://d21q7xesnoiieh.cloudfront.net/fit-in/800x0/filters:quality(95)/marketing/pianote/lead-gen/technique-essentials/logo.webp">
               <div class="md:pt-4 md:pl-4 text-white">
                    <div class="hidden md:inline">
                        <p class="pb-1 md:pb-3"><i class="fas fa-check text-pianote"></i> Build stronger fingers</p>
                        <p class="pb-1 md:pb-3"><i class="fas fa-check text-pianote"></i> Improve your coordination</p>
                        <p><i class="fas fa-check text-pianote"></i> Play piano faster</p>
                ...
                <div class="max-w-md mx-auto flex inline md:hidden text-white">
                            <p class="w-1/3 leading-tight"> <i class="fas fa-check text-pianote"></i><br> Build <br> stronger fingers</p>
                            <p class="w-1/3 leading-tight"> <i class="fas fa-check text-pianote"></i><br> Improve <br> your coordination</p>
                            <p class="w-1/3 leading-tight"> <i class="fas fa-check text-pianote"></i><br> Play <br> piano faster</p>
                </div>

                <div class="max-w-md md:max-w-auto mx-auto md:mx-0 mt-6 sm:mt-5">
                    @include('pianote._partials.sign-up-form', [
                    "recaptchaKey" => $recaptchaKey,
                        "formId" => "Pianote - Engagement - Trigger - Technique Essentials - Web Form2",
                        "formName" => 'Technique Essentials',
                        "nameInput" => true,
                            "buttonText" => "GET STARTED FOR FREE",
                            'stacked' => true,
            ...
            <div class="flex justify-center md:justify-start w-full md:w-1/2 sm:order-1 md:pl-6 mt-7 md:mt-0 relative">
                <img class="max-w-2xl md:max-w-4xl opacity-0 transition-opacity duration-300" loading="lazy" onload="this.classList.remove('opacity-0')"
