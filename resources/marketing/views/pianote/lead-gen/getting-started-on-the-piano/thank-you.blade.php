...
@section('page-body')
            ...
            <div class="text-center sm:px-3">
                ...
                <div class="max-w-xs mx-auto px-10 sm:px-7 relative">
                    ...
                    <div class="w-full relative rounded-xl overflow-hidden border-4 border-white" style="padding-bottom: 172%;">
                        <iframe class="fixed inset-0 h-full w-full absolute" src="//player.vimeo.com/video/1003820309" frameborder="0" allowfullscreen title="intro-video"></iframe>
                    </div>
                </div>
    ...
    <section class="text-center px-3 py-5 sm:py-12" style="background-color:#FFAC00;">
        <div class="container mx-auto max-w-5xl">
            <h2 class="mb-4"><strong>The easy and fun way to learn piano.</strong></h2>
            <h4 class="mb-4">
                Start playing the piano with a  <br class="inline sm:hidden">
                free trial to Pianote.</h4>
            <a class="join smaller w-11/12 sm:max-w-[300px] bg-pianote anchor-slide" href="#customize-anchor">START 30 DAY FREE TRIAL</a>
        </div>
    </section>
