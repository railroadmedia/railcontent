...
{{-- <div class="px-2 sm:px-0 w-full z-[60] sticky top-[40px] md:top-[56px] py-2" style="background: rgba(2, 8, 21, 0.93);">
                   ...
                   @php
                    ...
                    <div class="mt-3">
                        @include('pianote._partials.sign-up-form', [
                            ...
                            'nameInput' => true,
                            'formName' => 'Getting Started On The Piano V4',
    ...
    <section class="relative  px-4 sm:px-6 md:pt-20 pb-16 lg:pt-36 lg:pb-24" style="background-image: linear-gradient(to bottom, #F61A30, #900000);">
        <div class="pt-4 md:pt-0">
            <div class="container max-w-4xl mx-auto mb-12 sm:mb-20 -mt-20 md:-mt-40 lg:-mt-48 z-20 relative">
        ...
        <div class="container mx-auto max-w-4xl text-white">
            <div class="flex flex-wrap sm:flex-nowrap sm:items-center">
                <div class="px-5 sm:px-0 mb-3 sm:mb-0 w-full md:w-auto flex-shrink-0">
                    <picture>
                        <source media="(min-width: 768px)" srcset="https://d21q7xesnoiieh.cloudfront.net/fit-in/560x0/filters:quality(95)/marketing/pianote/lead-gen/getting-started/digital-cs-book.png">
                        <img class="w-auto h-64 sm:h-96" src="https://d21q7xesnoiieh.cloudfront.net/700x0/filters:quality(95)/marketing/pianote/lead-gen/getting-started/digital-cs-book.png" alt="Person playing piano">
                    </picture>
                </div>
                <div class="px-5 sm:pr-0 sm:pl-10 w-full md:w-auto flex-grow sm:order-1">
                    <p class="text-musora">BONUS</p>
                    <h3 class="my-3 leading-tight"><strong>Digital Chords & Scales Guide</strong></h3>
                    <p>When you sign up for Getting Started On The Piano, you’ll also get a FREE downloadable Digital Chords & Scales Guide.
                        <br><br>
                        This 174-page E-Book is your all-in-one guide to learning every chord shape, variation, and scale in every key.
                        <br><br>
                        Perfect for piano beginners, this handy guide will keep all the must-know building blocks of music at your fingertips.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    @endphp
    <section class="relative text-center px-4 sm:px-6 py-16 lg:py-24 bg-cover bg-center" style="background-image: url('{{ $section['backgroundImage'] }}');">
        <div class="container max-w-2xl mx-auto">
            ...
            <p class="pt-6 md:pt-10">Not sure what you’ve missed? <br><strong class="text-pianote">You need to get started on the piano, the easy and fun way!</strong></p>
        </div>
    </section>
        ...
        <div class="container mx-auto max-w-4xl">
            <div class="flex flex-wrap sm:flex-nowrap">
                ...
                <div class="px-6 sm:pr-0 sm:pl-7 mb-7 sm:mb-0 w-full md:w-1/2 sm:order-1">
                    <h4 class="leading-tight my-4"><strong>Designed for Absolute Beginners</strong></h4>
            ...
            <div class="flex flex-wrap sm:flex-nowrap justify-center">
                ...
                @foreach ($features as $feature)
                    <div class="w-full sm:w-1/3 px-2 mb-8 sm:mb-0 text-center flex flex-col items-center">
                        ...
                        <h6 class="mb-2"><strong>{{ $feature['title'] }}</strong></h6>
            ...
            <div class="max-w-lg mx-auto text-center md:text-left w-full md:w-1/2 sm:pl-5 lg:pl-0">
                @php
                        $content = [
                            ...
                            'heading' => 'Start Learning Piano <br><strong class="font-black">The Easy and Fun Way </strong>',
                            'description' => 'Because piano lessons should be fun and easy to follow along. <br> Get started on the piano with 4 FREE, step-by-step lessons and begin playing the songs you love.',
                            'features' => [
                                'Quick lessons',
                                'Designed for absolute beginners',
                                'Play along with a REAL teacher',
