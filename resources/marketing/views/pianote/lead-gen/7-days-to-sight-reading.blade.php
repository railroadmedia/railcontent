@php
    $steps = [
          [
              'position' => 'left',
              'img' => 'https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/7-days-to-sight-reading/Day1.jpg',
              'title' => 'The Basics',
          ...
          [
              'position' => 'right',
              'img' => 'https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/7-days-to-sight-reading/Day2.jpg',
          ...
          [
              'position' => 'left',
              'img' => 'https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/7-days-to-sight-reading/Day3.jpg',
              'title' => 'Intervals',
          ...
          [
              'position' => 'right',
              'img' => 'https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/7-days-to-sight-reading/Day4.jpg',
              'title' => 'Play a Song',
          ...
          [
              'position' => 'left',
              'img' => 'https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/7-days-to-sight-reading/Day5.jpg',
          ...
          [
              'position' => 'right',
              'img' => 'https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/7-days-to-sight-reading/Day6.jpg',
          ...
          [
              'position' => 'left',
              'img' => 'https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/7-days-to-sight-reading/Day7.jpg',
...
@section('meta')
    ...
    <meta property="og:image" content="https://www.musora.com/cdn-cgi/image/width=1200,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/7-days-to-sight-reading/share_image.jpg">
...
@section('page-body')
        ...
        <div class="max-w-md md:max-w-4xl mx-auto text-white">
            <div class="md:flex md:items-center md:gap-4 lg:gap-8 mb-10">
                <div class="w-full md:w-7/12 lg:w-1/2 text-center md:text-left">
                    <img class="h-12 md:h-16 mb-2 md:mb-0 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=350,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/7-days-to-sight-reading/logo.png" alt="logo">
                    ...
                    <img class="rounded-xl md:hidden mb-6 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=450,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/7-days-to-sight-reading/header_m.jpg" alt="lisa header image">
                ...
                <div class="w-full md:w-5/12 lg:w-1/2 hidden md:block">
                    <img class="rounded-xl lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=600,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/7-days-to-sight-reading/header.jpg" alt="lisa header image">
                </div>
            </div>
            <div class="md:mx-12 lg:mx-20 border rounded-xl p-6 md:py-6 md:px-10 md:flex md:text-center gap-10 lg:gap-16" style="border-color: #4B4B4B;">
                <div class="flex-1 mb-3 md:mb-0 flex items-center md:block">
                    <img class="h-8 mb-0 md:mb-2 mr-4 md:mr-0 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=60,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/7-days-to-sight-reading/lesson-time_icon.svg" alt="lesson time icon">
                    <p class="inline md:block mx-0 md:mx-auto">One short lesson a <br class="hidden md:inline">day for 7 days</p>
                </div>
                <div class="flex-1 mb-3 md:mb-0 flex items-center md:block">
                    <img class="h-8 mb-0 md:mb-2 mr-4 md:mr-0 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=60,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/7-days-to-sight-reading/follow-along_icon.svg" alt="follow along icon">
                ...
                <div class="flex-1 flex items-center md:block">
                    <img class="h-8 mb-0 md:mb-2 mr-4 md:mr-0 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=60,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/7-days-to-sight-reading/help_icon.svg" alt="help icon">
    ...
    <section class="py-12 md:pt-20 md:pb-32 px-6 md:px-6" style="background:#F9F9F9;">
        <div class="max-w-md md:max-w-4xl mx-auto">
            <img
                class="md:hidden mb-6 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=400,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/7-days-to-sight-reading/intro_collage.png" alt="intro collage">
            ...
            <div class="md:flex md:items-center md:gap-8 lg:gap-14">
                <div class="flex-1 order-1 hidden md:block">
                    <img class="lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=600,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/7-days-to-sight-reading/intro_collage.png" alt="intro collage">
                </div>
                <div class="flex-1">
                ...
                @foreach ($steps as $key => $step)
                    @if($step['position'] === 'right')
                        <div class="timeline timeline-div relative flex flex-col-reverse md:grid md:grid-cols-2 gap-2 md:gap-12 lg:gap-20 mb-16 md:mb-0 md:mb-16 lg:mb-28 pl-6 md:pl-0">
                            ...
                            <img class="timeline-img rounded-lg lazyload mb-4 md:mb-0" data-src="https://www.musora.com/cdn-cgi/image/width=1000,quality=95/{{ $step['img'] }}" alt="step {{$key+1}}" />
                        </div>
                    @else
    ...
    <section class="py-12 md:py-20 px-4 md:px-6" style="background:#F9F9F9;">
        <div class="max-w-md md:max-w-4xl mx-auto md:flex md:items-center gap-6 lg:gap-8">
            <div class="flex-1 order-1 mb-4 md:mb-0">
                <img data-open="soundSlice" class="lazyload autoplay-video cursor-pointer" data-src="https://www.musora.com/cdn-cgi/image/width=600,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/7-days-to-sight-reading/ui.png" alt="ui">
            </div>
            <div class="flex-1">
    ...
    <section class="pt-12 md:pb-20 md:pt-28 md:px-6" style="background:#00101D;">
        <div class="max-w-4xl mx-auto">
            <div class="flex flex-wrap sm:flex-nowrap items-start justify-center sm:mt-12 mb-12">
                <div class="py-40 sm:py-48 lg:py-64 border-8 border-white rounded-3xl shadow-xl w-56 sm:w-72 lg:w-96 bg-center bg-cover relative -mb-8 sm:mb-0 sm:-mt-8 sm:-mr-8 z-10 flex-shrink-0 cursor-pointer lazyload autoplay-video" data-bg="https://www.musora.com/cdn-cgi/image/width=550,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/7-days-to-sight-reading/7dtsr_coach.jpg">
                </div>
                {{-- <img class="border-8 border-white rounded-3xl shadow-xl w-56 sm:w-72 lg:w-96 relative -mb-8 sm:mb-0 sm:-mt-8 sm:-mr-8 z-10 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=550,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/products/the-power-of-chords/coach_profile-min.png"> --}}
                <div class="bg-white text-left md:rounded-xl pt-14 pb-8 sm:py-10 lg:py-12 px-6 sm:pr-10 sm:pl-14 lg:px-16 max-w-xl sm:mt-8 w-full sm:w-auto sm:flex-grow">
                    ...
                    <img class="h-10 lg:h-16 mt-7 lg:mt-10 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=350,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/products/the-power-of-chords/signature.png" alt="signature">
                </div>
            </div>
        </div>
    </section>

    <section class="py-12 md:py-20 bg-cover bg-center lazyload" data-bg="https://www.musora.com/cdn-cgi/image/width=1500,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/7-days-to-sight-reading/footer_7dtsr.jpg">
