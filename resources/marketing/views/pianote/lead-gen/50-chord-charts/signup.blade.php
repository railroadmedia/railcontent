...
@section('page-body')
    ...
    <section class="text-center py-14 md:py-16 lg:py-20 text-white bg-center bg-cover lazyload" style="background-color:#030618;" data-bg="https://cdn.musora.com/image/fetch/w_1500,q_60,q_auto:best/https://pianote.s3.amazonaws.com/lead-gen/50-chord-charts/final-bg.jpg">
        <div class="container mx-auto">
