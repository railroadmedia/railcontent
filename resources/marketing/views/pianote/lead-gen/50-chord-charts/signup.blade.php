...
@endsection
@section('page-body')
    <header class="text-white text-center lg:text-left py-7 md:py-12 lg:py-20 px-6 md:px-4 lg:px-6" style="background: #06091a url(https://www.musora.com/cdn-cgi/image/width=2000,q_60,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/50-chord-charts/header-bg.jpg) center bottom/cover;">
    ...
    <section class="text-center py-14 md:py-16 lg:py-20 text-white bg-center bg-cover lazyload" style="background-color:#030618;" data-bg="https://www.musora.com/cdn-cgi/image/width=1500,q_60,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/50-chord-charts/final-bg.jpg">
        <div class="container mx-auto">
