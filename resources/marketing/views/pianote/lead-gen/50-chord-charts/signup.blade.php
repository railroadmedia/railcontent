...
@endsection
@section('page-body')
    <header class="text-white text-center lg:text-left py-7 md:py-12 lg:py-20 px-6 md:px-4 lg:px-6" style="background: #06091a url(https://www.musora.com/musora-cdn/image/width=2000,q_60,quality=85/https://pianote.s3.amazonaws.com/lead-gen/50-chord-charts/header-bg.jpg) center bottom/cover;">
            ...
            <div class="flex flex-wrap justify-center items-center md:items-center">
                <div class="w-8/12 sm:w-6/12 lg:w-5/12 sm:order-1 text-right sm:pl-4 lg:pl-0">
                    <div class="relative inline-block align-bottom z-0 w-full max-w-xs lg:max-w-sm">
                        <div class="absolute rounded-2xl overflow-hidden" style="top: 1.5%;left: 1.5%;right: 1.5%;bottom: 6.5%;"><video src="https://pianote.s3.amazonaws.com/lead-gen/50-chord-charts/header-compressed.mp4" muted autoplay loop playsinline></video></div>
                        <img src="https://pianote.s3.amazonaws.com/lead-gen/50-chord-charts/tablet.svg">
                    </div>
                </div>
                <div class="w-full sm:w-6/12 lg:w-7/12 mt-5 sm:mt-0 {{--lg:mt-14--}}">
                    <img class="mb-4 lg:mb-6 h-20 md:h-28 lg:h-36" src="https://pianote.s3.amazonaws.com/lead-gen/50-chord-charts/logo.svg">
    ...
    <section class="text-center py-14 md:py-16 lg:py-20 text-white bg-center bg-cover lazyload" style="background-color:#030618;" data-bg="https://www.musora.com/musora-cdn/image/width=1500,q_60,quality=85/https://pianote.s3.amazonaws.com/lead-gen/50-chord-charts/final-bg.jpg">
        <div class="container mx-auto">
            <div class="w-full px-2 md:px-3 text-center">
                <img class="mb-6 h-20 md:h-24" src="https://pianote.s3.amazonaws.com/lead-gen/50-chord-charts/logo.svg">
                <h4><strong>Play the songs you love, easier.</strong></h4>
