...
@section('global-head')
    <title>You are the Academic | Pianote</title>
    <meta property="og:title" content="You are the Academic | Pianote">
...
@section('global-body')
    ...
    <section class="py-32 md:py-48 bg-center bg-cover bg-no-repeat" style="background-color:#1c0203;background-image:url('https://www.musora.com/cdn-cgi/image/width=1500,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/lead-gen/quiz/bg.jpg')">
        <div class="max-w-md md:max-w-4xl mx-auto text-center text-white px-6 lg:px-0">
            ...
            <h2 class="font-extrabold mt-2 mb-6">You are the Academic!</h2>
            <p class="mb-4">
