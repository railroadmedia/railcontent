...
@section('global-head')
    ...
    <meta property="og:image" content="https://www.musora.com/musora-cdn/image/width=1200,quality=85/https://pianote.s3.amazonaws.com/lead-gen/quiz/Q-SCIENTIST.png" style="display: none;">
...
@section('global-body')
    ...
    <section class="py-12 md:py-20 bg-center bg-cover bg-no-repeat" style="background-color:#1c0203;background-image:url('https://www.musora.com/musora-cdn/image/width=1500,quality=85/https://pianote.s3.amazonaws.com/lead-gen/quiz/bg.jpg')">
        <div class="max-w-2xl lg:max-w-3xl mx-auto text-center text-white px-6 lg:px-0">
            <img class="h-40 md:h-72 lg:h-80 mb-2" src="https://www.musora.com/musora-cdn/image/width=550,quality=85/https://pianote.s3.amazonaws.com/lead-gen/quiz/Q-SCIENTIST.png" alt="scientist">
