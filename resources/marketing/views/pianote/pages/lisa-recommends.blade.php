...
@section('global-body')
    ...
    <header class="relative text-white text-center bg-cover bg-top pb-8 md:pb-12 lg:pb-16 pt-40 md:pt-64 lg:pt-96 px-4 bg-musora-black" style="background-image:url(https://www.musora.com/musora-cdn/image/width=2000,quality=95/https://d2vyvo0tyx8ig5.cloudfront.net/shop/affiliate-header.jpg);">
        <div class="container mx-auto relative z-10">
            ...
            <div class="flex flex-wrap items-center justify-center max-w-3xl mx-auto">
                <div class="w-1/2 md:w-1/4 px-1 mb-3 md:mb-0">
                    <a target="_blank" class="join with-logo w-full" style="background-color:#0074c1;" href="https://www.sweetwater.com/shop/pianote/?irgwc=1&utm_source=Impact&utm_medium=Pianote&utm_campaign=Online%20Tracking%20Link&irclickid=yebUGaXrWxyLRxLSdcy%3AOQDDUkBU9-19ITh7V40"><img class="h-6 md:h-7" src="https://dpwjbsxqtam5n.cloudfront.net/drum-shop/sweetwater-logo.png"></a>
                </div>
                <div class="w-1/2 md:w-1/4 px-1 mb-3 md:mb-0">
                    <a target="_blank" class="join with-logo w-full" style="background-color:#ff9400;" href="https://www.amazon.com/shop/pianote"><img class="h-6 md:h-7" src="https://dpwjbsxqtam5n.cloudfront.net/drum-shop/amazon-logo.png"></a>
                </div>
                <div class="w-1/2 md:w-1/4 px-1">
                    <a target="_blank" class="join with-logo w-full" style="background-color:#00b8c0;" href="https://www.thomann.de/gb/thlpg_co74pz1xgm.html?offid=1&affid=882"><img class="h-6 md:h-7" style="padding: 1px 0 4px;" src="https://dpwjbsxqtam5n.cloudfront.net/drum-shop/thomann-logo.png"></a>
                </div>
                <div class="w-1/2 md:w-1/4 px-1">
                    <a target="_blank" class="join with-logo w-full" style="background-color:#cd2418;" href="https://guitar-center.pxf.io/a1eNNb"><img class="h-6 md:h-7" src="https://dpwjbsxqtam5n.cloudfront.net/drum-shop/guitar-center-logo.png"></a>
                </div>
            </div>
        </div>
