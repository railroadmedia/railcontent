<nav id="nav" class="top-bar row expanded @if(!empty($whiteNav)) bg-white @else bg-[#020815] @endif">
    <div class="logo">
        <a aria-label="Musora Home"
            ...
            @endif
        >
            <img class="@if(!empty($whiteNav)) invert @endif" src="https://www.musora.com/cdn-cgi/image/quality=95,width=250,metadata=none/https://dmmior4id2ysr.cloudfront.net/homepage/2023/musora_logo.png" alt="Drumeo">
        </a>
    </div>
