    ...
    >
        ...
        @else
            <img
                ...
                src="https://www.musora.com/cdn-cgi/image/width=900,quality=95/@yield('header-img')"
                alt="{{$page}} thumb"
                fetchpriority="high"
            />
        @endif
        ...
        <div class="px-4 md:px-0">
            <div class="mb-6">
                <img
                    ...
                    src="https://www.musora.com/cdn-cgi/image/width=150,quality=95/https://dmmior4id2ysr.cloudfront.net/homepage/2023/musora_logo.png"
                    alt="musora logo"
                    fetchpriority="high"
                />
                <img
                    class="h-6 md:h-9"
                    src="https://www.musora.com/cdn-cgi/image/width=150,quality=95/@if($page === 'method')https://dpwjbsxqtam5n.cloudfront.net/sales/2021/method-text.svg @elseif($page === 'coaches')https://dpwjbsxqtam5n.cloudfront.net/sales/2021/coaches-text.svg @elseif($page === 'songs')https://dpwjbsxqtam5n.cloudfront.net/sales/2021/songs-text.svg @endif"
                    alt="{{$page}} logo"
            ...
            @else
                <picture>
                    <source media="(min-width: 500px)" srcset="https://www.musora.com/cdn-cgi/image/width=900,quality=95/@yield('header-img')">
                    <img
                        class="rounded-t-xl md:h-72 lg:h-80 hidden md:inline-block @if($page === 'songs') cursor-pointer @endif"
                        src="https://www.musora.com/cdn-cgi/image/width=550,quality=95/@yield('header-img')"
                        alt="{{$page}} thumb"
