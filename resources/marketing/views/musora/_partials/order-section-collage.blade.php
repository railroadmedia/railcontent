        ...
        <div class="flex flex-wrap sm:flex-nowrap items-center">
            <div class="flex w-full justify-center sm:justify-start sm:w-auto sm:order-1 mb-7 sm:mb-0 -mt-4">
                <picture class="max-w-xs sm:max-w-full">
                    <source media="(min-width:640px)" srcset="https://d21q7xesnoiieh.cloudfront.net/fit-in/1000x0/filters:quality(95)/marketing/musora/membership/homepage/webp-format/musora-m-team2.webp">
                    <img class="transition-opacity opacity-0" loading="lazy" onload="this.classList.remove('opacity-0')" src="https://d21q7xesnoiieh.cloudfront.net/fit-in/640x0/filters:quality(95)/marketing/musora/membership/homepage/webp-format/musora-m-team2.webp" alt="musora collage image">
                </picture>
            </div>
            <div class="text-center sm:text-left w-full sm:w-auto flex-shrink-0 flex-col flex items-center sm:items-start">
                <img class="h-6 mb-3 sm:mb-6" src="https://d21q7xesnoiieh.cloudfront.net/fit-in/640x0/filters:quality(95)/marketing/musora/membership/homepage/webp-format/musora_logo.webp">
