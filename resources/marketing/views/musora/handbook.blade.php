        ...
        <div class="max-w-3xl mx-auto pt-20 pb-10 md:py-10 handbook md:px-6">
            ...
            <div class="px-4 md:px-0">
                ...
                <ul class="mb-16 pl-2 sm:pl-6 mt-4 list-disc">
                    <li><div class="flex justify-between"><span>Jared Falk</span><div class="flex justify-between sm:w-2/3 flex-col sm:flex-row leading-snug mb-4 sm:mb-0 text-right sm:text-left"><span>Founder</span><span>jared@musora.com</span></div></div></li>
                    <li><div class="flex justify-between"><span>James Falk</span><div class="flex justify-between sm:w-2/3 flex-col sm:flex-row leading-snug mb-4 sm:mb-0 text-right sm:text-left"><span>President/CEO</span><span>jame@musora.com</span></div></div></li>
                    ...
                    <li><div class="flex justify-between"><span>Amy Malcolmson</span><div class="flex justify-between sm:w-2/3 flex-col sm:flex-row leading-snug mb-4 sm:mb-0 text-right sm:text-left"><span>Chief Operating Officer</span><span>amy@musora.com</span></div></div></li>
