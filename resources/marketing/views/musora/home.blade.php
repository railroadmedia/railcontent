...
@section('layout-body')
            ...
            <div class="flex flex-wrap items-start max-w-6xl mx-auto mt-9">
                ...
                <div class="w-full px-4 md:px-2 lg:px-4 md:w-1/3">
                    <img
                        ...
                        src="https://dmmior4id2ysr.cloudfront.net/homepage/2021/coaches.png"
                        loading="lazy"
                        onload="this.classList.remove('opacity-0')"
                        alt="coaches icon"
                    ><br>
    ...
    <section class="py-12 md:py-20 relative overflow-hidden text-white text-center">
        ...
        <div class="container mx-auto relative z-0">
            <img
            class="h-9 md:h-14 transition-opacity opacity-0"
            src="https://d2vyvo0tyx8ig5.cloudfront.net/logo/pianote-logo-red.png"
            loading="lazy"
            onload="this.classList.remove('opacity-0')"
            alt="pianote logo"
        >
    ...
    <section class="py-12 md:py-20 relative overflow-hidden text-white text-center lazyload">
        ...
        <div class="container mx-auto relative z-0">
            <img
                class="h-9 md:h-14 transition-opacity opacity-0"
                src="https://d122ay5chh2hr5.cloudfront.net/sales/guitareo-logo-green.png"
                loading="lazy"
                onload="this.classList.remove('opacity-0')"
                alt="guitareo logo"
            >
    ...
    <section class="py-12 md:py-20 relative overflow-hidden text-white text-center lazyload">
        ...
        <div class="container mx-auto relative z-0">
            <img
                class="h-9 md:h-14 transition-opacity opacity-0"
                src="https://d21xeg6s76swyd.cloudfront.net/sales/2021/singeo-logo.png"
                loading="lazy"
                onload="this.classList.remove('opacity-0')"
                alt="singeo logo"
            >
