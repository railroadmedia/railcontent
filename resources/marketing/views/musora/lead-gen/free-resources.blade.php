...
{{--            <h5 class="border-y border-y-black py-4 mb-7 uppercase tracking-widest font-bold">GIVEAWAY</h5>--}}
        ...
        @if(Carbon\Carbon::create(2025, 2, 11, 16, 0, 0, 'America/Vancouver') > Carbon\Carbon::now())
            <a href="https://www.drumeo.com/giveaways" class="relative bg-cover bg-center group block rounded-2xl w-full pb-32 sm:pb-56 lg:pb-96"
                style="background-image:url('https://d21q7xesnoiieh.cloudfront.net/fit-in/2400x0/filters:quality(95)/marketing/musora/lead-gen/youtube/giveaway-banner-sticks.jpg');">
