...
@section('layout-body')
    ...
    <div class="container mx-auto max-w-7xl px-4 md:px-10">
        <header class="py-10 md:py-20">
            <h1 class="text-3xl md:text-5xl text-6xl"><strong>Free Resources</strong></h1>
        ...
        @php
            $benefits = [
                ['image' => 'https://d21q7xesnoiieh.cloudfront.net/fit-in/800x0/filters:quality(95)/marketing/musora/lead-gen/youtube/item-1.jpg', 'title' => 'Getting Started On The Drums'],
                ['image' => 'https://d21q7xesnoiieh.cloudfront.net/fit-in/1000x0/filters:quality(95)/marketing/musora/lead-gen/youtube/item-2.png', 'title' => 'Getting Started On The Piano'],
                ['image' => 'https://d21q7xesnoiieh.cloudfront.net/fit-in/800x0/filters:quality(95)/marketing/musora/lead-gen/youtube/item-2.png', 'title' => 'Improve Any Voice'],
                ['image' => 'https://d21q7xesnoiieh.cloudfront.net/fit-in/800x0/filters:quality(95)/marketing/musora/lead-gen/youtube/item-2.png', 'title' => 'Getting Started On The Acoustic Guitar'],
            ];
        @endphp
    
        <div class="grid grid-cols-2 gap-5 lg:gap-8 pb-10 md:pb-20">
            @foreach ($benefits as $benefit)
                <div class="text-left">
                    <img src="{{ $benefit['image'] }}" alt="{{ $benefit['title'] }}" class="mx-auto rounded-lg">
                    <h5 class="mt-2 capitalized font-bold">{{ $benefit['title'] }}</h5>
                </div>
            @endforeach
        </div>
        ...
        <section class="px-5 sm:px-6 py-8 sm:py-16 text-white rounded-3xl" style="background-color:#0C1523;">
            <div class="flex flex-col lg:flex-row items-center lg:items-start">
                <div class="w-full lg:w-5/12 px-6">
                    <img class="w-80 h-80 rounded-full" src="https://d21q7xesnoiieh.cloudfront.net/fit-in/1600x0/filters:quality(95)/marketing/musora/lead-gen/youtube/item-1.jpg" alt="Musora Team Image">
                </div>
                <div class="w-full lg:w-6/12 text-center lg:text-left">
                    <h2 class="uppercase pt-10 leading-tight lg:pl-6"><strong>ENTER TO Win A FREE GUITAR <br> SIGNED BY PEACH PIT</strong></h2>
                    <h5 class="tracking-tight pb-4 lg:pb-6 italic lg:pl-6">
                        Win a signed Fender Telecaster (value of $1200) signed by the <br class="hidden lg:block"> Peach Pit crew.
                    </h5>
          ...
          <section class="px-5 sm:px-6 py-8 sm:py-16 text-black rounded-3xl my-10 lg:my-20 bg-musora">
            <div class="flex flex-col lg:flex-row items-center">
                <div class="w-full lg:w-7/12 text-center md:text-left px-6 flex jusitfy-center flex-col items-center">
                    <h2 class="capitalize leading-tight"><strong>The ultimate music  <br> lessons experience  <br> at a special price</strong></h2>
                    <p class="tracking-tight pb-4 lg:pb-6 italic">
                        An exclusive discount for our YouTube community.
                    </p>
                </div>
                <div class="w-full md:w-1/2 lg:w-4/12 text-center max-w-[400px]">
                @php
                    $annualLink = '/ecommerce/add-to-cart?products=annual-plan';
                    $points = [
          ...
          <section class="px-5 sm:px-6 py-8 sm:pb-16 lg:pb-24 text-black">
        <div class="flex flex-col lg:flex-row gap-8 justify-between items-start relative">
            <div class="flex flex-col justify-evenly gap-4 w-full lg:w-5/12">
                ...
                <div class="flex flex-col space-y-4">
                    <a href="https://youtube.com/musoraofficial" class="bg-musora text-white font-bold py-14 rounded-2xl text-center">  
                        <div class="relative">
                    ...
                    <a href="https://youtube.com/drumeoofficial" class="bg-drumeo text-white font-bold py-14 rounded-2xl text-center"> 
                        <div class="relative">
                    ...
                    <a href="https://youtube.com/pianoteofficial" class="bg-pianote text-white font-bold py-14 rounded-2xl text-center">
                        <div class="relative">
