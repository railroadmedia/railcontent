...
<!-- Main -->
@section('layout-body')
    <header class="bg-cover bg-center text-center text-white py-12 md:py-20 lg:py-24 px-4 relative" style="background-color:#011223;background-image:url(https://www.musora.com/musora-cdn/image/width=1500,quality=85/https://musora-center.s3.amazonaws.com/affiliate/background-drums.jpg);">
        <div class="background-fade">
            <div class="drums" style="background-image: url(https://www.musora.com/musora-cdn/image/width=1500,quality=85/https://musora-center.s3.amazonaws.com/affiliate/background-drums.jpg);"></div>
            <div class="piano"  style="background-image: url(https://www.musora.com/musora-cdn/image/width=1500,quality=85/https://musora-center.s3.amazonaws.com/affiliate/background-piano.jpg);"></div>
            <div class="guitar"  style="background-image: url(https://www.musora.com/musora-cdn/image/width=1500,quality=85/https://musora-center.s3.amazonaws.com/affiliate/background-guitar.jpg);"></div>
        </div>
        <div class="container mx-auto max-w-6xl relative z-10">
            <img class="w-full mx-auto max-w-xs md:max-w-sm lg:max-w-md mb-10 md:mb-14 lg:mb-20" src="https://www.musora.com/musora-cdn/image/width=900,quality=85/https://musora-center.s3.amazonaws.com/affiliate/musora-logos.png" alt="musora logos">
    ...
    <section class="bg-cover bg-center text-center text-white py-8 md:py-10 lg:py-14 px-4 relative">
        {{-- background --}}
        <img src="https://www.musora.com/musora-cdn/image/width=1500,quality=85/https://musora-center.s3.amazonaws.com/affiliate/background-piano.jpg"
                            ...
                            <div class="rounded-2xl p-3 md:p-8" style="background:linear-gradient(#000C17, #01132b)">
                                ...
                                <div class="flex items-center justify-center pt-5 md:pt-8">
                                    <img
                                        ...
                                        src="https://www.musora.com/musora-cdn/image/width=200,quality=85/https://musora-center.s3.amazonaws.com/affiliate/testimonial-alejandro.jpg"
                                        loading="lazy"
                                        onload="this.classList.remove('opacity-0')"
                        ...
                        <div class="px-3">
                            <div class="rounded-2xl p-3 md:p-8" style="background:linear-gradient(#000C17, #01132b)">
                                ...
                                <div class="flex items-center justify-center pt-5 md:pt-8">
                                    <img
                                        class="rounded-full w-1/4 transition-opacity opacity-0"
                                        src="https://www.musora.com/musora-cdn/image/width=200,quality=85/https://musora-center.s3.amazonaws.com/affiliate/testimonial-piano-dreamers.jpg"
                                        loading="lazy"
                                        onload="this.classList.remove('opacity-0')"
                        ...
                        <div class="px-3">
                            <div class="rounded-2xl p-3 md:p-8" style="background:linear-gradient(#000C17, #01132b)">
                                ...
                                <div class="flex items-center justify-center pt-5 md:pt-8">
                                    <img
                                        class="rounded-full w-1/4 transition-opacity opacity-0"
                                        src="https://www.musora.com/musora-cdn/image/width=200,quality=85/https://musora-center.s3.amazonaws.com/affiliate/testimonial-aguafish.jpg"
                                        loading="lazy"
                                        onload="this.classList.remove('opacity-0')"
    ...
    <section class="bg-cover bg-center text-center text-white py-24 md:py-32 lg:py-52 px-4 relative">
        <img src="https://www.musora.com/musora-cdn/image/width=1500,quality=85/https://musora-center.s3.amazonaws.com/affiliate/background-guitar.jpg"
