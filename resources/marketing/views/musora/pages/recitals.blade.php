...
<!-- Main -->
@section('layout-body')
    <div class="promo-banner text-white py-1 mt-10 md:mt-4 lg:mt-0 hidden md:block" style="background:linear-gradient(75.93deg, #00C9AC 0%, #0B76DB 32.62%, #8300E9 65.25%, #F61A30 92.11%)">
        <div class="container mx-auto relative z-10">
            <div class="text text-center flex justify-center items-center">
                <p class="leading-tight">
                    ...
                    Submission deadline <strong class="font-extrabold">July 7th, 2023.</strong></p>
            </div>
        </div>
    </div>
    <section class="text-center text-white py-5 md:py-10 lg:py-16 px-5 md:px-7" style="background:#00101d ;">
        <div class="container mx-auto max-w-5xl">
            <img class="h-24 sm:h-32 lg:h-40 mb-3" src="https://dmmior4id2ysr.cloudfront.net/recitals/summer-recital-logo.png" alt="recital logo">
            <h3 class="leading-tight"><strong>Be a part of the first ever <br>Musora Summer Recital!</strong></h3>
            ...
            <div class="flex flex-wrap items-center justify-center mx-auto max-w-4xl">
                ...
                <div class="text-left md:pr-3 lg:pr-8 w-full md:w-3/5 lg:w-7/12">
                    <p class="mx-auto">
                        ...
                        Once you’ve submitted, we’ll connect with you the 2nd week of July with your recital date and session time, but feel free to join and watch any time during the week of July 24-28th where we’ll be streaming the recitals all week!
                    </p>
                </div>
            </div>
        </div>
