...
<head>
    ...
    <title>6 Month Ticket Redeem | Drumeo</title>
    <meta name="description" content="To redeem your 6 Month Ticket enter your code below!">
...
<div id="content">
    <div class="flex-video widescreen vimeo">
        <iframe src="//player.vimeo.com/video/90554430" width="600" height="338" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
    </div>
    ...
    @if($newAccount)
        <div class="redeem-switcher">
            <span class="red"><i class="fas fa-user"></i> Existing Member? <a href="/redeem-ticket/existing">Click here to add Drumeo to your account.</a> </span><br>
            (The form below is only for new accounts)
        </div>

        @include('action-codes.redeem-form-new')
    @else
        <div class="redeem-switcher">
            <span class="red"><i class="fas fa-user-slash"></i> Not already a member? <a href="/redeem-ticket">Click here to redeem on a new Drumeo account.</a> </span><br>
            (The form below is only for existing members)
        </div>

        @include('action-codes.redeem-form-existing')
    @endif
    <br>
