...
@section('layout-body')
    ...
    <header class="pb-24 sm:pb-32 pt-32 sm:pt-40 text-white text-center relative">
        <img src="https://www.musora.com/musora-cdn/image/width=2000,quality=95/https://dmmior4id2ysr.cloudfront.net/careers/header-image.jpg"
    ...
    <section class="pt-10 sm:pt-14 lg:pt-16 pb-96 px-5 relative text-white text-center bg-musora-black">
        <div class="container mx-auto relative z-0 max-w-5xl">
            <img
                ...
                src="https://www.musora.com/musora-cdn/image/width=750,quality=95/https://dmmior4id2ysr.cloudfront.net/careers/collage-1-m.png"
                loading="lazy"
                onload="this.classList.remove('opacity-0')"
                alt="collage 1"
            >
            <img
                ...
                src="https://www.musora.com/musora-cdn/image/width=1500,quality=95/https://dmmior4id2ysr.cloudfront.net/careers/collage-1.png"
                loading="lazy"
                onload="this.classList.remove('opacity-0')"
                alt="collage 1"
            >
