...
@section('layout-body')
    ...
    <section class="pt-10 sm:pt-14 lg:pt-16 pb-96 px-5 relative text-white text-center bg-musora-black">
        <div class="container mx-auto relative z-0 max-w-5xl">
            ...
            <a class="join bg-musora text-black" target="_blank" href="https://musoramediainc.bamboohr.com/careers/view.php?id=58">JOIN TALENT POOL <i class="fal fa-smile-plus"></i></a>
        </div>
    </section>
