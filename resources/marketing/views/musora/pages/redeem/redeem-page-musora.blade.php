...
@section('layout-body')
        ...
        <div class="container max-w-6xl mx-auto">
            <div class="flex flex-wrap sm:flex-nowrap items-center">
                <div class="w-full sm:w-7/12 sm:pr-8 text-center lg:text-left">
                    <div x-on:click="trailer = true;" class="mb-5 overflow-hidden relative block sm:hidden bg-cover bg-top cursor-hover autoplay-video" style="padding-bottom: 65%;">
                        <img
                    ...
                    <div class="px-5 sm:px-0">
                        ...
                        <div class="flex flex-wrap items-center justify-center sm:justify-center mt-6 sm:mt-5 lg:mt-10 sm:max-w-xs mx-auto lg:mx-0">
                            <a class="w-full join bg-black smaller mb-2 text-[22px] font-bebas text-center font-normal tracking-widest py-4" href="{{--TODO--}}">
                                Redeem your pass
                            </a>
                ...
                <div class="w-full sm:w-5/12 hidden sm:block">
                    <div x-on:click="trailer = true;"
                         class="bg-no-repeat bg-contain rounded-xl aspect-1:1 overflow-auto relative bg-top cursor-pointer autoplay-video" style="background-image:url('https://www.musora.com/musora-cdn/image/width=850,quality=85/https://dmmior4id2ysr.cloudfront.net/redeem/header-image.png');"
                    >
    ...
    <section class="py-10 sm:py-14 lg:py-20">
        <div class="max-w-6xl mx-auto">
            <h2 class="max-w-3xl mx-auto text-center mb-10"><strong>Here’s what you can expect with your Musora 30-Day Access Pass:</strong></h2>
            <div class="flex flex-wrap sm:items-start sm:justify-center text-left mb-2 sm:mb-6">
                @php
                    $gridItems = [
                        [
                ...
                @foreach ($gridItems as $key => $gridItem)
                    <div class="sm:flex sm:flex-wrap sm:items-start w-full sm:w-1/2 lg:w-1/3 pb-4 sm:pb-0 px-4 mb-4 sm:mb-8 border-b sm:border-b-0">
                        <picture>
    ...
    <section class="py-10 sm:py-14 lg:py-20 bg-[#f6f8fc]">
        <div class="max-w-6xl mx-auto">
            <h2 class="text-center mb-3"><strong>Start achieving your musical dreams.</strong></h2>
    ...
    <section class="py-10 sm:py-14 lg:py-20 bg-[#000C17]">
        <div class="max-w-6xl mx-auto lg:flex lg:items-center text-white gap-14 px-4">
            <div class="max-w-xl mx-auto lg:max-w-sm">
                <div class="pl-5 ">
                    <h2 class="leading-tight mb-4"><strong>Redeem 30 days of free music lessons with Musora.</strong></h2>
                    <p class="mb-10 lg:mb-14">Enter the unique code on your pass to create your Musora account and get started. Once you press submit, you'll have instant access to our vast library of lessons and track your progress as you learn.
                    </p>
                </div>
                <img class="mb-10" src="https://dmmior4id2ysr.cloudfront.net/redeem/musora-card.png" alt="musora card" />
            </div>
            <div class="flex-1">
                <p class="font-bold text-left md:text-center lg:text-left">Begin your musical journey today &#8595;</p>
