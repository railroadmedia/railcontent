...
>
    ...
    if ($code) {
        ...
        $accessCodeArray = array_filter(explode(' ', trim($code)));
    }
    @endphp
    @if(empty($existing))
    ...
    <div class="flex flex-wrap">
       ...
       <input 
            class="default-form-field uppercase"
            x-bind:class="{ 'border border-[#EF4444] bg-[#FECACA] text-black mb-1.5': errors.access_code }"
            type="text"
            name="access_code"
            maxlength="29"
