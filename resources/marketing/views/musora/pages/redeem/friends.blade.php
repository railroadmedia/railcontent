...
{{--                    cursor-pointer autoplay-video--}}
                    " style="padding-bottom: 65%;">
                        <img
                            ...
                            src="https://www.musora.com/cdn-cgi/image/width=600,quality=95/https://dmmior4id2ysr.cloudfront.net/redeem/header-image-m-2.png"
...
{{--                         cursor-pointer autoplay-video--}}
                         " style="background-image:url('https://www.musora.com/cdn-cgi/image/width=850,quality=95/https://dmmior4id2ysr.cloudfront.net/redeem/header-image-2.png');"
                    >
                    ...
                    <div class="z-10 flex flex-wrap sm:flex-nowrap items-start justify-evenly w-full sm:w-auto sm:flex-grow py-4 sm:py-3 lg:py-4 lg:px-5 text-left sm:text-center bg-[#F6F8FC]">
                        @foreach ($features as $key => $feature)
                            <div class="flex sm:block w-full sm:w-auto px-4 sm:px-3 my-2 sm:mb-0">
                                <img
                                    src="https://www.musora.com/cdn-cgi/image/width=500,quality=95/{{ $feature['image'] }}"
                ...
                <div class="flex flex-wrap sm:items-start sm:justify-center text-left">
                    ...
                    @foreach ($gridItems as $key => $gridItem)
                        <div class="sm:flex sm:flex-wrap sm:items-start w-full sm:w-1/2 lg:w-1/3 pb-4 sm:pb-0 px-2 lg:px-4 mb-4 sm:mb-8 border-b sm:border-b-0">
                            <picture>
                                <source media="(min-width:640px)" srcset="https://www.musora.com/cdn-cgi/image/width=640,quality=95/{{ $gridItem['image'] }}">
                                <img
                                    class="h-40 sm:h-auto sm:w-full rounded-xl mb-3 transition-opacity opacity-0"
                                    src="https://www.musora.com/cdn-cgi/image/width=600,quality=95/{{ $gridItem['image'] }}"
                                    alt="grid{{$key+1}}"
                                    loading="lazy"
        ...
        @endforeach
                ...
                @foreach($testimonials as $key => $testimonial)
                    <div class="w-full sm:w-1/2 md:w-1/4 px-4 sm:px-2">
                        ...
                        >
                            <picture>
                                <source media="(min-width:640px)" srcset="https://www.musora.com/cdn-cgi/image/width=500,quality=95/{{$testimonial['image']}}">
                                <img
                                    class="h-52 sm:h-auto sm:w-full rounded-xl transition-opacity opacity-0"
                                    src="https://www.musora.com/cdn-cgi/image/width=350,quality=95/{{$testimonial['image']}}"
