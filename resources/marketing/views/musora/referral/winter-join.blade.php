...
<div class="referral-sections -mt-[40px] md:-mt-[56px]">
    ...
    <section class="py-12 sm:py-20 text-white bg-cover bg-[url('https://www.musora.com/cdn-cgi/image/width=2000,quality=95/https://d3fzm1tzeyr5n3.cloudfront.net/referral/winter/info-section-bg.jpg')]">
        <div class="max-w-4xl mx-auto px-4 xl:px-0 sm:flex sm:items-center text-center sm:text-left">
            <div class="order-1">
                <img
                    ...
                    src="https://www.musora.com/cdn-cgi/image/width=500,quality=95/https://d3fzm1tzeyr5n3.cloudfront.net/referral/winter/leaf-ring.png"
                    alt="intro"
                />
            </div>
