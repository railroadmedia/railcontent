...
@section('head-includes')
    ...
    @if(!empty($product->meta_img))
        <meta property="og:image" content="@if(str_contains($product->meta_img, 'amazonaws') || str_contains($product->meta_img, 'cloudfront')) {{$product->meta_img}} @else https://d1fyshwdvi6fth.cloudfront.net/{{ $product->meta_img  }}@endif">
    @endif
