        ...
        <div class="flip-card-front card-inside">
            <section class="drum-shop h-full flex flex-col">
                <div class="top-image @if(!empty($thumbnail_logo)) with-logo @endif"
                     style="flex: 1; background-image:url(https://www.musora.com/musora-cdn/image/width=600,quality=85/@if(str_contains($thumbnail, 'amazonaws') || str_contains($thumbnail, 'cloudfront')){{$thumbnail}}@else{{'https://d1fyshwdvi6fth.cloudfront.net/'.$thumbnail}}@endif"
                     ;>
                    @if (!empty($badgeText))
                        <span
                    ...
                    @if(!empty($thumbnail_logo))
                        <div class="logo">
                            <img class="mx-auto"
                                 src="@if(str_contains($thumbnail_logo, 'amazonaws') || str_contains($thumbnail_logo, 'cloudfront')){{$thumbnail_logo}}@else{{'https://d1fyshwdvi6fth.cloudfront.net/'.$thumbnail_logo}}@endif"
                                 alt="packLogo">
                        </div>
                    @endif
