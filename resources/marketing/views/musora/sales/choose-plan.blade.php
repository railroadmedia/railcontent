...
@section('global-body')
    ...
    <section class="text-center text-white px-5 sm:px-6 py-10 sm:py-14 lg:py-20 bg-[#0c1524]"
        ...
        <div class="container max-w-6xl mx-auto">
            ...
            <div class="flex items-end justify-center my-5">
                <div class="px-2">
                    ...
                    <div id="plusButton" 
                         class="active option-buttons hover:opacity-90 cursor-pointer border-2 flex items-center rounded-xl py-4 px-5 bg-[#273040] border-[#0c1524]" 
                ...
                <div class="px-2">
                    <div id="nonPlusButton" class="option-buttons hover:opacity-90 cursor-pointer border-2 flex items-center rounded-xl py-4 px-5 bg-[#273040] border-[#0c1524]" 
                         x-bind:class="{ 'active': !plusMembershipSelected }"
