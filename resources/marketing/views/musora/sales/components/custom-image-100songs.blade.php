<div class="container max-w-7xl mx-auto relative flex pt-10 lg:m-9">
    ...
    <img
        ...
        onload="this.classList.remove('opacity-0')"
    />
        <div class="absolute inset-0 flex flex-col my-7 lg:justify-center md:justify-center md:items-start lg:items-start lg:pl-20">
            <div class="md:w-1/2 @if($textOnLeft) md:order-1 @endif text-center md:text-left px-8 pt-8 align-center relative z-10 sm:m-8">
