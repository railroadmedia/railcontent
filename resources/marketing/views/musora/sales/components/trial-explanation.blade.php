        ...
        <div class="relative pb-5">
            ...
            <div class="flex flex-wrap text-left pl-8 sm:pl-12">
                ...
                <div class="py-4 pl-4 pr-2 sm:px-5 mb-2 w-full">
                    ...
                    <h5 class="font-extrabold mb-1.5">7 Days</h5>
                ...
                <div class="py-4 pl-4 pr-2 sm:px-5 mb-2 w-full">
                    ...
                    <h5 class="font-extrabold mb-1.5">Day 7</h5>
                    <p class="leading-normal">You’ll be charged on @if(empty($month)) {{ Carbon\Carbon::now()->addDays(7)->format('F jS') }} @else {{ Carbon\Carbon::now()->addDays(30)->format('F jS') }} @endif. Cancel anytime before.</p>
                </div>
