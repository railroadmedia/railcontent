    ...
    <div class="container max-w-5xl mx-auto">
        <div class="flex flex-wrap sm:flex-nowrap justify-center text-left">
            ...
            <div class="mt-5 sm:mt-0 sm:pl-7 sm:w-1/2 flex-grow-0">
                <div class="h-full rounded-xl p-7 sm:p-10 pb-64 sm:pb-48 bg-black @if($theme != 'musora') text-white @else text-black @endif flex bg-cover bg-top" style="background-image:url('{{ $workoutsBG }}');">
                    <div>
