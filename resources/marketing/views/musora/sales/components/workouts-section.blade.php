    ...
    <div class="container max-w-4xl mx-auto">
        ...
        <div class="flex flex-wrap sm:flex-nowrap justify-center text-left">
            <div class="w-full sm:w-1/2">
                <div class="rounded-xl p-7 sm:p-10 mb-5 sm:mb-7 clearfix" style="background-color:#f6f8fc;">
                    <h5 class="leading-tight mb-3"><strong>Your daily energy boost.</strong></h5>
                    <h6 class="leading-normal"> You shouldn't lose momentum between lessons. We’ll help you build better <i class="fal fa-bolt inline text-6xl pt-3 pl-3 text-{{ $theme }} float-right"></i> habits through bite-sized guided practice sessions.

                    </h6>
                </div>
                <div class="rounded-xl p-7 sm:p-10 clearfix" style="background-color:#f6f8fc;">
