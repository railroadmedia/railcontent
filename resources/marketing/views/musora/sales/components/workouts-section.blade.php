<div class="h-96 sm:h-[720px] cursor-pointer autoplay-video w-full relative z-20" x-on:click="trailer = true;">
    ...
    <div class="h-full w-full absolute top-0 left-0 right-0 bottom-0 z-10" style="    background: rgba(5, 46, 87, 0.8) 100%;"></div>
