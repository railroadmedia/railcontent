...
<section class="text-center text-white px-5 sm:px-6 py-10 sm:py-14 lg:py-20" style="background-color:#0c1524;">
    <div class="container max-w-4xl mx-auto">
        ...
        <div class="max-w-xs sm:max-w-xl lg:max-w-4xl xl:max-w-full mx-auto">
            <div style="padding-bottom:62.4%" class="mt-4 sm:mt-6 lg:mt-8 lg:mb-6 bg-cover bg-center lazyload" x-on:click="soundslice = true;" data-bg="https://www.musora.com/musora-cdn/image/width=1500,quality=95/{{ $video }}"></div>
        </div>
