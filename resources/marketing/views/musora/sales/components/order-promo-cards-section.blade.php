    ...
    <div class="container max-w-5xl mx-auto">
        ...
        >
            ...
            <div class="w-full md:w-1/2 lg:w-full lg:px-1 px-1 relative">
                ...
                @endif
                <div  class="text-black overflow-hidden rounded-2xl block mx-auto mb-4 lg:mb-0 group border-2 @if(!empty($thirdDealLink)) border-musora @else border-drumeo @endif">
                    <div class="bg-white px-3 py-6 md:py-7">
                        ...
                        <p class="text-sm mb-5"><em>{!! $secondDealSub !!}</em></p>
                            ...
                            <a href="{{$secondDealLink}}" class="join @if(!empty($thirdDealLink)) musora @else drumeo @endif smaller w-full transition-opacity duration-300 group-hover:opacity-80 max-w-[230px]" role="button" tabindex="0" aria-label="{{ $buttonText }}"> {{$buttonText}} </a>
