<section class="text-center px-5 sm:px-6 py-10 sm:py-14 lg:py-20">
    <div class="container max-w-5xl mx-auto">
        <h2 class="text-center mb-4 sm:mb-10"><strong>How are the plans different?</strong></h2>
        <div class="flex items-center rounded-xl py-3 px-3 sm:px-6">
            <div class="w-1/2 text-left"></div>
            <div class="w-1/4">
                <img class="h-3 sm:h-6 lg:h-8" src="https://dpwjbsxqtam5n.cloudfront.net/logos/logo-blue.png">
            </div>
            <div class="w-1/4">
                <img class="h-3 sm:h-6 lg:h-8" src="https://dpwjbsxqtam5n.cloudfront.net/logos/logo-blue.png">
            </div>
