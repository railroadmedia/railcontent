    ...
    <div class="container max-w-6xl mx-auto">
            ...
            <div class="w-full md:w-1/2 px-2 md:px-3 relative">
                ...
                <a href="{{$plusAnnualLink}}" class="text-black overflow-hidden rounded-2xl block mx-auto mb-4 md:mb-0 group border-2 border-{{ $theme }}" aria-label="Plan">
                    <div class="bg-white px-3 py-6 md:py-9">
                        ...
                        <p class="text-sm"><em>Billed at ${{Prices::$plusSubscriptionAnnualFull}} per year.</em></p>
        ...
        @if(empty($month) && empty($noSelector))
            ...
            >
                <div class="w-full md:w-1/2 px-2 md:px-3 mb-4 md:mb-0 relative">
                    <p class="inline-block relative -bottom-1 mb-1 px-5 py-1 z-10 leading-tight text-xs opacity-0">&nbsp;</p>
        ...
        @if(empty($month) && empty($noSelector))
            <p x-bind:class="{ 'hidden': !plusMembershipSelected }">Or choose
                <u class="text-{{$theme}} cursor-pointer" x-bind:class="{ 'active': !plusMembershipSelected }" x-on:click="plusMembershipSelected = false" role="button" tabindex="0">lessons only</u>
                to save 17%. (no songs)</p>
            <p class="text-{{$theme}} cursor-pointer" x-cloak x-bind:class="{ 'hidden': plusMembershipSelected }">
