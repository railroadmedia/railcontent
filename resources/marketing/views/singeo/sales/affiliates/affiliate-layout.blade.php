...
@section('share-image')
    <meta property="og:image" content="https://www.musora.com/musora-cdn/image/width=540,quality=85/https://singeo.s3.amazonaws.com/sales/trials/@yield('url').jpg" style="display: none;">
@endsection
    ...
    <div class="text-white px-4 py-8 md:py-16" style="background-color:#000318;">
        <div class="container mx-auto">
            <div class="sm:flex mx-auto items-start text-center" style="max-width: 1050px;">
                <img class="avatar rounded-full border-4 lg:border-8 mx-auto mb-3 sm:mb-0 w-36 md:w-48 lg:w-72" style="border-color:#8300e9; background-color:#8300e9;" src="https://www.musora.com/musora-cdn/image/width=540,quality=85/https://singeo.s3.amazonaws.com/sales/trials/@yield('url').jpg">
