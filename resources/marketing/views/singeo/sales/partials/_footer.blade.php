...
<footer id="footer" class="bottom-footer clearfix relative bg-[#111729]">
    ...
    <div class="footer-bottom" @if(!empty($minimal)) style="border-top: 0;padding-top: 0;" @endif>
        <div class="container mx-auto">
            <img class="logo" src="https://www.musora.com/musora-cdn/image/width=280,quality=85/https://musora-center.s3.amazonaws.com/logos/singeo-logo-white.png" alt="Singeo">
            @if(empty($minimal))
