<nav id="nav" class="top-bar expanded">
    ...
    @if(!empty($cartVersion))
        <div class="button-wrap" id="app">
            <a href="{{ !empty($product) && $product->is_seasonal ? get_legacy_brand_base_url('musora').'/merch' : get_legacy_brand_base_url('singeo').'/shop' }}" class="join outline-button">Shop</a>
