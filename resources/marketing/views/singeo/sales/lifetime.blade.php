...
@section('global-body')
    ...
    <section class="content-section relative overflow-hidden text-white grey text-center upgrade-video-header">
        <div class="container mx-auto">
            ...
            <p class="uppercase" style="color:#FFAE00;">ONLY <s>100</s> {{ $products['singeo-lifetime-membership-access']->getStock() }} spots available</p>
                        ...
                        <div class="flip-div special">
                            <div class="flip-inner">
                                <div class="front">
                                    ...
                                    <div class="image-wrap" style="background-image:url(https://cdn.musora.com/image/fetch/w_670,q_auto:best/https://singeo.s3.amazonaws.com/sales/promos/november/lifetime-bundle-mic-card.jpg);"></div>
                                </div>
                                <div class="back">
                                    <div class="text-wrap">
                    ...
                    <div class="bonus-wrap relative inline-block align-top mx-auto mb-3 md:mb-4 px-2 md:px-3 lg:px-2 w-full md:w-1/2">
                        <div class="flip-div special">
                            <div class="flip-inner">
                                <div class="front">
                                    <div class="hover-icon"><i class="fas fa-arrow-right"></i><br>DETAILS</div>
                                    <div class="image-wrap" style="background-image:url(https://cdn.musora.com/image/fetch/w_670,q_auto:best/https://singeo.s3.amazonaws.com/sales/lifetime/lisa-witt-exclusive-card.jpg);"></div>
                                </div>
                                <div class="back">
                                    <div class="text-wrap">
