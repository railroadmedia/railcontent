...
@section('content')
    <header id="nav" class="bg-black-1 flex flex-row" style="background-color:#00162a;position: relative;padding: 7px 0;">
        <a href="/" class="logo flex flex-column align-center ph-1" style="max-width:144px;">
            <img src="https://singeo.s3.amazonaws.com/sales/2021/singeo-logo.png">
        </a>
