...
@section('global-body')
    ...
    <header class="header text-white relative overflow-hidden" style="background-color:#1a0239;">
        ...
        <div class="header-image relative mx-auto w-full h-full relative z-0 bg-no-repeat" style="max-width: 1536px;background-image:url(https://cdn.musora.com/image/fetch/w_2500,q_auto:best/q_auto:best/https://singeo.s3.amazonaws.com/sales/2022/header-bg-3.jpg);">
            <div class="top-0 left-0 absolute w-full h-full z-10 hidden lg:block" style="background: linear-gradient(to right, #1a0239, transparent 60%, transparent 85%, #1a0239);"></div>
            <div class="top-0 left-0 absolute w-full h-full z-10 hidden md:block lg:hidden" style="background: linear-gradient(to right, #1a0239, transparent 75%);"></div>
    ...
    <section class="px-2 lg:px-4 py-10 md:py-14 md:py-20 text-white text-center overflow-hidden" style="background:linear-gradient(to bottom, #01050f 60%, #021124);">
        <div class="container mx-auto max-w-6xl">
            <h3 class="leading-tight " data-aos-once="true" data-aos="fade-up" data-aos-offset="150" data-aos-delay="150"><strong>Discover, develop, and fall<br class="inline md:hidden"> in love with your voice.</strong></h3>
            <p class="text-light-navy mt-2 md:mt-4 mb-8 md:mb-10">Turn your desire to sing into passionate<br class="inline md:hidden"> practice that will build your strength,<br class="inline md:hidden"> control, and confidence.</p>
            <div class="md:grid md:grid-cols-3 md:gap-4 max-w-xs md:max-w-full mx-auto">
                <div class="relative rounded-xl overflow-hidden mb-3 md:mb-0" style="background-color:#051124;">
                    <div class="w-full aspect-16:9 bg-cover bg-center lazyload" data-bg="https://cdn.musora.com/image/fetch/w_700,q_auto:best/https://singeo.s3.amazonaws.com/sales/2022/method-thumbs.jpg"></div>
                    <div class=" px-4 lg:px-6 py-5 lg:py-7">
                        <i class="text-4xl align-middle fal fa-microphone-stand text-singeo"></i>
                        <img class="h-5 ml-2 imgfilter-method lazyload" data-src="https://cdn.musora.com/image/fetch/q_auto:best/https://dpwjbsxqtam5n.cloudfront.net/sales/2021/method-text.svg">
                        <h4 class="leading-tight my-3"><strong>Step-By-Step  <br class="hidden md:inline"> Curriculum</strong></h4>
                        <p class="leading-normal text-light-navy mb-10 md:mb-14">Fear-free singing lessons that remove the intimidation of singing in front of a stranger. Know exactly what to do with these guided singing lessons that allow you to progress at your own pace from the comfort of your own home. </p>
                ...
                <div class="relative rounded-xl overflow-hidden mb-3 md:mb-0" style="background-color:#051124;">
                    <div class="w-full aspect-16:9 bg-cover bg-center lazyload" data-bg="https://cdn.musora.com/image/fetch/w_700,q_auto:best/https://singeo.s3.amazonaws.com/sales/2022/songs-thumbs.jpg"></div>
                    <div class="px-4 lg:px-6 py-5 lg:py-7">
                ...
                <div class="relative rounded-xl overflow-hidden" style="background-color:#051124;">
                    <div class="w-full aspect-16:9 bg-cover bg-center lazyload" data-bg="https://cdn.musora.com/image/fetch/w_700,q_auto:best/https://singeo.s3.amazonaws.com/sales/2022/coaches-thumbs.jpg"></div>
                    <div class="px-4 lg:px-6 py-5 lg:py-7">
                        <img class="h-8 icon imgfilter-coaches" src="https://cdn.musora.com/image/fetch/w_800,q_auto:best/https://dpwjbsxqtam5n.cloudfront.net/sales/2021/coaches-icon.svg">
                        <img class="h-5 ml-2 imgfilter-coaches lazyload" data-src="https://cdn.musora.com/image/fetch/q_auto:best/https://dpwjbsxqtam5n.cloudfront.net/sales/2021/coaches-text.svg">
                        <h4 class="leading-tight my-3"><strong>Ongoing Motivation <br class="hidden md:inline"> & Support</strong></h4>
                        <p class="leading-normal text-light-navy mb-10 md:mb-14">Your vocal coaches are always on hand to answer your questions and keep you inspired with personal feedback when you want it and guidance that will improve your voice, build your confidence, and fuel your passion for singing. </p>
...
{{--            @endif--}}
            ...
            <div class="slick mx-auto max-w-xs md:max-w-xl lg:max-w-4xl my-9 md:mb-0 h-44 sm:h-24 lg:h-20">
                <div class="px-3 md:px-6">
                    <p class="leading-normal text-sm"><em>“I took traditional singing lessons in the past and didn’t have nearly this much fun.”</em></p>
                    <div class="flex flex-wrap md:flex-nowrap items-center justify-center mt-1.5">
                        <img class="rounded-full h-10 lazyload" data-src="https://cdn.musora.com/image/fetch/w_80,q_auto:best/https://singeo.s3.amazonaws.com/sales/2022/testimonials/AmberKissler.jpg"><br class="inline md:hidden">
                        <p class="w-full md:w-auto text-sm text-light-navy ml-1 md:ml-2 mr-0 mt-1 md:mt-0"><em>Amber Kissler,<br class="inline md:hidden"> Singeo Student from USA</em></p>
                    </div>
                </div>
                <div class="px-3 md:px-6">
                    <p class="leading-normal text-sm"><em>“I always thought I couldn’t sing in tune, but now I’m singing while playing bass without spoiling the song. ”</em></p>
                    <div class="flex flex-wrap md:flex-nowrap items-center justify-center mt-1.5">
                        <img class="rounded-full h-10 lazyload" data-src="https://cdn.musora.com/image/fetch/w_80,q_auto:best/https://singeo.s3.amazonaws.com/sales/2022/testimonials/JuanjoPeris.jpg"><br class="inline md:hidden">
                        <p class="w-full md:w-auto text-sm text-light-navy ml-1 md:ml-2 mr-0 mt-1 md:mt-0"><em>Juanjo Peris,<br class="inline md:hidden"> Singeo Student from Spain</em></p>
                    </div>
                </div>
                <div class="px-3 md:px-6">
                    <p class="leading-normal text-sm"><em>“Singeo really works. The skills are attainable, easy to learn, and lots of fun.”</em></p>
                    <div class="flex flex-wrap md:flex-nowrap items-center justify-center mt-1.5">
                        <img class="rounded-full h-10 lazyload" data-src="https://cdn.musora.com/image/fetch/w_80,q_auto:best/https://singeo.s3.amazonaws.com/sales/2022/testimonials/SylviaCantu.jpg"><br class="inline md:hidden">
                        <p class="w-full md:w-auto text-sm text-light-navy ml-1 md:ml-2 mr-0 mt-1 md:mt-0"><em>Sylvia Cantu,<br class="inline md:hidden"> Singeo Student from USA</em></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-10 md:py-16 lg:py-20 px-3 lg:px-6 text-white text-center" style="background:linear-gradient(to bottom, #8201e8, #400172);">
        <div class="container mx-auto max-w-6xl">
            <h2 class="leading-tight max-w-2xl"><em>“... You’re going to learn how your voice works, how to strengthen it – and to sing with confidence.”</em></h2>
            <h6 class="mt-5 mb-10 md:mb-20"><em>- Cody McManus, Music Producer</em></h6>
            <div class="mx-auto w-full opacity-50">
                <p class="text-sm mb-3"><em>From the music teachers of</em></p>
                <img class="h-5 md:h-6 mb-2 md:mb-0 mx-2 lazyload" data-src="https://dpwjbsxqtam5n.cloudfront.net/logos/logo-white.png" style="padding-bottom: 4px;"></a>
                <img class="h-5 md:h-6 mb-2 md:mb-0 mx-2 lazyload" data-src="https://d2vyvo0tyx8ig5.cloudfront.net/logo/logo-white.png" style="padding: 2px 0 1px;"></a>
                <img class="h-5 md:h-6 mb-2 md:mb-0 mx-2 lazyload" data-src="https://cdn.musora.com/image/fetch/w_160,q_auto:best/https://guitareo.s3.amazonaws.com/sales/guitareo-logo.png" style="padding: 2px 0 1px;"></a>
            </div>
        </div>
    </section>

    <div id="method" class="anchor"></div>
    <section class="content-section text-center px-4 lg:px-6 lazyload" style="padding-bottom: 0;" data-bg="https://cdn.musora.com/image/fetch/w_2000,q_auto:best/https://singeo.s3.amazonaws.com/sales/2022/method-bg.jpg">
        <div class="container mx-auto clearfix max-w-6xl">
            <i class="text-3xl md:text-5xl lg:text-6xl fal fa-microphone-stand text-singeo"></i><br>
            <img class="h-7 md:h-10 lg:h-11 mt-3 mb-4 md:mb-8 imgfilter-method lazyload" data-src="https://dpwjbsxqtam5n.cloudfront.net/sales/2021/method-text.svg">
    ...
    <div id="routines" class="anchor"></div>
    <section class="content-section text-center px-4 lg:px-5" style="padding-top: 0;background:linear-gradient(to bottom, #01050f 60%, #021225);">
        <div class="container mx-auto clearfix max-w-6xl">
            ...
            <h4 class="mb-6 md:mb-7 lg:mb-10 mt-8 md:mt-10 lg:mt-14 leading-normal">
                <strong class="inline-block mr-1 bg-singeo px-1 md:px-3 md:py-1 rounded-md md:rounded-lg leading-none" style="color: #000a1e;">PLUS VOCAL ROUTINES</strong><br>
                <em>Quick warm-up routines to fit any <br class="hidden md:inline">
                    schedule, ranging from <strong class="text-singeo">5 to 20 minutes</strong>.</em></h4>

            <div class="warm-up-bubble-wrap flex flex-wrap align-center md:justify-center max-w-6xl mx-auto">
                <div class="w-1/2 md:w-1/3 lg:w-1/5 h-full flex justify-center">
                    <div class="warm-up-bubble w-full bg-singeo rounded-full border-8 border-black flex flex-wrap content-center justify-center">
                        <img class="h-14 md:h-16 mb-4  lazyload" data-src="https://cdn.musora.com/image/fetch/w_200,q_auto:best/https://singeo.s3.amazonaws.com/sales/2021/icon-music-bubbles.png">
                        <h4 class="font-bebas w-full">5 MINUTE<br>BUBBLE EXERCISE</h4>
                    </div>
                </div>
                <div class="w-1/2 md:w-1/3 lg:w-1/5 h-full flex justify-center mt-32 md:mt-32 lg:mt-40 -mb-16 md:-mb-12 lg:mb-0">
                    <div class="warm-up-bubble w-full bg-singeo rounded-full border-8 border-black flex flex-wrap content-center justify-center">
                        <img class="h-14 md:h-16 mb-4 lazyload" data-src="https://cdn.musora.com/image/fetch/w_200,q_auto:best/https://singeo.s3.amazonaws.com/sales/2021/icon-mic-wings.png">
                        <h4 class="font-bebas w-full">VOCAL<br>FREEDOM</h4>
                    </div>
                </div>
                <div class="w-1/2 md:w-1/3 lg:w-1/5 h-full flex justify-center">
                    <div class="warm-up-bubble w-full bg-singeo rounded-full border-8 border-black flex flex-wrap content-center justify-center">
                        <img class="h-14 md:h-16 mb-4  lazyload" data-src="https://cdn.musora.com/image/fetch/w_200,q_auto:best/https://singeo.s3.amazonaws.com/sales/2021/icon-range-builder.png">
                        <h4 class="font-bebas w-full">THE RANGE<br>BUILDER ROUTINE</h4>
                    </div>
                </div>
                <div class="w-1/2 lg:w-1/5 h-full flex justify-center mt-32 md:mt-0 lg:mt-48 -mb-16 md:mb-0">
                    <div class="warm-up-bubble w-full bg-singeo rounded-full border-8 border-black flex flex-wrap content-center justify-center">
                        <img class="h-14 md:h-16 mb-4 lazyload" data-src="https://cdn.musora.com/image/fetch/w_200,q_auto:best/https://singeo.s3.amazonaws.com/sales/2021/icon-finding-balance.png">
                        <h4 class="font-bebas w-full">FINDING <br>BALANCE</h4>
                    </div>
                </div>
                <div class="w-1/2 lg:w-1/5 h-full flex justify-center">
                    <div class="warm-up-bubble w-full bg-singeo rounded-full border-8 border-black flex flex-wrap content-center justify-center">
                        <img class="h-14 md:h-16 mb-4  lazyload" data-src="https://cdn.musora.com/image/fetch/w_200,q_auto:best/https://singeo.s3.amazonaws.com/sales/2021/icon-warm-up.png">
                        <h4 class="font-bebas w-full">10 MINUTE VOCAL<br>WARM-UP</h4>
                    </div>
                </div>
            </div>
            <br>
    ...
    <section class="content-section text-center relative" style="background:linear-gradient(to bottom, #01050f 80%, #021225);">
        ...
        <div class="px-4 lg:px-6">
            <div class="container mx-auto relative z-10 max-w-6xl">
                ...
                <img class="h-7 md:h-10 lg:h-11 mt-1 mb-4 md:mb-8 imgfilter-songs lazyload" data-src="https://cdn.musora.com/image/fetch/q_auto:best/https://dpwjbsxqtam5n.cloudfront.net/sales/2021/songs-text.svg">
                ...
                <div class="feature-rotater w-full max-w-md md:max-w-full flex flex-wrap md:flex-nowrap items-center mx-auto mt-4 md:mt-14 lg:mt-20 mb-8 md:mb-10 px-2">
                    <div class="pic-wrap md:order-1 mx-auto my-5 md:my-0 pl-0 md:pl-5 lg:pl-10 flex-shrink-0">
                        <img class="lazyload side-pic songs w-full hidden" data-src="https://cdn.musora.com/image/fetch/w_800,q_auto:best/https://singeo.s3.amazonaws.com/sales/2022/singeo-screens-01.png">
                        <img class="lazyload side-pic songs w-full hidden" data-src="https://cdn.musora.com/image/fetch/w_800,q_auto:best/https://singeo.s3.amazonaws.com/sales/2022/singeo-screens-03.png">
                        <img class="lazyload side-pic songs w-full md:hidden" data-src="https://cdn.musora.com/image/fetch/w_800,q_auto:best/https://singeo.s3.amazonaws.com/sales/2022/singeo-screens-02.png">
                    </div>
                    <div class="text-left text-light-navy">
                        <div class="flex mx-auto mb-9 md:mb-7 lg:mb-10 md:cursor-pointer text-icon-wrap songs md:opacity-60 hover:opacity-90 active">
                            <i class="flex-shrink-0 w-8 md:w-10 lg:w-11 text-2xl md:text-3xl text-songs fal fa-music"></i>
                            <div class="pl-3">
                                <h3 class="mx-auto mb-2 md:mb-3"><strong>Pick the perfect song for you.</strong></h3>
                                <p>Choose songs from any era or style including country, electronic, funk, jazz, latin, pop, and R&B – and we’re adding student’s favorites every month. </p>
                            </div>
                        </div>
                        <div class="flex mx-auto mb-9 md:mb-7 lg:mb-10 md:cursor-pointer text-icon-wrap songs md:opacity-60 hover:opacity-90">
                            <i class="flex-shrink-0 w-8 md:w-10 lg:w-11 text-2xl md:text-3xl text-songs fal fa-tv-music"></i>
                            <div class="pl-3">
                                <h3 class="mx-auto mb-2 md:mb-3"><strong>Word-by-word karaoke playback.</strong></h3>
                                <p>Every song is presented in a familiar karaoke style, so you’ll always know what words to sing and when to sing them.</p>
                            </div>
                        </div>
                        <div class="flex mx-auto mb-9 md:mb-7 lg:mb-10 md:cursor-pointer text-icon-wrap songs md:opacity-60 hover:opacity-90">
                            <i class="flex-shrink-0 w-8 md:w-10 lg:w-11 text-2xl md:text-3xl text-songs fal fa-sliders-v"></i>
                            <div class="pl-3">
                                <h3 class="mx-auto mb-2 md:mb-3"><strong>Designed for your unique voice.</strong></h3>
                                <p>You can set the playback option for your unique voice, choosing from three different vocal ranges for every song.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="content-section text-center px-4 lg:px-6" style="background: linear-gradient(to bottom, #01050f 10%, #051531, #01050f 45%, #01050f 80%, #021225);">
        <div class="container mx-auto max-w-6xl">
            <img class="inline h-10 md:h-14 lg:h-16 icon imgfilter-coaches" src="https://cdn.musora.com/image/fetch/w_800,q_auto:best/https://dpwjbsxqtam5n.cloudfront.net/sales/2021/coaches-icon.svg"><br>
            <img class="h-7 md:h-10 lg:h-11 mt-3 mb-4 md:mb-8 imgfilter-coaches lazyload" data-src="https://cdn.musora.com/image/fetch/q_auto:best/https://dpwjbsxqtam5n.cloudfront.net/sales/2021/coaches-text.svg">
            <h3 class="leading-tight " data-aos-once="true" data-aos="fade-up" data-aos-offset="150" data-aos-delay="150"><strong>Your coaches. Your voice.<br class="inline lg:hidden"> Your future in singing.</strong></h3>
            <h6 class="leading-normal max-w-2xl lg:max-w-4xl text-light-navy mt-3 md:mt-5 mb-8 md:mb-10 text-shadow-4">Feel confident about your singing education with unlimited personal support from our in-house team of teachers PLUS distinguished coaches from around the world. You will have first-hand insight to the techniques and tools the biggest singing stars are using and you’ll learn how to apply those techniques to your own unique voice. Your singing destiny awaits. </h6>
                ...
                @foreach($coaches as $coach)
                    @if(empty($coach['trending']))
                        <div class="w-full md:w-1/2 px-1 md:px-2">
                            <div class="half-tile-bg overflow-hidden cursor-pointer relative mx-auto mb-3 rounded-3xl group lazyload" data-bg="https://cdn.musora.com/image/fetch/w_1000,q_auto:best/{{ $coach['image'] }}" data-open="{{ $coach['modal'] }}" style="background-color:#00141d;padding-bottom: 52.65%;">
            ...
            <h4 class="mt-8 md:mt-12 mb-3 mb-6 md:mb-7 lg:mb-10 leading-normal"><strong class="inline-block mr-1 bg-coaches px-3 py-1 rounded md:rounded-lg leading-none" style="color: #000a1e;">GRAMMY WINNERS, TRENDING<br class="inline sm:hidden"> SINGERS, & VOCAL COACHES</strong><br>
                <em>Enjoy special featured coaches, exclusive courses, and <br class="hidden md:inline">personalized events with some of the world’s best singers. </em></h4>
                ...
                @if(!empty($coach['bigTile']))
                    <div class="px-1 md:px-2 mb-3 md:mb-4 mx-auto max-w-md md:max-w-3xl lg:max-w-full">
                        <div style="background-size: cover;"
                                class="relative big-tile-bg bg-left-top rounded-xl overflow-hidden text-left px-3 md:px-10 lg:px-20 py-10 md:py-20 lg:py-36 cursor-pointer group @if(!empty($coach['trailer'])) autoplay-video @endif lazyload" data-bg="https://cdn.musora.com/image/fetch/w_2000,q_auto:best/{{ $coach['image'] }}" style="background-color:#010510"
            ...
            <h3 class="leading-tight mt-8 md:mt-16 mb-5 md:mb-20" data-aos-once="true" data-aos="fade-up" data-aos-offset="150" data-aos-delay="150"><strong>Get personal guidance<br class="inline sm:hidden"> and support</strong></h3>
            <div class="feature-rotater w-full max-w-md md:max-w-full flex flex-wrap md:flex-nowrap items-center mx-auto mb-8 md:mb-10">
                <div class="pic-wrap md:order-0 mx-auto my-5 md:my-0 pr-0 md:pr-5 lg:pr-10 flex-shrink-0">
                    <img class="lazyload side-pic coaches" data-src="https://cdn.musora.com/image/fetch/w_800,q_auto:best/https://singeo.s3.amazonaws.com/sales/2022/spread-q-a-lisa-darcy.png">
                </div>
                <div class="text-left">
                    <div class="flex mx-auto mb-9 md:mb-7 lg:mb-10 text-icon-wrap coaches active">
                        <i class="flex-shrink-0 w-8 md:w-10 lg:w-11 text-2xl md:text-4xl text-coaches fal fa-handshake-alt"></i>
                        <div class="pl-3">
                            <h3 class="mx-auto mb-2 md:mb-3"><strong>Engage With Your Coaches</strong></h3>
                            <p class="text-light-navy">This isn't a video game. Your coaches are REAL teachers who you can engage with on and off the screen. You'll never be alone.</p>
                        </div>
                    </div>
                    <div class="flex mx-auto mb-9 md:mb-7 lg:mb-10 text-icon-wrap coaches">
                        <i class="flex-shrink-0 w-8 md:w-10 lg:w-11 text-2xl md:text-4xl text-coaches fal fa-video"></i>
                        <div class="pl-3">
                            <h3 class="mx-auto mb-2 md:mb-3"><strong>Weekly Live Lessons</strong></h3>
                            <p class="text-light-navy">Tune in to live lessons and live Q&A sessions with your coaches every week. Submit a video of your singing to get personal feedback during a live session.</p>
                        </div>
                    </div>
                    <div class="flex mx-auto text-icon-wrap coaches">
                        <i class="flex-shrink-0 w-8 md:w-10 lg:w-11 text-2xl md:text-4xl text-coaches fal fa-question"></i>
                        <div class="pl-3">
                            <h3 class="mx-auto mb-2 md:mb-3"><strong>Your Questions Answered</strong></h3>
                            <p class="text-light-navy">Questions are good! They help you to learn properly and progress faster! We love hearing from you so reach out through live Q&As, instant chat, or email.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="content-section text-center">
        ...
        <div class="container mx-auto relative z-10">
            <img class="h-32 md:h-48 lg:h-56 mb-14 lazyload" data-src="https://cdn.musora.com/image/fetch/w_800,q_auto:best/https://singeo.s3.amazonaws.com/sales/2022/singeo-method-songs-coaches.png">
            <h6 class="text-light-navy mb-3 md:mb-5 ">Singing lessons at your fingertips.</h6>
            <h3 class="mb-8 md:mb-12" data-aos-once="true" data-aos="fade-up" data-aos-offset="150" data-aos-delay="150"><strong>Wherever you go. Whenever you want to learn.</strong></h3>
            <div class="device-spread relative w-full mx-auto mb-5 md:mb-0">
                <div class="z-10 text-arrow w-1/4 md:w-auto transform md:-translate-x-1/2 -translate-y-1/2 absolute uppercase text-xs md:text-sm lg:text-md desktop">
                    ...
                    <img class="hidden md:inline mt-1 w-7 lg:w-10 lazyload" data-src="https://cdn.musora.com/image/fetch/q_auto:best/https://singeo.s3.amazonaws.com/sales/2022/arrow-right-purple.png">
                </div>
                <div class="z-10 text-arrow w-1/4 md:w-auto transform md:-translate-x-1/2 -translate-y-1/2 absolute uppercase text-xs md:text-sm lg:text-md macbook">
                    <em class="inline-block">SING<br> POPULAR<br> SONGS</em><br class="hidden md:inline">
                    <img class="hidden md:inline mt-1 w-7 lg:w-10 lazyload" data-src="https://cdn.musora.com/image/fetch/q_auto:best/https://singeo.s3.amazonaws.com/sales/2022/arrow-right-alt-purple.png">
                </div>
                <div style="width: 110px;" class="z-10 text-arrow w-1/4 md:w-auto transform md:-translate-x-1/2 -translate-y-1/2 absolute uppercase text-xs md:text-sm lg:text-md ipad">
                    <em class="inline-block">WEEKLY<br> LIVE LESSONS<br> & SUPPORT</em><br class="hidden md:inline">
                    <img class="hidden md:inline mt-1 h-7 lg:h-9 lazyload" data-src="https://cdn.musora.com/image/fetch/q_auto:best/https://singeo.s3.amazonaws.com/sales/2022/arrow-left-down-purple.png">
                </div>
                <div class="z-10 text-arrow w-1/4 md:w-auto transform md:-translate-x-1/2 -translate-y-1/2 absolute uppercase text-xs md:text-sm lg:text-md iphone">
                    <em class="inline-block">VOCAL<br> ROUTINES</em><br class="hidden md:inline">
                    <img class="hidden md:inline mt-1 w-7 lg:w-10 lazyload" data-src="https://cdn.musora.com/image/fetch/q_auto:best/https://singeo.s3.amazonaws.com/sales/2022/arrow-left-purple.png">
                </div>
                <img class="w-full lazyload" data-src="https://cdn.musora.com/image/fetch/w_1500,q_auto:best/https://singeo.s3.amazonaws.com/sales/2022/singeo-device-spread.png">
                <video class="absolute rounded-md" style="width: 43.1%;height: 54%;left: 6.5%;top: 39.1%;" src="https://singeo.s3.amazonaws.com/sales/2022/spread-vid.mp4" type="video/mp4" autoplay="" loop="" playsinline="" muted></video>
            </div>
        </div>
    </section>
            ...
            <table class="w-full mx-auto border-separate comparison">
                ...
                <tr style="background-color:transparent!important;">
                    ...
                    <td class="rounded-t-xl">
                        <img class="h-6 md:h-11 lazyload"  data-src="https://cdn.musora.com/image/fetch/w_300,q_auto:best/https://musora-center.s3.amazonaws.com/logos/singeo-logo-white.png">
                    </td>
                    ...
                    <div class="testimonial w-full md:w-1/3 lg:w-1/4 md:px-2 pb-2 md:pb-4">
                        <div class="w-full rounded-xl overflow-hidden cursor-pointer" style="background: #051124;" data-open="{!!  str_replace(' ', '', $testimonial['name'])  !!}">
                            ...
                            <div class="p-4">
                                ...
                                <h6 class="leading-tight mt-3 mb-1 uppercase font-bebas text-singeo">{!!  $testimonial['name'] !!}</h6>
                                <p class="leading-normal text-light-navy text-sm"><em><u>Read more</u> &nbsp;<i class="fas fa-expand"></i></em></p>
                            </div>
                        </div>
                    </div>
                @endforeach
                <div class="w-full -mt-8 md:-mt-2 lg:mt-0 block lg:hidden">
                    <a class="join smaller outline light-navy testimonials-show-all mx-auto">Show More</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="content-section text-center px-6" style="background:linear-gradient(to bottom, #01050f, #021225);overflow:visible">
        <div class="container mx-auto max-w-4xl">
            <img class="h-28 md:h-32 lazyload" data-src="https://cdn.musora.com/image/fetch/w_250,q_auto:best/https://singeo.s3.amazonaws.com/sales/2022/singeo-guarantee.png">
            ...
            <p class="text-light-navy leading-normal md:leading-loose">Online lessons can be intimidating. Maybe you’re wondering if they work, or if you’ll use them enough – or if you’ll even enjoy the experience. So we’re removing the risk with our 90-day guarantee. More than anything, we want to make sure you have a POSITIVE experience developing new skills and gaining confidence to share your voice with the world. </p>
    ...
    @foreach($videoModals as $videoModal)
        <div class="reveal large" id="{{ $videoModal['modal'] }}" data-reveal data-reset-on-close="false">
            <div class="aspect-16:9 w-full relative">
                <iframe class="absolute w-full h-full reset-on-close" src="" data-lazy-load-url="{{ $videoModal['vimeo'] }}" frameborder="0" allowfullscreen allow="autoplay"></iframe>
            </div>
        </div>
    @endforeach
