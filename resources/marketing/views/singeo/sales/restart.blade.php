    ...
    @include("singeo.sales.partials._nav", [
                    ...
                    <div class="w-full text-center">
                        <div class="px-5 sm:px-0">
                            ...
                            <div class="flex flex-wrap items-center justify-center sm:justify-start mt-6 sm:mt-5 lg:mt-10 mx-auto sm:max-w-xs">
                                <a class="w-full join green smaller mb-2" href="/ecommerce/add-to-cart?products[singeo-annual-recurring-membership]=1&locked=true&promo-code=restart">SEE YOUR DEAL &raquo;</a>
            ...
            <div class="max-w-md md:max-w-4xl mx-auto px-4 lg:px-2">
                ...
                <div class="md:grid md:grid-cols-3 md:gap-4">
                    <div class="relative rounded-xl overflow-hidden mb-3 md:mb-0" style="background-color:#F6F8FC;">
                        <div class="w-full aspect-16:9 bg-cover bg-center lazyload" data-bg="https://www.musora.com/musora-cdn/image/width=700,quality=95/https://d21xeg6s76swyd.cloudfront.net/sales/promos/june/singeo-method.jpg"></div>
                        <div class=" px-3 lg:px-4 py-5 lg:py-7 text-center">
                            <img class="h-5 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=200,quality=95/https://d21xeg6s76swyd.cloudfront.net/sales/promos/june/singeo-method-logo.svg" alt="method-text">
                            <p class="mt-2">
                    ...
                    <div class="relative rounded-xl overflow-hidden mb-3 md:mb-0" style="background-color:#F6F8FC;">
                        <div class="w-full aspect-16:9 bg-cover bg-center lazyload" data-bg="https://www.musora.com/musora-cdn/image/width=700,quality=95/https://d21xeg6s76swyd.cloudfront.net/sales/promos/june/singeo-songs.jpg"></div>
                        <div class="px-3 lg:px-4 py-5 lg:py-7 text-center">
                            <img class="h-5 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=150,quality=95/https://d21xeg6s76swyd.cloudfront.net/sales/promos/june/singeo-songs-logo.svg" alt="songs-text">
                            <p class="mt-2">
                    ...
                    <div class="relative rounded-xl overflow-hidden" style="background-color:#F6F8FC;">
                        <div class="w-full aspect-16:9 bg-cover bg-center lazyload" data-bg="https://www.musora.com/musora-cdn/image/width=700,quality=95/https://d21xeg6s76swyd.cloudfront.net/sales/promos/june/singeo-coaches.jpg"></div>
                        <div class="px-3 lg:px-4 py-5 lg:py-7 text-center">
        ...
        <section class="py-14 sm:py-20 lg:py-24 relative overflow-hidden text-white text-center customize px-4 lg:px-6" style="background:linear-gradient(to left, #8300E9, #3E00C2);">
            <div class="container mx-auto max-w-6xl relative z-50">
                        ...
                        <div class=" inline-block relative w-full group" style="padding-bottom: 62%;perspective: 1000px;">
                            <div class="text-center w-full h-full absolute" style="transform-style: preserve-3d;">
                                <div class="  front absolute z-20 overflow-hidden rounded-3xl w-full h-full transition-transform duration-700" style="backface-visibility: hidden;">
                                    <div class="h-full w-full bg-top bg-contain bg-no-repeat" style="background-image:url(https://www.musora.com/musora-cdn/image/width=850,quality=95/https://d21xeg6s76swyd.cloudfront.net/sales/promos/june/membership-badge.png);"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <a class="join green" href="/ecommerce/add-to-cart?products[singeo-annual-recurring-membership]=1&locked=true&promo-code=restart">GET Started »</a>
            </div>
        </section>
