...
@section('global-head')
    <title>Lifetime Membership To Singeo | Singeo</title>
    <meta property="og:title" content="Lifetime Membership To Singeo">
    <meta property="og:url" content="https://www.singeo.com/{{ Request::path() }}">

    <meta name="description" content="Two, maybe three times per year you get the chance to become a Singeo Lifetime Member.">
    <meta property="og:description" content="Two, maybe three times per year you get the chance to become a Singeo Lifetime Member.">
    <meta property="og:image" content="https://d21q7xesnoiieh.cloudfront.net/fit-in/1200x0/filters:quality(95)/marketing/singeo/promos/november/bundles/singeo-lt-share-image.jpg" style="display: none;">

    <link rel="stylesheet" href="{{ mix('marketing/css/app.css') }}">
    <link href="{{ asset('/marketing/css/tailwind-helpers.css') }}" rel="stylesheet">
    <link href="{{ asset('/marketing/parcel/drumeo/nav-footer-singeo.css') }}" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('/marketing/parcel/drumeo/sales-singeo.css') }}">
        ...
        <div class="container mx-auto">
            ...
            <div class="w-full mx-auto my-4 sm:my-8 " style="max-width:920px;">
                <div class="aspect-16:9 w-full relative rounded-xl overflow-hidden">
                    <img class="absolute inset-0 object-cover" src="https://d21q7xesnoiieh.cloudfront.net/fit-in/1500x0/filters:quality(95)/marketing/singeo/promos/november/bundles/singeo-lifetime-thumb2.jpg">
                </div>
            </div>
...
{{--                <p class="leading-tight mt-4 text-musora">ONLY {{ $products['PIANOTE-MEMBERSHIP-LIFETIME']->getPublicStockCount() }} SPOTS AVAILABLE</p>--}}
    ...
    <section class="text-center px-3 sm:px-5 py-10 md:py-14 lg:py-16 px-2 md:px-4 relative overflow-hidden">
        <div class="container mx-auto max-w-4xl z-10 relative">
            ...
            <p class="leading-tight"><em>Pay once. Play forever. Get unlimited singing lessons for <br class="hidden sm:inline lg:hidden"> the price of 5 years of access to Singeo ($1200 total).</em></p>
            <img class="hidden sm:inline-block w-full max-w-3xl mb-10" src="https://d21q7xesnoiieh.cloudfront.net/fit-in/1500x0/filters:quality(95)/marketing/singeo/promos/november/bundles/timeline.png">
            <img class="sm:hidden inline-block w-full max-w-3xl mb-10" src="https://d21q7xesnoiieh.cloudfront.net/fit-in/800x0/filters:quality(95)/marketing/singeo/promos/november/bundles/timeline-m.png">
            <div class="flex flex-wrap sm:flex-nowrap items-start lg:items-center justify-center">
                <div class="order-1 sm:order-0 text-left sm:pr-5 lg:pr-7">
                    <p class="leading-relaxed my-5">
                        For the price of 5 years Singeo access, you’ll get:
                    </p>
                ...
                <img
                    class="mb-4 sm:mb-0 order-0 sm:order-1 h-40 lg:h-56 rounded-xl transition-opacity opacity-0"
                    src="https://d21q7xesnoiieh.cloudfront.net/fit-in/800x0/filters:quality(95)/marketing/singeo/promos/november/bundles/singeo-lifetime-collage.png"
                    alt="Anika"
                    loading="lazy"
    ...
    <section class="py-14 sm:py-20 lg:py-24 relative overflow-hidden text-white text-center customize px-4 lg:px-6"
        style="background:linear-gradient(to bottom, #420571, #051829);"
    >
                    ...
                    <div class=" inline-block relative w-full group" style="padding-bottom: 56%;perspective: 1000px;">
                        <div class="text-center w-full h-full absolute" style="transform-style: preserve-3d;">
                            <div class=" {{--border-2 border-musora--}} front absolute z-20 overflow-hidden rounded-3xl w-full h-full transition-transform duration-700" style="backface-visibility: hidden;">
                                <div class="h-full w-full bg-center bg-cover" style="background-image:url('https://d21q7xesnoiieh.cloudfront.net/fit-in/800x0/filters:quality(95)/marketing/singeo/promos/november/bundles/singeo-lifetime-card.jpg');"></div>
                            </div>
                        </div>
                    </div>
                </div>
...
{{--                <p class="mt-4 md:mt-5 leading-tight text-musora">ONLY {{ $products['PIANOTE-MEMBERSHIP-LIFETIME']->getPublicStockCount() }} SPOTS AVAILABLE</p>--}}
                <h3 class="leading-tight mt-8 sm:mt-12 mb-5 sm:mb-9"><strong>+ get 13 free bonuses.</strong></h3>
            </div>
    ...
    @php
        $faqs = [
            [
                ...
                "desc" => 'Simply, for life! Either yours or ours. Your Lifetime Membership is valid as long as Singeo (Musora) remains in service and you stay alive.',
            ],
            [
                "title" => "What happens if Singeo or Musora’s service ends?",
