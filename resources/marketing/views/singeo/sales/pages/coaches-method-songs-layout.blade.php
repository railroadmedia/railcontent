...
@section('page-footer')
    @include('musora.sales.components.order-section-collage', [
        ...
        'list' => '<li class="leading-tight mb-3"><i class="fa-li fas fa-check text-singeo"></i> Trusted by 30,000 happy students.</li>
                    ...
                    <li class="leading-tight text-coaches"><i class="fa-li fas fa-check"></i> <strong>*BONUS*</strong> voice, guitar, and drum lessons with full access to all Musora communities.</li>',
