...
@section('global-body')
    ...
    <div class="hero-header px-4 py-12 md:py-20 lg:py-32 bg-black bg-top bg-cover" style="background-image:url(https://www.musora.com/musora-cdn/image/width=1500,quality=85/https://singeo.s3.amazonaws.com/sales/2021/background-order.jpg);">
