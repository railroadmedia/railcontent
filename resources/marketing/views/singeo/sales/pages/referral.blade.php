            ...
            <div class="flex flex-wrap lg:flex-nowrap items-center px-4">
                ...
                <div class="lg:pl-10 max-w-md lg:max-w-none mx-auto">
                    <form id="commentform" name="singeo" method="post" action="{{ URL::route('access-codes.form-claim') }}">
                        ...
                        <input name="button" type="submit" id="button" class="bg-singeo leading-none text-lg border-0 rounded-full select-none cursor-pointer text-center py-4 px-16 uppercase font-bebas-neue" value="Redeem Guest Pass"/>
                    </form>
                </div>
            </div>
        </div>
