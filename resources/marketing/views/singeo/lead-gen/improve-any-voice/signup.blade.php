...
@section('styles')
    ...
    <meta property="og:image" content="https://www.musora.com/cdn-cgi/image/width=1200,q_60,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/4-exercises/og-image.jpg">
    ...
    <style>
        .hero-header {
            ...
            background-image: url('https://www.musora.com/cdn-cgi/image/width=900,q_60,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/4-exercises/header-mobile.png');
        }

        @media (min-width: 768px) {
            .hero-header {
                background-size: 1300px;
                background-image: url('https://www.musora.com/cdn-cgi/image/width=2900,q_60,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/4-exercises/header-desktop.png');
            }
        }
...
@section('body')
    ...
    <section class="final-pitch px-4 py-14 md:py-20 lg:py-24 text-white text-center bg-cover bg-center" style="background-image:url(https://www.musora.com/cdn-cgi/image/width=1500,q_60,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/4-exercises/bottom-background.png);">
        <div class="container mx-auto">
