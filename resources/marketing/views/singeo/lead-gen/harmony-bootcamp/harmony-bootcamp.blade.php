@php
    $steps = [
          [
              'position' => 'left',
              'img' => 'https://www.musora.com/cdn-cgi/image/width=1000,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/harmony-bootcamp/step1.jpg',
              'desc' => 'Enter your email address. It’s free. <br class="hidden md:inline">That’s right - 100% free!'
          ],
          [
              'position' => 'right',
              'img' => 'https://www.musora.com/cdn-cgi/image/width=1000,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/harmony-bootcamp/step2.jpg',
          ...
          [
              'position' => 'right',
              'img' => 'https://www.musora.com/cdn-cgi/image/width=1000,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/harmony-bootcamp/step6.jpg',
...
@section('styles')
    ...
    <style>
        ...
        .header {
            ...
            background-image: url('https://www.musora.com/cdn-cgi/image/width=700,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/harmony-bootcamp/header_m.jpg');
        }
        ...
        @media (min-width: 768px) {
            .header {
                background-image: url('https://www.musora.com/cdn-cgi/image/width=2000,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/harmony-bootcamp/header_bg.jpg');
...
@section('body')
        ...
        <div class="mx-auto relative z-10 max-w-md md:max-w-5xl">
            <div class="flex flex-wrap items-center">
                <div class="w-full md:w-2/3 lg:w-1/2 md:text-left mt-40 md:mt-0">
                    <img class="h-28 sm:h-36 lg:h-40 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=840,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/harmony-bootcamp/logo.png" alt="logo">
    ...
    <section class="text-white py-12 sm:py-20 px-4 sm:px-6 bg-musora-black">
        <div class="max-w-3xl lg:max-w-6xl mx-auto">
            <div class="md:grid md:grid-cols-2 sm:gap-6 md:gap-16 lg:gap-20 items-center justify-center flex flex-col mx-auto max-w-4xl">
                ...
                <img class="rounded-xl sm:w-2/3 md:w-auto mx-auto lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=810,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/harmony-bootcamp/intro_image.jpg" alt="intro image">
            </div>
        </div>
    </section>
    ...
    <section class="px-4 py-12 sm:py-20">
        <div class="max-w-md sm:max-w-3xl lg:max-w-6xl mx-auto">
            <div class="sm:grid sm:grid-cols-2 items-center text-center">
                <img class="rounded-md h-72 sm:h-80 lg:h-96 mb-7 sm:mb-0 mx-auto lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=660,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/harmony-bootcamp/ui.png" alt="intro image">
    ...
    <section class="px-4 py-14 sm:py-20 md:pb-32 bg-musora-black">
        <div class="max-w-3xl lg:max-w-4xl mx-auto text-white relative">
            <div class="w-3/4 sm:w-2/3 mx-auto relative md:static text-center mb-8">
                <img class="md:w-80 lg:w-96 md:absolute -bottom-10 right-2 md:border-8 rounded-3xl md:border-solid border-musora-black lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=800,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/harmony-bootcamp/coach_image.png" alt="coach image">
            </div>
    ...
    <section class="py-20 bg-cover lazyload" style="background-position: 25% 50%;" data-bg="https://www.musora.com/cdn-cgi/image/width=1500,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/beginner-vocal-bootcamp/footer_bg_d.jpg">
        <div class="max-w-2xl lg:max-w-3xl mx-auto text-center text-white px-4">
            <img class="mb-4 h-28 md:h-36 lg:h-40 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=840,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/harmony-bootcamp/logo.png" alt="logo">
            <h5 class="mb-2">
