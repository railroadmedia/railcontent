        ...
        <div class="mx-auto relative z-10 max-w-md md:max-w-5xl">
            <div class="flex flex-wrap items-center">
                <div class="w-full md:w-1/2">
                    ...
                    <img class="h-28 md:h-32 lg:h-40" src="https://www.musora.com/musora-cdn/image/width=840,quality=85/https://singeo.s3.amazonaws.com/lead-gen/harmony-bootcamp/logo.png" alt="logo">
