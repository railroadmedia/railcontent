...
@section('global-body')
        ...
        <div class="mx-auto relative z-10 max-w-md md:max-w-5xl">
            <div class="flex flex-wrap items-center">
                <div class="w-full md:w-1/2">
                    ...
                    <img class="h-28 md:h-32 lg:h-40" src="https://www.musora.com/cdn-cgi/image/width=840,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/harmony-bootcamp/logo.png" alt="logo">
    ...
    <section class="text-center text-white py-10 md:py-14 lg:py-24 px-5 md:px-7" style="background:#00101d ;">
        <div class="container mx-auto text-center max-w-2xl">
            <div class="bg-white text-center rounded-md inline-block overflow-hidden w-11 mr-2 align-middle mb-4 md:mb-0">
            ...
            <a target="_blank" class=" @if(Carbon\Carbon::create(2022, 10, 12, 19, 0, 0, 'America/Vancouver') < Carbon\Carbon::now()) sold-out @endif join medium" href="">Afternoon Session - 2:30pm PDT &raquo;</a>
