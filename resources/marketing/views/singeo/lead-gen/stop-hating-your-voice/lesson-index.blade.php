...
@section('body')
    <header class="header text-center text-white py-10 md:py-20 px-4 bg-center bg-no-repeat relative" style="background-color:#010519; background-image:url(https://www.musora.com/cdn-cgi/image/width=1500,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/stop-hating-your-voice/order-bg.jpg);">
        <div class="container mx-auto relative z-10 max-w-4xl">
            <img class="h-16 md:h-24 lg:h-28" src="https://www.musora.com/cdn-cgi/image/width=1500,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/stop-hating-your-voice/logo.png">
        </div>
    </header>
                ...
                @foreach ($lessons as $lesson)
                    <a href="{{ $lesson['href'] }}" class="flex lg:flex-auto w-full md:w-1/2 lg:w-1/3 px-2 md:px-3 mb-7 md:mb-10 step">
                        <div class="rounded-xl overflow-hidden" style="background: linear-gradient(to bottom, #153044 56%, #252646); ">
                            <div class="aspect-16:9 w-full bg-cover bg-black bg-center mb-2 cursor-pointer hover:opacity-90 transition-opacity duration-300 relative" style="background-image:url(https://www.musora.com/cdn-cgi/image/width=800,quality=95/{{ $lesson['img'] }});">
    ...
    <section class="text-center py-12 md:py-20 text-white bg-center bg-cover lazyload" style="background-color:#030d17;" data-bg="https://www.musora.com/cdn-cgi/image/width=1500,q_60,quality=95/https://d21xeg6s76swyd.cloudfront.net/products/singing-starter-kit/final-bg.jpg">
        <div class="container mx-auto">
            <div class="w-full px-3 md:px-4 text-center">
                <img class="h-16 sm:h-20 lg:h-24 mb-5 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=1300,q_60,quality=95/https://d21xeg6s76swyd.cloudfront.net/products/singing-starter-kit/logo.png">
