...
@section('body')
    <header class="header text-center text-white py-10 md:py-18 px-4 bg-center bg-no-repeat relative" style="background-color:#010519; background-image:url(https://cdn.musora.com/image/fetch/w_1500,q_auto:best/https://singeo.s3.amazonaws.com/lead-gen/stop-hating-your-voice/order-bg.jpg);">
        <div class="container mx-auto relative z-10 max-w-4xl">
            <img class="h-16 md:h-24 lg:h-28" src="https://cdn.musora.com/image/fetch/w_1500,q_auto:best/https://singeo.s3.amazonaws.com/lead-gen/stop-hating-your-voice/logo.png">
        </div>
    </header>
                ...
                @foreach ($lessons as $lesson)
                    <a href="{{ $lesson['href'] }}" class="flex lg:flex-auto w-full md:w-1/2 lg:w-1/3 px-2 md:px-3 mb-7 md:mb-10 step">
                        <div class="rounded-xl overflow-hidden" style="background: linear-gradient(to bottom, #153044 56%, #252646); ">
                            <div class="aspect-16:9 w-full bg-cover bg-black bg-center mb-2 cursor-pointer hover:opacity-90 transition-opacity duration-300 relative" style="background-image:url(https://cdn.musora.com/image/fetch/w_800,q_auto:best/{{ $lesson['img'] }});">
