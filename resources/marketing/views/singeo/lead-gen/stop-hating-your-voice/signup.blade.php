...
@section('body')
    <header class="header text-white text-center px-3 md:px-6 pt-40 pb-4 md:py-5 lg:py-7 relative bg-no-repeat lazyload" style="background-color:#160431;" data-bg="https://www.musora.com/musora-cdn/image/width=2000,quality=85/https://singeo.s3.amazonaws.com/lead-gen/stop-hating-your-voice/header-bg.jpg">
        <div class="container mx-auto relative z-20 max-w-4xl">
            <div class="flex flex-wrap items-center">
                ...
                <div class="w-full md:w-1/2 lg:w-6/12">
                    <img class="h-24 md:h-36" src="https://www.musora.com/musora-cdn/image/width=500,quality=85/https://singeo.s3.amazonaws.com/lead-gen/stop-hating-your-voice/logo.png">
    ...
    <section class="px-4 sm:px-6 py-12 md:py-14 lg:py-20 text-white text-center lazyload bg-top bg-no-repeat bg-contain bg-musora-black" data-bg="https://www.musora.com/musora-cdn/image/width=1200,quality=85/https://singeo.s3.amazonaws.com/lead-gen/stop-hating-your-voice/introduction-bg.jpg">
    ...
    <section class="lisa-bio text-white pt-44 pb-6 md:py-28 lg:py-32 px-4 sm:px-6 relative bg-no-repeat lazyload bg-musora-black" data-bg="https://www.musora.com/musora-cdn/image/width=1900,quality=85/https://singeo.s3.amazonaws.com/lead-gen/stop-hating-your-voice/coach-bg.jpg">
        <div class="container mx-auto max-w-3xl relative z-20">
            <div class="md:flex flex-wrap md:w-7/12 text-center sm:text-left">
                <img class="h-16 sm:h-24 lg:h-32 mx-auto sm:mx-0 mb-4 sm:mb-6 lg:mb-8 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=1500,quality=85/https://singeo.s3.amazonaws.com/lead-gen/stop-hating-your-voice/meet-lisa.png">
    ...
    <section class="final-pitch px-4 py-14 md:py-20 lg:py-24 text-white text-center bg-cover bg-center lazyload" data-bg="https://www.musora.com/musora-cdn/image/width=1500,quality=85/https://singeo.s3.amazonaws.com/lead-gen/stop-hating-your-voice/order-bg.jpg">
        <div class="container mx-auto">
            <img class="h-20 sm:h-32 lg:h-44" src="https://www.musora.com/musora-cdn/image/width=500,quality=85/https://singeo.s3.amazonaws.com/lead-gen/stop-hating-your-voice/logo.png">
