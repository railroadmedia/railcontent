...
@section('body')
    ...
    <a href="/choose-plan" class="edge-pitch block text-center w-full whitespace-nowrap z-10 py-2 sm:py-1 fixed mx-auto bg-black text-white">
        <div class="container mx-auto">
            <div class="text-center sm:text-left inline-block align-middle hover:opacity-90 transition-opacity duration-300">
                <img class="align-middle w-auto mr-2 h-6 hidden sm:inline-block" src="https://www.musora.com/cdn-cgi/image/width=200,quality=95/https://d21xeg6s76swyd.cloudfront.net/sales/2021/singeo-logo.png">
                <p class="inline-block align-middle mx-auto text-xs leading-tight">
                    Get more songs + world-class vocal lessons <br>
    ...
    <section class="text-center py-14 md:py-24 lg:py-32 text-white lazyload" style="background: #6d7894 center center/cover;" data-bg="https://www.musora.com/cdn-cgi/image/width=2000,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/holiday-karaoke/final.jpg">
        <div class="container mx-auto">
            <div class="w-full px-2 md:px-3 text-center">
                ...
                <h4 class="mt-5 lg:mt-6 mb-6 lg:mb-9 leading-normal px-3">
                    Get more songs & world-class vocal lessons inside <br class="hidden md:inline">
