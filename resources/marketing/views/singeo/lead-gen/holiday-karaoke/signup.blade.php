...
@section('body')
    <header class="relative overflow-hidden text-white text-center py-14 md:py-24 lg:py-36 px-4 md:px-6" style="background: #2b3857 url(https://www.musora.com/cdn-cgi/image/width=2000,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/holiday-karaoke/header_no_snow.jpg) center center/cover;">
        <div class="container mx-auto max-w-5xl relative z-50">
            <img class="py-1 md:py-0 h-28 md:h-48 lg:h-60" src="https://www.musora.com/cdn-cgi/image/width=1300,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/holiday-karaoke/logo.png">
    ...
    <section class="relative overflow-hidden text-white text-center py-7 md:py-12 px-6 lazyload" style="background: #6d7894 center center/cover;" data-bg="https://www.musora.com/cdn-cgi/image/width=2000,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/holiday-karaoke/final.jpg">
        <div class="container mx-auto max-w-5xl relative z-50">
            <img class="py-1 md:py-0 h-28 md:h-48 lg:h-60" src="https://www.musora.com/cdn-cgi/image/width=1300,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/holiday-karaoke/logo.png">
