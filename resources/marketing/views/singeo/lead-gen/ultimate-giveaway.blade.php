...
@section('global-head')
    ...
    <meta property="og:image" content="https://www.musora.com/musora-cdn/image/width=1200,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/giveaway/ultimate/header_bg.jpg" style="display: none;">
    ...
    <style>
        ...
        header {
            background-image:url(https://d21xeg6s76swyd.cloudfront.net/lead-gen/giveaway/ultimate/header_bg_m.jpg);
        ...
        @media (min-width:768px) {
            header {
                background-image:url(https://d21xeg6s76swyd.cloudfront.net/lead-gen/giveaway/ultimate/header_bg.jpg);
            }
        }

        .final-bg {
            background-image:url(https://www.musora.com/musora-cdn/image/width=750,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/giveaway/ultimate/footer_bg_m.jpg);
            background-position:50% 0;
            background-size:cover;
        }
        ...
        @media (min-width:768px) {
            .final-bg {
                background-image:url(https://www.musora.com/musora-cdn/image/width=2000,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/giveaway/ultimate/footer_bg.jpg);
            }
        }
    </style>
@stop
...
@section('global-body')
        ...
        <div class="container relative z-10 mx-auto max-w-5xl md:mt-0">
            <div class="flex flex-wrap">
                ...
                <div class="w-full md:w-7/12 lg:w-1/2 sm:text-left">
                    <img class="inline-block sm:hidden h-32  lazyload" data-src="https://www.musora.com/musora-cdn/image/width=650,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/giveaway/ultimate/logo_center_align.svg" alt="title image">
                    <img class="hidden sm:inline-block h-28 lg:h-36 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=650,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/giveaway/ultimate/logo_left_align.svg" alt="title image">
    ...
    <section class="text-center py-8 md:py-10 lg:py-20 px-5 md:px-4 text-white" style="background-color:#2e1e56;">
        <div class="container mx-auto max-w-4xl">
            ...
            <img class="rounded-xl lazyload" data-src="https://d21xeg6s76swyd.cloudfront.net/lead-gen/giveaway/ultimate/lifetime.png">
            <div class="flex flex-col sm:flex-row flex-wrap items-end mt-5">
                <div class="w-full sm:w-1/2 lg:w-1/3 mb-7 sm:mb-2 md:px-1">
                    <div class="flex flex-col flex-auto rounded-xl p-6" style="background:linear-gradient(to bottom, #c956d5, #9b1dac);">
                        ...
                        <img class="mx-auto h-28 md:h-36 lg:h-44 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=500,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/giveaway/ultimate/Mic.png" alt="logo">
                    </div>
                </div>
                <div class="w-full sm:w-1/2 lg:w-1/3 mb-7 sm:mb-2 md:px-1">
                    <div class="flex flex-col flex-auto rounded-xl p-6" style="background:linear-gradient(to bottom, #c956d5, #9b1dac);">
                        ...
                        <img class="mx-auto h-28 md:h-36 lg:h-44 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=500,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/giveaway/ultimate/Headphones.png" alt="logo">
                    </div>
                </div>
                <div class="w-full sm:w-1/2 lg:w-1/3 mb-7 sm:mb-2 md:px-1">
                    <div class="flex flex-col flex-auto rounded-xl p-6" style="background:linear-gradient(to bottom, #c956d5, #9b1dac);">
                        ...
                        <img class="mx-auto h-28 md:h-36 lg:h-44 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=500,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/giveaway/ultimate/VocalMist.png" alt="logo">
                    </div>
                </div>
                <div class="w-full sm:w-1/2 lg:w-1/3 mb-7 sm:mb-2 md:px-1">
                    <div class="flex flex-col flex-auto rounded-xl p-6" style="background:linear-gradient(to bottom, #c956d5, #9b1dac);">
                        ...
                        <img class="mx-auto h-28 md:h-36 lg:h-44 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=500,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/giveaway/ultimate/Hoodie.png" alt="logo">
                    </div>
                </div>
                <div class="w-full sm:w-1/2 lg:w-1/3 mb-7 sm:mb-2 md:px-1">
                    <div class="flex flex-col flex-auto rounded-xl p-6" style="background:linear-gradient(to bottom, #c956d5, #9b1dac);">
                        ...
                        <img class="mx-auto h-28 md:h-36 lg:h-44 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=500,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/giveaway/ultimate/Shirt.png" alt="logo">
                    </div>
                </div>
                <div class="w-full sm:w-1/2 lg:w-1/3 mb-7 sm:mb-2 md:px-1">
                    <div class="flex flex-col flex-auto rounded-xl p-6" style="background:linear-gradient(to bottom, #c956d5, #9b1dac);">
                        ...
                        <p class="rounded-md px-5 my-3 py-1.5 leading-none" style="background-color:#21173b;">Value of <strong>$29</strong></p>
                        <img class="mx-auto h-28 md:h-36 lg:h-44 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=500,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/giveaway/ultimate/Tumbler.png" alt="logo">
                    </div>
                </div>
            </div>
    ...
    <section class="px-4 py-12 sm:py-20">
        <div class="max-w-md sm:max-w-2xl mx-auto">
            <div class="flex flex-wrap sm:flex-nowrap items-center text-center">
                <img class="sm:order-1 rounded-md h-72 sm:h-80 lg:h-96 mb-7 sm:mb-0 mx-auto lazyload" data-src="https://www.musora.com/musora-cdn/image/width=660,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/giveaway/ultimate/UI.png" alt="intro image">
    ...
    <section class="text-center text-white py-8 md:py-14 lg:py-20 px-5 md:px-7 bg-center bg-cover final-bg">
        <div class="container mx-auto max-w-2xl">
            <img class="h-24 sm:h-28 lg:h-44 lazyload mb-4 sm:mb-6" data-src="https://www.musora.com/musora-cdn/image/width=650,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/giveaway/ultimate/logo_center_align.svg" alt="title image">
