@php
    $steps = [
          [
              'position' => 'left',
              'img' => 'https://www.musora.com/musora-cdn/image/width=1000,quality=85/https://singeo.s3.amazonaws.com/lead-gen/beginner-vocal-bootcamp/step1.jpg',
              'desc' => 'Enter your email address. It’s free. That’s right - 100% free!'
          ],
          [
              'position' => 'right',
              'img' => 'https://www.musora.com/musora-cdn/image/width=1000,quality=85/https://singeo.s3.amazonaws.com/lead-gen/beginner-vocal-bootcamp/step2.jpg',
              'desc' => 'Join the Private Facebook Group. You’ll be emailed the invite.'
          ],
          [
              'position' => 'left',
              'img' => 'https://www.musora.com/musora-cdn/image/width=1000,quality=85/https://singeo.s3.amazonaws.com/lead-gen/beginner-vocal-bootcamp/step3.jpg',
              'desc' => 'Log in for your 60 minute LIVE lessons with Lisa.'
          ],
          [
              'position' => 'right',
              'img' => 'https://www.musora.com/musora-cdn/image/width=1000,quality=85/https://singeo.s3.amazonaws.com/lead-gen/beginner-vocal-bootcamp/step4.jpg',
              'desc' => 'Get your downloadable resources, practice tips, and connect with Lisa.'
          ],
          [
              'position' => 'left',
              'img' => 'https://www.musora.com/musora-cdn/image/width=1000,quality=85/https://singeo.s3.amazonaws.com/lead-gen/beginner-vocal-bootcamp/step5.jpg',
              'desc' => 'Post your progress (if you want - it’s totally up to you).'
          ],
          [
              'position' => 'right',
              'img' => 'https://www.musora.com/musora-cdn/image/width=1000,quality=85/https://singeo.s3.amazonaws.com/lead-gen/beginner-vocal-bootcamp/step6.jpg',
              'desc' => 'Sing BETTER!'
          ],
      ];
@endphp
...
@section('body')
        ...
        <div class="mx-auto relative z-10 max-w-md md:max-w-5xl">
            <div class="flex flex-wrap items-center">
                ...
                <div class="w-full md:w-1/2 md:text-left">
                    <img class="h-16 sm:h-20 lg:h-24 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=840,quality=85/https://singeo.s3.amazonaws.com/lead-gen/beginner-vocal-bootcamp/logo.png" alt="logo">
    ...
    <section class="text-white py-12 sm:py-20 px-4 sm:px-6 bg-musora-black">
        <div class="max-w-3xl lg:max-w-6xl mx-auto">
            <div class="md:grid md:grid-cols-2 sm:gap-6 md:gap-16 lg:gap-20 items-center justify-center flex flex-col mx-auto mb-10 sm:mb-20 md:mb-24 lg:mb-32 max-w-4xl">
                ...
                <img class="rounded-md sm:w-2/3 md:w-auto mx-auto lazyload" data-src="https://www.musora.com/musora-cdn/image/width=810,quality=85/https://singeo.s3.amazonaws.com/lead-gen/beginner-vocal-bootcamp/intro_image.jpg" alt="intro image">
            </div>
            ...
            <div class="flex flex-wrap sm:flex-nowrap items-center max-w-xs sm:max-w-5xl mx-auto">
                <img class="rounded-xl mx-auto w-72 lg:w-96 order-1 sm:order-0 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=800,quality=85/https://singeo.s3.amazonaws.com/lead-gen/beginner-vocal-bootcamp/end_of_bootcamp_image.jpg" alt="intro image">
    ...
    <section class="px-4 py-12 sm:py-20">
        <div class="max-w-md sm:max-w-3xl lg:max-w-6xl mx-auto">
            <div class="sm:grid sm:grid-cols-2 sm:gap-6 md:gap-12 lg:gap-20 items-center text-center">
                <img class="rounded-md h-72 sm:h-80 lg:h-96 mb-7 sm:mb-0 mx-auto lazyload" data-src="https://www.musora.com/musora-cdn/image/width=660,quality=85/https://singeo.s3.amazonaws.com/lead-gen/beginner-vocal-bootcamp/screen_image2.png" alt="intro image">
    ...
    <section class="py-20 bg-cover lazyload" style="background-position: 25% 50%;" data-bg="https://www.musora.com/musora-cdn/image/width=1500,quality=85/https://singeo.s3.amazonaws.com/lead-gen/beginner-vocal-bootcamp/footer_bg_d.jpg">
        <div class="max-w-2xl lg:max-w-3xl mx-auto text-center text-white px-4">
            <img class="mb-4 w-3/4 sm:w-2/3 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=840,quality=85/https://singeo.s3.amazonaws.com/lead-gen/beginner-vocal-bootcamp/logo.png" alt="logo">
            <h5 class="mb-2">
