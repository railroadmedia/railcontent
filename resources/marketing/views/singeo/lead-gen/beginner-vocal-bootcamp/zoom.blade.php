...
@section('global-body')
    ...
    <section class="text-center text-white py-10 md:py-14 lg:py-24 px-5 md:px-7" style="background:#00101d ;">
        <div class="container mx-auto text-center max-w-2xl">
            ...
            <a target="_blank" class=" @if(Carbon\Carbon::create(2022, 12, 20, 16, 0, 0, 'America/Vancouver') < Carbon\Carbon::now()) sold-out @endif join medium" href="https://us06web.zoom.us/j/84488082900?pwd=am1jTk9BOTdlN3hBS1E5YkVyK094dz09">Afternoon Session - 2pm PDT &raquo;</a>
