        ...
        <div class="mx-auto relative z-10 max-w-md md:max-w-5xl">
            <div class="flex flex-wrap items-center">
                <div class="w-full md:w-1/2">
                    ...
                    <img class="sm:w-4/5 md:w-full" src="https://www.musora.com/cdn-cgi/image/width=840,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/beginner-vocal-bootcamp/logo.png" alt="logo">
