...
@section('body')
    ...
    <section class="text-white py-12 sm:py-20 px-4 sm:px-6 bg-musora-black">
        <div class="max-w-3xl lg:max-w-4xl mx-auto">
            <div class="md:grid md:grid-cols-2 sm:gap-6 md:gap-12 items-center justify-center flex flex-col mx-auto">
                ...
                <img class="rounded-md sm:w-2/3 md:w-auto mx-auto lazyload" data-src="https://cdn.musora.com/image/fetch/w_810,q_auto:best/https://singeo.s3.amazonaws.com/lead-gen/beginner-vocal-bootcamp/intro_image2.jpg" alt="intro image">
            </div>
        </div>
    </section>
    ...
    <section class="py-12 sm:py-20 px-4 sm:px-6">
        <div class="max-w-3xl lg:max-w-4xl mx-auto">
            ...
            <div class="flex flex-wrap sm:flex-nowrap items-center mx-auto">
                <img class="rounded-xl mx-auto w-72 lg:w-96 order-1 sm:order-0 lazyload" data-src="https://cdn.musora.com/image/fetch/w_800,q_auto:best/https://singeo.s3.amazonaws.com/lead-gen/beginner-vocal-bootcamp/collage.png" alt="intro image">
    ...
    <section class="px-4 py-12 sm:py-20">
        <div class="max-w-md sm:max-w-3xl lg:max-w-5xl mx-auto">
            <div class="sm:grid sm:grid-cols-2 sm:gap-6 md:gap-12 lg:gap-20 items-center text-center">
                <img class="rounded-md h-72 sm:h-80 lg:h-96 mb-7 sm:mb-0 mx-auto lazyload" data-src="https://cdn.musora.com/image/fetch/w_660,q_auto:best/https://singeo.s3.amazonaws.com/lead-gen/beginner-vocal-bootcamp/ui.png" alt="intro image">
    ...
    <section class="py-20 bg-cover lazyload" style="background-position: 25% 50%;" data-bg="https://cdn.musora.com/image/fetch/w_1500,q_auto:best/https://singeo.s3.amazonaws.com/lead-gen/beginner-vocal-bootcamp/footer_bg_d.jpg">
        <div class="max-w-2xl lg:max-w-3xl mx-auto text-center text-white px-4">
            <img class="mb-4 h-20 sm:h-24 lg:h-36 lazyload" data-src="https://cdn.musora.com/image/fetch/w_840,q_auto:best/https://singeo.s3.amazonaws.com/lead-gen/beginner-vocal-bootcamp/logo2.png" alt="logo">
            <h5 class="mb-2">
