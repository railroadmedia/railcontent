@php
    $steps = [
          [
              'position' => 'left',
              'img' => 'https://d21xeg6s76swyd.cloudfront.net/lead-gen/beginner-vocal-bootcamp/Step1alt.png',
              'desc' => 'Enter your email address. It’s free. That’s right - 100% free!'
          ],
          [
              'position' => 'right',
              'img' => 'https://d21xeg6s76swyd.cloudfront.net/lead-gen/beginner-vocal-bootcamp/step2.jpg',
              'desc' => 'Join the Private Facebook Group. You’ll be emailed the invite.'
          ],
          [
              'position' => 'left',
              'img' => 'https://d21xeg6s76swyd.cloudfront.net/lead-gen/beginner-vocal-bootcamp/step3.jpg',
              'desc' => 'Log in for your 90 minute LIVE Lesson with Lisa.'
          ],
          [
              'position' => 'right',
              'img' => 'https://d21xeg6s76swyd.cloudfront.net/lead-gen/beginner-vocal-bootcamp/step4.jpg',
              'desc' => 'Get your downloadable resources, practice tips, and connect with Lisa.'
          ],
          [
              'position' => 'left',
              'img' => 'https://d21xeg6s76swyd.cloudfront.net/lead-gen/beginner-vocal-bootcamp/step5.jpg',
              'desc' => 'Post your progress (if you want - it’s totally up to you).'
          ],
          [
              'position' => 'right',
              'img' => 'https://d21xeg6s76swyd.cloudfront.net/lead-gen/beginner-vocal-bootcamp/step6.jpg',
              'desc' => 'Sing BETTER!'
          ],
      ];
@endphp
...
@section('body')
        ...
        <div class="mx-auto relative z-10 max-w-md md:max-w-5xl">
            <div class="flex flex-wrap items-center">
                ...
                <div class="w-full sm:w-7/12 lg:w-1/2 md:text-left">
                    <img class="h-20 sm:h-24 lg:h-36 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=840,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/beginner-vocal-bootcamp/logo2.png" alt="logo">
                    ...
                    <div class="flex justify-center items-center md:justify-start mb-2 sm:mb-5">
                        ...
                        <p class="leading-tight uppercase text-yellow ml-4">
                            <a target="_blank" href="https://www.google.com/search?q=9am+PDT" class="font-extrabold"><strong>Monday, Sept 19 @ 9am PDT</strong> <i class="fa-light fa-info-circle"></i></a>
                        </p>
                    </div>
    ...
    <section class="text-white py-12 sm:py-20 px-4 sm:px-6 bg-musora-black">
        <div class="max-w-3xl lg:max-w-4xl mx-auto">
            <div class="md:grid md:grid-cols-2 sm:gap-6 md:gap-12 items-center justify-center flex flex-col mx-auto">
                ...
                <img class="rounded-md sm:w-2/3 md:w-auto mx-auto lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=810,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/beginner-vocal-bootcamp/intro_image2.jpg" alt="intro image">
            </div>
        </div>
    </section>
    ...
    <section class="py-12 sm:py-20 px-4 sm:px-6">
        <div class="max-w-3xl lg:max-w-4xl mx-auto">
            <div class="text-center mb-10 sm:mb-20 md:mb-24">
                ...
                <div class="flex flex-col md:flex-row md:gap-6 lg:gap-10">
                    <div class="md:w-1/3 mb-8 md:mb-0">
                        <img class="h-12 md:h-16" src="https://d21xeg6s76swyd.cloudfront.net/lead-gen/beginner-vocal-bootcamp/myths_icon.svg" alt="ear icon">
                    ...
                    <div class="md:w-1/3 mb-8 md:mb-0">
                        <img class="h-12 md:h-16" src="https://d21xeg6s76swyd.cloudfront.net/lead-gen/beginner-vocal-bootcamp/right_icon.svg" alt="hurts icon">
                    ...
                    <div class="md:w-1/3">
                        <img class="h-12 md:h-16" src="https://d21xeg6s76swyd.cloudfront.net/lead-gen/beginner-vocal-bootcamp/power_icons.svg" alt="bad song icon">
            ...
            <div class="flex flex-wrap sm:flex-nowrap items-center mx-auto">
                <img class="rounded-xl mx-auto w-72 lg:w-96 order-1 sm:order-0 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=800,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/beginner-vocal-bootcamp/collage.png" alt="intro image">
    ...
    <section class="px-4 py-12 sm:py-20">
        <div class="max-w-md sm:max-w-3xl lg:max-w-5xl mx-auto">
            <div class="sm:grid sm:grid-cols-2 sm:gap-6 md:gap-12 lg:gap-20 items-center text-center">
                <img class="rounded-md h-72 sm:h-80 lg:h-96 mb-7 sm:mb-0 mx-auto lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=660,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/beginner-vocal-bootcamp/ui.png" alt="intro image">
    ...
    <section class="py-20 bg-cover lazyload" style="background-position: 25% 50%;" data-bg="https://www.musora.com/cdn-cgi/image/width=1500,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/beginner-vocal-bootcamp/footer_bg_d.jpg">
        <div class="max-w-2xl lg:max-w-3xl mx-auto text-center text-white px-4">
            <img class="mb-4 h-20 sm:h-24 lg:h-36 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=840,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/beginner-vocal-bootcamp/logo2.png" alt="logo">
            <h5 class="mb-2">
