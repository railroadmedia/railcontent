...
@section('global-head')
    ...
    <style>
        ...
        .header {
            ...
            background-image: url('https://www.musora.com/cdn-cgi/image/width=700,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/beginner-vocal-bootcamp/header_bg_m.jpg');
        }
