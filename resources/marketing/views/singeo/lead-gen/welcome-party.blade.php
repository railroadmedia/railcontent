...
@section('global-body')
    ...
    <div class="title-wrap text-white py-5 md:py-12 lg:py-16 px-5 md:px-7 lg:px-3" style="background: linear-gradient(00deg, #011a33, #000c17);">
        <div class="container mx-auto max-w-3xl">
            <img style="width: 100%;border-radius:10px;" src="https://www.musora.com/cdn-cgi/image/width=2000,quality=95/https://d21xeg6s76swyd.cloudfront.net/sales/2021/background-teachers-2.jpg">
