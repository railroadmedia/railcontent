...
@endif
    ...
    <section class="text-center py-12 md:py-20 text-white bg-center bg-cover lazyload" style="background-color:#030d17;" data-bg="https://www.musora.com/musora-cdn/image/width=1500,q_60,quality=95/https://d21xeg6s76swyd.cloudfront.net/products/singing-starter-kit/final-bg.jpg">
        <div class="container mx-auto">
            <div class="w-full px-3 md:px-4 text-center">
                <img class="h-16 sm:h-20 lg:h-24 mb-5 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=1300,q_60,quality=95/https://d21xeg6s76swyd.cloudfront.net/products/singing-starter-kit/logo.png">
