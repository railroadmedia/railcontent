...
@section('global-body')
    ...
    <header class="header text-white text-center px-4 sm:px-6 py-14 md:py-20 lg:py-32 relative bg-no-repeat bg-cover bg-top lazyload" style="background-color:#031e3b;" data-bg="https://www.musora.com/cdn-cgi/image/width=1500,quality=95/https://d21xeg6s76swyd.cloudfront.net/products/shop-header.jpg">
