    ...
    <header class="py-12 md:py-20" style="background:linear-gradient(180deg, #00101D 0%, #23053A 100%);">
        <div class="max-w-md md:max-w-4xl mx-auto md:flex md:items-center text-white md:gap-10 px-6 lg:px-0">
            <div class="md:w-1/2 text-center md:text-left">
                <picture>
                    <source media="(min-width: 768px)" srcset="https://www.musora.com/musora-cdn/image/width=600,quality=85/https://singeo.s3.amazonaws.com/lead-gen/harmony-pack/logo_left_light.png">
                    <img class="h-24 lg:h-32 rounded-b-md lazyload mb-3" data-src="https://www.musora.com/musora-cdn/image/width=460,quality=85/https://singeo.s3.amazonaws.com/lead-gen/harmony-pack/logo_center_light.png" alt="logo">
                </picture>
                <div class="relative md:hidden">
                    <img class="rounded-xl mb-4" src="https://www.musora.com/musora-cdn/image/width=650,quality=85/https://singeo.s3.amazonaws.com/lead-gen/harmony-pack/header_thumb_m.jpg" alt="header thumb">
...
{{--                    </div>--}}
            ...
            <div class="md:w-1/2 hidden md:block relative">
                <img class="rounded-xl" src="https://www.musora.com/musora-cdn/image/width=850,quality=85/https://singeo.s3.amazonaws.com/lead-gen/harmony-pack/header_thumb.jpg" alt="header thumb">
...
{{--                </div>--}}
    ...
    <section class="pt-12 pb-40 md:py-20 relative">
        <div class="max-w-md md:max-w-4xl mx-auto md:flex md:items-center md:gap-6 px-6 lg:px-0 relative">
            ...
            <div class="absolute md:relative left-0 right-0 md:w-2/5 flex justify-center md:block">
                <img class="h-72 md:h-auto lazyload" data-src="https://www.musora.com/musora-cdn/image/width=700,quality=85/https://singeo.s3.amazonaws.com/lead-gen/harmony-pack/notepad.png" alt="note pad">
            </div>
        </div>
    </section>
        ...
        <div class="max-w-md md:max-w-4xl mx-auto md:text-center px-6 lg:px-0">
            ...
            <div class="md:flex md:flex-wrap md:gap-6 lg:gap-10">
                <div class="md:flex-1 flex md:block mb-6 md:mb-0">
                    <img class="h-9 md:h-12 mb-6 mr-4 md:mr-0 lazyload" data-src="https://singeo.s3.amazonaws.com/lead-gen/harmony-pack/music_icon.svg" alt="music icon">
                    <div>
                ...
                <div class="md:flex-1 flex md:block mb-6 md:mb-0">
                    <img class="h-9 md:h-12 mb-6 mr-3 md:mr-0 lazyload" data-src="https://singeo.s3.amazonaws.com/lead-gen/harmony-pack/understanding_icon.svg" alt="understanding icon">
                    <div>
                ...
                <div class="md:flex-1 flex md:block">
                    <img class="h-9 md:h-12 mb-6 mr-3 md:mr-0 lazyload" data-src="https://singeo.s3.amazonaws.com/lead-gen/harmony-pack/mic_icon.svg" alt="mic icon">
                    <div>
    ...
    <section class="pb-12 pt-20 md:pb-20 md:pt-24 relative" style="background:#00101D;">
        <div class="absolute flex justify-center left-0 right-0 -top-12 md:-top-20 lg:-top-24">
            <img class="h-24 md:h-32 lg:h-36 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=280,quality=85/https://singeo.s3.amazonaws.com/sales/2022/singeo-guarantee.png" alt="guarantee badge">
        </div>
    ...
    <section class="py-12 md:py-20 text-center" style="background:#F7ECFF;">
        <img class="h-20 md:h-24 lg:h-32 mb-2 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=600,quality=85/https://singeo.s3.amazonaws.com/lead-gen/harmony-pack/logo_center_dark.png" alt="logo">
