    ...
    <header class="py-12 md:py-20" style="background:linear-gradient(180deg, #00101D 0%, #23053A 100%);">
        <div class="max-w-md md:max-w-4xl mx-auto md:flex md:items-center text-white md:gap-10 px-6 lg:px-0">
            <div class="md:w-1/2 text-center md:text-left">
                <picture>
                    <source media="(min-width: 768px)" srcset="https://www.musora.com/cdn-cgi/image/width=600,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/harmony-pack/logo_left_light.png">
                    <img class="h-24 lg:h-32 rounded-b-md lazyload mb-3" data-src="https://www.musora.com/cdn-cgi/image/width=460,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/harmony-pack/logo_center_light.png" alt="logo">
                </picture>
                <div class="relative md:hidden">
                    <img class="rounded-xl mb-4" src="https://www.musora.com/cdn-cgi/image/width=650,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/harmony-pack/header_thumb_m.jpg" alt="header thumb">
...
{{--                    <p>**90-DAY GUARANTEE**</p>--}}
            ...
            <div class="md:w-1/2 hidden md:block relative">
                <img class="rounded-xl" src="https://www.musora.com/cdn-cgi/image/width=850,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/harmony-pack/header_thumb.jpg" alt="header thumb">
...
{{--                    <a class="join smaller w-full tracking-tighter mb-2" href="/ecommerce/add-to-cart?products[the-essential-guide-to-beautiful-harmonies]=1">get started for ${{ floatval($productPrices['the-essential-guide-to-beautiful-harmonies']->discounted_price) }}</a>--}}
            ...
            <div class="absolute md:relative left-0 right-0 md:w-2/5 flex justify-center md:block">
                <img class="h-72 md:h-auto lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=700,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/harmony-pack/notepad.png" alt="note pad">
            </div>
        </div>
    </section>
    ...
    <section class="pb-12 pt-20 md:pb-20 md:pt-24 relative" style="background:#00101D;">
        <div class="absolute flex justify-center left-0 right-0 -top-12 md:-top-20 lg:-top-24">
            <img class="h-24 md:h-32 lg:h-36 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=280,quality=95/https://d21xeg6s76swyd.cloudfront.net/sales/2022/singeo-guarantee.png" alt="guarantee badge">
        </div>
    ...
    <section class="py-12 md:py-20 text-center" style="background:#F7ECFF;">
        <img class="h-20 md:h-24 lg:h-32 mb-2 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=600,quality=95/https://d21xeg6s76swyd.cloudfront.net/lead-gen/harmony-pack/logo_center_dark.png" alt="logo">
