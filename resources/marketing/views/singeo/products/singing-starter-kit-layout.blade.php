...
@section('global-body')
    ...
    <header class="text-center text-white py-5 md:py-8 bg-top bg-no-repeat relative" style="background-color:#000419;background-image: url(https://www.musora.com/musora-cdn/image/width=1900,quality=85/https://d21xeg6s76swyd.cloudfront.net/products/singing-starter-kit/header2.jpg);">
        <div class="container mx-auto relative z-10">
            ...
            <img class="h-20 md:h-32 lg:h-40" src="https://www.musora.com/musora-cdn/image/width=980,quality=85/https://d21xeg6s76swyd.cloudfront.net/products/singing-starter-kit/logo.png" alt="Starterkit logo"><br>
                ...
                <div class="px-5 mb-6 sm:mb-20">
                    <div class="md:flex flex-wrap items-start md:items-center">
                        <div class="w-full md:w-2/5 lg:w-1/2 px-5 md:px-0 relative">
                            ...
                            <img class="rounded-3xl" src="https://www.musora.com/musora-cdn/image/width=900,quality=85/https://d21xeg6s76swyd.cloudfront.net/products/singing-starter-kit/introduction.jpg" alt="Introduction thumbnail">
                        </div>
                ...
                <div class="px-5 mb-6 sm:mb-20">
                    <div class="md:flex flex-wrap items-start md:items-center">
                        <div class="w-full md:w-2/5 lg:w-1/2 px-5 md:px-0 relative sm:order-2">
                            ...
                            <img class="rounded-3xl" src="https://www.musora.com/musora-cdn/image/width=900,quality=85/https://d21xeg6s76swyd.cloudfront.net/products/singing-starter-kit/lesson1.jpg" alt="Lesson 1 Thumbnail"></div>
                ...
                <div class="px-5 mb-6 sm:mb-20">
                    <div class="md:flex flex-wrap items-start md:items-center">
                        <div class="w-full md:w-2/5 lg:w-1/2 px-5 md:px-0 relative">
                            ...
                            <img class="rounded-3xl" src="https://www.musora.com/musora-cdn/image/width=900,quality=85/https://d21xeg6s76swyd.cloudfront.net/products/singing-starter-kit/lesson2.jpg" alt="Lesson 2 Thumbnail"></div>
                        <div class="w-full md:w-3/5 lg:w-1/2 mb-4 md:mb-0 md:pl-10 lg:pl-12 pt-7">
                ...
                <div class="px-5 mb-6 sm:mb-20">
                    <div class="md:flex flex-wrap items-start md:items-center">
                        <div class="w-full md:w-2/5 lg:w-1/2 px-5 md:px-0 relative sm:order-2">
                            ...
                            <img class="rounded-3xl" src="https://www.musora.com/musora-cdn/image/width=900,quality=85/https://d21xeg6s76swyd.cloudfront.net/products/singing-starter-kit/lesson3.jpg" alt="Lesson 3 Thumbnail"></div>
                        <div class="w-full md:w-3/5 lg:w-1/2 mb-4 md:mb-0 md:pr-10 lg:pr-12 pt-7">
                ...
                <div class="px-5 mb-6 sm:mb-20">
                    <div class="md:flex flex-wrap items-start md:items-center">
                        <div class="w-full md:w-2/5 lg:w-1/2 px-5 md:px-0 relative">
                            ...
                            <img class="rounded-3xl" src="https://www.musora.com/musora-cdn/image/width=900,quality=85/https://d21xeg6s76swyd.cloudfront.net/products/singing-starter-kit/lesson4.jpg" alt="Lesson 4 Thumbnail"></div>
                        <div class="w-full md:w-3/5 lg:w-1/2 mb-4 md:mb-0 md:pl-10 lg:pl-12 pt-7">
                ...
                <div class="px-5 mb-6 sm:mb-20">
                    <div class="md:flex flex-wrap items-start md:items-center">
                        <div class="w-full md:w-2/5 lg:w-1/2 px-5 md:px-0 relative sm:order-2">
                            ...
                            <img class="rounded-3xl" src="https://www.musora.com/musora-cdn/image/width=900,quality=85/https://d21xeg6s76swyd.cloudfront.net/products/singing-starter-kit/lesson5.jpg" alt="Lesson 5 Thumbnail"></div>
                        <div class="w-full md:w-3/5 lg:w-1/2 mb-4 md:mb-0 md:pr-10 lg:pr-12 pt-7">
                ...
                <div class="px-5">
                    <div class="md:flex flex-wrap items-start md:items-center">
                        <div class="w-full md:w-2/5 lg:w-1/2 px-5 md:px-0 relative">
                            ...
                            <img class="rounded-3xl" src="https://www.musora.com/musora-cdn/image/width=900,quality=85/https://d21xeg6s76swyd.cloudfront.net/products/singing-starter-kit/lesson6.jpg" alt="Lesson 6 Thumbnail"></div>
                        <div class="w-full md:w-3/5 lg:w-1/2 mb-4 md:mb-0 md:pl-10 lg:pl-12 pt-7">
    ...
    <section class="lisa-bio text-white pt-10 md:pt-44 lg:pt-64 pb-0 md:pb-16 lg:pb-36 px-4 relative bg-cover bg-top lazyload" style="background-color:#100924;" data-bg="https://www.musora.com/musora-cdn/image/width=1900,quality=85/https://d21xeg6s76swyd.cloudfront.net/products/singing-starter-kit/bio-bg.jpg">
        <div class="container mx-auto max-w-5xl relative z-10">
            <div class="md:flex flex-wrap md:w-7/12 ml-auto order-1 text-center md:text-left">
                ...
                <img class="h-10 md:h-20 lg:h-24 mt-2 md:mt-3 mb-44 md:mb-5" src="https://www.musora.com/musora-cdn/image/width=880,quality=85/https://d21xeg6s76swyd.cloudfront.net/products/singing-starter-kit/lisa.png" alt="Lisa Witt text">
            ...
            <div class="slick-2 mx-auto text-left" style="max-width:1100px;">
                <div class="px-2">
                    <div class="rounded-2xl p-3 md:p-8" style="background:linear-gradient(to bottom, #1e0338, #060416)">
                        ...
                        <div class="flex items-center pt-5 md:pt-8">
                            <img class="rounded-full w-1/4 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=140,quality=85/https://d21xeg6s76swyd.cloudfront.net/products/singing-starter-kit/diane.jpg" alt="Diane Smith">
                ...
                <div class="px-2">
                    <div class="rounded-2xl p-3 md:p-8" style="background:linear-gradient(to bottom, #1e0338, #060416)">
                        ...
                        <div class="flex items-center pt-5 md:pt-8">
                            <img class="rounded-full w-1/4 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=140,quality=85/https://d21xeg6s76swyd.cloudfront.net/products/singing-starter-kit/susan.jpg" alt="Susan French">
                            <div class="text pl-3 md:pl-5">
                ...
                <div class="px-2">
                    <div class="rounded-2xl p-3 md:p-8" style="background:linear-gradient(to bottom, #1e0338, #060416)">
                        ...
                        <div class="flex items-center pt-5 md:pt-8">
                            <img class="rounded-full w-1/4 lazyload" data-src="https://www.musora.com/musora-cdn/image/width=140,quality=85/https://d21xeg6s76swyd.cloudfront.net/products/singing-starter-kit/kelly.jpg" alt="Kelly">
                            <div class="text pl-3 md:pl-5">
    ...
    <section class="text-white pb-20 md:pb-20 lg:pb-24" style="background:#000419;">
        <div class="container mx-auto">
            <div class="flex items-start lg:items-center flex-wrap md:flex-nowrap max-w-5xl mx-auto px-5 md:px-6 lg:px-8 text-center md:text-left">
                <img class="w-36 md:w-52 lg:w-60 mb-5 md:mb-0 mx-auto md:order-1 inline-block lazyload" data-src="https://www.musora.com/musora-cdn/image/width=480,quality=85/https://d21xeg6s76swyd.cloudfront.net/sales/2021/guarantee.png" alt="Guarantee badge">
