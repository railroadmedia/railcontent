...
@section('global-body')
    ...
    <header class="text-center text-white py-5 md:py-8 bg-top bg-no-repeat relative" style="background-color:#000419;background-image: url(https://www.musora.com/cdn-cgi/image/width=1900,quality=95/https://d21xeg6s76swyd.cloudfront.net/products/singing-starter-kit/header2.jpg);">
        <div class="container mx-auto relative z-10">
            ...
            <img class="h-20 md:h-32 lg:h-40" src="https://www.musora.com/cdn-cgi/image/width=980,quality=95/https://d21xeg6s76swyd.cloudfront.net/products/singing-starter-kit/logo.png"><br>
            ...
            <div class="flex flex-wrap justify-center mt-3 sm:mt-5">
                ...
                @foreach($lessons as $lesson)
                    <div class="w-1/2 sm:w-1/3 p-1 sm:p-1.5">
                        <img class="rounded-xl cursor-pointer hover:opacity-80 transition-opacity lazyload" data-open="lesson{{ $lesson['lesson'] }}" data-src="https://www.musora.com/cdn-cgi/image/width=1000,quality=95/{{ $lesson['image'] }}">
                    </div>

                    <div class="reveal max-w-2xl" style="max-width:600px" id="lesson{{ $lesson['lesson'] }}" data-reveal data-reset-on-close="false">
                        <img class="lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=1000,quality=95/{{ $lesson['image'] }}">
                        <div class="p-4">
    ...
    <section class="lisa-bio text-white pt-10 md:pt-44 lg:pt-64 pb-0 md:pb-16 lg:pb-36 px-4 relative bg-cover bg-top lazyload" style="background-color:#100924;" data-bg="https://www.musora.com/cdn-cgi/image/width=1900,quality=95/https://d21xeg6s76swyd.cloudfront.net/products/singing-starter-kit/bio-bg.jpg">
        <div class="container mx-auto max-w-5xl relative z-10">
            <div class="md:flex flex-wrap md:w-7/12 ml-auto order-1 text-center md:text-left">
                ...
                <img class="h-10 md:h-20 lg:h-24 mt-2 md:mt-3 mb-44 md:mb-5" src="https://www.musora.com/cdn-cgi/image/width=880,quality=95/https://d21xeg6s76swyd.cloudfront.net/products/singing-starter-kit/lisa.png">
            ...
            <div class="slick-2 mx-auto text-left" style="max-width:1100px;">
                <div class="px-2">
                    <div class="rounded-2xl p-3 md:p-8" style="background:linear-gradient(to bottom, #1e0338, #060416)">
                        ...
                        <div class="flex items-center pt-5 md:pt-8">
                            <img class="rounded-full w-1/4 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=140,quality=95/https://d21xeg6s76swyd.cloudfront.net/products/singing-starter-kit/diane.jpg">
                ...
                <div class="px-2">
                    <div class="rounded-2xl p-3 md:p-8" style="background:linear-gradient(to bottom, #1e0338, #060416)">
                        ...
                        <div class="flex items-center pt-5 md:pt-8">
                            <img class="rounded-full w-1/4 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=140,quality=95/https://d21xeg6s76swyd.cloudfront.net/products/singing-starter-kit/susan.jpg">
                            <div class="text pl-3 md:pl-5">
                ...
                <div class="px-2">
                    <div class="rounded-2xl p-3 md:p-8" style="background:linear-gradient(to bottom, #1e0338, #060416)">
                        ...
                        <div class="flex items-center pt-5 md:pt-8">
                            <img class="rounded-full w-1/4 lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=140,quality=95/https://d21xeg6s76swyd.cloudfront.net/products/singing-starter-kit/kelly.jpg">
                            <div class="text pl-3 md:pl-5">
    ...
    <section class="text-white pb-20 md:pb-20 lg:pb-24" style="background:#000419;">
        <div class="container mx-auto">
            <div class="flex items-start lg:items-center flex-wrap md:flex-nowrap max-w-5xl mx-auto px-5 md:px-6 lg:px-8 text-center md:text-left">
                <img class="w-36 md:w-52 lg:w-60 mb-5 md:mb-0 mx-auto md:order-1 inline-block lazyload" data-src="https://www.musora.com/cdn-cgi/image/width=480,quality=95/https://d21xeg6s76swyd.cloudfront.net/sales/2021/guarantee.png">
