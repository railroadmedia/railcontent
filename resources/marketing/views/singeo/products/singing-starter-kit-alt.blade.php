            ...
            <div class="flex flex-wrap justify-center mt-3 sm:mt-5">
                ...
                @foreach($lessons as $lesson)
                    <div class="w-1/2 sm:w-1/3 p-1 sm:p-1.5">
                        <img class="rounded-xl cursor-pointer hover:opacity-80 transition-opacity lazyload" data-open="lesson{{ $lesson['lesson'] }}" data-src="https://cdn.musora.com/image/fetch/w_1000,q_auto:best/{{ $lesson['image'] }}">
                    </div>

                    <div class="reveal" style="max-width:600px" id="lesson{{ $lesson['lesson'] }}" data-reveal data-reset-on-close="false">
                        <img class="lazyload" data-src="https://cdn.musora.com/image/fetch/w_1000,q_auto:best/{{ $lesson['image'] }}">
                        <div class="p-4">
