...
{{--        </div>--}}
{{--    </div>--}}
{{--    <div class="inset-0 block sm:hidden absolute bg-center bg-cover z-0" style="background-image:url(https://www.musora.com/cdn-cgi/image/width=750,quality=95/https://dpwjbsxqtam5n.cloudfront.net/promos/november/header-banner-bg-m.jpg);"></div>--}}
{{--    <div class="inset-0 block sm:hidden absolute bg-center bg-cover z-0" style="background-image:url(https://www.musora.com/cdn-cgi/image/width=750,quality=95/https://dpwjbsxqtam5n.cloudfront.net/promos/november/header-banner-bg-m2.jpg);"></div>--}}
{{--    <div class="inset-0 hidden sm:block absolute bg-center bg-cover z-0" style="background-image:url(https://www.musora.com/cdn-cgi/image/width=2000,quality=95/https://dpwjbsxqtam5n.cloudfront.net/promos/november/header-banner-bg.jpg);"></div>--}}
{{--</section>--}}
