            ...
            @foreach(array_filter($bundles, function($val){if($val['visible'] === 1){ return 1; }}) as $key => $bundle)
                <div class="card-wrap">
                    <a href="{{ $bundle['slug'] }}" class="bundle-card">
                        ...
                        <div class="bg-center bg-cover pb-40 sm:pb-56 lg:pb-72" style="background-image:url(https://www.musora.com/musora-cdn/image/width=2000,quality=95/{{ $bundle['img'] }});"></div>
