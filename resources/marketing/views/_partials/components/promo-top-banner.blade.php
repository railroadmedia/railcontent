<section class="relative text-center py-7 md:py-12 px-4 md:px-0 overflow-hidden">
    ...
    <div class="container mx-auto relative z-10">
        <div>
            <img class="sm:h-32 md:h-44 lg:h-48 mb-2 md:mb-4 -mt-10 sm:-mt-16 {{ $logoStyles }}" src="https://www.musora.com/musora-cdn/image/quality=95,width=250,metadata=none/{{ $logo }}" alt="drumeo summer sale logo" fetchpriority="high">
