<section class="relative text-center py-7 md:py-12 px-4 md:px-0">
    <picture>
    ...
    <div class="container mx-auto relative z-10">
        <div>
            <img class="sm:h-32 md:h-44 lg:h-48 -mt-10 sm:-mt-16" src="https://www.musora.com/musora-cdn/image/quality=100,width=250,metadata=none/{{ $logo }}" alt="drumeo summer sale logo" fetchpriority="high">
            <p class="uppercase text-white">get lessons, accessories, and merch.</p>
