<a class="flex flex-row relative text-[#3F3F46] border-b border-[#E4E4E7] no-underline hover:bg-[#E7EFF6] group py-2 px-3" href="/{{ $lessonURL }}">
    <div class="flex flex-col text-[#00101D] align-left justify-center hide-xs-only font-black text-lg xl:text-xl" style="flex: 0 0 35px;">{{ $lessonNumber }}</div>
    ...
    <div class="flex flex-col justify-center" style="flex:0 0 35px;">
