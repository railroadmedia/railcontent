<div class="w-full {{ (!empty($stacked) && $stacked) ? 'px-2 sm:px-3' : '' }} mb-2 lg:mb-0">
    ...
    <p class="{{ (!empty($stacked) && $stacked) ? 'my-2 pl-3' : '' }} text-center lg:text-left pl-3">
    ...
    <div class="gap-x-4 flex justify-center lg:justify-start flex-wrap lg:space-x-5 pl-3">
        @foreach ($checkboxItems as $label => $id)
            <div class="relative flex items-start justify-center lg:items-center lg:justify-start lg:space-x-3">
