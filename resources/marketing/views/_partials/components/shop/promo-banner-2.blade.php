<style>
 ...
 <div class="big-promo-banner text-white text-center lg:text-left relative py-2 bg-cover bg-center shadow-lg"
     style="background: url('https://d21q7xesnoiieh.cloudfront.net/fit-in/1000x0/filters:quality(95)/marketing/drumeo/promos/summer-sale/header-bg.webp');">
