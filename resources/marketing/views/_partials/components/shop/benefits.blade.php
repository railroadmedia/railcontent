<div class="py-7 sm:flex">
    ...
    @foreach ($benefits as $benefit)
        <div class="p-3 text-center sm:w-1/3">
            <i class="fas {{ $benefit['icon']  }} text-white rounded-full text-3xl leading-7 w-16 h-16 items-center justify-center mx-auto bg-{{ $theme }}" style="display:flex;"></i>
    ...
    @endforeach
        <div class="p-3 text-center sm:w-1/3">
            <i class="fas fa-smile text-white rounded-full text-3xl leading-7 w-16 h-16 items-center justify-center mx-auto bg-{{ $theme }}" style="display:flex;"></i>
            <div class="text-sm leading-6 mb-4 sm:mb-0">
