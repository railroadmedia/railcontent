<style>
 ...
 <div class="big-promo-banner w-full text-white text-center lg:text-left relative py-2 bg-cover bg-center shadow-lg @if(!empty($isFixed)) z-[60] sticky top-[40px] md:top-[56px] @endif"
     style="background: url('https://d21q7xesnoiieh.cloudfront.net/fit-in/1000x0/filters:quality(95)/marketing/pianote/promos/summer-sale/header-bg.webp'); position: fixed">
   <div class="container max-w-5xl mx-auto px-3">
        <div class="flex flex-col sm:flex-row items-center justify-between">
            <h4 class="text-white uppercase font-semibold tracking-wide font-sans">Final sale</h4>
