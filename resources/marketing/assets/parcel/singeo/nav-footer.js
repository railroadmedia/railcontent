$(document).ready(function (){
    ...
    (function getPopUpCookie() {
        ...
        if (hasCookie < 0 && cookiesEnabled === true && window.location.hostname.endsWith('singeo.com')) {
            setTimeout(function () {
    ...
    function setPopUpCookie() {
        if (!popUp) {
            document.cookie = "cookieAccept=true; expires=" + new Date(2147483647 * 1000).toUTCString() + "; path=/; domain=singeo.com;";
            popUp = true;
        }
    }
