        ...
        sections.each(function () {
            ...
            if (category === 'all') {
                ...
                sectionCards.each(function(){
                    if($(this).hasClass('lightning-deal')){
                        $(this).addClass('hide');
                    }
...
var Sorting = {
    ...
    sortInSection: function(sortValue, sortDirection){
        ...
        $('.lightning-deals-section').addClass('hide');
        $('.scalable-card.lightning-deal').removeClass('hide');
...
$(function () {
    ...
    $('#sortOrder')
        .change(function () {
            var thisSelectLabel = $(this).prev('label');
            var thisFilterValue = $(this).val();

            thisSelectLabel.find('.label-text').text(thisFilterValue);

            switch(thisFilterValue){
                case 'Popularity':
                    Sorting.sortItems('popularity', 'asc');
                    break;
    ...
    $('#sortBySection')
        .change(function () {
            ...
            switch(thisFilterValue){
                case 'Popularity':
                    Sorting.sortInSection('popularity', 'asc');
                    break;
                case 'Price: Low to High':
