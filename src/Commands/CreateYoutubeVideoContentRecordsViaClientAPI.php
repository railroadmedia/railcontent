...
class CreateYoutubeVideoContentRecordsViaClientAPI extends Command
{
     ...
     * @var string
     */
    protected $signature = 'command:CreateYoutubeVideoContentRecordsViaClientAPI {maxPages?} {skipPages?}';
    ...
    public function handle()
    {
        ...
        $tokenData = $client->refreshToken(
            config('railcontent.video_sync.youtube_client_api.refresh_token')
        );
...
//                    $this->info('Retrieved video ' . $videoId . ' with duration value of ' . $duration);
        ...
        foreach ($items as $video) {
            ...
            // create if needed
            $existingRecords = $this->contentService->getBySlugAndType(
        ...
        $this->info('CreateYoutubeVideoContentRecordsViaClientAPI complete.');
    }
