...
class PlaylistListener
{
    ...
    public function handlePlaylistItemsUpdated(PlaylistItemsUpdated $playlistItemsUpdated)
    {
      //  Decorator::$typeDecoratorsEnabled = false;
        ...
        $duration = $contents->sumFetched('fields.length_in_seconds') + $contents->sumFetched('fields.video.fields.length_in_seconds') + $contents->sumFetched('assignments_duration');
