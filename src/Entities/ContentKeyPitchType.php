...
/**
 * @ORM\Entity(repositoryClass="Railroad\Railcontent\Repositories\ContentKeyPitchTypeRepository")
 * @ORM\HasLifecycleCallbacks
 * @ORM\Table(name="railcontent_content_key_pitch_type")
 *
 */
class ContentKeyPitchType
{
    /**
