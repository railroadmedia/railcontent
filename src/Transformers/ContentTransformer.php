    ...
    public function transform($data)
    {
        ...
        if (!is_array($data[array_key_first($data)])) {
            ...
            $content = [
                ...
                'enrollment_start_time' => $data['enrollment_start_time'],
                'enrollment_end_time' => $data['enrollment_end_time'],
            ...
            foreach ($data as $rowIndex => $row) {
                ...
                if (is_array($row) && (isset($row['id']))) {
                    ...
                    $content[$row['id']] = [
                        ...
                        'enrollment_start_time' => $row['enrollment_start_time'],
                        'enrollment_end_time' => $row['enrollment_end_time'],
