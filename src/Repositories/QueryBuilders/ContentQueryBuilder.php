    ...
    public function selectPrimaryColumns()
    {
        $this->addSelect(
            [
                ...
                ConfigService::$tableContent . '.quarter_published as quarter_published',
                ConfigService::$tableContent . '.quarter_removed as quarter_removed',
            ]
        );
    ...
    public function selectFilterOptionColumns()
    {
        $this->addSelect(
            [
                ...
                ConfigService::$tableContent . '.instrument as content_instrument',
