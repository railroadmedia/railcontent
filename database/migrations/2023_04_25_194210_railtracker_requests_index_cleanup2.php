...
return new class () extends Migration {
    ...
    public function up(): void
    {
        ...
        if (!app()->environment('testing')) {
            Schema::connection('drumeo_laravel_mysql_writer_only')
                ->table('railtracker4_requests', function (Blueprint $table) {
            ...
            Schema::connection('pianote_laravel_mysql_writer_only')
                ->table('railtracker4_requests', function (Blueprint $table) {
                    $table->dropForeign('railtracker4_requests_url_protocol_foreign');
                    $table->dropForeign('railtracker4_requests_referer_url_protocol_foreign');
                    $table->dropForeign('railtracker4_requests_url_domain_foreign');
            ...
            Schema::connection('guitareo_laravel_mysql_writer_only')
                ->table('railtracker4_requests', function (Blueprint $table) {
                    $table->dropForeign('railtracker4_requests_url_protocol_foreign');
                    $table->dropForeign('railtracker4_requests_referer_url_protocol_foreign');
                    $table->dropForeign('railtracker4_requests_url_domain_foreign');
            ...
            Schema::connection('singeo_laravel_mysql_writer_only')
                ->table('railtracker4_requests', function (Blueprint $table) {
                    $table->dropForeign('railtracker4_requests_url_protocol_foreign');
                    $table->dropForeign('railtracker4_requests_referer_url_protocol_foreign');
                    $table->dropForeign('railtracker4_requests_url_domain_foreign');
