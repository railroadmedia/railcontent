...
class BFUpdates extends Seeder
{
    ...
    public function run()
    {
        ...
        Product::where('brand_id', 1)->where('name', 'Electrify Your Drumming')->update(['discounted_price' => 77]);
        ...
        Product::where('brand_id', 1)->where('name', 'Vater Drumeo 5A Drumsticks')->update(['discounted_price' => 9.65]);
        Product::where('brand_id', 1)->where('name', 'Drumeo QuietPad')->update(['discounted_price' => 29.99]);
        ...
        Product::where('brand_id', 1)->where('name', 'The Best Beginner Drum Book')->update(['discounted_price' => 22.50]);
        Product::where('brand_id', 1)->where('name', 'The Drummer’s Toolbox')->update(['discounted_price' => 22.50]);
        ...
        Product::where('brand_id', 1)->where('name', 'Easy Rudiments')->update(['discounted_price' => 22.50]);

        Product::where('brand_id', 1)->where('product_type_id', 4)->update(['discounted_price' => 20]);
        ...
        Product::where('brand_id', 2)->where('product_type_id', 3)->update(['discounted_price' => 17]);
        Product::where('brand_id', 2)->where('product_type_id', 4)->update(['discounted_price' => 20]);
...
//        todo socks price
        ...
        Product::where('brand_id', 3)->where('name', "Guitarist's Survival Kit")->update(['discounted_price' => 67]);
        ...
        Product::where('brand_id', 4)->where('name', 'Do Re Mi Tumbler')->update(['discounted_price' => 21.70]);
        ...
        Product::where('brand_id', 4)->where('product_type_id', 4)->update(['discounted_price' => 20]);
