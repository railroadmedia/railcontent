    ...
    public function run()
    {
        $products = [
            [
                ...
                "metaDesc" => "",
                "metaImg" => "",
                "shortDesc" => "The Ultimate Online Drum Lessons Experience. You’ll get step-by-step drum lessons from the best drummers in the world (and much more).",
                "headerText" => "",
                "price" => 240,
                "discountedPrice" => "",
                "features" => [
                ...
                "page_logo" => "",
                "video" => "",
                "instructorName" => "Award-Winning Membership",
                "instructorDesc" => "",
                "instructorImg" => null,
                "studyText" => "",
                "overview" => "",
            ...
            [
                ...
                "metaDesc" => "",
                "metaImg" => "",
                "shortDesc" => "Make the jump from beginner to intermediate drummer",
                "headerText" => "",
                "price" => 127,
                "discountedPrice" => "",
                "features" => [
            ...
            [
                ...
                "metaDesc" => "The fastest way to get started on the drums and play the songs you love.",
                "metaImg" => "https://drumeo-assets.s3.amazonaws.com/drum-shop/new-drummers/og-image.jpg",
                "shortDesc" => "Your guide to go from a total beginner to playing drums with real music in 90-days or less.",
                "headerText" => "",
                "price" => 7,
                "discountedPrice" => "",
                "features" => [
            ...
            [
                ...
                "metaDesc" => "",
                "metaImg" => "",
                "shortDesc" => "Todd Sucherman’s 26-week course to rapidly improve your rock drumming -- featuring weekly video lessons and hand-picked exercises.",
                "headerText" => "",
            ...
            [
                ...
                "metaDesc" => "",
                "metaImg" => "",
                "shortDesc" => "Bruce Becker’s 26-week course to improve your hand technique and foot technique on the drums -- featuring weekly video lessons and exercises.",
                "headerText" => "",
                "speicalText" => "Or free with Drumeo",
                "price" => 197,
                "discountedPrice" => "",
            ...
            [
                ...
                "metaDesc" => "",
                "metaImg" => "",
                "shortDesc" => "Jared Falk’s 26-week course to unlock your musicality and creativity on the drums -- with weekly video lessons and hand-picked exercises.",
                "headerText" => "",
                "speicalText" => "Or free with Drumeo",
                "price" => 197,
                "discountedPrice" => "",
            ...
            [
                ...
                "metaDesc" => "",
                "metaImg" => "",
                "shortDesc" => "Your guide to learning MORE songs in less time with Jared Falk & Dave Atkinson",
                "headerText" => "",
                "speicalText" => "Or free with Drumeo",
                "price" => 19,
                "discountedPrice" => "",
                ...
                "page_logo" => "",
                "video" => "",
                "instructorName" => "Jared Falk & Dave Atkinson",
                "instructorDesc" => "",
                "instructorImg" => "",
                "studyText" => "",
                "overview" => "",
            ...
            [
                ...
                "metaDesc" => "",
                "metaImg" => "",
                "shortDesc" => "The ultimate crash course to playing more creative & more musical drum fills your audience will love!",
                "headerText" => "",
                "speicalText" => "Or free with Drumeo",
                "price" => 97,
                "discountedPrice" => "",
            ...
            [
                ...
                "metaDesc" => "",
                "metaImg" => "",
                "shortDesc" => "The ultimate guide to playing electronic dance music on the drums.",
                "headerText" => "",
                "speicalText" => "Or free with Drumeo",
                "price" => 197,
                "discountedPrice" => 97,
            ...
            [
                ...
                "metaDesc" => "",
                "metaImg" => "",
                "shortDesc" => "Jared Falk’s step-by-step curriculum for building a rock-solid foundation on the drums -- with 18 hours of video lessons and a 274-page workbook.",
                "headerText" => "",
                "price" => 247,
                "discountedPrice" => 197,
                "features" => [
            ...
            [
                ...
                "metaDesc" => "",
                "metaImg" => "",
                "shortDesc" => "Mike Michalkow’s encyclopedia of drum lessons -- with more than 30 hours of video lessons on every topic that most drummers ever want to learn.",
                "headerText" => "",
                "speicalText" => "Or free with Drumeo",
                "price" => 247,
                "discountedPrice" => 197,
...
All sheet music features Drumeo SmartBeat Sheet Music for playing or pausing the notation, speeding up or slowing down the exercises, and creating loops to improve your learning experience. You’ll also get online access to Drumeo features like progress tracking, video commenting, and community forums where you can connect with students and teachers from around the world.",
            ...
            [
                ...
                "metaDesc" => "",
                "metaImg" => "",
                "shortDesc" => "Perfectly structured step by step lessons, with teachers that are fun to watch, and unlimited support - 100% guaranteed. Learn piano online the easy way.",
                "headerText" => "",
                "price" => 197,
                "discountedPrice" => "",
                "features" => [
            ...
            [
                ...
                "metaDesc" => "",
                "metaImg" => "",
                "shortDesc" => "Start playing beautiful piano music from your very first lesson.",
                "headerText" => "",
                "price" => 7,
                "discountedPrice" => "",
                "features" => [
            ...
            [
                ...
                "metaDesc" => "",
                "metaImg" => "",
                "shortDesc" => "Don’t you want your playing to sound... better?",
                "headerText" => "",
                "price" => 99,
                "discountedPrice" => "",
                "features" => [
            ...
            [
                ...
                "metaDesc" => "",
                "metaImg" => "",
                "shortDesc" => "Start playing piano or keyboard in your church.",
                "headerText" => "",
                "price" => 99,
                "discountedPrice" => "",
                "features" => [
                ...
                "page_logo" => "",
                "video" => "",
                "instructorName" => "Lisa Witt & Amberly Martz",
                "instructorDesc" => "",
                "instructorImg" => "",
                "studyText" => "",
                "overview" => "",
            ...
            [
                ...
                "metaDesc" => "",
                "metaImg" => "",
                "shortDesc" => "Master the fundamentals -- so you can play anything you want on the piano.",
                "headerText" => "",
                "price" => 120,
                "discountedPrice" => "",
                "features" => [
            ...
            [
                ...
                "metaDesc" => "",
                "metaImg" => "",
                "shortDesc" => "It’s time to tame your left hand.",
                "headerText" => "",
                "price" => 99,
                "discountedPrice" => "",
                "features" => [
            ...
            [
                ...
                "metaDesc" => "",
                "metaImg" => "",
                "shortDesc" => "Play faster, make fewer mistakes, and learn songs quickly!",
                "headerText" => "",
                "price" => 99,
                "discountedPrice" => "",
                "features" => [
            ...
            [
                ...
                "metaDesc" => "",
                "metaImg" => "",
                "shortDesc" => "The shortcuts to sounding great on the piano.",
                "headerText" => "",
                "price" => 99,
                "discountedPrice" => "",
                "features" => [
            ...
            [
                ...
                "metaDesc" => "",
                "metaImg" => "",
                "shortDesc" => "The fun way to start playing classical piano.",
                "headerText" => "",
                "price" => 47,
                "discountedPrice" => "",
                "features" => [
                ...
                "page_logo" => "",
                "video" => "",
                "instructorName" => "Victoria Theodore",
                "instructorDesc" => "",
                "instructorImg" => "",
                "studyText" => "",
                "overview" => "",
            ...
            [
                ...
                "metaDesc" => "",
                "metaImg" => "",
                "shortDesc" => "Unlimited guitar lessons, a huge song library, and ongoing support from real teachers.",
                "headerText" => "",
                "price" => 127,
                "discountedPrice" => "",
                "features" => [
                ...
                "page_logo" => "",
                "video" => "",
                "instructorName" => "Ayla Tesler-Mabe",
                "instructorDesc" => "",
                "instructorImg" => "",
                "studyText" => "",
                "overview" => "",
            ...
            [
                ...
                "metaDesc" => "",
                "metaImg" => "",
                "shortDesc" => "Learn the most important guitar techniques and reach total guitar freedom.",
                "headerText" => "",
                "price" => 197,
                "discountedPrice" => "",
                "features" => [
            ...
            [
                ...
                "metaDesc" => "",
                "metaImg" => "",
                "shortDesc" => "Transform your guitar playing with the ultimate encyclopedia of guitar lessons.",
                "headerText" => "",
                "price" => 197,
                "discountedPrice" => "",
                "features" => [
            ...
            [
                ...
                "metaDesc" => "",
                "metaImg" => "",
                "shortDesc" => "Build a rock-solid foundation and get started on the acoustic guitar the right way.",
                "headerText" => "",
                "price" => 197,
                "discountedPrice" => "",
                "features" => [
            ...
            [
                ...
                "metaDesc" => "",
                "metaImg" => "",
                "shortDesc" => "Build the skills and knowledge to play 500 songs on the guitar. Comes with downloadable chord charts.",
                "headerText" => "",
                "price" => 97,
                "discountedPrice" => "",
                "features" => [
            ...
            [
                ...
                "sku" => "BDS2-DIGI",
                "thumbnail" => "",
                "metaDesc" => "ass Drum Secrets includes over 15 hours of video training to help you improve your bass drum speed, power, and control.",
                "metaImg" => "",
                "shortDesc" => "",
                "headerText" => "Improve your bass drum speed, power, & control",
                "price" => 0,
                "discountedPrice" => "",
                "features" => [
...
Beyond the use of specific techniques, these three instructors bring unique advice, tips and tricks, and practical applications to the BDS 2.0 lessons. This allows you to choose from several options when applying essential concepts within your drumming. Ultimately, it will allow you to refine your own unique drumming style instead of adopting a single point of view.",
                "instructorImg" => "https://s3.amazonaws.com/drumeo-packs/Instructors/jared-dave-sean.jpg",
                "benefits" => [
                    [
                        "icon" => "fa-list",
...
This powerful resource makes it easy to access your lessons anytime from virtually anywhere. It's works on PCs, Macs, iPads, iPhones, Android devices, and other mobile computers that have an active Internet connection. Best of all, you get unlimited lifetime access to the Cobus Method members area, so you can enjoy the lessons for years to come.",
            ...
            [
                ...
                "sku" => "TCM-DIGI",
                "thumbnail" => "",
                "metaDesc" => "The Cobus Method by Cobus Potgieter will show you how to play the drums completely by ear - with step by step video drum lessons for drummers of all levels.",
                "metaImg" => "",
                "shortDesc" => "",
                "headerText" => "The Cobus Method",
                "price" => 0,
                "discountedPrice" => "",
                "features" => [
                ...
                "instructorName" => "Cobus Potgieter",
                "instructorDesc" => "Cobus Potgieter is a self-taught phenom who has taken the drumming world by storm with his passionate approach and unique style - all without a single professional drum lesson.
...
In the Cobus Method training system, Cobus explores the boundaries of learning how to play the drums 100% by ear. He takes you through all of his strategies, including: how to learn to play songs by ear, how to make your own songs, and how to write new and unique drum parts while working with professional studio musicians.",
                "instructorImg" => "https://s3.amazonaws.com/drumeo-packs/Instructors/cobus-potgieter.jpg",
                "benefits" => [
                    [
                        "icon" => "fa-list",
...
This powerful resource makes it easy to access your lessons anytime from virtually anywhere. It's works on PCs, Macs, iPads, iPhones, Android devices, and other mobile computers that have an active Internet connection. Best of all, you get unlimited lifetime access to the Cobus Method members area, so you can enjoy the lessons for years to come.",
            ...
            [
                ...
                "sku" => "DFS-DIGI",
                "thumbnail" => "",
                "metaDesc" => "The Drum Fill System will help you learn how to play more creative, dynamic drum fills so you can spice up your drumming and add some extra flare to any song!",
                "metaImg" => "",
                "shortDesc" => "",
                "headerText" => "Unlock your natural ability to play creative drum fills",
                "price" => 0,
                "discountedPrice" => "",
                "features" => [
...
This powerful resource makes it easy to access your lessons anytime from virtually anywhere. It's works on PCs, Macs, iPads, iPhones, Android devices, and other mobile computers that have an active Internet connection. Best of all, you get unlimited lifetime access to the Drum Fill System members area, so you can enjoy the lessons for years to come.",
            ...
            [
                ...
                "sku" => "DPAS-DIGI",
                "thumbnail" => "",
                "metaDesc" => "The Drum Play-Along System includes 50 play-along songs, so you can jam-along to rock, jazz, latin, pop rock, folk rock, and hard rock songs!",
                "metaImg" => "",
                "shortDesc" => "",
                "headerText" => "50 play-along songs to boost your creativity on the drums",
                "price" => 0,
                "discountedPrice" => "",
                "features" => [
                ...
                "instructorName" => "",
                "instructorDesc" => "",
                "instructorImg" => "https://s3.amazonaws.com/drumeo-packs/Pack%20Images/Drum%20Play-Along%20System/spread.png",
                "benefits" => [
                    [
                        "icon" => "fa-list",
...
This powerful resource makes it easy to access your lessons anytime from virtually anywhere. It's works on PCs, Macs, iPads, iPhones, Android devices, and other mobile computers that have an active Internet connection. Best of all, you get unlimited lifetime access to the Drum Play-Along System members area, so you can enjoy the lessons for years to come.",
            ...
            [
                ...
                "sku" => "DRUDSYS-DIGI",
                "thumbnail" => "",
                "metaDesc" => "Learn how to play all 40 drum rudiments with these simple video drum lessons by renowned instructor Lionel Duperron.",
                "metaImg" => "",
                "shortDesc" => "",
                "headerText" => "Boost your drumming by mastering the 40 rudiments",
                "price" => 0,
                "discountedPrice" => "",
                "features" => [
...
This powerful resource makes it easy to access your lessons anytime from virtually anywhere. It's works on PCs, Macs, iPads, iPhones, Android devices, and other mobile computers that have an active Internet connection. Best of all, you get unlimited lifetime access to the Drum Rudiment System members area, so you can enjoy the lessons for years to come.",
            ...
            [
                ...
                "sku" => "DTUNESYS-DIGI",
                "thumbnail" => "",
                "metaDesc" => "The Drum Tuning System gives you tips for cleaning, tuning, and maintaining your drums so you can get the most value out of your kit!",
                "metaImg" => "",
                "shortDesc" => "",
                "headerText" => "",
                "price" => 0,
                ...
                "instructorName" => "Mike Michalkow",
                "instructorDesc" => "Mike Michalkow has been teaching drums and percussion for more than 20 years, having studied under master drummers Dom Famularo, Jim Chapin, Chuck Silverman, Thomas Lang, John “JR” Robinson, Peter Magadini, and Virgil Donati.
...
Mike’s comprehensive teaching methods have helped thousands of drummers around the world reach their goals, through his best-selling training packs including The Drumming System, Jazz Drumming System, Latin Drumming System, Moeller Method Secrets, and Total Rock Drummer.",
                "instructorImg" => "https://s3.amazonaws.com/drumeo-packs/Instructors/mike-michalkow.jpg",
                "benefits" => [
                    [
                        "icon" => "fa-list",
...
This powerful resource makes it easy to access your lessons anytime from virtually anywhere. It's works on PCs, Macs, iPads, iPhones, Android devices, and other mobile computers that have an active Internet connection. Best of all, you get unlimited lifetime access to the Drum Tuning System members area, so you can enjoy the lessons for years to come.",
            ...
            [
                ...
                "sku" => "JDS-DIGI",
                "thumbnail" => "",
                "metaDesc" => "The Jazz Drumming System is a complete and comprehensive solution for drummers interested in learning to play jazz music - with over seven hours of step-by-step video training by Mike Michalkow.",
                "metaImg" => "https://s3.amazonaws.com/drumeo-packs/Pack%20Images/Jazz%20Drumming%20System/thumbnail.jpg",
                "shortDesc" => "",
                "headerText" => "The ultimate guide for playing jazz music on the drums",
                "price" => 0,
                "discountedPrice" => "",
                "features" => [
...
This powerful resource makes it easy to access your lessons anytime from virtually anywhere. It's works on PCs, Macs, iPads, iPhones, Android devices, and other mobile computers that have an active Internet connection. Best of all, you get unlimited lifetime access to the Jazz Drumming System members area, so you can enjoy the lessons for years to come.",
            ...
            [
                ...
                "sku" => "LDS-DIGI",
                "thumbnail" => "",
                "metaDesc" => "The Latin Drumming System is a complete and comprehensive solution for drummers interested in learning to play latin music - with over five hours of step-by-step video training by Mike Michalkow.",
                "metaImg" => "https://s3.amazonaws.com/drumeo-packs/Pack%20Images/Latin%20Drumming%20System/thumbnail.jpg",
                "shortDesc" => "",
                "headerText" => "The ultimate guide for playing latin music on the drums",
                "price" => 0,
                "discountedPrice" => "",
                "features" => [
                    "Split screen video makes learning simple",
...
This powerful resource makes it easy to access your lessons anytime from virtually anywhere. It's works on PCs, Macs, iPads, iPhones, Android devices, and other mobile computers that have an active Internet connection. Best of all, you get unlimited lifetime access to the Latin Drumming System members area, so you can enjoy the lessons for years to come.",
            ...
            [
                ...
                "sku" => "MM-DIGI",
                "thumbnail" => "",
                "metaDesc" => "Meytal Cohen's Maximum Meytal video training pack will help anyone learn how to play rock music on the drums, with step-by-step lessons for all levels.",
                "metaImg" => "",
                "shortDesc" => "",
                "headerText" => "Build your foundation & improve your creativity on the drums",
                "price" => 0,
                "discountedPrice" => "",
                "features" => [
                ...
                "instructorName" => "Meytal Cohen",
                "instructorDesc" => "Meytal Cohen was born in Israel. She is the youngest of seven children with four sisters and two brothers. Her father passed away when she was in the second grade, so her mom raised all seven children. They would eventually become doctors and lawyers - except for Meytal.
...
Her big break came when she teamed up with two friends to film an electric violin version of Toxicity by System Of A Down. It was to be an audition tape for America's Got Talent, but it ended up having far greater success on YouTube. As a result, Meytal continued to upload videos. Today she has over 430,000 subscribers and well over 75,000,000 video views on YouTube. In addition, she has nearly half a million fans following her on Facebook.",
                "instructorImg" => "https://s3.amazonaws.com/drumeo-packs/Instructors/meytal-cohen.jpg",
                "benefits" => [
                    [
                        "icon" => "fa-list",
...
This powerful resource makes it easy to access your lessons anytime from virtually anywhere. It's works on PCs, Macs, iPads, iPhones, Android devices, and other mobile computers that have an active Internet connection. Best of all, you get unlimited lifetime access to the Maximum Meytal members area, so you can enjoy the lessons for years to come.",
            ...
            [
                ...
                "sku" => "MOELLERMS-DIGI",
                "thumbnail" => "",
                "metaDesc" => "The Moeller Method Secrets video lessons will teach you the moeller technique to help you improve your hand speed, power, and control on the drums.",
                "metaImg" => "",
                "shortDesc" => "",
                "headerText" => "The proven method to improve your hand speed, power, & control",
                "price" => 0,
                "discountedPrice" => "",
                "features" => [
...
//            ],
        ...
        foreach($products as $product){
            ...
            $newProduct = Product::create([
                            ...
                            'meta_img' => empty($product['metaImg']) ? null : $product['metaImg'],
                            'special_text' => empty($product['specialText']) ? null : $product['specialText'],
                            ...
                            'product_img' => empty($product['instructorImg']) ? null : $product['instructorImg'],
