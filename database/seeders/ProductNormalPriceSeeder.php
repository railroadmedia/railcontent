...
class ProductNormalPriceSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        Product::where('brand_id', 1)->where('name', 'Electrify Your Drumming')->update(['discounted_price' => 197]);
        ...
        Product::where('brand_id', 1)->where('name', 'The Drumeo Foiled Water Bottle')->update(['discounted_price' => 29]);
        ...
        Product::where('brand_id', 2)->where('name', 'The Most Beautiful Classical Piano Pieces')->update(['discounted_price' => 49]);
        ...
        Product::where('brand_id', 2)->where('product_type_id', 4)->update(['discounted_price' => 29]);
        Product::where('brand_id', 2)->where('product_type_id', 5)->update(['discounted_price' => 59]);
        ...
        Product::where('brand_id', 3)->where('name', "Chords & Scales Poster")->update(['discounted_price' => 12]);
        Product::where('brand_id', 3)->where('name', "Guitarist's Survival Kit")->update(['discounted_price' => 89]);
        Product::where('brand_id', 3)->where('name', "The Guitareo Foiled Water Bottle")->update(['discounted_price' => 29]);
        ...
        Product::where('brand_id', 4)->where('name', "The Singeo Foiled Water Bottle")->update(['discounted_price' => 29]);
    }
}
